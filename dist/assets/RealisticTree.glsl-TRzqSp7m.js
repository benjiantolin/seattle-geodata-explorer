import{ik as $e,Z as x,aK as k,bi as Fe,jt as et,g as Bt,eM as Ht,i9 as Wt,fr as V,hZ as kt,pT as Ut,k1 as Yt,xR as tt,_ as c,x as H,y as at,xS as Zt,xT as qt,kf as Q,aa as ot,k8 as Oe,i7 as Ge,hX as Xt,m7 as Jt,xU as U,a6 as he,Y as rt,k2 as ne,cM as re,dy as Kt,dA as Qt,l as ea,c3 as ta,jB as aa,e0 as oa,aw as z,eg as ra,ir as ia,bz as na,ap as sa,ao as we,dY as la,am as je,an as ca,h_ as da,aA as ua}from"./index-CSq8vRn8.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as D,b4 as G,G as K,b as y,I as j,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,W as oe,ba as $a,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,Q as Oa,U as Na,N as Ia,O as La,P as Va,R as Pa,V as Ea,X as Ra,T as Aa,Y as Da,x as m,A as Ga,bd as ye,be as Me,a1 as ja,aq as Ba,B as Ha,aS as Wa,a3 as ka,az as Ua}from"./OutputColorHighlightOID.glsl-D2YBZHSb.js";import{t as ze,Q as Le}from"./InterleavedLayout-CURfrff4.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-B73IRyVx.js";import{r as Ya}from"./VertexBuffer-B2n6U6Qu.js";import{g as Za}from"./plane-pnPndfZh.js";import{T as Ve,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-CUtDDuye.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `),e.include(Ft,a),r.include(Ee,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),r.uniforms.add(o.uniforms.get("localOrigin"),new ee("ambient",b=>b.ambient),new ee("diffuse",b=>b.diffuse),new N("opacity",b=>b.opacity),new N("layerOpacity",b=>b.layerOpacity)),O&&r.uniforms.add(new y("tex",b=>b.texture)),e.include(Ot,a),r.include(Re,a),r.include(Pt),e.include(No,a),r.include(Et,a),Ae(r),De(r),te(r),r.main.add(i`
    discardBySlice(vpos);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),r.include(Ee,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),ue(r),Ae(r),De(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),r.include(Re,a),r.include(Pt),r.include(Et,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();

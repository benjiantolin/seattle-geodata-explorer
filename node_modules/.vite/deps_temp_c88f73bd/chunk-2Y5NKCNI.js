...
async function G2() {
  has("host-webworker") && (!M2 && globalThis.invokeStaticMessage ? M2 = await import("./request-6HFW754G.js") : R3 = true);
}
async function J2() {
  s4 || await import("./IdentityManager-YBGP3BZ3.js");
}
...
async function te(e5) {
  ...
  if (!r4) return se(e5);
  const { QueueProcessor: t5 } = await import("./QueueProcessor-NXRZCAK7.js"), s5 = e(re, r4.origin, () => {
...
//# sourceMappingURL=chunk-2Y5NKCNI.js.map

...
var n5 = null;
function r5() {
  return n5 || (n5 = import("./lerc-wasm-XNHGKUEF.js").then((e7) => e7.l).then(({ default: t8 }) => t8({ locateFile: (t9) => n2(`esri/layers/support/rasterFormats/${t9}`) })).then((e7) => {
    l2(e7);
  }), n5);
}
...
var e3;
function o7() {
  return e3 ?? (e3 = import("./qb3-wasm-AWYBFNNZ.js").then(({ default: n15 }) => n15({ locateFile: (n16) => n2(`esri/layers/support/rasterFormats/${n16}`) })).then((t8) => {
    u4(t8);
  })), e3;
}
...
var a11 = i()({ RSP_NearestNeighbor: "nearest", RSP_BilinearInterpolation: "bilinear", RSP_CubicConvolution: "cubic", RSP_Majority: "majority" });
var i10 = i()({ esriNoDataMatchAny: "any", esriNoDataMatchAll: "all" });
...
var O4 = class extends n3 {
  ...
  symbolize(e7) {
    ...
    try {
      ...
      return i2.getLogger(this).error("symbolize", s6.message), t8;
    }
  }
  simpleStretch(e7, t8) {
    if (!T3(e7)) return e7;
    try {
      ...
      return i2.getLogger(this).error("symbolize", s6.message), e7;
    }
  }
...
//# sourceMappingURL=chunk-7UNZOK7I.js.map

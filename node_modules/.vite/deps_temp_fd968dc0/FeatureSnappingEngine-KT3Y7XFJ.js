...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-BS64QR2W.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-S3TVQ7WW.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-R45ENWUL.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-DJXRFXRC.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-KT3Y7XFJ.js.map

import {
  t as t3
} from "./chunk-LNQB4LFV.js";
import {
  e as e3
} from "./chunk-RIOHB6DZ.js";
import {
  e as e4
} from "./chunk-VGQ4YUS4.js";
import {
  i as i2
} from "./chunk-7ZSSTKOI.js";
import {
  r as r4
...
import {
  h as h3,
  h2 as h4
} from "./chunk-DDWI6AZW.js";
import {
  r as r5,
  s as s3
} from "./chunk-PJTZOLPI.js";
import {
  p as p3
} from "./chunk-EQMG7ZUR.js";
import {
  n as n6
} from "./chunk-YGB7KNNT.js";
import {
  i as i3
} from "./chunk-7FOXO2HF.js";
import {
  g as g3,
  v as v3,
  y as y3
} from "./chunk-HEUAOIKM.js";
import {
  g as g2,
  h as h2,
  p as p2
...
var q3 = class extends l {
  ...
  async _createSelfSnappingEngine(e8) {
    const [{ SelfSnappingEngine: t6 }, n11] = await Promise.all([import("./SelfSnappingEngine-KP5QZMZV.js"), g4()]);
  ...
  async _createGridSnappingEngine(e8) {
    ...
    const { GridSnappingEngine: n11 } = await import("./GridSnappingEngine-YTWGMEUY.js");
    return s2(e8), { type: "grid", engine: new n11({ view: t6, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e8) {
    const { FeatureSnappingEngine: t6 } = await import("./FeatureSnappingEngine-KT3Y7XFJ.js");
    s2(e8);
...
async function o2() {
  const e8 = await import("./geometryEngine-OL4TKZHK.js");
  return s4(e8);
}
function n7(t6) {
...
var de2 = class extends l {
  ...
  initialize() {
    this.addHandles([a3(() => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e8 && (this.snappingManager || (this._defaultSnappingManager = new q3({ view: e8, options: this.snappingOptions })), "2d" === e8.type ? import("./editingTools-U7F6BFBT.js") : "3d" === e8.type && (import("./editingTools-VFPIFFR7.js"), import("./GraphicsLayerView3D-VGP7O6IA.js")));
    }, w), l2(() => {
      var _a;
  ...
  async _makeDrawGraphicTool2D(e8) {
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-U7F6BFBT.js")), u5(), c5()]);
  ...
  async _makeDrawGraphicTool3D(e8) {
    var _a;
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-VFPIFFR7.js")), u5(), c5()]);
  ...
  async _setupMove3DOperation(e8, t6, o3, a11, i5 = false) {
    const [s7, n11] = await Promise.all([this._requireModule(import("./editingTools-VFPIFFR7.js")), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _setupPointTransform3DOperation(e8, t6, o3) {
    const a11 = "transform", { enableRotation: i5, enableScaling: s7, enableZ: n11 } = t6, p7 = await this._requireModule(import("./editingTools-VFPIFFR7.js"));
    if (Ge(p7)) return p7;
  ...
  async _setupPolyTransform3DOperation(e8, t6, o3, a11 = false) {
    var _a, _b;
    const i5 = "transform", { enableRotation: s7, enableScaling: n11, enableZ: p7, preserveAspectRatio: l8 } = t6, [h7, c6] = await Promise.all([this._requireModule(import("./editingTools-VFPIFFR7.js")), c5()]);
    if (Ge(h7)) return h7;
  ...
  async _setupReshape3DOperation(e8, t6, o3, a11 = false) {
    const i5 = "reshape", [s7, n11, p7] = await Promise.all([this._requireModule(import("./editingTools-VFPIFFR7.js")), u5(), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _getGraphicMover(e8, t6, o3) {
    const { enableMoveAllGraphics: a11, highlightOptions: i5 } = t6, r9 = await this._requireModule(import("./GraphicMover-6XYKQNCH.js"));
  ...
  async _getBox(e8, t6, o3) {
    var _a, _b;
    const { enableRotation: a11, enableScaling: i5, highlightOptions: r9, preserveAspectRatio: s7 } = t6, [n11, p7] = await Promise.all([this._requireModule(import("./Box-XEMTZRLJ.js")), c5()]);
  ...
  async _getReshape(e8, t6, o3) {
    const { highlightOptions: a11, reshapeOptions: i5 } = t6, r9 = "split" === (i5 == null ? void 0 : i5.edgeOperation), s7 = "move" === (i5 == null ? void 0 : i5.shapeOperation), n11 = !!(i5 == null ? void 0 : i5.enableCreateCurveFromStraightEdge), [p7, l8, h7] = await Promise.all([this._requireModule(import("./Reshape-N6HKGMTZ.js")), u5(), c5()]);
...
//# sourceMappingURL=chunk-MIJG37OT.js.map

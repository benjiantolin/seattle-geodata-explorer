...
var C5 = class extends P2 {
  ...
  vertex(t9) {
    const o19 = new rt(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new Y2(t9.pos.xy.divide(o3), 1)), i10 = wn(this.draw.locations, o19.xy), r10 = Xe(this.instance.dotSize.divide(2), new C2(1));
    let s12 = new C2(0);
...
var O2 = class extends B4 {
  ...
  vertex(t9) {
    const e9 = new rt(2 / o3, 0, 0, 0, -2 / o3, 0, -1, 1, 1).multiply(new Y2(t9.pos, 1)), s12 = this.clip(t9.id), i10 = new _3(e9.xy, s12, 1), r10 = this.storage.getVVData(t9.id).multiply(this.instance.isActive.get(0)).multiply(t9.inverseArea), l10 = this.storage.getDataDrivenData0(t9.id).multiply(this.instance.isActive.get(1)).multiply(t9.inverseArea), d9 = this.draw.tileZoomFactor.multiply(o3).divide(this.draw.pixelRatio), n16 = this._dotThreshold(r10, this.instance.dotValue, this.draw.tileDotsOverArea), c8 = this._dotThreshold(l10, this.instance.dotValue, this.draw.tileDotsOverArea), u18 = t9.pos.add(0.5).divide(d9);
...
var m6 = class {
  ...
  getFBO(t9) {
    if (null == this._dotFBO) {
      const s12 = o3, r10 = o3, i10 = new h2(s12, r10);
  ...
  getDotDensityMesh(t9) {
    if (null == this._dotMesh) {
      const o19 = o3, r10 = o19 * o19, n16 = 2, d9 = new Int16Array(r10 * n16);
...
//# sourceMappingURL=chunk-46U7KJRK.js.map

...
var E2 = class {
  ...
  async _createAutoIntervalBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7, normalizationField: a4, numBins: r5, normalizationType: n5, normalizationTotal: o2, start: l7, end: u5 } = e5, c4 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), m8 = G2(c4, { field: s7, normalizationField: a4, normalizationType: n5, normalizationTotal: o2, numBins: r5, minValue: h2(l7, false), maxValue: h2(u5, false) }), d6 = this._calculateHistogramBins(c4, m8, i3);
...
//# sourceMappingURL=chunk-TG2J5DJP.js.map

...
import {
  ...
  u,
  v
} from "./chunk-4O3GNO36.js";
import "./chunk-V7TIH5Q6.js";
import {
  e as e4
...
var j2 = class extends s2(B) {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-MXUX3AVD.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-R5EUZ7N7.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

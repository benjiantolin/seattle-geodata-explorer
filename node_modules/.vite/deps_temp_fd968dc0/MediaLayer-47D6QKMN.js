...
import {
  p as p4
} from "./chunk-P7KHYHBL.js";
import "./chunk-4EZJEMIN.js";
import {
  p as p5
} from "./chunk-MNHGU67B.js";
import {
  N,
  W,
  X
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-KJHICSCI.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
...
//# sourceMappingURL=MediaLayer-47D6QKMN.js.map

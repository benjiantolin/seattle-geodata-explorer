...
import {
  d as d5
} from "./chunk-V4LEYPP6.js";
import "./chunk-FI6YY3FK.js";
import {
  U as U3,
  ie,
  w as w3
} from "./chunk-Y25OMHCK.js";
import "./chunk-OCKIDAOE.js";
import {
  c as c4
} from "./chunk-ROUWFFTF.js";
import "./chunk-EC56NYYL.js";
import "./chunk-EMYTFTHF.js";
import {
  S,
  a2 as a7,
  e2 as e8,
...
import "./chunk-XXE6GX65.js";
import {
  u as u8
} from "./chunk-F4TUEUJJ.js";
import {
  l as l7
...
import {
  s as s10,
  t as t8
} from "./chunk-GXDDXJEO.js";
import "./chunk-BPSN5NKI.js";
import {
  ut
} from "./chunk-PX5CNYR7.js";
...
async function l11(l14, m9, d15, j6, u19) {
  ...
  for (const { objectId: e22, points: o12 } of x4) {
    ...
    for (const { x: e23, y: n11, z: a15 } of o12) F4.x = e23, F4.y = n11, F4.z = a15 ?? 0, await c2(F4, U5, C, 0, { signal: u19 }), c6(U5, v7, E5, g9, P6), S4.push(P6.z);
  }
...
var l13 = class extends m3 {
  constructor(e22, r15) {
    super(e22, r15, new t7(u11, () => import("./LineCallout.glsl-SVQHEJO2.js")), a11.locations);
  }
...
var _O = class _O extends m5 {
  ...
  get _materialParameters() {
    ...
    if (r15.size = u4(s18.size || 0), n11.verticalOffset) {
      ...
      r15.verticalOffset = { screenLength: u4(e22), minWorldLength: i10 || 0, maxWorldLength: null != s19 ? s19 : 1 / 0 };
    }
...
function i6(r15, i10, s18, f12) {
  return null != r15 && (T(i10, f12) ? (a3(s18, r15), true) : (p5[0] = r15[0], p5[1] = r15[1], p5[2] = 0, !!o5(p5, i10, 0, p5, f12, 0) && (s18[0] = p5[0], s18[1] = p5[1], p5[0] = r15[2], p5[1] = r15[3], p5[2] = 0, !!o5(p5, i10, 0, p5, f12, 0) && (s18[2] = p5[0], s18[3] = p5[1], true))));
}
var p5 = n2();
...
var h6 = class extends r9 {
  ...
  async doLoad(e22) {
    ...
    const i10 = [];
    if (!m8) {
      const { make: e23 } = await import("./Graphics3DSymbolLayerFactory-R5VSFWNG.js");
      m8 = e23;
    }
...
function u16(l14, m9, u19) {
  ...
  let i10 = true;
  return e18[0] = null != l14.xmin ? l14.xmin : 0, e18[1] = null != l14.ymin ? l14.ymin : 0, e18[2] = null != l14.zmin ? l14.zmin : 0, i10 = i10 && o5(e18, l14.spatialReference, 0, e18, u19, 0), m9[0] = e18[0], m9[1] = e18[1], e18[0] = null != l14.xmax ? l14.xmax : 0, e18[1] = null != l14.ymax ? l14.ymax : 0, e18[2] = null != l14.zmax ? l14.zmax : 0, i10 = i10 && o5(e18, l14.spatialReference, 0, e18, u19, 0), m9[2] = e18[0], m9[3] = e18[1], null == l14.xmin && (m9[0] = -1 / 0), null == l14.ymin && (m9[1] = -1 / 0), null == l14.xmax && (m9[2] = 1 / 0), null == l14.ymax && (m9[3] = 1 / 0), i10;
}
var e18 = n2();
...
var ke = (_b = class extends b {
  ...
  async _boundsForGraphics3DGraphic(e22, t15) {
    const i10 = this._viewSpatialReference, r15 = this.owner.view.renderSpatialReference, s18 = this.owner.view.basemapTerrain.spatialReference, a15 = (e23, t16, s19) => o5(e23, r15, t16, e23, i10, t16, s19), n11 = (e23, t16, r16) => o5(e23, s18, t16, e23, i10, t16, r16), o12 = this._viewElevationProvider ? { service: this._viewElevationProvider, useViewElevation: null != t15 && !!t15.useViewElevation, minDemResolution: null != t15 ? t15.minDemResolution : null, minDemResolutionForPoints: this.owner.view.resolution } : null, l14 = await e22.getProjectedBoundingBox(a15, n11, o12, t15 == null ? void 0 : t15.signal);
    if (!l14) return null;
  ...
  computeAttachmentOrigin(e22, t15) {
    ...
    if (r15.draped.num > 0) {
      ...
      if (o4(Be, e23, i11, a15), !n5(Be, this._viewElevationProvider.spatialReference, Be, t15)) return null;
      u7(He, He, Be), s18++;
    }
  ...
  async rendererChange(e22) {
    if (this._rendererChangeAbortController = e(this._rendererChangeAbortController), e22 !== this.currentRenderer) if (this._validateRenderer(e22), null == e22 && this._currentRendererChange(null, false), t8(e22)) if (e22 == null ? void 0 : e22.arcadeRequired) {
  ...
  setClippingExtent(e22, t15) {
    const i10 = this.symbolCreationContext.clippingExtent, r15 = i4();
    return u16(e22, r15, t15) ? this.symbolCreationContext.clippingExtent = B(u3(), r15) : this.symbolCreationContext.clippingExtent = null, !H(this.symbolCreationContext.clippingExtent, i10);
  }
...
function h9(r15, c11, o12, f12) {
  const l14 = b8;
  return r15 ? (o12 && f12 && (l14.len = p2(c11, o12)), s6(l14.dir, r15)) : f12 ? (l14.len = p2(c11, o12), c(l14.dir, o12, c11), g3(l14.dir, l14.dir, 1 / l14.len)) : (c(l14.dir, o12, c11), A2(l14.dir, l14.dir)), l14;
}
function v5(r15, n11, t15) {
  const i10 = P2(k3(r15), t15.dir), e22 = -X(r15, n11);
...
var G4 = class {
  ...
  isVisibleInFrustum(t15, e22, i10 = false) {
    ...
    if (0 === this._maxSpan) {
      ...
      return !(i10 || !t15.intersectsRay(k2(e23.origin, e23.direction)));
    }
    for (let n11 = 0; n11 < this._extent.length; n11++) {
      const e23 = this._extent[n11];
      if (!i10 && t15.intersectsRay(k2(e23.origin, e23.direction))) return true;
  ...
  _toRenderBoundingExtentGlobal(t15, r15, n11) {
    ...
    for (const { x0: i10, x1: s18, y0: c11, y1: l14 } of U4) for (let p8 = 0; p8 < o12; p8++) {
      const h11 = p8 / (o12 - 1);
      v6[0] = o(t15[i10], t15[s18], h11), v6[1] = o(t15[c11], t15[l14], h11), v6[2] = n11, n5(v6, r15, v6, this._renderCoordsHelper.spatialReference), E2(v6, v6, I2), l5(V, v6);
    }
...
function e21(o12) {
  return O.isCollection(o12) ? o12.toArray() : Array.isArray(o12) ? o12 : i9(o12) || i3(o12) || c10(o12) ? [o12] : n10;
}
function i9(r15) {
...
//# sourceMappingURL=GraphicsLayerView3D-VGP7O6IA.js.map

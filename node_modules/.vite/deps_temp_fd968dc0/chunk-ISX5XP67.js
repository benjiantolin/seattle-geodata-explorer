...
var a2 = class {
  constructor(e6, a3) {
    this._rctx = e6, this._attributes = [{ name: "position", offset: 0, type: R.SHORT, count: 2 }], this.layout = { hash: t3(this._attributes), attributes: this._attributes, stride: 4 }, this._vertexBuffer = new r2(e6, [new t2("a_position", 2, R.SHORT, 0, 4)], new Uint16Array(a3)), this._vao = new h2(e6, this._vertexBuffer), this._count = a3.length / 2;
  }
  get locations() {
...
//# sourceMappingURL=chunk-ISX5XP67.js.map

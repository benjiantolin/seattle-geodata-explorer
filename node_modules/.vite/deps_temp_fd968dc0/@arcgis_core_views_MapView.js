import {
  ...
  n as n13,
  o as o11
} from "./chunk-6KOHMHOC.js";
import "./chunk-GQGQDZ2T.js";
import {
  c as c6,
  g as g2,
  s as s10
} from "./chunk-5EBUAXUA.js";
import {
  i as i11,
  n as n14,
  o as o12,
...
import {
  m as m11
} from "./chunk-5SYP4WKF.js";
import {
  g as g3,
  t as t10
} from "./chunk-LBB77VGX.js";
import {
  a2 as a6,
  e as e14,
  u as u7
...
import {
  m as m6
} from "./chunk-ZXWRBNC2.js";
import {
  m as m7
} from "./chunk-3I7YQQDR.js";
import "./chunk-JA56NOZO.js";
...
import {
  L as L3
} from "./chunk-BB4PWYWU.js";
import "./chunk-GEGX35PE.js";
import "./chunk-QKW7XKOW.js";
import "./chunk-MI6JR3MQ.js";
import "./chunk-MNHGU67B.js";
import {
  n as n11
} from "./chunk-RC7NOGLN.js";
import "./chunk-NPYFNHY2.js";
import "./chunk-JW6DU3OK.js";
import {
  l as l8
} from "./chunk-LGXMPOBO.js";
import {
  l as l7,
  z as z2
} from "./chunk-JKQBCFM3.js";
import "./chunk-3WDW43UF.js";
import "./chunk-FVWIE7DA.js";
import "./chunk-KK7ZK36G.js";
...
import {
  i as i9
} from "./chunk-XHOWV5TV.js";
import {
  m as m9
} from "./chunk-G3PMWE2Q.js";
...
var V = (u19) => {
  ...
  let _12 = class extends V5 {
    ...
    initialize() {
      ...
      }, f5.WIDGET)]), j(() => this.ready && this.popupEnabled && !this.updating).then(() => import("./Popup-J4L2AG3K.js"));
    }
    destroy() {
    ...
    async setupPopup() {
      ...
      if ((_a4 = this._popupSetupTask) == null ? void 0 : _a4.abort(), this.popup && !i12(this.popup)) return this._popupSetupTask = d3(async (p27) => {
        if (!this.popupEnabled || !p5(this.popupElement)) if (this.dependencies.popup && "function" == typeof this.dependencies.popup) await this.dependencies.popup(), s2(p27), customElements.get("arcgis-popup") || i.getLogger(this).error(new s("view:undefined-popup-element", "`arcgis-popup` custom element is undefined and can't be opened")), this.popupElement = document.createElement("arcgis-popup");
          ...
          const { default: e30 } = await import("./Popup-J4L2AG3K.js");
...
var p6 = class extends b {
  constructor(e30) {
    super(e30), this.view = null, this.baseLayerViews = new O(), this.groundLayerViews = new O(), this.referenceLayerViews = new O(), this._loadingHandle = l5(() => {
      var _a4, _b;
...
var i13 = class extends b {
  constructor(o30) {
    super(o30), this.factor = 1.5, this.offset = i5(0, 0), this.position = null, this.size = 120, this.maskUrl = null, this.maskEnabled = true, this.overlayUrl = null, this.overlayEnabled = true, this.visible = true;
  }
  get version() {
...
var b6 = class extends l3 {
  ...
  syncSources() {
    ...
    const s35 = (t28) => {
      var _a5, _b, _c, _d, _e;
      l10(t28) ? ((_a5 = t28.layers) == null ? void 0 : _a5.forEach(s35), (_b = t28.tables) == null ? void 0 : _b.forEach(s35)) : c4(t28) ? ((_c = t28.sublayers) == null ? void 0 : _c.forEach(s35), (_d = t28.subtables) == null ? void 0 : _d.forEach(s35)) : d4(t28) ? (_e = t28.sublayers) == null ? void 0 : _e.forEach(s35) : e13(t28) && e30.add(t28);
    };
  ...
  async getSelectedFeatures(e30, s35 = {}, o30 = "layerView") {
    ...
    const l24 = ((e30 == null ? void 0 : e30.length) ? n34.filter((t27) => e30.includes(t27.layer)) : n34).map(async (e31) => {
      ...
      const r29 = m8(t27) ? t27.parent : t27;
      if (null != r29) {
  ...
  updateSelection(e30) {
    ...
    for (const s35 of i30) {
      ...
      if (this.sources.includes(e31) && (e13(e31) || m8(e31)) && null !== i31) {
  ...
  _refreshVisualization() {
    ...
    for (const n34 of e30) {
      const e31 = s35.get(n34), r29 = m8(n34) ? n34.parent : n34;
      if (null != r29 && E2(r29)) {
        if (j4(r29)) continue;
  ...
  _refreshListeners() {
    ...
    const e30 = new Set(this.sources.map((e31) => m8(e31) ? e31.parent : e31));
    for (const t27 of e30) e13(t27) && "on" in t27 && t27.on && this._layerEditHandles.push(t27.on("edits", (e31) => this._onLayerEdit(e31, t27)));
  }
  ...
  _onParentLayerEdit(e30, t27) {
    ...
    if ((_a4 = o30 == null ? void 0 : o30.updateFeatures) == null ? void 0 : _a4.forEach((e31) => {
      ...
      const n34 = t27.sublayers.find((e32) => {
        var _a6;
        return !(!e13(e32) || !((_a6 = this.getSelection(e32)) == null ? void 0 : _a6.includes(s36)));
      });
      e13(n34) && n34 !== o31 && (this.removeFromSelection(n34, [s36]), this.appendToSelection(o31, [s36]));
    }), s35.length) {
      const e31 = [];
      s35.forEach(({ error: t28, objectId: s36 }) => {
        null != s36 && null == t28 && e31.push(s36);
      }), t27.sublayers.forEach((t28) => {
        e13(t28) && this._selectionMap.has(t28) && this.removeFromSelection(t28, e31);
      });
    }
  }
...
var j4 = (e30) => {
  var _a4;
  return m8(e30) ? true === ((_a4 = e30.parent) == null ? void 0 : _a4.isTable) : e30.isTable;
};
...
var L4 = async (e30, t27, s35 = {}) => {
  ...
  if (M3(e30)) {
    const i30 = e30;
    o30 = void 0 === i30 ? null : await i30.queryFeatures(new b3({ ...s35, objectIds: t27 })).then((t28) => ({ data: t28, layer: e30.layer }));
  } else {
    const i30 = e30;
    o30 = void 0 === i30 ? null : await i30.queryFeatures(new b3({ ...s35, objectIds: t27 })).then((e31) => ({ data: e31, layer: i30 }));
  }
  return o30;
};
var C3 = b6;
...
function m14(e30, t27) {
  ...
  return { type: "click", pointerType: a31, button: r29, buttons: i30, x: o30, y: s35, native: p27, timestamp: u19, screenPoint: i5(o30, s35), mapPoint: b7(e30, o30, s35), eventId: c27, cancelable: l24, stopPropagation: () => t27.stopPropagation(), defer: (e31) => t27.defer(e31), preventDefault: () => t27.preventDefault() };
}
function g5(e30, t27) {
...
function b7(e30, t27, a31) {
  return e30.toMap(i5(t27, a31), { exclude: [] });
}
function y5(e30) {
...
var u10 = class extends b {
  ...
  updateHoveredStateFromKnownPointers(t27) {
    this._pointerLocations.forEach((e30, o30) => {
      this._updateHoveredStateForPointerAtScreenPosition(i5(e30.x, e30.y), o30, e30.pointerType, t27);
    });
  }
...
var B2 = (_a = class extends n3(n6) {
  ...
  set map(e30) {
    e30 !== this._get("map") && ((e30 == null ? void 0 : e30.destroyed) && (i.getLogger(this).warn("#map", "The provided map is already destroyed", { map: e30 }), e30 = null), m4(e30) && e30.load().catch(() => {
...
var W2 = G2 = class extends n4 {
  ...
  _update() {
    ...
    const R = o7(this.viewMat3), _12 = r9(c27[0] / 2, c27[1] / 2), b12 = r9(-c27[0] / 2, -c27[1] / 2), z5 = u3(o30);
    M2(R, R, _12), h2(R, R, z5), M2(R, R, b12), i4(this.displayViewMat3, this.displayMat3, R);
  ...
  constructor(...t27) {
    super(...t27), this.paddedViewState = new L5(), this._updateContent = (() => {
      ...
      return () => {
        ...
        o6(t28, i30.left + i30.right, i30.top + i30.bottom), e9(t28, e30, t28), r7(o30.size, t28);
...
var l16;
var p12 = l16 = class extends o9(b) {
  constructor(e30) {
...
var a12;
var n20 = a12 = class extends o9(b) {
  constructor() {
...
var a13;
var c14 = a13 = class extends o9(b) {
  constructor(e30) {
...
var z3 = class extends b {
  constructor(t27) {
    super(t27), this.constraints = null, this.ready = false, this.resizeAlign = "center", this.addHandles([l5(() => {
      var _a4;
  ...
  toScreen(t27, e30) {
    ...
    return false === (e30 == null ? void 0 : e30.pickClosestTarget) || this.state.paddedViewState.wrapMapCoordinate(s35, s35), this.state.toScreen(s35, s35), i5(s35[0], s35[1]);
  }
  _project(t27, e30) {
    var _a4;
...
var m17 = class extends t8 {
  ...
  onInstall(t27) {
    super.onInstall(t27), this._watchHandles.add([l5(() => {
      var _a4;
...
function i26(t27, n34) {
  if (n34 ? (n34.radius = 0, n34.center.x = 0, n34.center.y = 0) : n34 = { radius: 0, center: i5() }, 0 === t27.length) return n34;
  ...
  const h17 = 0.5 * (m27 + x3), D4 = 0.5 * (s35 + y12), g15 = u19 * a31 - l24 * l24, f18 = (h17 * a31 - D4 * l24) / g15, p27 = (u19 * D4 - l24 * h17) / g15, b12 = i5(f18 + r29, p27 + o30);
...
var p14 = class extends t8 {
  ...
  _dragStart(t27, e30) {
    ...
    const n34 = d13("begin", i5(0, 0), i30);
    this._doubleTapDrag.emit(n34, void 0, a31), e30.stopPropagation();
  }
  _dragUpdate(t27) {
    if (!this._doubleTapDragActive) return;
    const { data: e30, modifiers: i30 } = t27, { center: a31 } = e30, o30 = d13("update", i5(a31.x - this._dragStartCenter.x, a31.y - this._dragStartCenter.y), e30);
    this._doubleTapDrag.emit(o30, void 0, i30), t27.stopPropagation();
  }
  _dragEnd(t27) {
    if (!this._doubleTapDragActive) return;
    const { data: e30, modifiers: i30 } = t27, { center: a31 } = e30, o30 = d13("end", i5(a31.x - this._dragStartCenter.x, a31.y - this._dragStartCenter.y), e30);
...
function r21(e30) {
  ...
  return e30.forEach((e31) => {
    i30.push(i5(e31.event.x, e31.event.y));
  }), i26(i30);
}
function a20(t27) {
  const e30 = r21(t27);
...
var a23 = class {
  ...
  interpolate(t27, e30, i30) {
    ...
    c27.spatialReference = t27.center.spatialReference, c27.x = o5(t27.center.x, e30.center.x, r29), c27.y = o5(t27.center.y, e30.center.y, r29), this.viewpoint.scale = o5(t27.scale, e30.scale + a31, n34);
    let p27 = t27.rotation;
    const l24 = e30.rotation;
    Math.abs(l24 - p27) >= 180 && (p27 += 360 * (p27 < l24 ? 1 : -1)), this.viewpoint.rotation = o5(p27, l24, s35);
  }
  copyFrom(t27) {
...
function T5(t27, i30, e30, n34) {
  ...
  if (a31) {
    const t28 = 1.5, i31 = n9(), a32 = i5(...n34.toScreen(i31, ...e30.center)), m27 = i5(...e30.toScreen(i31, ...n34.center)), h17 = null != m27 && m27.x > -1 * e30.size[0] && m27.x < (t28 + 0.5) * e30.size[0] && m27.y > -1 * e30.size[1] && m27.y < (t28 + 0.5) * e30.size[1], u19 = null != a32 && a32.x > -1 * n34.size[0] && a32.x < (t28 + 0.5) * n34.size[0] && a32.y > -1 * n34.size[1] && a32.y < (t28 + 0.5) * n34.size[1];
...
function r27() {
  return Promise.all([import("./webglDeps-RZPWBWLT.js"), import("./mapViewDeps-2ZK3CKOA.js")]);
}
var a26 = () => r27().then(() => import("./TileLayerView2D-AYIOCXE4.js"));
var t22 = () => r27().then(() => import("./FeatureLayerView2D-ORBWDA2B.js"));
var i29 = { "base-dynamic": () => r27().then(() => import("./BaseDynamicLayerView2D-CMC54WVE.js")), "base-tile": a26, "bing-maps": a26, catalog: () => r27().then(() => import("./CatalogLayerView2D-NA552WQD.js")), "catalog-dynamic-group": () => r27().then(() => import("./CatalogDynamicGroupLayerView2D-4FYW5FHN.js")), "catalog-footprint": () => r27().then(() => import("./CatalogFootprintLayerView2D-SNAOWW72.js")), csv: t22, "geo-rss": () => r27().then(() => import("./GeoRSSLayerView2D-TRPOFGPO.js")), feature: t22, geojson: t22, parquet: t22, graphics: () => r27().then(() => import("./GraphicsLayerView2D-HVVG6CJF.js")), group: () => r27().then(() => import("./GroupLayerView2D-5FLDKNUM.js")), imagery: () => r27().then(() => import("./ImageryLayerView2D-RDZLP4ET.js")), "imagery-tile": () => r27().then(() => import("./ImageryTileLayerView2D-BFH7XYSQ.js")), kml: () => r27().then(() => import("./KMLLayerView2D-JPBUBD2X.js")), "knowledge-graph": () => r27().then(() => import("./KnowledgeGraphLayerView2D-MRPI7BCM.js")), "link-chart": () => r27().then(() => import("./KnowledgeGraphLayerView2D-MRPI7BCM.js")), "knowledge-graph-sublayer": t22, "map-image": () => r27().then(() => import("./MapImageLayerView2D-35V64GAA.js")), "map-notes": () => r27().then(() => import("./MapNotesLayerView2D-GPFHLNGJ.js")), media: () => r27().then(() => import("./MediaLayerView2D-3GT3ZIMA.js")), "ogc-feature": () => r27().then(() => import("./OGCFeatureLayerView2D-D6PIRIQ2.js")), "open-street-map": a26, "oriented-imagery": t22, route: () => r27().then(() => import("./RouteLayerView2D-NGACRCOH.js")), stream: () => r27().then(() => import("./StreamLayerView2D-RN552TLL.js")), "subtype-group": () => r27().then(() => import("./SubtypeGroupLayerView2D-5XH7LMAJ.js")), tile: a26, "vector-tile": () => r27().then(() => import("./VectorTileLayerView2D-OFHPU6WQ.js")), video: () => r27().then(() => import("./VideoLayerView2D-W2SAMCXX.js")), wcs: () => r27().then(() => import("./ImageryTileLayerView2D-BFH7XYSQ.js")), "web-tile": a26, wfs: t22, wms: () => r27().then(() => import("./WMSLayerView2D-YWCGZ6AO.js")), wmts: () => r27().then(() => import("./WMTSLayerView2D-BEDYI2JP.js")), "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "gaussian-splat": null, "integrated-mesh-3dtiles": null, "integrated-mesh": null, "line-of-sight": null, "point-cloud": null, scene: null, unknown: null, unsupported: null, viewshed: null, voxel: null };
function s31(r29) {
...
var l21 = { "area-measurement": null, dimension: null, "direct-line-measurement": null, "elevation-profile": () => import("./ElevationProfileAnalysisView2D-ABKEE2F5.js"), "line-of-sight": null, slice: null, viewshed: null, "volume-measurement": null };
function n29(n34) {
...
var L6 = class extends l3 {
  ...
  initialize() {
    ...
    }, this._applyViewPadding, h), l5(() => this.padding, this._applyUIPadding, h), l5(() => [this.container, this._locale], ([t27, o30]) => {
...
var _11 = class extends b {
  constructor(t27) {
    super(t27), this._clear = () => {
      ...
      e30 && (this.addHandles(e30.map((t29) => l5(() => {
        var _a5;
...
var h15 = class extends i9(b) {
  ...
  _updateRotationWatcher(t27) {
    this.removeAllHandles(), this._watchForView(), t27 && this.addHandles("2d" === t27.type ? l5(() => t27 == null ? void 0 : t27.rotation, this._updateForRotation, h) : l5(() => t27 == null ? void 0 : t27.camera, this._updateForCamera, h));
  }
  _watchForView(t27) {
...
var ie;
async function re() {
  const [, { GraphicsView2D: e30, GraphicContainer: t27, LabelManager: i30, MapViewNavigation: r29, MagnifierView2D: s35, GridView2D: a31, Stage: n34 }] = await Promise.all([import("./webglDeps-RZPWBWLT.js"), import("./mapViewDeps-2ZK3CKOA.js")]);
...
var se = (_a3 = class extends a22(d10(o13(V(C2(K))))) {
  ...
  constructor(e30) {
    super(e30), this._magnifierView = null, this._gridView = null, this.stage = null, this._resolveWhenReady = [], this.rootLayerViews = new l8({ getCollections: () => {
      var _a4, _b;
  ...
  get typeSpecificPreconditionsReady() {
    ...
    return b4(t27.spatialReference, i30);
  }
  get background() {
...
__decorate([m2({ constructOnly: true })], se.prototype, "deactivatedWebGLExtensions", void 0), __decorate([m2({ constructOnly: true })], se.prototype, "debugWebGLExtensions", void 0), __decorate([m2({ readOnly: true })], se.prototype, "featuresTilingScheme", void 0), __decorate([m2({ readOnly: true })], se.prototype, "graphicsTileStore", null), __decorate([m2()], se.prototype, "graphicsView", void 0), __decorate([m2()], se.prototype, "constraintsInfo", null), __decorate([m2()], se.prototype, "initialExtentRequired", null), __decorate([m2()], se.prototype, "labelManager", void 0), __decorate([m2({ type: i18, nonNullable: true })], se.prototype, "navigation", void 0), __decorate([m2({ constructOnly: true })], se.prototype, "renderCanvas", void 0), __decorate([m2()], se.prototype, "renderingOptions", void 0), __decorate([m2({ constructOnly: true })], se.prototype, "supersampleScreenshotsEnabled", void 0), __decorate([m2()], se.prototype, "defaultsFromMapSettings", null), __decorate([m2({ readOnly: true })], se.prototype, "typeSpecificPreconditionsReady", null), __decorate([m2(l9(s12, "analyses"))], se.prototype, "analyses", void 0), __decorate([m2()], se.prototype, "analysisViewManager", void 0), __decorate([m2({ type: a30 })], se.prototype, "background", null), __decorate([m2()], se.prototype, "center", null), __decorate([m2({ type: O })], se.prototype, "floors", void 0), __decorate([m2()], se.prototype, "grid", void 0), __decorate([m2({ type: u7 })], se.prototype, "highlightOptions", null), __decorate([m2()], se.prototype, "map", void 0), __decorate([m2()], se.prototype, "padding", null), __decorate([m2({ readOnly: true })], se.prototype, "rendering", null), __decorate([m2({ readOnly: true })], se.prototype, "resolution", null), __decorate([m2()], se.prototype, "scale", null), __decorate([m2({ type: Boolean, value: false })], se.prototype, "spatialReferenceLocked", null), __decorate([m2({ readOnly: true })], se.prototype, "tileInfo", null), __decorate([m2({ type: e15, readOnly: true })], se.prototype, "timeline", void 0), __decorate([m2({ readOnly: true })], se.prototype, "type", void 0), __decorate([m2({ readOnly: true })], se.prototype, "updating", null), __decorate([m2({ readOnly: true })], se.prototype, "view2dType", void 0), __decorate([m2({ readOnly: true })], se.prototype, "visibleArea", null), __decorate([m2()], se.prototype, "zoom", null), __decorate([m2({ readOnly: true })], se.prototype, "navigating", null), __decorate([m2(), s4((e30) => e30 instanceof u18 ? e30 : m(p24, e30))], se.prototype, "ui", void 0), __decorate([m2()], se.prototype, "animationsEnabled", void 0), se = __decorate([a3("esri.views.View2D")], se);
var ae = se;

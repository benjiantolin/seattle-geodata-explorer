...
import {
  i as i4,
  p as p7
} from "./chunk-SGTC7OYX.js";
import {
  a as a4,
  f as f5
} from "./chunk-PMNP64LK.js";
import {
  F
...
import {
  E
} from "./chunk-J65VX55V.js";
import {
  g as g2
} from "./chunk-53F6V7JQ.js";
import {
  u as u3
} from "./chunk-MY6ZOYEB.js";
import {
  f as f4
} from "./chunk-4WAPEDHU.js";
import {
  W as W2
} from "./chunk-6FCAV3BU.js";
import {
  s as s3,
  t as t2
...
import {
  s as s2
} from "./chunk-ZGM6V2AL.js";
import {
  L
} from "./chunk-XF3K3UOF.js";
import {
  t as t3
} from "./chunk-QBWJZCB2.js";
import {
  m as m3
} from "./chunk-UMOPQFQW.js";
import {
  e as e2
} from "./chunk-QZXSDGSU.js";
import {
  l as l3
} from "./chunk-TEIC2ZQX.js";
import {
  d
...
var h = class {
  constructor() {
    this.quantizeOriginPosition = "upperLeft", this.scale = new n8(), this.translate = new o3();
  }
};
var n8 = class {
  constructor() {
...
function u7(r7) {
  ...
  if (W3 > 0) {
    for (const e7 of E2) if (void 0 === w3[e7]) throw new Error(`Feature collection missing required attribute: ${e7}`);
  }
...
var I = { fetchAndConvertSerializedLinkChart: (e7) => y4(e7) };

// node_modules/@arcgis/core/layers/knowledgeGraph/constants.js
var _2 = "ESRI__ID";
var I2 = "ESRI__OriginID";
var t5 = "ESRI__DestID";
var S = "ESRI__LayoutGeometry";
var o4 = "ESRI__AggregationCount";
var E4 = "LC.ESRI__IsSpatial";
...
var o5 = class _o {
  ...
  writeToStore(o9, n12, p13) {
    ...
    return o9.forEach((o10) => {
      ...
      let u9, c6 = null;
      if (p13 && o10.properties[p13] && (c6 = ut(o10.properties[p13])), "originId" in o10 && "destinationId" in o10 && (o10.properties[I2] = o10.originId, o10.properties[t5] = o10.destinationId), o10.properties[n12] = o10.id, o10.id && this._featureLookup.has(o10.id) && this._featureLookup.get(o10.id).attributes) {
    ...
    if (n12 = e7 || new b2({ where: "1=1", outFields: ["*"] }), "link-chart" === t7.parentCompositeLayer.type) {
      ...
      return s8.forEach((i12) => {
        if (this.relationshipTypeNames.has(t7.objectType.name)) {
          ...
          const n13 = this.memberIdTypeLookup.get(i12.attributes[I2]), o10 = this.memberIdTypeLookup.get(i12.attributes[t5]), s9 = this._isEndEntitySpatial(n13, i12, I2), a10 = this._isEndEntitySpatial(o10, i12, t5);
          i12.attributes[E4] = Number(s9 && a10);
        } else {
          ...
          n13 && i12.attributes[n13.name] ? i12.attributes[E4] = 1 : i12.attributes[E4] = 0;
        }
...
var Ne = class extends p12(a3(f5(c(p2(p6(l5(t(f2(l(b3)))))))))) {
  ...
  get fields() {
    ...
    }), e7.push(m2.fromJSON({ name: this.objectIdField, type: "esriFieldTypeString", alias: this.objectIdField, editable: false }), m2.fromJSON({ name: o4, type: "esriFieldTypeInteger", alias: o4, editable: false }), m2.fromJSON({ name: E4, type: "esriFieldTypeInteger", alias: E4, editable: false })), e7;
  }
  get formTemplate() {
...
function _e(e7, t7, r7) {
  var _a, _b;
  const i10 = [["ESRI__AGGREGATION_COUNT", o4], ["ESRI__ORIGIN_ID", I2], ["ESRI__DESTINATION_ID", t5], ["ESRI__LAYOUT_GEOMETRY", S]];
  try {
...
//# sourceMappingURL=chunk-LP6W6JC4.js.map

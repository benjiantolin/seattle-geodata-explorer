import {
  ...
  t as t3,
  t2 as t4
} from "./chunk-FYLWBXBH.js";
import {
  _,
  a as a3,
  i as i2
} from "./chunk-F76JQZ2Y.js";
import {
  e as e2
...
import {
  n as n2
} from "./chunk-OKZ3XQCH.js";
import {
  C,
  t as t2
} from "./chunk-Z4WKPVY3.js";
import {
  a as a2,
  d as d2,
  e,
  ...
  r,
  s
} from "./chunk-FYP5AU2V.js";
import "./chunk-CCKCPQUX.js";
...
var t5 = class {
  constructor(e5, t8, s4 = 0) {
    this.values = {}, this._geometry = void 0, this._pbfGeometry = null, this.featureIndex = s4;
    const r7 = t8.keys, a6 = t8.values, o5 = e5.asUnsafe();
    for (; o5.next(); ) switch (o5.tag()) {
      case 1:
        this.id = o5.getUInt64();
        break;
      case 2: {
        const e6 = o5.getMessage().asUnsafe(), t9 = this.values;
        for (; !e6.empty(); ) {
          const s5 = e6.getUInt32(), o6 = e6.getUInt32();
          t9[r7[s5]] = a6[o6];
        }
        e6.release();
        break;
      ...
      case 3:
        this.type = o5.getUInt32();
        break;
      case 4:
        this._pbfGeometry = o5.getMessage();
        break;
      default:
        o5.skip();
    }
  ...
  getGeometry(t8) {
    ...
    const s4 = this._pbfGeometry.asUnsafe();
    let r7, a6;
    this._pbfGeometry = null, t8 ? t8.reset(this.type) : r7 = [];
    let o5, n6 = 1, i4 = 0, l4 = 0, h5 = 0;
    for (; !s4.empty(); ) {
      if (0 === i4) {
        const e5 = s4.getUInt32();
        n6 = 7 & e5, i4 = e5 >> 3;
      }
      switch (i4--, n6) {
        case 1:
          l4 += s4.getSInt32(), h5 += s4.getSInt32(), t8 ? t8.moveTo(l4, h5) : r7 && (a6 && r7.push(a6), a6 = [], a6.push(new i(l4, h5)));
          break;
        case 2:
          l4 += s4.getSInt32(), h5 += s4.getSInt32(), t8 ? t8.lineTo(l4, h5) : a6 && a6.push(new i(l4, h5));
          break;
        case 7:
          t8 ? t8.close() : a6 && !a6[0].equals(l4, h5) && a6.push(a6[0].clone());
          break;
        default:
          throw s4.release(), new Error("Invalid path operation");
      }
    }
    return t8 ? o5 = t8.result() : r7 && (a6 && r7.push(a6), o5 = r7), s4.release(), this._geometry = o5, o5;
  }
};
...
var t6 = class _t {
  constructor(s4) {
    this.extent = t3, this.keys = [], this.values = [], this._pbfLayer = s4.clone();
    const a6 = s4.asUnsafe();
    for (; a6.next(); ) switch (a6.tag()) {
      case 1:
        this.name = a6.getString();
        break;
      case 3:
        this.keys.push(a6.getString());
        break;
      case 4:
        this.values.push(a6.processMessage(_t._parseValue));
        break;
      case 5:
        this.extent = a6.getUInt32();
        break;
      default:
        a6.skip();
    }
...
var o3 = class extends t4 {
  constructor(t8) {
    super(t8);
  }
  add(t8, o5, r7, u3, h5, a6, n6, d4, e5, p3, i4, c4) {
    const M = this.array;
    let l4 = t4.i1616to32(t8, o5);
    M.push(l4);
    const m3 = 31;
    l4 = t4.i8888to32(Math.round(m3 * r7), Math.round(m3 * u3), Math.round(m3 * h5), Math.round(m3 * a6)), M.push(l4), l4 = t4.i8888to32(Math.round(m3 * n6), Math.round(m3 * d4), Math.round(m3 * e5), Math.round(m3 * p3)), M.push(l4), l4 = t4.i1616to32(i4, 0), M.push(l4), c4 && M.push(...c4);
  }
};
var r3 = class extends t4 {
  ...
  add(t8, o5, r7) {
    const u3 = this.array;
    u3.push(t4.i1616to32(t8, o5)), r7 && u3.push(...r7);
  }
};
var u = class extends t4 {
  constructor(t8) {
    super(t8);
  }
  add(t8, o5, r7, u3, h5, a6, n6) {
    const d4 = this.array, e5 = this.index;
    let p3 = t4.i1616to32(t8, o5);
    d4.push(p3);
    const i4 = 15;
    return p3 = t4.i8888to32(Math.round(i4 * r7), Math.round(i4 * u3), h5, a6), d4.push(p3), n6 && d4.push(...n6), e5;
  }
};
var h4 = class extends t4 {
  ...
  add(o5, r7, u3, h5, a6, n6, d4, e5, p3, i4, c4, M) {
    const l4 = this.array;
    let m3 = t4.i1616to32(o5, r7);
    l4.push(m3), m3 = t4.i1616to32(Math.round(8 * u3), Math.round(8 * h5)), l4.push(m3), m3 = t4.i8888to32(a6 / 4, n6 / 4, e5, p3), l4.push(m3), m3 = t4.i8888to32(0, f(d4), 10 * i4, Math.min(10 * c4, 255)), l4.push(m3), M && l4.push(...M);
  }
};
var a5 = class extends t4 {
  ...
  add(t8, o5, r7, u3, h5) {
    const a6 = this.array, n6 = t4.i1616to32(2 * t8 + r7, 2 * o5 + u3);
...
var k = class {
  ...
  _filterFeatures(e5) {
    ...
    for (let f3 = 0; f3 < l4.length; f3++) {
      ...
      const _2 = p3.getData();
      for (; _2.nextTag(2); ) {
        const e7 = _2.getMessage(), t8 = new t5(e7, p3, m3++);
        e7.release();
        const r8 = t8.values;
        if (r8) {
...
//# sourceMappingURL=WorkerTileHandler-TM5GPFR6.js.map

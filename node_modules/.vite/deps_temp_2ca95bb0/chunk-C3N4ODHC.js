import {
  ...
  l as l2,
  m as m3
} from "./chunk-G34IWJDK.js";
import {
  m as m2
} from "./chunk-XNTURHBL.js";
import {
  u
...
var d = class extends l(n) {
  ...
  readFormat(t2, o3) {
    if (!o3.fieldFormat) return t2 ? m2.fromJSON(t2) : null;
  }
  clone() {
    var _a, _b;
...
__decorate([m({ value: null, clonable: false, types: l2, json: { write: { overridePolicy(t2, o3, e2) {
...
var U = class extends l(n) {
  ...
  readContent(t2, e2) {
    const { popupElements: o3 } = e2;
    return Array.isArray(o3) && o3.length > 0 ? this._readPopupInfoElements(e2.description, e2.mediaInfos, o3) : this._readPopupInfo(e2);
  }
  writeWebSceneContent(t2, e2, o3, s9) {
    this._writePopupTemplateContent(t2, e2, s9);
  }
  writeWebMapContent(t2, e2, o3, s9) {
    this._writePopupTemplateContent(t2, e2, s9);
  }
  writeFieldInfos(t2, e2, o3, s9) {
    const { content: i21 } = this, r3 = Array.isArray(i21) ? i21 : null, { writeFieldFormat: n8, ...p22 } = s9 || {};
    if (t2) {
      const o4 = r3 ? r3.filter((t3) => "fields" === t3.type) : [], s10 = o4.length && o4.every((t3) => {
        var _a;
  ...
  writeLayerOptions(t2, e2, o3, s9) {
    e2[o3] = !t2 || null === t2.showNoDataRecords && null === t2.returnTopmostRaster ? null : t2.toJSON(s9);
  }
  writeTitle(t2, e2) {
    e2.title = t2 || "";
  }
  async collectRequiredFields(t2, e2, o3) {
    const s9 = this.expressionInfos || [];
    await this._collectExpressionInfoFields(t2, e2, o3, [...s9, ...this._getContentExpressionInfos(this.content, s9)]), w(t2, e2, [...this.outFields || [], ...this._getActionsFields(this.actions), ...this._getTitleFields(this.title), ...this._getContentFields(this.content)]);
  }
  async getRequiredFields(t2, e2) {
    const o3 = /* @__PURE__ */ new Set();
    return await this.collectRequiredFields(o3, t2, e2), [...o3].sort();
  }
  _writePopupTemplateContent(t2, e2, o3) {
    "string" != typeof t2 ? Array.isArray(t2) && (e2.popupElements = t2.filter((t3) => "web-scene" === (o3 == null ? void 0 : o3.origin) ? W.has(t3.type) : k.has(t3.type)).map((t3) => t3 == null ? void 0 : t3.toJSON(o3)), e2.popupElements.forEach((t3) => {
  ...
  _writeFieldsContent(t2, e2, o3) {
    ...
    if (Array.isArray(i21)) for (const r3 of s9) {
      ...
      t3 ? t3.visible = true : i21.push(r3.toJSON(o3));
    }
    else e2.fieldInfos = s9.map((t3) => t3.toJSON(o3));
  }
  ...
  _writeRelationshipContent(t2, e2) {
    var _a, _b;
    const o3 = ((_a = t2.orderByFields) == null ? void 0 : _a.map((e3) => this._toFieldOrderJSON(e3, t2.relationshipId))) || [], s9 = [...((_b = e2.relatedRecordsInfo) == null ? void 0 : _b.orderByFields) || [], ...o3];
  ...
  _writeMediaContent(t2, e2) {
    ...
    Array.isArray(e2.mediaInfos) ? e2.mediaInfos = [...e2.mediaInfos, ...o3] : e2.mediaInfos = o3;
  }
  _readPopupInfoElements(t2, e2, o3) {
    const s9 = { description: false, mediaInfos: false };
    return o3.map((o4) => "media" === o4.type ? (o4.mediaInfos || !e2 || s9.mediaInfos || (o4.mediaInfos = e2, s9.mediaInfos = true), I.fromJSON(o4)) : "text" === o4.type ? (o4.text || !t2 || s9.description || (o4.text = t2, s9.description = true), i18.fromJSON(o4)) : "attachments" === o4.type ? n2.fromJSON(o4) : "fields" === o4.type ? l3.fromJSON(o4) : "expression" === o4.type ? i8.fromJSON(o4) : "relationship" === o4.type ? l6.fromJSON(o4) : "utilityNetworkAssociations" === o4.type ? a10.fromJSON(o4) : void 0).filter(Boolean);
  }
  _toRelationshipContent(t2) {
    const { field: e2, order: o3 } = t2;
    ...
    return !Number.isNaN(i21) && r3 ? l6.fromJSON({ relationshipId: i21, orderByFields: [{ field: r3, order: o3 }] }) : null;
  }
  _toFieldOrderJSON(t2, e2) {
    const { order: o3, field: s9 } = t2;
    return { field: `${B}${e2}/${s9}`, order: o3 };
  }
  _readPopupInfo({ description: t2, mediaInfos: e2, showAttachments: o3, relatedRecordsInfo: s9 = { showRelatedRecords: false } }) {
    const i21 = [];
    t2 ? i21.push(new i18({ text: t2 })) : i21.push(new l3()), Array.isArray(e2) && e2.length && i21.push(I.fromJSON({ mediaInfos: e2 })), o3 && i21.push(n2.fromJSON({ displayType: "auto" }));
  ...
  _getMediaInfoFields(t2) {
    const { caption: e2, title: o3, value: s9 } = t2, i21 = s9 || {}, { fields: r3, normalizeField: n8, tooltipField: p22, sourceURL: a13, linkURL: l8 } = i21, d3 = [...this._extractFieldNames(o3), ...this._extractFieldNames(e2), ...this._extractFieldNames(a13), ...this._extractFieldNames(l8), ...r3 ?? []];
  ...
  async _collectExpressionInfoFields(t2, e2, o3, s9) {
    s9 && await Promise.all(s9.map((s10) => v(t2, e2, o3, s10.expression)));
  }
  ...
  _getActionFields(t2) {
    const { className: e2, title: o3, type: s9 } = t2, i21 = "button" === s9 || "toggle" === s9 ? t2.image : "";
    return [...this._extractFieldNames(o3), ...this._extractFieldNames(e2), ...this._extractFieldNames(i21)];
  }
  _getTitleFields(t2) {
...
//# sourceMappingURL=chunk-C3N4ODHC.js.map

...
function o2(o5, e2, t2) {
  let a4, c4;
  return void 0 === e2 || Array.isArray(e2) ? (c4 = o5, t2 = e2, a4 = [void 0]) : (c4 = e2, a4 = Array.isArray(o5) ? o5 : [o5]), (o6, e3) => {
    const d2 = o6.constructor.prototype;
    a4.forEach((a5) => {
      const s3 = j(o6, a5, c4);
      s3.read && "object" == typeof s3.read || (s3.read = {}), s3.read.reader = d2[e3], t2 && (s3.read.source = (s3.read.source || []).concat(t2));
    });
  };
}
...
function j2(i3, r3 = false, s3 = a(i3)) {
...
//# sourceMappingURL=chunk-ZTJQU2RH.js.map

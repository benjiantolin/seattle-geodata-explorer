import {
  o as o3
} from "./chunk-YX42MH5M.js";
import {
  c as c2
} from "./chunk-B3R53J2C.js";
import {
  C as C2,
  o as o2
...
async function L(n2) {
  null == k && (k = Promise.all([import("./projectOperator-63CWBN2Q.js").then((n3) => (v = n3, v.load())), import("./projectOperator-JTRL3OUG.js").then((n3) => (P2 = n3, P2.load())), import("./geographicTransformationUtils-KACEL73W.js").then((n3) => (A = n3, A.load()))])), await k, s2(n2), E.notify();
}
function W(n2, e2, r2) {
...
//# sourceMappingURL=chunk-U2YUDRYM.js.map

...
function t(t2) {
  ...
  function f(...f2) {
    return u2 && r2 === this && n(f2, i2) || (e = t2.apply(this, f2), r2 = this, i2 = f2, u2 = true), e;
  }
  return f;
}
function n(t2, n3) {
...
function I(e, n3, t2, o, r2, u2, i2 = null) {
  ...
  const { absoluteZ: l } = y(n3, t2, o, r2, e, u2);
  return Z(l, n3, t2, o, r2, e, i2, s2);
}
...
function Z(e, n3, t2, o, r2, u2, i2, s2) {
  ...
  switch (s2) {
    case "absolute-height":
      return e - l;
    case "relative-to-ground":
      return e - ((u2.elevationProvider.getElevation(n3, t2, o, r2, "ground") ?? 0) + l);
    case "relative-to-scene":
      return e - ((u2.elevationProvider.getElevation(n3, t2, o, r2, "scene") ?? 0) + l);
  }
}
function P(e, n3) {
...
//# sourceMappingURL=chunk-O2IDYRHR.js.map

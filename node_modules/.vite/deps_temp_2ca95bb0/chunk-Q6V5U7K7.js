...
function b(n3, i2) {
  ...
  const e2 = o2(n3), t3 = c3(n3), r2 = null != e2 && !isNaN(e2) && e2 > 0 && i2 > e2, l2 = null != t3 && !isNaN(t3) && t3 > 0 && i2 < t3;
  return r2 || l2;
}
function v(n3, i2) {
...
var I = (_a = class extends B {
  ...
  loadDependencies() {
    return c({ "action-group": () => import("./calcite-action-group-WXYWYC3M.js"), "action-menu": () => import("./calcite-action-menu-YC35MA56.js"), action: () => import("./calcite-action-N754OQKO.js"), icon: () => import("./calcite-icon-J7CTACBF.js"), "list-item": () => import("./calcite-list-item-WMPDN2QM.js"), list: () => import("./calcite-list-5P7FHET7.js"), notice: () => import("./calcite-notice-KGMGPMKA.js") });
  }
  render() {
    var _a2, _b;
  ...
  get _renderedPanelAction() {
    ...
    return n("calcite-action", { active: t3, appearance: "transparent", disabled: n3, icon: a3(e2), key: `action-${e2.uid}`, onclick: () => this._togglePanel(e2), scale: "s", slot: "actions-end", text: i2 ?? "", title: i2 ?? void 0 }, this._renderFallbackIcon(e2));
  }
  ...
  _renderAction(e2) {
    ...
    return n("calcite-action", { active: "toggle" === r2 && i2.value, appearance: "transparent", "data-action-id": i2.id, disabled: a4, icon: a3(i2), indicator: c5, key: `action-${i2.uid}`, loading: o3, onclick: () => this._triggerAction(t3, i2), scale: "s", slot: n3 ? void 0 : "actions-end", text: l2 ?? "", textEnabled: n3, title: l2 ?? void 0 }, this._renderFallbackIcon(i2));
  }
  _renderFallbackIcon(e2) {
    ...
    return n3 && (s3[n3] = true), o3 || n3 ? n("span", { "aria-hidden": "true", class: this.classes(t3.itemActionIcon, s3), key: "icon", styles: c4(o3) }) : null;
  }
...
//# sourceMappingURL=chunk-Q6V5U7K7.js.map

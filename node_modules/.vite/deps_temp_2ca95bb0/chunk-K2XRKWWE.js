...
async function P2(e, n2, o3) {
  ...
  let u, h, x2, d2, M2, w, b2, z, L2 = 0;
  const S2 = [], U2 = [];
  for (const t of e) if (null != t) if (u || (u = t.spatialReference, h = G(u), x2 = u.isWebMercator, w = x2 ? 102100 : 4326, d2 = r[w].maxX, M2 = r[w].minX, b2 = r[w].plus180Line, z = r[w].minus180Line), h) if ("mesh" === t.type) U2.push(t);
    ...
    s4 = Number(s4.toFixed(9)), r3 = Number(r3.toFixed(9)), e2.intersects(b2) && r3 !== d2 ? (L2 = r3 > L2 ? r3 : L2, o4 = j2(o4, x2), S2.push(o4), U2.push("cut")) : e2.intersects(z) && s4 !== M2 ? (L2 = r3 * (2 * d2) > L2 ? r3 * (2 * d2) : L2, o4 = j2(o4, x2, 360), S2.push(o4), U2.push("cut")) : U2.push(o4);
  ...
  if (S2.length > 0 && F > 0) {
    const t = v2(S2, await i3(i4, S2, N, o3)), n3 = [], s4 = [];
...
//# sourceMappingURL=chunk-K2XRKWWE.js.map

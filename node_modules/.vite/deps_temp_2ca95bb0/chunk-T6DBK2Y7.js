...
function M(t3 = 1, n2) {
  const a2 = $(), i = () => {
    a(n2) ? a2.reject(u()) : 0 === t3 ? a2() : (--t3, t(() => i()));
  };
  return i(), a2.promise;
}
function P(e2) {
...
var r2 = class {
  ...
  observe(e2) {
    ...
    for (let s3 = 0; s3 < n2; ++s3) {
      const t3 = r3[s3];
      if (t3.destroyed) i = true;
      else if (t3 === e2) {
        o = true;
        break;
      }
    }
    return o || (r3.push(e2), i && this._removeDestroyedObservers()), new s2(r3, e2);
  }
...
//# sourceMappingURL=chunk-T6DBK2Y7.js.map

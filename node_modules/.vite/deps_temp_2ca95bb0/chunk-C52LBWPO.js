...
var l = class extends u {
  constructor(t5, e8, s, i2, r6, u2, l2) {
    super(s), this.texture = t5, this.textureNormal = e8, this.textureOcclusion = i2, this.textureMetallicRoughness = r6, this.scale = u2, this.normalTextureTransformMatrix = l2;
  }
};
...
var r4 = class extends i {
  constructor(o2, r6, s) {
    super(o2, "float", 2, (t5, e8, f2) => t5.setUniform1f(o2, r6(e8, f2), s));
  }
};
...
function x2(u2, d3) {
  ...
  u2.fragment.include(e7);
  const { emissionSource: c2, hasEmissiveTextureTransform: x3, bindType: g2 } = d3, p2 = 3 === c2 || 4 === c2 || 5 === c2;
  p2 && (u2.include(r5, d3), u2.fragment.uniforms.add(1 === g2 ? new e3("texEmission", (e8) => e8.textureEmissive) : new e4("texEmission", (e8) => e8.textureEmissive)));
  const h = 2 === c2 || p2;
  h && u2.fragment.uniforms.add(1 === g2 ? new e2("emissiveBaseColor", (e8) => e8.emissiveBaseColor) : new e("emissiveBaseColor", (e8) => e8.emissiveBaseColor));
  const T = 0 !== c2;
  T && !(7 === c2 || 6 === c2 || 4 === c2 || 5 === c2) && u2.fragment.uniforms.add(1 === g2 ? new r("emissiveStrength", (e8) => e8.emissiveStrength) : new r4("emissiveStrength", (e8) => e8.emissiveStrength));
  ...
  u2.fragment.code.add(t2`
    vec4 getEmissions(vec3 symbolColor) {
      ...
      ${n2(T, `emissions.rgb *= emissiveStrength * ${t2.float(f)};`)}
      return emissions;
    }
  `);
}
...
//# sourceMappingURL=chunk-C52LBWPO.js.map

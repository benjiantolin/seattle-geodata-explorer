import {
  a as a5
} from "./chunk-YG3OCWC4.js";
import {
  i as i4,
  m as m6,
  t2 as t3
} from "./chunk-UBBEDIVB.js";
import {
  $
...
import {
  l as l6
} from "./chunk-LMXHV7O2.js";
import {
  j as j4
} from "./chunk-HVT73YFO.js";
import "./chunk-JWFVUWRE.js";
import "./chunk-NPYFNHY2.js";
import {
  p as p3,
  s as s7
} from "./chunk-QI3VURPU.js";
...
var Te = class extends a7(F(_2(l4(b(j2(t(l2(s6(o3(l(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-DF4NARUC.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-YCJIUXLV.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-QGKV45RB.js.map

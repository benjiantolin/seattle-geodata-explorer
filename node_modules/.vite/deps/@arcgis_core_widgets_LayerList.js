...
import {
  ...
  u,
  v
} from "./chunk-PPRBGPKN.js";
import "./chunk-L7URVBR7.js";
import {
  e as e4
...
var y = class extends l {
  ...
  initialize() {
    ...
    }, () => this._viewHandles(), h), l2(() => [this.listItemCreatedFunction, this.checkPublishStatusEnabled, this.listModeDisabled], () => this._recompileList()), l2(() => e4(this.view) ? this.view.inGeographicLayout : null, () => this._compileList())], m3.view);
  }
  destroy() {
  ...
  moveListItem(e7, t3, s5, i3) {
    var _a, _b;
    const r = e7 == null ? void 0 : e7.layer;
    if (!r || "subtype-sublayer" === r.type || "sublayer" === r.type) return;
    const a3 = (_b = (_a = this.view) == null ? void 0 : _a.map) == null ? void 0 : _b.layers, o = t3 ? m2(t3) : a3, l4 = s5 ? m2(s5) : a3;
    if (!o || !l4) return;
    const { operationalItems: n2 } = this, h3 = (t3 == null ? void 0 : t3.children) || n2, m4 = (s5 == null ? void 0 : s5.children) || n2, c3 = l4.length - i3;
    e7.parent = s5 || null, h3.remove(e7), o.remove(r), m4.includes(e7) || m4.add(e7, c3), l4.includes(r) || l4.add(r, c3), this._compileList();
  }
  ...
  _createListItem(e7) {
    const { view: t3, listItemCreatedFunction: s5, checkPublishStatusEnabled: i3, listModeDisabled: r } = this;
    return new I({ checkPublishStatusEnabled: i3, listModeDisabled: r, layer: e7, listItemCreatedFunction: s5, view: t3 });
  }
  _removeAllItems() {
  ...
  _watchLayersListMode(e7) {
    this.removeHandles(m3.layerListMode), e7 && !this.listModeDisabled && this.addHandles(l2(() => e7.filter((e8) => "listMode" in e8).map((e8) => e8.listMode).toArray(), () => this._compileList()), m3.layerListMode);
  }
  _compileList() {
    var _a, _b;
  ...
  _sortItems(e7) {
    const { operationalItems: t3 } = this;
    t3.sort((t4, s5) => {
      const i3 = e7.indexOf(t4.layer), r = e7.indexOf(s5.layer);
      return i3 > r ? -1 : i3 < r ? 1 : 0;
    });
  }
  _recompileList() {
  ...
  _viewHandles() {
    const { view: e7 } = this;
    this.removeHandles([m3.mapLayers, m3.layerViews, m3.viewLayers]), (e7 == null ? void 0 : e7.ready) ? this.addHandles([l2(() => {
      var _a, _b;
      return (_b = (_a = this.view) == null ? void 0 : _a.map) == null ? void 0 : _b.allLayers;
    }, (e8) => this._createMapLayerHandles(e8), h), l2(() => {
      var _a;
...
var j2 = class extends s2(B) {
  constructor(e7, i3) {
    super(e7, i3), this._rootListEl = null, this._activeItem = null, this._tooltipReferenceMap = new s(), this._focusRootFlowItem = false, this._focusPanelFlowItem = false, this._focusLayerFlowItem = null, this._layerListMap = new s(), this._lastDragDetail = null, this._selectedDragItemLayerUid = null, this._rootGroupUid = `operational-${this.uid}`, this._openedLayersController = null, this.catalogLayerList = null, this.catalogOptions = null, this.collapsed = false, this.dragEnabled = false, this.filterPlaceholder = "", this.filterPredicate = null, this.filterText = "", this.headingLevel = 2, this.knowledgeGraphOptions = null, this.layerTablesEnabled = new O(["knowledge-graph"]), this.listItemCanGiveFunction = null, this.listItemCanReceiveFunction = null, this.mapImageOptions = null, this.messages = null, this.messagesCommon = null, this.minDragEnabledItems = e5, this.minFilterItems = i, this.openedLayers = new O(), this.openedLayerLists = new O(), this.selectedItems = new P(), this.selectionMode = "none", this.tableList = null, this.tileOptions = null, this.viewModel = new v2(), this.visibilityAppearance = "default", this.visibleElements = new l3(), this._canMove = ({ dragEl: e8, fromEl: t3, toEl: i4 }, o) => {
      ...
      const { _lastDragDetail: t3 } = this, { toEl: i4, fromEl: o, dragEl: s5, newIndex: l4 } = e8;
      if (o && i4 && !((t3 == null ? void 0 : t3.newIndex) === l4 && (t3 == null ? void 0 : t3.dragEl) === s5 && (t3 == null ? void 0 : t3.toEl) === i4 && (t3 == null ? void 0 : t3.fromEl) === o)) {
        ...
        this._moveLayerFromChildList({ toEl: i4, fromEl: o, dragEl: s5, newIndex: l4 });
      }
    };
  }
  initialize() {
    this.addHandles([a2(() => this.openedLayers, "change", () => this._handleOpenedLayersChange(), h), a2(() => this.viewModel.operationalItems, "change", () => s3(this.selectedItems), h), l2(() => [this.filterPredicate, this._rootListEl], () => f(this._rootListEl, this.filterPredicate))]);
  }
  loadDependencies() {
    return c({ button: () => import("./calcite-button-7BBOJ2KZ.js"), flow: () => import("./calcite-flow-4SLCKMBT.js"), "flow-item": () => import("./calcite-flow-item-5QNRPYJO.js"), list: () => import("./calcite-list-632IXF55.js"), notice: () => import("./calcite-notice-7DYFHPEL.js"), tooltip: () => import("./calcite-tooltip-K5LQSGST.js") });
  }
  destroy() {
  ...
  async _handleOpenedLayersChange() {
    ...
    const l4 = await Promise.all(t3.map((e8) => this._createFlowList(e8, s5)));
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-7BA6QCT7.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
    return new t3({ headingLevel: i3, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, ...o, catalogLayer: e7, layerTablesEnabled: m4, onCatalogOpen: p2, onTablesOpen: c3 });
  }
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-PAQYF4Z4.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;
  ...
  _renderPanelFlowItems() {
    ...
    return e7.toArray().map(({ title: i3, panel: o }, s5) => {
      const l4 = () => this._handlePanelFlowItemBack(o);
      return n("calcite-flow-item", { afterCreate: this._focusPanelFlowItemNode, afterUpdate: this._focusPanelFlowItemNode, bind: this, description: i3, heading: o.title, headingLevel: this.headingLevel, key: `flow-panel-${o.uid}`, selected: !t3.length && s5 === e7.length - 1, onCalciteFlowItemBack: (e8) => {
        e8.preventDefault(), l4();
      } }, o.render(), n("calcite-button", { appearance: "transparent", onclick: l4, slot: "footer-actions", width: "full" }, this.messagesCommon.back));
    });
  }
  ...
  _renderItems() {
    const { visible: e7, collapsed: t3, _visibleItems: i3, _openedPanelItems: o, _filterEnabled: s5, _rootGroupUid: l4, visibleElements: { closeButton: r, collapseButton: a3, heading: n2, flow: d }, _dragEnabled: c3, selectionMode: m4, filterText: h3, openedLayers: y2, filterPlaceholder: u2, messages: g } = this, _ = [n("calcite-flow-item", { afterCreate: this._focusRootFlowItemNode, afterUpdate: this._focusRootFlowItemNode, bind: this, closable: r, closed: !e7, collapsed: t3, collapsible: a3, heading: n2 ? g.widgetLabel : void 0, headingLevel: this.headingLevel, key: "root-flow-item", selected: !y2.length && !o.length, onCalciteFlowItemClose: () => this.visible = false }, (i3 == null ? void 0 : i3.length) ? null : this._renderNoItems(), n("calcite-list", { afterCreate: (e8) => {
    ...
    }, canPull: (e8) => this._canMove(e8, "pull"), canPut: (e8) => this._canMove(e8, "put"), "data-layer-type": l4, displayMode: A, dragEnabled: c3, filterEnabled: s5, filterPlaceholder: u2, filterProps: t, filterText: s5 ? h3 : "", group: l4, key: "root-list", label: g.widgetLabel, onmouseleave: this._clearActiveItem, onmouseover: this._setActiveItem, selectionAppearance: "border", selectionMode: m4, onCalciteListChange: (e8) => this._handleCalciteListChange(e8), onCalciteListDragEnd: (e8) => this._handleCalciteListDragEnd(e8.detail), onCalciteListFilter: (e8) => {
      var _a;
  ...
  _moveLayerFromChildList({ toEl: e7, fromEl: t3, dragEl: i3, newIndex: o }) {
    const s5 = N(i3), l4 = N(e7), r = N(t3);
    this.viewModel.moveListItem(s5, r, l4, o);
  }

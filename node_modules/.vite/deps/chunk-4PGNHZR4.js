import {
  y as y2
} from "./chunk-P37R7JOW.js";
import {
  a as a4,
  s as s3
} from "./chunk-WNYLLEXF.js";
import {
  l as l2
...
var l3 = class extends b {
  ...
  get languageParameter() {
    ...
    let r2 = "local" === o || "global" === o ? o : m(o ?? l()) ?? "global";
    return r2 = "no" === r2 ? "nb" : r2, r2;
  }
};
__decorate([m2()], l3.prototype, "apiKey", void 0), __decorate([m2()], l3.prototype, "id", void 0), __decorate([m2()], l3.prototype, "language", void 0), __decorate([m2()], l3.prototype, "places", void 0), __decorate([m2()], l3.prototype, "serviceUrl", void 0), __decorate([m2()], l3.prototype, "worldview", void 0), l3 = __decorate([a2("esri.support.BasemapStyle")], l3);
var p = l3;
...
var x = (_a = class extends a3(u2) {
  ...
  async _loadLayersFromJSON(e, r2, t) {
    var _a2, _b;
    const s4 = (_a2 = this.resourceInfo) == null ? void 0 : _a2.context, a5 = ((_b = this.portalItem) == null ? void 0 : _b.portal) || (s4 == null ? void 0 : s4.portal) || null, o = O2[(s4 == null ? void 0 : s4.origin) || ""] ?? "web-map", { populateOperationalLayers: i2 } = await import("./layersCreator-PJVFB32X.js"), n3 = [];
...
__decorate([m2({ json: { read: false, write: { ignoreOrigin: true, target: "baseMapLayers", writer(e, r2, t, s4) {
  this._writeBaseLayers(e, r2, s4);
} }, origins: { "web-scene": { write: { ignoreOrigin: true, target: { baseMapLayers: { type: O } }, writer(e, r2, t, s4) {
  this._writeBaseLayers(e, r2, s4);
} } } } } })], x.prototype, "baseLayers", null), __decorate([m2({ json: { read: false, write: { ignoreOrigin: true, target: "groundLayers", writer(e, r2, t, s4) {
  this._writeGroundLayers(e, r2, s4);
} }, origins: { "web-scene": { write: { ignoreOrigin: true, target: { groundLayers: { type: O } }, writer(e, r2, t, s4) {
  this._writeGroundLayers(e, r2, s4);
} } } } } })], x.prototype, "groundLayers", null), __decorate([m2({ type: String, json: { origins: { "web-scene": { write: true } } } })], x.prototype, "id", void 0), __decorate([m2({ type: k })], x.prototype, "portalItem", void 0), __decorate([m2()], x.prototype, "referenceLayers", null), __decorate([m2({ readOnly: true })], x.prototype, "resourceInfo", void 0), __decorate([m2({ type: f })], x.prototype, "spatialReference", void 0), __decorate([m2({ type: p })], x.prototype, "style", void 0), __decorate([m2()], x.prototype, "thumbnailUrl", void 0), __decorate([m2({ type: String, json: { origins: { "web-scene": { write: { isRequired: true } } } } })], x.prototype, "title", void 0), __decorate([r("title")], x.prototype, "writeTitle", null), x = $ = __decorate([a2("esri.Basemap")], x);
...
//# sourceMappingURL=chunk-4PGNHZR4.js.map

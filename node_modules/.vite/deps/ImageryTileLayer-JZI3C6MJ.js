...
import {
  ...
  t as t4,
  u as u4
} from "./chunk-HC2MNY46.js";
import "./chunk-XH26QSBY.js";
import {
  c as c4,
  f as f4,
  o as o3
} from "./chunk-KEHDMXCM.js";
import {
  N as N3,
  i2 as i4
} from "./chunk-6KFLUP3Y.js";
import {
  C as C2,
  p as p2
} from "./chunk-YHC2HV7A.js";
import {
  $ as $2,
  b as b2,
  c as c3,
...
import {
  n as n2,
  u as u3
} from "./chunk-6RTLENJK.js";
import {
  T,
  w
} from "./chunk-DFIRKGZN.js";
import "./chunk-AB7LSC2V.js";
import "./chunk-LQUWEUUQ.js";
import {
  C,
  G,
  H,
  ...
  v2 as v3,
  y
} from "./chunk-IVHJBKJJ.js";
import {
  E,
  W,
  v as v2
} from "./chunk-TMTFMEET.js";
import "./chunk-CFLUVJCX.js";
import {
  c as c2
} from "./chunk-CC42EMTS.js";
...
var f6 = class extends X {
  ...
  async _buildInMemoryRaster(t7, i8, r6) {
    ...
    if (!d7[0].value && d7[1].value) throw new s2("inmemory-raster:open", "failed to build in memory raster");
...
var m7 = class extends X {
  ...
  async _fetchData(e3) {
    ...
    if ("coverage" !== ((_a = r6.type) == null ? void 0 : _a.toLowerCase()) || "grid" !== ((_c = (_b = r6.domain) == null ? void 0 : _b.domainType) == null ? void 0 : _c.toLowerCase())) throw new s2(s7, "Only coverage with Grid domain type is supported");
    if (!r6.ranges) throw new s2(s7, "Missing ranges in the grid coverage data");
    if (!((_d = r6.domain.referencing) == null ? void 0 : _d.length)) throw new s2(s7, "Missing domain referencing in the grid coverage data");
    const a2 = Object.values(r6.ranges);
    for (let n5 = 0; n5 < a2.length; n5++) {
      const { axisNames: e4, shape: r7, type: c7, values: l7 } = a2[n5];
      if (!("ndarray" === c7.toLowerCase() && (l7 == null ? void 0 : l7.length) && (e4 == null ? void 0 : e4.length) && (r7 == null ? void 0 : r7.length))) throw new s2(s7, "Only ranges with valid NdArray, axisNames, shape, and inline values are supported");
      if (!(i7(e4[e4.length - 1]) && r4(e4[e4.length - 2]))) throw new s2(s7, "Only row-major ordered pixel values are supported. X axis must be the last axis.");
    }
    return p4(r6);
  }
};
...
var h2 = class extends X {
  ...
  async _fetchData(t7) {
    ...
    if ("JPG" !== r6 && "PNG" !== r6 && "GIF" !== r6 && "BMP" !== r6) throw new s2("image-aux-raster:open", "the data is not a supported format");
    ...
    if (null == i8) throw new s2("image-aux-raster:open", "the data cannot be decoded");
    return i8;
  }
...
var g3 = class extends X {
  ...
  async _open(e3) {
    ...
    const l7 = a2.data;
    if (this.sourceJSON = l7, !l7) throw new s2("imageserverraster:open", "cannot initialize tiled image service, missing service info");
    if (!l7.tileInfo) throw new s2("imageserverraster:open", "use ImageryLayer to open non-tiled image services");
    ...
    if (null == o6) throw new s2("image-server-raster:open", "cannot initialize image service");
    c4(o6, l7);
...
var b4 = class extends X {
  ...
  _parseHeader(t7) {
    ...
    if (!r6) throw new s2("mrf:open", "not a valid MRF format");
    ...
    if (!x.has(g4)) throw new s2("mrf:open", "currently does not support compression " + g4);
    const d7 = t4(r6, "DataType") || "UInt8", b6 = y2.get(d7);
    if (null == b6) throw new s2("mrf:open", "currently does not support pixel type " + d7);
    ...
    if (e2(t7, "MRF_META/CachedSource")) throw new s2("mrf:open", "currently does not support MRF referencing other data files");
...
var E2 = class extends X {
  ...
  async _open(e3) {
    ...
    if (!s7) throw new s2("tiffraster:open", "failed to open url " + this.url);
    ...
    if (this._headerInfo = { littleEndian: a2, isBigTiff: o6, ifds: f7, pyramidIFDs: h3, maskIFDs: p6, ...u8 }, this._set("rasterInfo", c7), !u8.isSupported) throw new s2("tiffraster:open", "this tiff is not supported: " + u8.message);
    if (!u8.tileWidth) throw new s2("tiffraster:open", "none-tiled tiff is not optimized for access, convert to COG and retry.");
    ...
    if (3 === x2 && 2 === g4) throw new s2("tiffraster:open", "unsupported horizontal difference encoding. Predictor=3 is supported for floating point data");
  ...
  async _readIFDs(e3, i8, r6, s7 = 4, a2) {
    ...
    if (!(n5 == null ? void 0 : n5.ifd)) throw new s2("tiffraster:open", "cannot parse tiff header. failed to open url " + this.url);
...
var u7 = class {
  ...
  static async open(r6) {
    ...
    if (Object.keys(u8).forEach((t7) => {
      ...
      if (!this.supportedFormats.has(c7)) throw new s2("rasterfactory:open", "not a supported format " + c7);
      if ("CRF" === c7) throw new s2("rasterfactory:open", `cannot open raster: ${e3}`);
...
var Y2 = class extends p(t(b(j2(o3(s5(X2(i4(l6(l5(f3(l3(l2(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-FCD4YEX6.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
  ...
  write(e3, t7) {
    ...
    if (t7 == null ? void 0 : t7.messages) {
      ...
      t7.messages.push(new s2("layer:unsupported", `Layers (${this.title}, ${this.id}) of type '${this.declaredClass}' are not supported in the context of '${e4}'`, { layer: this }));
    }
    return null;
  }
  async _openRaster(e3) {
    ...
    if (this.raster) await this._openFromRaster(this.raster, e3), t7 = t3(this.raster), !t7 && this.rasterFunction && (this._primaryRasters = [this.raster], await this._initializeWithFunctionRaster(this.rasterFunction));
      ...
      if (!t8 && !i8) throw new s2("imagery-tile-layer:open", "missing url or source parameter");
    ...
    if (!r6) throw new s2("imagery-tile-layer:load", "cannot load resources on " + this.url);
  ...
  async _openFromUrlWithRasterFunction(e3, t7, r6) {
    ...
    if (a2 > -1) throw new s2("imagery-tile-layer:open", `cannot open raster: ${i8[a2]}`);
  ...
  async _openFromUrl(e3, t7) {
    ...
    if (null == r6) throw new s2("imagery-tile-layer:open", `cannot open raster: ${e3}`);
  ...
  async _openFromSource(e3, t7) {
    ...
    if (!i8) throw new s2("imagery-tile-layer:open", r6);
    ...
    if (null == o6) throw new s2("imagery-tile-layer:open", r6);
  ...
  async _initializeWithFunctionRaster(e3, t7) {
    try {
      ...
      r6 instanceof s2 && i.getLogger(this).error("imagery-tile-layer:open", r6.message), i.getLogger(this).warn("imagery-tile-layer:open", "the raster function cannot be applied and is removed"), this._set("rasterFunction", null), this.raster = this._primaryRasters[0];
    }
  }
...
//# sourceMappingURL=ImageryTileLayer-JZI3C6MJ.js.map

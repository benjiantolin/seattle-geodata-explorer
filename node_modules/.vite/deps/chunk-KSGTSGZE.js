...
var r5 = i()({ absoluteValue: "absolute-value", multiplier: "multiplier" });
  ...
  constructor(e7) {
    ...
    (_a = e7.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _a.forEach((i10) => {
      ...
      if ("entity" === t7.get(s8)) this.entityTypeNames.add(s8);
        ...
        if ("relationship" !== t7.get(s8)) return i2.getLogger(this).warn(`A named type, ${s8}, was in the inclusion list that wasn't in the data model and will be removed`), void ((_a2 = e7.inclusionModeDefinition) == null ? void 0 : _a2.namedTypeDefinitions.delete(s8));
...
function _e(e7, t7, r7) {
  ...
  try {
    ...
    i2.getLogger(this).warn("Error updating labelingInfo", s8);
  }
  return l7(e7, t7, r7);
}
...
//# sourceMappingURL=chunk-KSGTSGZE.js.map

...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-HQDRXWX2.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-2LZQHMBH.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-G7XEGGJC.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-GTHSMYYV.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-ZD7CWNCY.js.map

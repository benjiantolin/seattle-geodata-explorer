...
var c = class extends b {
  ...
  async update(t, r) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-4DAKYIJM.js");
...
var k = v = class extends a3(u) {
  ...
  async fetchResources(e = {}, t) {
    const { fetchResources: i2 } = await import("./resourceUtils-4DAKYIJM.js");
    return i2(this, e, t);
  }
  async addResource(e, t, i2) {
    const { addOrUpdateResources: r } = await import("./resourceUtils-4DAKYIJM.js");
  ...
  async removeResource(e, t) {
    const { removeResource: r } = await import("./resourceUtils-4DAKYIJM.js");
  ...
  async removeAllResources(e) {
    const { removeAllResources: t } = await import("./resourceUtils-4DAKYIJM.js");
    return t(this, e);
  }
  resourceFromPath(e) {
...
//# sourceMappingURL=chunk-YVGTLVXJ.js.map

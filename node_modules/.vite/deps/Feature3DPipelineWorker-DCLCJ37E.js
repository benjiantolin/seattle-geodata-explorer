...
function f4(e12, n13) {
  const a10 = n13.viewSpatialReference, i5 = n13.renderSpatialReference, { extent: c8 } = e12, f8 = g(c8), u9 = n3();
  return n6([f8[0], f8[1], 0], a10, u9, i5), u9;
}
...
var h5 = class {
  ...
  async _createGeometry(e12) {
    ...
    const b6 = [["position", new t2(y, x2, 3, true)], ["normal", new t2(p4, w4, 3, true)], ["color", new t2(_3, w4, 4, true)], ["rotation", new t2(g6, w4, 1, true)], ["size", new t2(h8, w4, 2, true)], ["centerOffsetAndDistance", new t2(f8, w4, 4, true)]], I = new Uint8Array(o7);
...
var v2 = class {
  ...
  async createAddCommand(e12) {
    ...
    const o7 = this._isPrimitive, s13 = this._primitive || d3, u9 = u(c3(s13)), h8 = u2(p(u9)), y = u2(t3(h8, { isPrimitive: o7, width: 100, depth: null, height: null })), C2 = new Float64Array(16 * n13), b6 = new Float64Array(16 * n13), g6 = a5(e12), x2 = await i5.applyElevationAlignmentTo(g6);
...
var _2 = class extends b {
  ...
  _scheduleTilesSync() {
    ...
    const t5 = this._synchronizationTask, e12 = d2(async () => {
      try {
  ...
  *loadedTiles() {
  ...
  async _addTile(t5) {
    ...
    const o7 = new v3(t5, d2(async (e13) => {
...
var d4 = class extends u6 {
  ...
  getCentroid(t5) {
    return n2(new e4(), this._geometryOverride, t5.hasZ, t5.hasM);
  }
};
var a8 = class {
  constructor(t5, e12) {
...
var n11 = class {
  constructor(n13, a10, r4) {
    ...
    const i5 = a3 + a10.reduce((e12, { usedMemory: t5 }) => e12 + t5, 0), d5 = 3 * n;
    this.usedMemory = s4 + i5 + d5, this.featureCount = a10.reduce((e12, t5) => e12 + t5.featureCount, 0);
  }
  get id() {
    return this.descriptor.id;
  }
...
//# sourceMappingURL=Feature3DPipelineWorker-DCLCJ37E.js.map

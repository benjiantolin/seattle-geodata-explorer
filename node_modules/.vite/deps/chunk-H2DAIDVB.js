...
var g3 = (_a = class extends n2 {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./@arcgis_core_layers_MapImageLayer.js")).default)({ url: t19 });
  }
...
async function o5(s18) {
  if (s18) {
    const { default: s19 } = await import("./arcgis-knowledge-client-core-simd-42RXWHVN.js").then((e11) => e11.a);
    return s19({ locateFile: (s20) => n(t5 + s20) });
  }
  const { default: r6 } = await import("./arcgis-knowledge-client-core-UDKMOCQ5.js").then((e11) => e11.a);
...
var d5 = () => i2.getLogger("esri.rest.knowledgeGraph.WasmToQueryResponseObjConstructors");
  ...
  if (e11.headers.get("content-length") && i2.getLogger("esri.rest.knowledgeGraph.knowledgeGraphService").warnOnce("Found `Content-Length` header when expecting a streaming HTTP response! Please investigate whether all intermediate HTTP proxies and/or load balancers are configured such that they don't forcefully buffer the entire response before returning it to the client. A valid HTTP streaming response should use Chunked Transfer Encoding and not have a Content Length defined."), o7 == null ? void 0 : o7.includes("application/x-protobuf")) {
    ...
    const g7 = new ReadableStream({ pull: async function e12(l6) {
      ...
      try {
        ...
        throw i2.getLogger("esri.rest.knowledgeGraph.knowledgeGraphService").error(y7), c6(y7), o8.releaseLock(), d(y7) ? y7 : new s("knowledge-graph:unexpected-server-response", "Error inside streaming data return parsing", { error: y7 });
      }
    } });
...
//# sourceMappingURL=chunk-H2DAIDVB.js.map

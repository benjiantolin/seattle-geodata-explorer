...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-FLZQWI6P.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-SQPKJXN6.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-ACXJ25U2.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-MLDBKJG6.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-OUOFXK73.js.map

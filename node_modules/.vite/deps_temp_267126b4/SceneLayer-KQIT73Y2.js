...
import {
  F
} from "./chunk-3TBW5ZWT.js";
import {
  t as t2
} from "./chunk-SA666V3B.js";
import {
  i as i3
} from "./chunk-5YNHQRWK.js";
import {
  o as o3
...
import {
  l as l6
} from "./chunk-52URPAP4.js";
import {
  j as j4
} from "./chunk-LG63IYIP.js";
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s4(o3(l2(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-OWCGHFTJ.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-PZ44KRNG.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-KQIT73Y2.js.map

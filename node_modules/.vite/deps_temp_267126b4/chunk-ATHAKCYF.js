...
import {
  n as n6
} from "./chunk-KLOTTUX2.js";
import {
  i as i3
} from "./chunk-XS3HXECT.js";
import {
  e as e4
} from "./chunk-IG77V6IO.js";
import {
  i as i2
} from "./chunk-DMG6MME7.js";
import {
  g as g3,
  v as v3,
  y as y3
...
var q3 = class extends l2 {
  ...
  async _createSelfSnappingEngine(e8) {
    const [{ SelfSnappingEngine: t6 }, n11] = await Promise.all([import("./SelfSnappingEngine-AKDP6QOI.js"), g4()]);
  ...
  async _createGridSnappingEngine(e8) {
    ...
    const { GridSnappingEngine: n11 } = await import("./GridSnappingEngine-ZWQ3QGUM.js");
    return s2(e8), { type: "grid", engine: new n11({ view: t6, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e8) {
    const { FeatureSnappingEngine: t6 } = await import("./FeatureSnappingEngine-OUOFXK73.js");
    s2(e8);
...
async function o2() {
  const e8 = await import("./geometryEngine-BGR67PNQ.js");
  return s4(e8);
}
function n7(t6) {
...
var de2 = class extends l2 {
  ...
  initialize() {
    this.addHandles([a2(() => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e8 && (this.snappingManager || (this._defaultSnappingManager = new q3({ view: e8, options: this.snappingOptions })), "2d" === e8.type ? import("./editingTools-52DRUAKN.js") : "3d" === e8.type && (import("./editingTools-YTEHG7II.js"), import("./GraphicsLayerView3D-QF53VSJI.js")));
    }, w), l(() => {
      var _a;
  ...
  async _makeDrawGraphicTool2D(e8) {
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-52DRUAKN.js")), u5(), c5()]);
  ...
  async _makeDrawGraphicTool3D(e8) {
    var _a;
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-YTEHG7II.js")), u5(), c5()]);
  ...
  async _setupMove3DOperation(e8, t6, o3, a11, i5 = false) {
    const [s7, n11] = await Promise.all([this._requireModule(import("./editingTools-YTEHG7II.js")), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _setupPointTransform3DOperation(e8, t6, o3) {
    const a11 = "transform", { enableRotation: i5, enableScaling: s7, enableZ: n11 } = t6, p7 = await this._requireModule(import("./editingTools-YTEHG7II.js"));
    if (Ge(p7)) return p7;
  ...
  async _setupPolyTransform3DOperation(e8, t6, o3, a11 = false) {
    var _a, _b;
    const i5 = "transform", { enableRotation: s7, enableScaling: n11, enableZ: p7, preserveAspectRatio: l8 } = t6, [h7, c6] = await Promise.all([this._requireModule(import("./editingTools-YTEHG7II.js")), c5()]);
    if (Ge(h7)) return h7;
  ...
  async _setupReshape3DOperation(e8, t6, o3, a11 = false) {
    const i5 = "reshape", [s7, n11, p7] = await Promise.all([this._requireModule(import("./editingTools-YTEHG7II.js")), u5(), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _getGraphicMover(e8, t6, o3) {
    const { enableMoveAllGraphics: a11, highlightOptions: i5 } = t6, r9 = await this._requireModule(import("./GraphicMover-Q32PU56D.js"));
  ...
  async _getBox(e8, t6, o3) {
    var _a, _b;
    const { enableRotation: a11, enableScaling: i5, highlightOptions: r9, preserveAspectRatio: s7 } = t6, [n11, p7] = await Promise.all([this._requireModule(import("./Box-GJ2G2DSS.js")), c5()]);
  ...
  async _getReshape(e8, t6, o3) {
    const { highlightOptions: a11, reshapeOptions: i5 } = t6, r9 = "split" === (i5 == null ? void 0 : i5.edgeOperation), s7 = "move" === (i5 == null ? void 0 : i5.shapeOperation), n11 = !!(i5 == null ? void 0 : i5.enableCreateCurveFromStraightEdge), [p7, l8, h7] = await Promise.all([this._requireModule(import("./Reshape-ALA3DTOZ.js")), u5(), c5()]);
...
//# sourceMappingURL=chunk-ATHAKCYF.js.map

...
async function r(t, e, n) {
  ...
  if (!(await import("./intersectsOperator-ACPINMZI.js")).execute(e, n)) return new c({ pixelType: t.pixelType, width: a2, height: r2, mask: h2, maskIsAlpha: false, pixels: [...t.pixels] });
  if ("polyline" === n.type) return s(t, e, n);
  return (await import("./containsOperator-NXV5CQY6.js")).execute(n, e) ? t : o(t, e, n);
}
function o(t, e, n) {
  if (!t) return t;
...
//# sourceMappingURL=chunk-OKRJXX5E.js.map

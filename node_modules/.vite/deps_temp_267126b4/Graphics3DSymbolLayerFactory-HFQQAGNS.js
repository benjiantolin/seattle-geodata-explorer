...
import {
  I as I2,
  u as u21
} from "./chunk-2ZPXWQXM.js";
import "./chunk-4FWFNZMT.js";
import {
  x as x5
} from "./chunk-UC4NYDAS.js";
...
import {
  h as h4
} from "./chunk-OS4WJEAC.js";
import "./chunk-NAJIRKWY.js";
import {
  p as p5,
  u as u11
} from "./chunk-G43T4ZEV.js";
...
var _he = class _he extends m13 {
  ...
  async _prepareResourcesCIM(e33, t30, r28) {
    const { OverrideHelper: i24 } = await import("./OverrideHelper-KCXQRHVP.js");
    if (this._overrideHelperClass = i24, this._cimData = t30, !this._context.sharedResources.cimSymbolRasterizer) {
      const e34 = (await import("./CIMSymbolRasterizer-I7ODKUDP.js")).CIMSymbolRasterizer;
    ...
    if (this._arcadeInfo = { spatialReference: h19, fields: c26, geometryType: "esriGeometryPoint" }, (a26 == null ? void 0 : a26.primitiveOverrides) && o25.push(i24.createRenderExpressions(a26.primitiveOverrides, this._arcadeInfo)), o25.length > 0 && (await Promise.all(o25), s2(r28)), this._context.renderer && "dictionary" === this._context.renderer.type && this._context.renderer.scaleExpression) {
      ...
      if (e34.scaleExpression) {
        const t31 = e34.scaleExpression, r29 = await h3(t31, this._context.layer.spatialReference), { default: i25 } = await import("./callExpressionWithFeature-ALPNGRG3.js"), s28 = new Z(c26);
...
var g8 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t16(j7, () => import("./LineMarker.glsl-LW6EJEXU.js")), S3(t30).locations);
  }
...
var V4 = class extends m10 {
  constructor(e33, r28) {
    super(e33, r28, new t16(I2, () => import("./Path.glsl-VTDXJAW2.js")), x8(r28).locations);
  }
  initializePipeline(e33) {
...
var S9 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t16(x5, () => import("./Pattern.glsl-U7A3NR2E.js")), b12(t30).locations);
  }
...
var h17 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t16(C4, () => import("./WaterSurface.glsl-BFDE75SY.js")), e21() ? c13.locations : r17.locations);
  }
  initializePipeline(e33) {
...
//# sourceMappingURL=Graphics3DSymbolLayerFactory-HFQQAGNS.js.map

...
import {
  ...
  l as l6,
  p as p2
} from "./chunk-CGAGJELP.js";
import {
  F
} from "./chunk-MYNDXMM6.js";
import {
  l as l2
...
var b = I = (_a = class extends a3(u2) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { queryAll: o3 } = await import("./ElevationQuery-ORUP7SQH.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  async createElevationSampler(r4, e2) {
    await this.load({ signal: e2 == null ? void 0 : e2.signal });
    const { createSampler: o3 } = await import("./ElevationQuery-ORUP7SQH.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  clone() {
  ...
  async _loadLayersFromJSON(r4, e2, o3) {
    const t3 = (e2 == null ? void 0 : e2.origin) || "web-scene", s4 = (e2 == null ? void 0 : e2.portal) || null, a5 = (e2 == null ? void 0 : e2.url) || null, { populateOperationalLayers: i4 } = await import("./layersCreator-JKJXUFU3.js");
    s2(o3);
    const n8 = [];
...
//# sourceMappingURL=chunk-ZYXI7PUW.js.map

import {
  p
} from "./chunk-2TL4SUJL.js";
import "./chunk-ZZI5OAXU.js";
import "./chunk-3CJX5MKT.js";
import {
  o as o2
...
var S = class extends p(l2(b(j(l(b2))))) {
  ...
  async queryElevation(e, r2) {
    const { query: t3 } = await import("./ElevationQuery-ORUP7SQH.js");
    return s2(r2), t3(this, e, r2);
  }
  async createElevationSampler(e, r2) {
    const { createSampler: t3 } = await import("./ElevationQuery-ORUP7SQH.js");
    return s2(r2), t3(this, e, r2);
  }
...
//# sourceMappingURL=ElevationLayer-5MXMKGDK.js.map

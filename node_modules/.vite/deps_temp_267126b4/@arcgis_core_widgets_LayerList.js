...
import {
  ...
  u,
  v
} from "./chunk-L7ODK7GU.js";
import "./chunk-GEF5EAEO.js";
...
var j2 = class extends s2(B) {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-56HFTSTH.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-BH6T6KGE.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

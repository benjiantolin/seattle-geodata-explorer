...
import {
  V
} from "./chunk-QUQ2YBC3.js";
import {
  F
} from "./chunk-WFP4RRUX.js";
import {
  c
...
import {
  i as i2
} from "./chunk-CQLADLRQ.js";
import {
  F as F2
} from "./chunk-3VDQXJLC.js";
import {
  t as t3
} from "./chunk-V4OHPQW6.js";
import {
  o as o3
} from "./chunk-BZDZQNFO.js";
import {
  p as p6
} from "./chunk-2MZLU2TU.js";
import {
  c as c2
} from "./chunk-LS46TS2A.js";
import {
  c as c3
} from "./chunk-RIH2C7VM.js";
import {
  t as t4
} from "./chunk-YP3SF2GM.js";
import {
  o as o4
...
__decorate([m2({ type: String, json: { write: true } })], p8.prototype, "alias", void 0), __decorate([m2({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], p8.prototype, "name", void 0), __decorate([m2({ types: l7, json: { write: true } })], p8.prototype, "fieldFormat", void 0), p8 = __decorate([a2("esri.layers.support.FieldConfiguration")], p8);
...
var et = class extends V(f4(c(n7(F2(a4(p4(p7(l6(e2(t(f3(l5(b3(j2(l3(s5(o4(l(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-F3426MB4.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-CLS2NI2P.js"), e4);
  ...
  async queryPivot(e4, t5) {
    ...
    const o7 = await import("./PivotQuery-LZZIPQIN.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-PZYZGLNW.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8 == null ? void 0 : a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-G57WQEA7.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
  ...
  async queryTopObjectIds(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-PZYZGLNW.js");
...
__decorate([m2({ clonable: false, readOnly: true })], et.prototype, "_titleCreator", null), __decorate([m2(I)], et.prototype, "attributeTableTemplate", void 0), __decorate([o("service", "capabilities")], et.prototype, "readCapabilities", null), __decorate([m2({ json: { origins: { "web-scene": { write: false } }, write: true } })], et.prototype, "charts", void 0), __decorate([m2({ readOnly: true })], et.prototype, "createQueryVersion", null), __decorate([m2({ json: { read: { source: "layerDefinition.copyrightText" } } })], et.prototype, "copyright", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.displayField" } } })], et.prototype, "displayField", void 0), __decorate([m2({ types: x, readOnly: true })], et.prototype, "defaultSymbol", void 0), __decorate([m2({ type: R })], et.prototype, "dynamicDataSource", void 0), __decorate([m2({ type: Boolean })], et.prototype, "editingEnabled", null), __decorate([o(["portal-item", "web-scene"], "editingEnabled", ["layerDefinition.capabilities"])], et.prototype, "readEditingEnabled", null), __decorate([o("web-map", "editingEnabled", ["capabilities", "layerDefinition.capabilities"])], et.prototype, "readEditingEnabledFromWebMap", null), __decorate([r(["portal-item", "web-scene"], "editingEnabled", { "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabled", null), __decorate([r("web-map", "editingEnabled", { capabilities: { type: String }, "layerDefinition.capabilities": { type: String } })], et.prototype, "writeEditingEnabledToWebMap", null), __decorate([m2({ readOnly: true })], et.prototype, "effectiveEditingEnabled", null), __decorate([m2({ clonable: false, readOnly: true })], et.prototype, "featureTitleFields", null), __decorate([m2({ type: [p8], json: { name: "layerDefinition.fieldConfigurations", write: { overridePolicy(e4, t5, r3) {
  ...
  i4 && e(r3, i4, t5);
} } } }, read: { source: "layerDefinition.geometryType", reader: j.read } } })], et.prototype, "geometryType", void 0), __decorate([m2({ readOnly: true, clonable: false })], et.prototype, "graphicOrigin", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.hasM" } } })], et.prototype, "hasM", void 0), __decorate([m2({ json: { read: { source: "layerDefinition.hasZ" } } })], et.prototype, "hasZ", void 0), __decorate([m2(u2)], et.prototype, "id", void 0), __decorate([m2({ readOnly: true, json: { origins: { service: { read: true } }, read: false } })], et.prototype, "infoFor3D", void 0), __decorate([m2({ json: { origins: { "web-map": { write: { target: "layerDefinition.type" } } } } })], et.prototype, "isTable", void 0), __decorate([o("service", "isTable", ["type", "geometryType"]), o("isTable", ["layerDefinition.type", "layerDefinition.geometryType"])], et.prototype, "readIsTable", null), __decorate([r("web-map", "isTable")], et.prototype, "writeIsTable", null), __decorate([m2(p5)], et.prototype, "labelsVisible", void 0), __decorate([m2({ type: [A2], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: l8, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: l8, write: { layerContainerTypes: a3 } } })], et.prototype, "labelingInfo", void 0), __decorate([m2((() => {
  const e4 = a(b2);
  return e4.json.origins["portal-item"] = { write: { target: "layerDefinition.drawingInfo.transparency", writer(e5, t5, r3) {
    e(r3, n4(e5), t5);
  } } }, e4;
})())], et.prototype, "opacity", void 0), __decorate([m2(d)], et.prototype, "legendEnabled", void 0), __decorate([m2({ type: ["show", "hide"], json: (() => {
  const e4 = a(T.json);
  return e4.origins["portal-item"] = { read: false, write: false }, e4;
})() })], et.prototype, "listMode", void 0), __decorate([o("globalIdField", ["layerDefinition.globalIdField", "layerDefinition.fields"])], et.prototype, "readGlobalIdField", null), __decorate([m2({ json: { origins: { "web-map": { write: { target: "layerDefinition.objectIdField", overridePolicy: Ye } } } } })], et.prototype, "objectIdField", void 0), __decorate([o("objectIdField", ["layerDefinition.objectIdField", "layerDefinition.fields"])], et.prototype, "readObjectIdField", null), __decorate([m2({ type: ["ArcGISFeatureLayer"], json: { write: { target: "layerType", ignoreOrigin: true, layerContainerTypes: a3 } } })], et.prototype, "operationalLayerType", void 0), __decorate([m2(Xe.outFields)], et.prototype, "outFields", void 0), __decorate([m2({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], et.prototype, "path", void 0), __decorate([m2(l4)], et.prototype, "popupEnabled", void 0), __decorate([m2({ type: q2, json: { name: "popupInfo", write: true } })], et.prototype, "popupTemplate", void 0), __decorate([r("popupTemplate")], et.prototype, "writePopupTemplate", null), __decorate([m2({ readOnly: true })], et.prototype, "defaultPopupTemplate", null), __decorate([m2({ types: m5, json: { origins: { service: { write: { target: "drawingInfo.renderer", enabled: false } }, "web-scene": { types: u3, name: "layerDefinition.drawingInfo.renderer", write: { layerContainerTypes: a3, overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3 == null ? void 0 : r3.writeLayerSchema, layerContainerTypes: a3 }) } } }, write: { target: "layerDefinition.drawingInfo.renderer", overridePolicy: (e4, t5, r3) => ({ ignoreOrigin: r3 == null ? void 0 : r3.writeLayerSchema, layerContainerTypes: a3 }) } } })], et.prototype, "renderer", null), __decorate([o("service", "renderer", ["drawingInfo.renderer", "defaultSymbol"]), o("renderer", ["layerDefinition.drawingInfo.renderer", "layerDefinition.defaultSymbol"])], et.prototype, "readRenderer", null), __decorate([m2()], et.prototype, "resourceInfo", void 0), __decorate([m2((() => {
  const e4 = a(s3);
  return e4.json.origins["portal-item"] = { read: false, write: false }, e4;
})())], et.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m2({ clonable: false })], et.prototype, "source", null), __decorate([s2("source")], et.prototype, "castSource", null), __decorate([o("portal-item", "source", ["featureSet"]), o("web-map", "source", ["featureSet"])], et.prototype, "readSource", null), __decorate([m2({ json: { read: { source: "layerDefinition.extent.spatialReference" } } })], et.prototype, "spatialReference", void 0), __decorate([m2({ type: Number })], et.prototype, "subtypeCode", void 0), __decorate([m2({ type: [a5] })], et.prototype, "templates", void 0), __decorate([o("templates", ["editFieldsInfo", "creatorField", "editorField", "templates"])], et.prototype, "readTemplates", null), __decorate([m2({ type: u4 })], et.prototype, "timeInfo", void 0), __decorate([m2()], et.prototype, "title", void 0), __decorate([o("service", "title", ["name"]), o("portal-item", "title", ["layerDefinition.title", "layerDefinition.name", "title"])], et.prototype, "readTitle", null), __decorate([o("web-map", "title", ["layerDefinition.name", "title"])], et.prototype, "readTitleFromWebMap", null), __decorate([m2({ type: String })], et.prototype, "sublayerTitleMode", void 0), __decorate([m2({ json: { read: false } })], et.prototype, "type", void 0), __decorate([m2({ type: String })], et.prototype, "typeIdField", void 0), __decorate([o("service", "typeIdField"), o("typeIdField", ["layerDefinition.typeIdField"])], et.prototype, "readTypeIdField", null), __decorate([m2({ type: [c3] })], et.prototype, "types", void 0), __decorate([o("service", "types", ["types"]), o("types", ["layerDefinition.types"])], et.prototype, "readTypes", null), __decorate([m2({ type: Boolean, json: { origins: { "portal-item": { write: { target: "layerDefinition.defaultVisibility", layerContainerTypes: a3 } } } } })], et.prototype, "visible", void 0), __decorate([o("portal-item", "visible", ["visibility", "layerDefinition.defaultVisibility"])], et.prototype, "readVisible", null), et = __decorate([a2("esri.layers.FeatureLayer")], et);

export {
  et
};
//# sourceMappingURL=chunk-JXLODNJY.js.map

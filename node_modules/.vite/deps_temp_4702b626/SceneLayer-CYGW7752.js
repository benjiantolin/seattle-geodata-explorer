import {
  a as a5
} from "./chunk-5GIGDDDY.js";
import {
  i as i4,
  m as m6,
  t2 as t3
} from "./chunk-ENE3OWEO.js";
import {
  $
...
import {
  l as l6
} from "./chunk-BVV5SL7F.js";
import {
  j as j4
} from "./chunk-CAKN26VU.js";
...
var Te = class extends a7(F(_2(l4(b(j2(t(l2(s6(o3(l(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-ZFZUQ2QO.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-PUS2ABS6.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-CYGW7752.js.map

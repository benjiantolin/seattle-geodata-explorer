...
var f2 = class extends b {
  ...
  get subtypeFilter() {
    ...
    if (!d2(e4) || !((_a = e4.subtypes) == null ? void 0 : _a.length) || !t) return { mode: "not-in-use", filter: null };
  ...
  getFetchCandidatesParameters(e4, t, r3) {
    ...
    if (a2 && f3 && x((_c = this.view) == null ? void 0 : _c.map) && (o2(i3) || d2(i3)) && (o2(v2) || d2(v2)) && ((_d = this.view.map.utilityNetworks) == null ? void 0 : _d.find((e5) => e5.isUtilityLayer(v2)))) {
  ...
  async loadRules() {
    ...
    if (i3 && e4 && t && x(t == null ? void 0 : t.map) && (o2(e4) || d2(e4))) try {
...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-ZP3RYXNM.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-YSQILOCU.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-XNZUGKFW.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-TNZPD6BP.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-LSDCCITM.js.map

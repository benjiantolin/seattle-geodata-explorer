import {
  $
} from "./chunk-6V4CMD3B.js";
import "./chunk-R5P2JIAV.js";
import "./chunk-YK2C6A2U.js";
import {
  n as n6,
  p as p3
...
import {
  ...
  p as p2,
  y as y2
} from "./chunk-EPHSM36G.js";
import {
  _,
  r as r2
} from "./chunk-CSQSVMAH.js";
import "./chunk-EKCA6TMH.js";
import {
  R,
  j as j3,
  w
...
import {
  s as s4
} from "./chunk-CUGFZZ3F.js";
import "./chunk-VYJO54EW.js";
import "./chunk-BUC7RMUM.js";
...
import "./chunk-IAZASSNO.js";
import "./chunk-ALKEERWI.js";
import "./chunk-3YV4AX6S.js";
import "./chunk-VZEUC4NE.js";
import "./chunk-A4SH4PWO.js";
import "./chunk-KS6RLNAC.js";
import "./chunk-6KB3ZCFU.js";
import "./chunk-RBGN4V3G.js";
import "./chunk-JHV6OBEB.js";
import "./chunk-3OMUAXI5.js";
import "./chunk-HJ2NUIR4.js";
import "./chunk-OAOJTDGP.js";
import "./chunk-JHQKBALC.js";
...
var C = class extends p(m2(a6)) {
  ...
  load(e2) {
    const t6 = null != e2 ? e2.signal : null, r3 = this._fetchService(t6).then(() => {
      this.indexInfo = r2(this.parsedUrl.path, this.rootNode, this.nodePages, this.customParameters, this.apiKey, i2.getLogger(this), t6);
    });
  ...
  async queryCachedFeature(e2, r3) {
    ...
    return new _2({ attributes: o7[0], layer: this, sourceLayer: this });
  }
...
var p12 = class extends p(m2(n2)) {
  ...
  get fields() {
    return this.loaded || "loading" === this.loadStatus ? this._get("fields") : (i2.getLogger(this).error("building summary statistics are not loaded"), null);
  }
  load(r3) {
...
var k = class extends _(l5(b(j2(t(l2(s6(o4(b3)))))))) {
  constructor(e2) {
  ...
  async _fetchAssociatedFeatureService(e2) {
    try {
      const { portalItem: t6 } = await s4(`${this.url}/layers/${this.layerId}`, { sceneLayerItem: this.portalItem, customParameters: this.customParameters, apiKey: this.apiKey, signal: e2 });
...
The following sublayers have no binary attributes and will not work with Popups:${o7}${i7.join(o7)}` : "";
    i2.getLogger(this).warn(`Associated FeatureLayer could not be loaded for this BuildingSceneLayer: ${this.title}.`, l9, n9);
  }
  _validateElevationInfo(e2) {
    const t6 = "Building scene layers";
    j3(i2.getLogger(this), w(t6, "absolute-height", e2)), j3(i2.getLogger(this), R(t6, e2));
  }
};
function N2(e2, t6) {

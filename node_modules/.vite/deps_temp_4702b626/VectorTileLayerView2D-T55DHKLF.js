import {
  ...
  n2 as n3,
  y as y2
} from "./chunk-VEQJMP3Y.js";
import {
  i as i3
} from "./chunk-MCAEG4EB.js";
import {
  n as n4
} from "./chunk-L35YUM25.js";
import {
  r2 as r
...
import {
  t as t3,
  t2 as t4
} from "./chunk-T56MEBDV.js";
import "./chunk-U3B7YMY7.js";
import {
  D,
  l
} from "./chunk-LCWQCZQQ.js";
import {
  c,
  o as o2,
  t as t2
...
var c2 = class {
  constructor(i6, t7) {
    this._tiles = /* @__PURE__ */ new Map(), this._tileCache = new e3(40, (e8) => e8.dispose()), this._viewSize = [0, 0], this._visibleTiles = /* @__PURE__ */ new Map(), this.acquireTile = i6.acquireTile, this.releaseTile = i6.releaseTile, this.tileInfoView = i6.tileInfoView, this._container = t7;
  }
  destroy() {
  ...
  getIntersectingTiles(e8, l2, o3, r4, n8) {
    ...
    const h8 = Math.min(a6[0], c4[0]), d6 = Math.min(a6[1], c4[1]), _3 = Math.max(a6[0], c4[0]), f4 = Math.max(a6[1], c4[1]), T2 = e4(h8, d6, _3, f4), u4 = i2(), p5 = [];
...
//# sourceMappingURL=VectorTileLayerView2D-T55DHKLF.js.map

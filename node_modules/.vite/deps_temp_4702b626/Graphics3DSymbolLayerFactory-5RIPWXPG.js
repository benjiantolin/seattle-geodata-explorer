import {
  x as x5
} from "./chunk-MQ7FXKID.js";
import {
  C as C4
} from "./chunk-JSIENPTJ.js";
import {
  C as C3,
  O as O2,
  O2 as O3,
...
import {
  j as j7
} from "./chunk-MUXCAEZU.js";
import {
  d as d10
} from "./chunk-TMDM46DQ.js";
import {
  I as I2,
  u as u21
} from "./chunk-DJAQ3NMX.js";
...
import {
  h as h6
} from "./chunk-ZAIYD7H4.js";
import "./chunk-NAJIRKWY.js";
import {
  p as p6,
  u as u15
} from "./chunk-C5TX2J67.js";
...
import "./chunk-74YPMIAX.js";
import "./chunk-JT6LQ5FA.js";
import "./chunk-ZL6MI33D.js";
import "./chunk-OKN63ENQ.js";
import {
  l as l10,
  n as n15
...
var _he = class _he extends m13 {
  ...
  async _prepareResourcesCIM(e33, t30, r28) {
    const { OverrideHelper: i24 } = await import("./OverrideHelper-RTSXDQXM.js");
    if (this._overrideHelperClass = i24, this._cimData = t30, !this._context.sharedResources.cimSymbolRasterizer) {
      const e34 = (await import("./CIMSymbolRasterizer-4G6SQZYQ.js")).CIMSymbolRasterizer;
    ...
    if (this._arcadeInfo = { spatialReference: h19, fields: c26, geometryType: "esriGeometryPoint" }, (a26 == null ? void 0 : a26.primitiveOverrides) && o25.push(i24.createRenderExpressions(a26.primitiveOverrides, this._arcadeInfo)), o25.length > 0 && (await Promise.all(o25), s2(r28)), this._context.renderer && "dictionary" === this._context.renderer.type && this._context.renderer.scaleExpression) {
      ...
      if (e34.scaleExpression) {
        const t31 = e34.scaleExpression, r29 = await h3(t31, this._context.layer.spatialReference), { default: i25 } = await import("./callExpressionWithFeature-2DEBQQOK.js"), s28 = new Z(c26);
...
var g8 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t15(j7, () => import("./LineMarker.glsl-QQZR5GB3.js")), S3(t30).locations);
  }
...
var j8 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t15(d10, () => import("./NativeLine.glsl-DBO3JCC5.js")), t30.hasVertexColors ? v4.locations : o18.locations), this.primitiveType = _4.LINES;
  }
...
var V4 = class extends m10 {
  constructor(e33, r28) {
    super(e33, r28, new t15(I2, () => import("./Path.glsl-W7Y6UYJL.js")), x8(r28).locations);
  }
  initializePipeline(e33) {
...
var S9 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t15(x5, () => import("./Pattern.glsl-H4MPVXF4.js")), b12(t30).locations);
  }
...
var h17 = class extends m10 {
  constructor(e33, t30) {
    super(e33, t30, new t15(C4, () => import("./WaterSurface.glsl-L5F6F4JP.js")), e21() ? c13.locations : r17.locations);
  }
  initializePipeline(e33) {
...
//# sourceMappingURL=Graphics3DSymbolLayerFactory-5RIPWXPG.js.map

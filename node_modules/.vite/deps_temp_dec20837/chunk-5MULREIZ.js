import {
  l as l2,
  p
} from "./chunk-VXXZN2NI.js";
import {
  h,
  i,
  m,
  r
} from "./chunk-3RWZ3F45.js";
import {
  n
} from "./chunk-BKXD7GOW.js";
import {
  m as m2
} from "./chunk-OUDWAZ6C.js";
import {
  c as c2,
  e as e2,
  i as i2,
...
var e3 = class extends r3 {
  ...
  marshalledCall(e4, a2, l4, c4) {
    return c4(e4, a2, (a3, o3, i5) => {
      i5 = i5.map((t3) => t3 instanceof r3 && !(t3 instanceof s3) ? n3(t3, e4, c4) : t3);
      const u = this.call(l4, { args: i5 });
      return C(u) ? u.then((t3) => n3(t3, l4, c4)) : u;
    });
  }
};
...
var t2 = class {
  ...
  slice(t3 = 0, e4 = this.length()) {
    const s4 = [];
    for (let r4 = t3; r4 < e4; r4++) s4.push(this.get(r4));
    return s4;
  }
};
...
var P2 = { "small-integer": "esriFieldTypeSmallInteger", integer: "esriFieldTypeInteger", long: "esriFieldTypeLong", single: "esriFieldTypeSingle", double: "esriFieldTypeDouble", string: "esriFieldTypeString", date: "esriFieldTypeDate", "date-only": "esriFieldTypeDateOnly", "time-only": "esriFieldTypeTimeOnly", "timestamp-offset": "esriFieldTypeTimestampOffset", oid: "esriFieldTypeOID", geometry: "esriFieldTypeGeometry", blob: "esriFieldTypeBlob", raster: "esriFieldTypeRaster", guid: "esriFieldTypeGUID", "global-id": "esriFieldTypeGlobalID", xml: "esriFieldTypeXML", "big-integer": "esriFieldTypeBigInteger", esriFieldTypeSmallInteger: "esriFieldTypeSmallInteger", esriFieldTypeInteger: "esriFieldTypeInteger", esriFieldTypeLong: "esriFieldTypeLong", esriFieldTypeSingle: "esriFieldTypeSingle", esriFieldTypeDouble: "esriFieldTypeDouble", esriFieldTypeString: "esriFieldTypeString", esriFieldTypeDate: "esriFieldTypeDate", esriFieldTypeDateOnly: "esriFieldTypeDateOnly", esriFieldTypeTimeOnly: "esriFieldTypeTimeOnly", esriFieldTypeTimestampOffset: "esriFieldTypeTimestampOffset", esriFieldTypeOID: "esriFieldTypeOID", esriFieldTypeGeometry: "esriFieldTypeGeometry", esriFieldTypeBlob: "esriFieldTypeBlob", esriFieldTypeRaster: "esriFieldTypeRaster", esriFieldTypeGUID: "esriFieldTypeGUID", esriFieldTypeGlobalID: "esriFieldTypeGlobalID", esriFieldTypeXML: "esriFieldTypeXML", esriFieldTypeBigInteger: "esriFieldTypeBigInteger" };
function I(e4) {
  return void 0 === e4 ? "" : e4 = (e4 = (e4 = e4.replace(/\/featureserver\/[0-9]*/i, "/FeatureServer")).replace(/\/mapserver\/[0-9]*/i, "/MapServer")).split("?")[0];
}
function J(e4, i5) {
  i5 || (i5 = {}), "function" == typeof i5 && (i5 = { cmp: i5 });
  const r4 = "boolean" == typeof i5.cycles && i5.cycles, t3 = i5.cmp && (n4 = i5.cmp, function(e5) {
    return function(i6, r5) {
      const t4 = { key: i6, value: e5[i6] }, o4 = { key: r5, value: e5[r5] };
      return n4(t4, o4);
    };
  });
  var n4;
  const o3 = [];
  return function e5(i6) {
    if ((i6 == null ? void 0 : i6.toJSON) && "function" == typeof i6.toJSON && (i6 = i6.toJSON()), void 0 === i6) return;
    if ("number" == typeof i6) return isFinite(i6) ? "" + i6 : "null";
    if ("object" != typeof i6) return JSON.stringify(i6);
    let n5, l4;
    if (Array.isArray(i6)) {
      for (l4 = "[", n5 = 0; n5 < i6.length; n5++) n5 && (l4 += ","), l4 += e5(i6[n5]) || "null";
      return l4 + "]";
    }
    ...
    const s4 = o3.push(i6) - 1, y2 = Object.keys(i6).sort(t3 == null ? void 0 : t3(i6));
    for (l4 = "", n5 = 0; n5 < y2.length; n5++) {
      const r5 = y2[n5], t4 = e5(i6[r5]);
      t4 && (l4 && (l4 += ","), l4 += JSON.stringify(r5) + ":" + t4);
    }
    return o3.splice(s4, 1), "{" + l4 + "}";
  }(e4);
}
function M(e4) {
  switch (e4.type) {
...
var i3 = class _i extends t2 {
  constructor(t3, s4, i5, h4, e4, a2) {
    super(t3), this._lazyPt = [], this._hasZ = false, this._hasM = false, this._spRef = s4, this._hasZ = i5, this._hasM = h4, this._cacheId = e4, this._partId = a2;
  }
  get(t3) {
...
function le(e4, t3) {
  return isNaN(e4) || null == t3 || "" === t3 ? e4.toString() : (t3 = Y(t3, "‰", ""), t3 = Y(t3, "¤", ""), l2(e4, { pattern: t3 }));
}
function fe(e4, t3) {
...
function de(e4, t3, r4) {
  if (null === e4) {
    if (null === t3 || t3 === P3) return me(null, null, r4);
  ...
  if (e4 === P3) {
    ...
    if (null === t3 || t3 === P3) return me(e4, 0, r4);
    ...
    if (null === t3 || t3 === P3) return me(Se(e4), 0, r4);
    ...
    if (null === t3 || t3 === P3) return me(e4.toNumber(), 0, r4);
...
function ye(e4, t3) {
  ...
  if (null === e4 && t3 === P3 || null === t3 && e4 === P3) return true;
...
function ge(e4, t3) {
  ...
  return null !== e4 && "object" == typeof e4 && "castToText" in e4 ? e4.castToText() : L(e4) ? "object, Function" : e4 === P3 ? "" : G2(e4) ? "object, Module" : "";
}
function he(e4) {
  const t3 = [];
  if (e4 instanceof t2) {
...
function be(e4, t3, n4 = false) {
  ...
  return null !== e4 && "object" == typeof e4 && "castToText" in e4 ? e4.castToText(n4) : L(e4) ? "object, Function" : e4 === P3 ? "" : G2(e4) ? "object, Module" : "";
}
function Ne(e4, t3 = false) {
  ...
  } else if (e4 === P3) return "null";
  return "null";
}
function Se(e4, t3) {
  return n2(e4) ? e4 : null === e4 || "" === e4 ? 0 : ne(e4) || re(e4) || ie(e4) ? NaN : t(e4) ? e4 ? 1 : 0 : o(e4) || "" === e4 || void 0 === e4 ? NaN : void 0 !== t3 && e2(e4) ? (t3 = Y(t3, "‰", ""), t3 = Y(t3, "¤", ""), p(e4, { pattern: t3 })) : e4 === P3 ? 0 : Number(e4);
}
function Ze(e4, t3) {
  if (ne(e4)) return e4;
  if (e2(e4)) {
...
function Te(e4, t3) {
  ...
  let a2 = DateTime.fromISO(e4, { zone: i5 });
  return a2.isValid || n4.test(e4) && (e4 = e4.replace(n4, "T$1"), a2 = DateTime.fromISO(e4, { zone: t3 }), a2.isValid) ? a2 : null;
}
function Ae(e4) {
...
function je(e4) {
  ...
  return e4 instanceof m3 ? 0 === e4.points.length ? null : e4 : e4 instanceof z ? "NaN" === e4.xmin || null === e4.xmin || isNaN(e4.xmin) ? null : e4 : null;
}
function xe(e4, t3) {
  if (!e4) return t3;
...
function Ce(e4, t3, n4 = null, r4 = null) {
  ...
  let i5, o3, u = null;
  for (let a2 = 0; a2 < t3.fields.length; a2++) {
    const n5 = t3.fields[a2];
    n5.name.toLowerCase() === e4.toString().toLowerCase() && (u = n5);
  }
  if (null === u) throw new n(null, "FieldNotFound", null, { key: e4 });
  let s4 = t3.typeIdField, l4 = "id", f5 = t3.types;
  if (t3.subtypeField && (s4 = t3.subtypeField, l4 = "code", f5 = t3.subtypes ?? []), null === r4 && n4 && s4) r4 = n4.hasField(s4) ? n4.field(s4) : null;
  else if (s4 && null !== r4) {
    let e5 = false;
    for (const t4 of f5 || []) if (r4 === t4[l4]) {
      e5 = true;
      break;
    }
    if (!e5) {
      for (const t4 of f5 || []) if (r4 === t4.name) {
        r4 = t4[l4], e5 = true;
        break;
      }
    }
  ...
  return null != r4 && f5.some((e5) => {
    var _a;
    return e5[l4] === r4 && (i5 = (_a = e5.domains) == null ? void 0 : _a[u.name], i5 && "inherited" === i5.type && (i5 = Fe(u.name, t3), o3 = true), true);
  }), o3 || i5 || (i5 = Fe(e4, t3)), { field: u, domain: i5 };
}
function Fe(e4, t3) {
  let n4;
...
function we(e4, t3) {
  ...
  const n4 = "boolean" == typeof t3.cycles && t3.cycles, r4 = t3.cmp && (i5 = t3.cmp, function(e5) {
    return function(t4, n5) {
      const r5 = { key: t4, value: e5[t4] }, a3 = { key: n5, value: e5[n5] };
      return i5(r5, a3);
    };
  });
  var i5;
  ...
  return function e5(t4) {
    ...
    let i6, o3;
    if (Array.isArray(t4)) {
      for (o3 = "[", i6 = 0; i6 < t4.length; i6++) i6 && (o3 += ","), o3 += e5(t4[i6]) || "null";
      return o3 + "]";
    }
    ...
    const u = a2.push(t4) - 1, s4 = Object.keys(t4).sort(r4 == null ? void 0 : r4(t4));
    for (o3 = "", i6 = 0; i6 < s4.length; i6++) {
      const n5 = s4[i6], r5 = e5(t4[n5]);
      r5 && (o3 && (o3 += ","), o3 += JSON.stringify(n5) + ":" + r5);
    }
    return a2.splice(u, 1), "{" + o3 + "}";
  }(e4);
}
function Je(e4) {
  if (null === e4) return null;
...
function Re(e4, t3) {
  if (o(e4) || te(e4)) {
    let n4 = false, r4 = false, i5 = [], o3 = t3;
    if (o(e4)) {
      for (const t4 of e4) Me(i5, t4);
      i5.length > 0 && (o3 = e4[0].spatialReference, n4 = e4[0].hasZ, r4 = e4[0].hasM);
    } else if (e4 instanceof i3) i5 = e4._elements, i5.length > 0 && (n4 = e4._hasZ, r4 = e4._hasM, o3 = e4.get(0).spatialReference);
    else {
      if (!te(e4)) throw new n(null, "InvalidParameter", null);
      for (const t4 of e4.toArray()) Me(i5, t4);
      i5.length > 0 && (o3 = e4.get(0).spatialReference, n4 = true === e4.get(0).hasZ, r4 = true === e4.get(0).hasM);
    }
    if (0 === i5.length) return null;
    return h2(i5) || (i5 = i5.slice().reverse()), new P({ rings: [i5], spatialReference: o3, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function ve(e4, t3) {
  if (o(e4) || te(e4)) {
    let n4 = false, r4 = false, i5 = [], a2 = t3;
    if (o(e4)) {
      for (const t4 of e4) Me(i5, t4);
      i5.length > 0 && (a2 = e4[0].spatialReference, n4 = true === e4[0].hasZ, r4 = true === e4[0].hasM);
    } else if (e4 instanceof i3) i5 = e4._elements, i5.length > 0 && (n4 = e4._hasZ, r4 = e4._hasM, a2 = e4.get(0).spatialReference);
    else if (te(e4)) {
      for (const t4 of e4.toArray()) Me(i5, t4);
      i5.length > 0 && (a2 = e4.get(0).spatialReference, n4 = true === e4.get(0).hasZ, r4 = true === e4.get(0).hasM);
    }
    return 0 === i5.length ? null : new y({ paths: [i5], spatialReference: a2, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function Pe(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return 0 === i5.length ? null : new m3({ points: i5, spatialReference: a2, hasZ: n4, hasM: r4 });
  }
  return e4;
}
...
async function ze(e4, t3 = null, n4 = null) {
  ...
  if (Array.isArray(e4)) {
    const r4 = [], i5 = [];
    for (const a2 of e4) null === a2 || V(a2) || a2 instanceof c || c2(a2) || ne(a2) ? i5.push(Ge(a2, n4)) : (i5.push(null), r4.push(Ve(a2, t3, n4, i5.length - 1, i5)));
...
function Qe(e4) {
  ...
  if (!t3.fields) return null;
  const n4 = [];
  for (const r4 of t3.fields) n4.push(l3(r4));
...
function Xe(r4, i5) {
  const a2 = m.systemTimeZoneCanonicalName;
  return "system" === r4 && (r4 = a2), { version: et, engineVersion: e, timeZone: r4, userTimeZone: a2, spatialReference: i5 instanceof f ? i5.toJSON() : i5, application: s.applicationName ?? "", engine: "web", locale: l() };
}
var et = "1.34";
var tt = Object.freeze(Object.defineProperty({ __proto__: null, ImplicitResult: v, ReturnResult: R, absRound: se, arcadeVersion: et, autoCastArrayOfPointsToMultiPoint: Pe, autoCastArrayOfPointsToPolygon: Re, autoCastArrayOfPointsToPolyline: ve, autoCastFeatureToGeometry: Je, binaryOperator: Le, breakResult: _2, castAsJson: Ge, castAsJsonAsync: ze, castRecordToText: pe, continueResult: I2, defaultExecutingContext: Xe, defaultTimeZone: Ke, defaultUndefined: z2, equalityTest: ye, featureDomainCodeLookup: Be, featureDomainValueLookup: $e, featureFullDomain: He, featureSchema: Qe, featureSubtypes: We, fixNullGeometry: je, fixSpatialReference: De, formatDate: fe, formatNumber: le, getDomain: Ce, getDomainCode: Oe, getDomainValue: xe, getType: E, greaterThanLessThan: de, isArray: o, isBoolean: t, isDate: ne, isDateOnly: re, isDictionary: K, isDictionaryLike: Q, isEmpty: ue, isFeature: H, isFeatureSet: B, isFeatureSetCollection: X, isFunctionParameter: L, isGeometry: U, isGraphic: i2, isImmutableArray: te, isInteger: r2, isJsDate: c2, isKnowledgeGraph: ee, isModule: G2, isNumber: n2, isObject: ae, isPixel: $, isSimpleType: V, isString: e2, isSubtypeGrouplayer: Ue, isSubtypeSublayer: qe, isTime: ie, isVoid: q, isVoxel: W, multiReplace: Y, parseGeometryFromJson: ke, pcCheck: oe, stableStringify: we, standardiseDateFormat: ce, tick: Ye, toBoolean: Ae, toDate: Ze, toNumber: Se, toNumberArray: he, toString: ge, toStringArray: _e, toStringExplicit: be, voidOperation: P3 }, Symbol.toStringTag, { value: "Module" }));
...
var p2;
function f4(i5) {
  return null === i5 ? null : ne(i5) ? i5.clone() : V(i5) ? i5 : U(i5) ? i5.clone() : te(i5) ? i5.toArray().map((a2) => f4(a2)) : o(i5) ? i5.map((a2) => f4(a2)) : H(i5) ? p2.createFromArcadeFeature(i5) : X(i5) || B(i5) ? i5 : K(i5) || "esri.arcade.Attachment" === (i5 == null ? void 0 : i5.declaredClass) ? i5.deepClone() : ("esri.arcade.Portal" === (i5 == null ? void 0 : i5.declaredClass) || ee(i5) || i5 instanceof s2 || L(i5), i5);
}
...
function w(t3, e4, s4 = false, r4 = false) {
  ...
  const i5 = new p3();
  i5.immutable = false;
  for (const [n4, o3] of Object.entries(t3)) void 0 !== o3 && i5.setField(n4, w(o3, e4, s4, r4));
...
var p3 = class _p {
  ...
  static convertObjectToArcadeDictionary(t3, e4, s4 = true, r4 = false) {
    ...
    for (const n4 in t3) {
      const o3 = t3[n4];
      void 0 !== o3 && i5.setField(n4.toString(), w(o3, e4, s4, r4));
    }
    return i5.immutable = s4, i5;
  }
  ...
  async castAsJsonAsync(e4 = null, s4 = null) {
    ...
    for (let o3 in this.attributes) {
      const u = this.attributes[o3];
      (s4 == null ? void 0 : s4.keyTranslate) && (o3 = s4.keyTranslate(o3)), void 0 !== u && (V(u) || u instanceof c || u instanceof m ? r4[o3] = Ge(u, s4) : i5.push(this.castDictionaryValueAsJsonAsync(r4, o3, u, e4, s4)));
    }
  ...
  deepClone() {
    const t3 = new _p();
    t3.immutable = false;
    for (const s4 of this.keys()) t3.setField(s4, f4(this.field(s4)));
    return t3;
  }
};
...
//# sourceMappingURL=chunk-5MULREIZ.js.map

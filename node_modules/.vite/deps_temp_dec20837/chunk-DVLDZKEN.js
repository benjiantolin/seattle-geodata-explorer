...
var p = (() => {
  ...
  }), s3 = (t9, r2, i4) => (e5.set(t9, r2), o6.observe(t9, i4), e(() => {
...
function d(e5, t9) {
  ...
  const i4 = t9.vnodeSelector;
  if (f(i4)) {
    const o6 = t9.properties || n2, d5 = o6.key || i4, f3 = { key: d5, afterCreate: c2, afterUpdate: s, afterRemoved: a, parentWidget: e5, widgetConstructor: i4, widgetProperties: { ...o6, key: d5, children: r2 } };
    return { vnodeSelector: i4.vnodeSelector, properties: f3, children: void 0, text: void 0, domNode: null };
  }
  return t9;
}
...
var o3 = function(r2, t9) {
  for (var n7 = 0, i4 = r2.length; n7 < i4; n7++) {
    var d5 = r2[n7];
...
var t6 = function(r2, e5) {
  ...
  var i4 = [];
  return o3(t9, i4), { vnodeSelector: r2, properties: e5 || void 0, children: i4, text: void 0, domNode: null };
};
...
var d2 = (e5, t9, r2, o6) => {
  let i4 = e5[t9];
  if ("" === i4.vnodeSelector) return;
  let n7 = i4.properties;
  if (!(n7 ? void 0 === n7.key ? n7.bind : n7.key : void 0)) {
    for (let s3 = 0; s3 < e5.length; s3++) if (s3 !== t9) {
      let t10 = e5[s3];
      if (l3(t10, i4)) throw new Error(`${r2.vnodeSelector} had a ${i4.vnodeSelector} child ${"added" === o6 ? o6 : "removed"}, but there is now more than one. You must add unique key properties to make them distinguishable.`);
    }
  }
};
var a2 = (e5) => {
...
var y2 = (t9, i4, n7) => {
  if (!i4) return;
  let l4 = n7.eventHandlerInterceptor, p4 = Object.keys(i4), d5 = p4.length;
  for (let a3 = 0; a3 < d5; a3++) {
    let d6 = p4[a3], f3 = i4[d6];
    ...
    if ("class" === d6) k(t9, f3, true);
      ...
      let e5 = Object.keys(f3), r2 = e5.length;
      for (let o6 = 0; o6 < r2; o6++) {
        let r3 = e5[o6], i5 = f3[r3];
        i5 && (s2(i5), n7.styleApplyer(t9, r3, i5));
      }
    } else if ("key" !== d6 && null != f3) {
      let s3 = typeof f3;
      "function" === s3 ? (0 === d6.lastIndexOf("on", 0) && (l4 && (f3 = l4(d6, f3, t9, i4)), "oninput" === d6 && function() {
        let e5 = f3;
        f3 = function(t10) {
  ...
  if ("" === p4) l4 = e5.domNode = d5.createTextNode(e5.text), void 0 !== o6 ? t9.insertBefore(l4, o6) : t9.appendChild(l4);
    ...
    for (let a3 = 0; a3 <= p4.length; ++a3) {
      ...
      if (a3 === p4.length || "." === f3 || "#" === f3) {
        ...
        "." === f4 ? l4.classList.add(c4) : "#" === f4 ? l4.id = c4 : ("svg" === c4 && (i4 = n4(i4, { namespace: r })), void 0 !== i4.namespace ? l4 = e5.domNode = d5.createElementNS(i4.namespace, c4) : (l4 = e5.domNode = e5.domNode || d5.createElement(c4), "input" === c4 && e5.properties && void 0 !== e5.properties.type && l4.setAttribute("type", e5.properties.type)), void 0 !== o6 ? t9.insertBefore(l4, o6) : l4.parentNode !== t9 && t9.appendChild(l4)), s3 = a3 + 1;
      }
    }
    w2(l4, e5, i4);
  }
...
var A = (t9, i4, n7, l4) => {
  ...
  for (let f3 = 0; f3 < a3; f3++) {
    let a4 = d5[f3], c4 = n7[a4], u2 = i4[a4];
    if ("class" === a4) u2 !== c4 && (k(t9, u2, false), k(t9, c4, true));
    else if ("classes" === a4) {
      let e5 = t9.classList, r2 = Object.keys(c4), o6 = r2.length;
      for (let t10 = 0; t10 < o6; t10++) {
        let o7 = r2[t10], i5 = !!c4[o7];
        i5 !== !!u2[o7] && (p4 = true, i5 ? e5.add(o7) : e5.remove(o7));
      }
    } else if ("styles" === a4) {
      let e5 = Object.keys(c4), r2 = e5.length;
      for (let o6 = 0; o6 < r2; o6++) {
        let r3 = e5[o6], i5 = c4[r3];
        i5 !== u2[r3] && (p4 = true, i5 ? (s2(i5), l4.styleApplyer(t9, r3, i5)) : l4.styleApplyer(t9, r3, ""));
      }
    } else if (c4 || "string" != typeof u2 || (c4 = ""), "value" !== a4 || g(t9)) {
      if (c4 !== u2) {
        let i5 = typeof c4;
        "function" === i5 && l4.eventHandlerInterceptor || (l4.namespace === r ? "href" === a4 ? t9.setAttributeNS(o4, a4, c4) : t9.setAttribute(a4, c4) : "string" === i5 ? "innerHTML" === a4 ? t9[a4] = t3.sanitize(c4) : "role" === a4 && "" === c4 ? t9.removeAttribute(a4) : g(t9) && a4 in t9 ? t9[a4] = c4 : t9.setAttribute(a4, c4) : t9[a4] !== c4 && (t9[a4] = c4), p4 = true);
      }
    } else {
      let e5 = t9[a4];
...
var S = (e5, t9, r2, o6, n7) => {
  ...
  o6 = o6 || i2;
  let s3, f3 = (r2 = r2 || i2).length, c4 = o6.length, u2 = 0, m2 = 0, h3 = false;
  for (; m2 < c4; ) {
    let i4 = u2 < f3 ? r2[u2] : void 0, c5 = o6[m2];
    if (void 0 !== i4 && l3(i4, c5)) h3 = N(i4, c5, n7) || h3, u2++;
    else {
      let i5 = p2(r2, c5, u2 + 1);
      if (i5 >= 0) {
        for (s3 = u2; s3 < i5; s3++) v2(r2[s3]), d2(r2, s3, e5, "removed");
        h3 = N(r2[i5], c5, n7) || h3, u2 = i5 + 1;
...
N = (e5, t9, o6) => {
  let i4 = e5.domNode, l4 = false;
  if (e5 === t9) return false;
  let s3 = false;
  if ("" === t9.vnodeSelector) {
    if (t9.text !== e5.text) {
      let e6 = i4.ownerDocument.createTextNode(t9.text);
      return i4.parentNode.replaceChild(e6, i4), t9.domNode = e6, l4 = true, l4;
    }
    t9.domNode = i4;
  } else 0 === t9.vnodeSelector.lastIndexOf("svg", 0) && (o6 = n4(o6, { namespace: r })), e5.text !== t9.text && (s3 = true, void 0 === t9.text ? i4.removeChild(i4.firstChild) : i4.textContent = t9.text), t9.domNode = i4, s3 = S(t9, i4, e5.children, t9.children, o6) || s3, s3 = A(i4, e5.properties, t9.properties, o6) || s3, t9.properties && t9.properties.afterUpdate && t9.properties.afterUpdate.apply(t9.properties.bind || t9.properties, [i4, o6, t9.vnodeSelector, t9.properties, t9.children]);
  return s3 && t9.properties && t9.properties.updateAnimation && t9.properties.updateAnimation(i4, t9.properties, e5.properties), l4;
};
...
var d4 = (e5, r2, t9) => {
  let d5 = function(d6) {
    t9("domEvent", d6);
    let i4 = r2(), p4 = n6(d6.currentTarget, i4.domNode);
    p4.reverse();
    let l4, a3 = o5(i4.getLastRender(), p4);
...
var i3 = (t9) => {
  let n7, o6, i4 = d3(t9), p4 = i4.performanceLogger, l4 = true, a3 = false, s3 = [], c4 = [], u2 = (e5, r2, t10) => {
    let o7, l5 = () => o7;
    i4.eventHandlerInterceptor = d4(n7, l5, p4), o7 = e5(r2, t10(), i4), s3.push(o7), c4.push(t10);
  }, f3 = () => {
    if (o6 = void 0, l4) {
...
//# sourceMappingURL=chunk-DVLDZKEN.js.map

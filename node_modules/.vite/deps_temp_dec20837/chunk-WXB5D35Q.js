...
import {
  i as i2
} from "./chunk-PDDYKYDZ.js";
import {
  f as f2
} from "./chunk-GOQS4H34.js";
import {
  a,
  c as c3
...
function q2(t3, n5, r3) {
  const { vertexSpace: e3, transform: o4, vertexAttributes: i3 } = t3, a4 = t(e3) ? o4 : null, s2 = Y2(t3.spatialReference, r3, 3);
...
function H({ vertexAttributes: t3, spatialReference: n5, transform: r3 }, { origin: e3 }, i3, l) {
  ...
  const u = 1 / Y2(n5, l, 2);
  f(rt, rt, [u, u, u]);
  const f3 = h2(et, rt), { position: m, normal: p, tangent: g } = I(t3, e3, r3), x2 = new Float64Array(m.length), h3 = $(m, n5, f3, x2, c4);
  if (!h3) return null;
  const v2 = j(ot, f3), j2 = _(p, m, n5, x2, c4, v2, p !== t3.normal ? p : void 0);
  if (!j2 && p) return null;
...
//# sourceMappingURL=chunk-WXB5D35Q.js.map

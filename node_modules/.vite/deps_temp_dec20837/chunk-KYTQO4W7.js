...
import {
  ...
  o,
  r3 as r5
} from "./chunk-C52LBWPO.js";
import {
  e as e5
} from "./chunk-FSZZ37ZU.js";
import {
  d as d2,
  e4 as e2,
  f,
  ...
  t2,
  u
} from "./chunk-5ZHZAKF4.js";
import {
  e2 as e
} from "./chunk-NMKKB65B.js";
import {
  e as e4
...
vec3 normalView;
vec3 viewDirection;
} shadingParams;`), o5.doubleSidedMode) {
    case 0:
...
function J(J2) {
  ...
  if (f(X, J2), Q.add("position", "vec3"), Z.add("vpos", "vec3", { invariant: true }), K2.include(u, J2), K2.include(p2, J2), K2.include(n3, J2), K2.include(a3, J2), !o(ee)) return K2.include(f3, J2), K2;
  ...
  return ve && oe && K2.include(c), K2.include(d4, J2), K2.include(d, J2), K2.include(t3, J2), Z.add("vPositionLocal", "vec3"), K2.include(d3, J2), K2.include(i, J2), K2.include(r3, J2), X.uniforms.add(new e2("externalColor", (e8) => e8.externalColor, { supportsNaN: true })), Z.add("vcolorExt", "vec4"), K2.include(i2, J2), X.include(r2), X.include(l2), K2.include(ne ? p4 : f5, J2), X.main.add(t`
    ...
    ${n2(ve, "vNormalWorld = dpNormal(vvLocalNormal(normalModel()));")}
    vpos = addVerticalOffset(vpos, localOrigin);
    ${n2(de, "vTangent = dpTransformVertexTangent(tangent);")}
    gl_Position = transformPosition(proj, view, vpos);
    ${n2(ve && oe, "gl_Position = offsetBackfacingClipPosition(gl_Position, vpos, vNormalWorld, cameraPosition);")}
  ...
  `), K2.include(f4, J2), Y.include(t4, J2), K2.include(f2, J2), Y.include(p, J2), K2.include(n6, J2), d2(Y, J2), Y.uniforms.add(X.uniforms.get("localOrigin"), new e("ambient", (e8) => e8.ambient), new e("diffuse", (e8) => e8.diffuse), new r4("opacity", (e8) => e8.opacity), new r4("layerOpacity", (e8) => e8.layerOpacity)), ce && Y.uniforms.add(new e3("tex", (e8) => e8.texture)), K2.include(n5, J2), Y.include(n4, J2), Y.include(i3), K2.include(e7, J2), Y.include(e6, J2), p3(Y), v(Y), a2(Y), Y.main.add(t`
    discardBySlice(vpos);
    discardByTerrainDepth();
    ${ce ? t`
            vec4 texColor = texture(tex, ${ue ? "colorUV" : "vuv0"});
            ${n2(se, "texColor.rgb /= texColor.a;")}
    ...
    vec3 albedo = mixExternalColor(${n2(te, "vColor.rgb *")} matColor, texColor.rgb, vcolorExt.rgb, colorMixMode);
    float opacity_ = layerOpacity * mixExternalOpacity(${n2(te, "vColor.a * ")} opacity, texColor.a, vcolorExt.a, opacityMixMode);
    ...
    ${1 === le || 2 === le ? t`
            ...
            ${n2(ae, "mrr = applySnowToMRR(mrr, snow);")}
    ...
    outputColorHighlightOID(finalColor, vpos, albedo ${n2(ae, ", snow")});
  `), K2;
}
...
//# sourceMappingURL=chunk-KYTQO4W7.js.map

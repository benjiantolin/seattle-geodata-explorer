...
var a = globalThis;
function has(d2) {
  return "function" == typeof e[d2] ? e[d2] = e[d2](a) : e[d2];
}
var _a, _b, _c, _d;
e = ((_a = a.dojoConfig) == null ? void 0 : _a.has) || ((_b = a.esriConfig) == null ? void 0 : _b.has) ? { ...(_c = a.dojoConfig) == null ? void 0 : _c.has, ...(_d = a.esriConfig) == null ? void 0 : _d.has } : {}, has.add = (a4, d2, r4, t3) => {
  (t3 || void 0 === e[a4]) && (e[a4] = d2), r4 && has(a4);
  ...
  if (has.add("host-browser", e4), has.add("host-node", !("object" != typeof a.process || !((_a2 = a.process.versions) == null ? void 0 : _a2.node) || !a.process.versions.v8)), has.add("dom", e4), has("host-browser")) {
    const e5 = navigator, a4 = e5.userAgent, d2 = e5.appVersion, r4 = parseFloat(d2);
    if (has.add("wp", parseFloat(a4.split("Windows Phone")[1]) || void 0), has.add("msapp", parseFloat(a4.split("MSAppHost/")[1]) || void 0), has.add("khtml", d2.includes("Konqueror") ? r4 : void 0), has.add("edge", parseFloat(a4.split("Edge/")[1]) || void 0), has.add("opr", parseFloat(a4.split("OPR/")[1]) || void 0), has.add("webkit", !has("wp") && !has("edge") && parseFloat(a4.split("WebKit/")[1]) || void 0), has.add("chrome", !has("edge") && !has("opr") && parseFloat(a4.split("Chrome/")[1]) || void 0), has.add("android", !has("wp") && parseFloat(a4.split("Android ")[1]) || void 0), has.add("safari", !d2.includes("Safari") || has("wp") || has("chrome") || has("android") || has("edge") || has("opr") ? void 0 : parseFloat(d2.split("Version/")[1])), has.add("mac", d2.includes("Macintosh")), !has("wp") && /(iPhone|iPod|iPad)/.test(a4)) {
      const e6 = RegExp.$1.replace(/P/, "p"), d3 = /OS ([\d_]+)/.test(a4) ? RegExp.$1 : "1", r5 = parseFloat(d3.replace(/_/, ".").replaceAll("_", ""));
  ...
  if (a.navigator) {
    const e4 = navigator.userAgent, a4 = /Android|webOS|iPhone|iPad|iPod|BlackBerry|Opera Mini|IEMobile/i.test(e4), d2 = /iPhone/i.test(e4);
    a4 && has.add("esri-mobile", a4), d2 && has.add("esri-iPhone", d2), has.add("esri-geolocation", !!navigator.geolocation);
  }
  has.add("esri-wasm", "WebAssembly" in a), has.add("esri-performance-mode-frames-between-render", 20), has.add("esri-force-performance-mode", false), has.add("esri-shared-array-buffer", () => {
    const e4 = "SharedArrayBuffer" in a, d2 = false === a.crossOriginIsolated;
    return e4 && !d2;
  }), has.add("wasm-simd", () => {
...
function s(n3, t3, e4, r4, l2, o2, u2) {
  if (null == n3 && null == r4) return true;
  t3 = Math.max(0, t3), l2 = Math.max(0, l2), e4 = Math.max(0, e4 < 0 ? ((n3 == null ? void 0 : n3.length) ?? 0) + e4 : e4), o2 = Math.max(0, o2 < 0 ? ((r4 == null ? void 0 : r4.length) ?? 0) + o2 : o2);
  const f2 = e4 - t3;
  if (null == n3 || null == r4 || f2 !== o2 - l2) return false;
  if (u2) {
    for (let i2 = 0; i2 < f2; i2++) if (!u2(n3[t3 + i2], r4[l2 + i2])) return false;
  } else for (let i2 = 0; i2 < f2; i2++) if (n3[t3 + i2] !== r4[l2 + i2]) return false;
  return true;
}
function h(n3, t3, e4) {
...
function S(n3, t3, e4, r4) {
  ...
  const o2 = Math.min(l2, e4);
  for (let u2 = 0; u2 < o2; ++u2) if (n3[u2] === t3) return r4.last = u2, u2;
  return -1;
}
function j(t3, e4, r4, l2) {
  const o2 = r4 ?? t3.length, u2 = S(t3, r(e4), o2, l2);
  if (-1 !== u2) return t3[u2] = t3[o2 - 1], null == r4 && t3.pop(), e4;
}
var v = /* @__PURE__ */ new Set();
function z(n3, t3, e4 = n3.length, r4 = t3.length, l2, o2) {
  if (0 === r4 || 0 === e4) return e4;
  v.clear();
  for (let f2 = 0; f2 < r4; ++f2) v.add(t3[f2]);
  l2 = l2 || y;
  const u2 = Math.max(0, l2.last - 10);
  for (let f2 = u2; f2 < e4; ++f2) if (v.has(n3[f2]) && (o2 == null ? void 0 : o2.push(n3[f2]), v.delete(n3[f2]), n3[f2] = n3[e4 - 1], --e4, --f2, 0 === v.size || 0 === e4)) return v.clear(), e4;
  for (let f2 = 0; f2 < u2; ++f2) if (v.has(n3[f2]) && (o2 == null ? void 0 : o2.push(n3[f2]), v.delete(n3[f2]), n3[f2] = n3[e4 - 1], --e4, --f2, 0 === v.size || 0 === e4)) return v.clear(), e4;
  return v.clear(), e4;
}
function C(n3) {
...
function U(n3) {
  return s2(n3) ? 179769e303 : i(n3) ? 65504 : f(n3) ? 3402823e32 : a3(n3) ? 4294967295 : c2(n3) ? 65535 : t2(n3) || o(n3) ? 255 : e3(n3) ? 2147483647 : u(n3) ? 32767 : r3(n3) ? 127 : 256;
}
var p = -32768;
var F2 = -2147483648;
var b2 = 2 ** 32 - 1;
...
//# sourceMappingURL=chunk-V7ANDVX5.js.map

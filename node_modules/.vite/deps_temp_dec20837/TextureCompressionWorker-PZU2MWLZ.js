...
function s() {
  return t ?? (t = (async () => {
    const s3 = await import("./basis_encoder-L4O4BZZK.js"), t2 = await s3.default({ locateFile: (s4) => n(`esri/libs/basisu/${s4}`) });
...
function e() {
  return n2 ?? (n2 = (async () => {
    const e2 = await import("./dxt_encoder-JRD6DAIF.js");
...
//# sourceMappingURL=TextureCompressionWorker-PZU2MWLZ.js.map

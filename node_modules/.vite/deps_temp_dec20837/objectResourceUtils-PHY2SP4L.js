import {
  ...
  m,
  t as t3
} from "./chunk-TLMDZPCQ.js";
import "./chunk-643F3H6L.js";
import "./chunk-KYTQO4W7.js";
import "./chunk-ANU4BL2L.js";
import {
  n2 as n7,
  o3 as o4,
  s as s2,
  t2 as t4
} from "./chunk-TLAEHVD6.js";
import "./chunk-BMTHMJVY.js";
import "./chunk-C52LBWPO.js";
import "./chunk-Z3HFDK67.js";
import "./chunk-FSZZ37ZU.js";
import "./chunk-KBTOFAKF.js";
import "./chunk-7GJW4WNB.js";
import "./chunk-5ZHZAKF4.js";
import "./chunk-NMKKB65B.js";
import "./chunk-HU2EI3QQ.js";
import "./chunk-RLUHC4MC.js";
import "./chunk-4YX4B24K.js";
import "./chunk-ZJQQ6AGC.js";
import "./chunk-ALKEERWI.js";
import {
  t as t2
} from "./chunk-4XZWL4SH.js";
import "./chunk-LGGDM4NZ.js";
...
import {
  ...
  n as n6,
  o2 as o3
} from "./chunk-P7XYDQ5C.js";
import {
  t
} from "./chunk-7JMDQX2D.js";
import "./chunk-LN2JDUZT.js";
import "./chunk-JHV6OBEB.js";
import {
  n as n4
} from "./chunk-GIOPUS6O.js";
import "./chunk-CMYJXVZT.js";
import "./chunk-4X4BOGIG.js";
import "./chunk-7QPS6ATI.js";
import {
  A as A2
} from "./chunk-72JGHIJQ.js";
import "./chunk-JXJGYA34.js";
import {
  d as d2,
  o as o2
} from "./chunk-UF3FLIWF.js";
import {
  d,
  l as l2,
  n as n5,
  r as r2
} from "./chunk-FNRXJ34J.js";
...
import {
  r as r3
} from "./chunk-M5GNKKCA.js";
import {
  a as a3
} from "./chunk-5TURZZJM.js";
import {
  u as u2
} from "./chunk-JK27AMJT.js";
import "./chunk-NLWLBMYL.js";
import "./chunk-LPUPM55U.js";
import "./chunk-7MKB4OXO.js";
...
import {
  h
} from "./chunk-3KF2ZGIA.js";
import {
  l,
  q
} from "./chunk-VTWAVKG3.js";
import "./chunk-UMZRTZ6I.js";
import {
  e as e2
} from "./chunk-OB5BIAYS.js";
import "./chunk-NV4FBUWV.js";
import "./chunk-KEQQSEWI.js";
import {
  p,
  y
} from "./chunk-ORRNI4IU.js";
import {
  n,
  u
...
var t6 = class _t {
  ...
  get size() {
    let t7 = 0;
    for (const e3 of this._outer.values()) t7 += e3.size;
    return t7;
  }
  get(t7, e3) {
    var _a;
    return (_a = this._outer.get(t7)) == null ? void 0 : _a.get(e3);
  }
  getInner(t7) {
    return this._outer.get(t7);
  }
  set(t7, e3, r4) {
    const o5 = this._outer.get(t7);
    o5 ? o5.set(e3, r4) : this._outer.set(t7, /* @__PURE__ */ new Map([[e3, r4]]));
  }
  delete(t7, e3) {
    const r4 = this._outer.get(t7);
    r4 && (r4.delete(e3), 0 === r4.size && this._outer.delete(t7));
  }
  pop(t7, e3) {
    const r4 = this.get(t7, e3);
    return this.delete(t7, e3), r4;
  }
  *outerMap() {
    for (const t7 of this._outer) yield t7;
  }
  *values() {
    for (const t7 of this._outer.values()) yield* t7.values();
  }
  *[Symbol.iterator]() {
    for (const [t7, e3] of this._outer) for (const [r4, o5] of e3) yield [t7, r4, o5];
  }
  forEach(t7) {
    this._outer.forEach((e3, r4) => t7(e3, r4));
  }
  forAll(t7) {
    this._outer.forEach((e3, r4) => e3.forEach((e4, o5) => t7(e4, r4, o5)));
  }
  copy() {
    const e3 = new _t();
    return this.forAll((t7, r4, o5) => e3.set(r4, o5, t7)), e3;
  }
};
...
function M3(e3, t7) {
  var _a, _b;
  const r4 = new Array(), n8 = new Array(), s5 = new Array(), a4 = new t6(), u3 = e3.resource, c2 = r3.parse(u3.version || "1.0", "wosr");
  k.validate(c2);
...
async function z(e3, r4) {
  ...
  if (r4.cache) s5 = await r4.cache.loadGLTF(o5.url, r4, !!r4.usePBR);
    ...
    const { loadGLTF: e4 } = await import("./loader-2M7IILPK.js");
...
function J(e3, r4, t7, o5, s5, i5) {
  ...
  return n8.lods.forEach((e4, f2) => {
    ...
    if (d3 && 0 !== f2) return;
    const p2 = new t5(e4.name, e4.lodThreshold, [0, 0, 0]);
    e4.parts.forEach((e5) => {
...
//# sourceMappingURL=objectResourceUtils-PHY2SP4L.js.map

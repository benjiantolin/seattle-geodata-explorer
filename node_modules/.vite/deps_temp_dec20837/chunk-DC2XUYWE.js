...
function w2(t, n2, r4, o2 = j2()) {
  const e = r4[0] - n2[0], c3 = r4[1] - n2[1], u2 = r4[2] - n2[2], i = t[0] - n2[0], s2 = t[1] - n2[1], f2 = t[2] - n2[2], a = c3 * f2 - u2 * s2, m = u2 * i - e * f2, g3 = e * s2 - c3 * i, h = a * a + m * m + g3 * g3, l = Math.abs(h - 1) > 1e-5 && h > 1e-12 ? 1 / Math.sqrt(h) : 1;
  return o2[0] = a * l, o2[1] = m * l, o2[2] = g3 * l, o2[3] = -(o2[0] * t[0] + o2[1] * t[1] + o2[2] * t[2]), o2;
}
function S(t, r4, o2, e = 0, s2 = Math.floor(o2 * (1 / 3)), f2 = Math.floor(o2 * (2 / 3))) {
  if (o2 < 3) return false;
  r4(B2, e);
  let a = s2, m = false;
  for (; a < o2 - 1 && !m; ) r4(C, a), a++, m = !H(B2, C);
  if (!m) return false;
  for (a = Math.max(a, f2), m = false; a < o2 && !m; ) r4(D, a), a++, c(E2, B2, C), A(E2, E2), c(F, C, D), A(F, F), m = !H(B2, D) && !H(C, D) && Math.abs(P(E2, F)) < A3;
  return m ? (w2(B2, C, D, t), true) : (0 !== e || 1 !== s2 || 2 !== f2) && S(t, r4, o2, 0, 1, 2);
}
...
function Z(e, c3, u2, i, s2) {
  ...
  let m = -a / f2;
  return 1 & i && (m = r(m, 0, 1)), !(4 & i) && m < 0 || !(8 & i) && m > 1 ? a >= 0 ? 2 : 3 : (u(s2, c3, g(s2, u2, m)), a >= 0 ? 0 : 1);
}
var $ = [0, 0, 1, 0];
var _2 = 12;
var tt = 8;
...
//# sourceMappingURL=chunk-DC2XUYWE.js.map

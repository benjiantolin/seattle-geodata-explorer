...
async function N(n2, r) {
  ...
  if (-1 === u2) return null;
  const o3 = `${n2.slice(0, u2)}/rest/info`, s2 = null != r ? r.signal : null, { data: c2 } = await H(o3, { query: { f: "json" }, responseType: "json", signal: s2 });
...
//# sourceMappingURL=chunk-VJR6QL57.js.map

...
import {
  l as l2,
  n
} from "./chunk-VHGXSFWK.js";
import {
  o
} from "./chunk-QCDC3X2D.js";
import {
  E,
  c,
  l,
...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l2(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-LPEEVRI2.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-6XOTPX5M.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-AKLKBMZN.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-RDYKCJXV.js.map

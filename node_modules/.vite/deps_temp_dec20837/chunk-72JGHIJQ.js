...
function e(t2, e2) {
  ...
  let f2 = true, a = true;
  return t2.some((r, n) => (f2 = f2 && 0 === r, a = a && r === n, !f2 && !a)), f2 ? U(t2.length) : a ? A(t2.length) : m(t2) && t2.BYTES_PER_ELEMENT === Uint16Array.BYTES_PER_ELEMENT ? t2 : i(t2, !e2);
}
function i(r, t2) {
  for (const e2 of r) {
...
//# sourceMappingURL=chunk-72JGHIJQ.js.map

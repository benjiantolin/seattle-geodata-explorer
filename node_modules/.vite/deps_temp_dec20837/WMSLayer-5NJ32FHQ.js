...
import {
  t as t3
} from "./chunk-TOXLPHBE.js";
import {
  l as l4
} from "./chunk-J22ALXJE.js";
import {
  l as l3
} from "./chunk-PCRUXMXE.js";
import "./chunk-NUG6BDHY.js";
import {
  f as f3
} from "./chunk-DEPMKP7V.js";
import {
  p
...
var o4 = { visible: "visibleSublayers" };
var a4 = class extends b2 {
  constructor(e) {
    super(e), this.scale = 0;
  }
  set layer(e) {
    this._get("layer") !== e && (this._set("layer", e), this.removeHandles("layer"), e && this.addHandles([e.sublayers.on("change", () => this.notifyChange("visibleSublayers")), e.on("wms-sublayer-update", (e2) => this.notifyChange(o4[e2.propertyName]))], "layer"));
  }
  get layers() {
  ...
  get visibleSublayers() {
    const { layer: e, scale: r2 } = this, s5 = e == null ? void 0 : e.sublayers, t4 = [], o6 = (e2) => {
      const { minScale: s6, maxScale: a6, sublayers: l6, visible: i2 } = e2;
      i2 && (0 === r2 || (0 === s6 || r2 <= s6) && (0 === a6 || r2 >= a6)) && (l6 ? l6.forEach(o6) : t4.push(e2));
    };
    return s5 == null ? void 0 : s5.forEach(o6), t4;
  }
  toJSON() {
    const { layer: e, layers: r2 } = this, { imageFormat: s5, imageTransparency: t4, version: o6 } = e;
    return { format: s5, request: "GetMap", service: "WMS", styles: "", transparent: t4 ? "TRUE" : "FALSE", version: o6, layers: r2 };
  }
};
__decorate([m()], a4.prototype, "layer", null), __decorate([m({ readOnly: true })], a4.prototype, "layers", null), __decorate([m({ type: Number })], a4.prototype, "scale", void 0), __decorate([m({ readOnly: true })], a4.prototype, "version", null), __decorate([m({ readOnly: true })], a4.prototype, "visibleSublayers", null), a4 = __decorate([a3("esri.layers.support.ExportWMSImageParameters")], a4);
...
var o5 = { 84: 4326, 83: 4269, 27: 4267 };
function a5(n) {
  if (!n) return null;
  ...
  const s5 = d2("Capability", i2), o6 = d2("Service", i2), a6 = s5 && d2("Request", s5);
  if (!s5 || !o6 || !a6) return null;
  const l6 = d2("Layer", s5);
  if (!l6) return null;
  const m5 = "WMS_Capabilities" === i2.nodeName || "WMT_MS_Capabilities" === i2.nodeName ? i2.getAttribute("version") : "1.3.0", f5 = x3("Title", o6, "") || x3("Name", o6, ""), p3 = x3("AccessConstraints", o6, ""), h3 = /^none$/i.test(p3) ? "" : p3, y3 = x3("Abstract", o6, ""), S2 = parseInt(x3("MaxWidth", o6, "5000"), 10), E = parseInt(x3("MaxHeight", o6, "5000"), 10), L2 = g(a6, "GetMap"), C = N2(a6, "GetMap"), M2 = b5(l6, m5, r2);
  if (!M2) return null;
  let T3, R2 = 0;
  ...
  I3.forEach((e) => {
    "Layer" === e.nodeName && (0 === R2 ? T3 = e : 1 === R2 ? (M2.name && (M2.name = "", w3(b5(T3, m5, r2))), w3(b5(e, m5, r2))) : w3(b5(e, m5, r2)), R2++);
  });
...
function h2(e, t4, n) {
  const r2 = parseFloat(e.getAttribute("minx") ?? "0"), i2 = parseFloat(e.getAttribute("miny") ?? "0"), s5 = parseFloat(e.getAttribute("maxx") ?? "0"), o6 = parseFloat(e.getAttribute("maxy") ?? "0");
  return { xmin: n ? isNaN(i2) ? -Number.MAX_VALUE : i2 : isNaN(r2) ? -Number.MAX_VALUE : r2, ymin: n ? isNaN(r2) ? -Number.MAX_VALUE : r2 : isNaN(i2) ? -Number.MAX_VALUE : i2, xmax: n ? isNaN(o6) ? Number.MAX_VALUE : o6 : isNaN(s5) ? Number.MAX_VALUE : s5, ymax: n ? isNaN(s5) ? Number.MAX_VALUE : s5 : isNaN(o6) ? Number.MAX_VALUE : o6, spatialReference: { wkid: t4 } };
}
function N2(e, t4) {
  const n = d2(t4, e);
  if (n) {
...
function b5(e, t4, n) {
  ...
  return Array.prototype.slice.call(e.childNodes).forEach((e2) => {
    ...
    const t5 = e2.getAttribute("name"), n2 = e2.getAttribute("units"), r2 = e2.textContent, i3 = e2.getAttribute("unitSymbol") ?? void 0, s6 = e2.getAttribute("default") ?? void 0, o6 = "0" !== m4("default", e2, "0"), a7 = "0" !== m4("nearestValue", e2, "0"), l7 = "0" !== m4("current", e2, "0");
    if (F({ name: t5, units: n2 })) {
      return { name: "time", units: "ISO8601", extent: I2(r2), default: I2(s6), multipleValues: o6, nearestValue: a7, current: l7 };
    }
    if (L({ name: t5, units: n2 })) {
      return { name: "elevation", units: n2, extent: T2(r2), unitSymbol: i3, default: T2(s6), multipleValues: o6, nearestValue: a7 };
    }
    return { name: t5, units: n2, extent: R(r2), unitSymbol: i3, default: R(s6), multipleValues: o6, nearestValue: a7 };
  }), a6;
}
function A(e) {
...
var Y = class extends p(l3(f3(t2(b3(j(l2(b4))))))) {
  constructor(...e) {
  ...
  writeSublayers(e, t4, r2, o6) {
    ...
    for (const a6 of i2) {
      const e2 = { sublayer: a6, ...o6 }, r3 = a6.write({ parentLayerId: "number" == typeof ((_b = a6.parent) == null ? void 0 : _b.id) ? a6.parent.id : -1 }, e2);
  ...
  createExportImageParameters(e, t4, r2, o6) {
    const s5 = (o6 == null ? void 0 : o6.pixelRatio) ?? 1, i2 = i({ extent: e, width: t4 }) * s5, a6 = new a4({ layer: this, scale: i2 }), { xmin: n, ymin: l6, xmax: p3, ymax: m5, spatialReference: u2 } = e, c4 = X(u2, this.spatialReferences), y3 = "1.3.0" === this.version && o3(c4) ? `${l6},${n},${m5},${p3}` : `${n},${l6},${p3},${m5}`, f5 = a6.toJSON(), d3 = "1.3.0" === this.version ? "crs" : "srs";
    return { bbox: y3, [d3]: null == c4 || isNaN(c4) ? void 0 : "EPSG:" + c4, ...f5 };
  }
  async fetchImage(e, t4, r2, o6) {
    const i2 = this.mapUrl, a6 = this.createExportImageParameters(e, t4, r2, o6);
    if (!a6.layers) {
      const e2 = document.createElement("canvas");
      return e2.width = t4, e2.height = r2, e2;
    }
    const n = B(o6 == null ? void 0 : o6.timeExtent), l6 = { responseType: "image", query: this._mixCustomParameters({ width: t4, height: r2, ...a6, time: n, ...this.refreshParameters }), signal: o6 == null ? void 0 : o6.signal };
    return H(i2 ?? "", l6).then((e2) => e2.data);
  }
  async fetchImageBitmap(e, t4, r2, o6) {
    const i2 = this.mapUrl ?? "", a6 = this.createExportImageParameters(e, t4, r2, o6);
    if (!a6.layers) {
      const e2 = document.createElement("canvas");
      return e2.width = t4, e2.height = r2, e2;
    }
    const n = B(o6 == null ? void 0 : o6.timeExtent), l6 = { responseType: "blob", query: this._mixCustomParameters({ width: t4, height: r2, ...a6, time: n, ...this.refreshParameters }), signal: o6 == null ? void 0 : o6.signal }, { data: p3 } = await H(i2, l6);
    return t3(p3, i2, o6 == null ? void 0 : o6.signal);
  }
  fetchFeatureInfo(e, t4, r2, o6, s5) {
    ...
    const l6 = "1.3.0" === this.version ? { I: o6, J: s5 } : { x: o6, y: s5 }, p3 = { query_layers: n, request: "GetFeatureInfo", info_format: this.featureInfoFormat, feature_count: 25, width: t4, height: r2, ...l6 }, m5 = { ...this.createExportImageParameters(e, t4, r2), ...p3 }, u2 = this._mixCustomParameters(m5);
  ...
  async _fetchService(e) {
    ...
    if (!this.resourceInfo && ((_a = this.parsedUrl) == null ? void 0 : _a.path)) {
      const { path: t4, query: r2 } = this.parsedUrl, { data: o6 } = await H(t4, { query: { SERVICE: "WMS", REQUEST: "GetCapabilities", ...r2, ...this.customParameters }, responseType: "xml", signal: e });
      this.resourceInfo = a5(o6);
    }
    if (this.parsedUrl) {
...
function ee(e, t4, r2) {
  ...
  for (const i2 of e) {
    const e2 = new m3();
    e2.read(i2, t4), r2 && !r2.includes(e2.name) && (e2.visible = false), o6.set(e2.id, e2);
  }
  const s5 = [];
  for (const a6 of e) {
    const e2 = null != a6.id ? o6.get(a6.id) : null;
    if (e2) if (null != a6.parentLayerId && a6.parentLayerId >= 0) {
      const t5 = o6.get(a6.parentLayerId);
      if (!t5) continue;
...
//# sourceMappingURL=WMSLayer-5NJ32FHQ.js.map

...
import {
  t as t5
} from "./chunk-TPNBXKQS.js";
import {
  d,
  x,
  y as y2
} from "./chunk-VKY5EE53.js";
import {
  l as l2
} from "./chunk-MC6MSXPM.js";
import {
  P as P4,
  Z,
  d as d2,
  z as z3
} from "./chunk-42F7Y67F.js";
import {
  t as t4
} from "./chunk-ISQSALQT.js";
import {
  i as i6
...
import {
  L,
  i as i4
} from "./chunk-643I5DV4.js";
import {
  I,
  a
} from "./chunk-4JEVQLAG.js";
import {
  $,
  $e,
  Ae,
  ...
  ye,
  z as z2
} from "./chunk-44NLZHQQ.js";
import {
  P
} from "./chunk-E6JTOPSG.js";
import {
  t as t3
...
function F(F4) {
  function p7(n7, e3, o5) {
    ...
    if (o3(n7)) return n7;
    throw new n2(e3, "InvalidParameter", o5);
  }
  function y4(n7, t8) {
  ...
  function N2(n7, r6, o5, u3) {
    oe(o5, 1, 2, n7, r6);
    let s7 = o5[0];
    if (te(s7) && (s7 = s7.toArray()), false === o3(s7)) throw new n2(n7, "InvalidParameter", r6);
    if (o5.length > 1) {
      if (false === L2(o5[1])) throw new n2(n7, "InvalidParameter", r6);
      let e3 = s7;
  ...
  F4.functions.array = function(r6, a5) {
    return F4.standardFunction(r6, a5, (s7, c5, l6) => {
      ...
      if (o3(l6[0])) {
        if (2 === l6.length && false === t2(l6[1])) throw new n2(r6, "InvalidParameter", a5);
      ...
      const f8 = Se(l6[0]);
      if (isNaN(f8) || false === r2(f8)) throw new n2(r6, "InvalidParameter", a5);
    ...
    return F4.standardFunction(n7, r6, (o5, u3, a5) => {
      if (oe(a5, 1, 1, n7, r6), te(a5[0])) {
        if (a5[0].length() <= 0) throw new n2(n7, "OutOfBounds", r6);
        return a5[0].get(0);
      }
      if (o3(a5[0])) {
        if (a5[0].length <= 0) throw new n2(n7, "OutOfBounds", r6);
      ...
      throw new n2(n7, "InvalidParameter", r6);
    });
    ...
    return F4.standardFunction(n7, r6, (o5, i11, u3) => {
      if (oe(u3, 1, 1, n7, r6), o3(u3[0])) {
        if (u3[0].length <= 0) throw new n2(n7, "OutOfBounds", r6);
    ...
    return F4.standardFunction(n7, r6, (o5, i11, l6) => {
      if (oe(l6, 2, 2, n7, r6), o3(l6[0])) {
        let e3 = Se(l6[1]);
        if (isNaN(e3) || false === r2(e3)) throw new n2(n7, "InvalidParameter", r6);
        const o6 = l6[0];
        if (o6.length <= 0) throw new n2(n7, "OutOfBounds", r6);
        if (e3 < 0 && (e3 = o6.length + e3), e3 < 0) throw new n2(n7, "OutOfBounds", r6);
        if (e3 >= o6.length) throw new n2(n7, "OutOfBounds", r6);
    ...
    return F4.standardFunction(n7, r6, (o5, i11, l6) => {
      if (oe(l6, 3, 3, n7, r6), o3(l6[0])) {
        ...
        if (e3 > i12.length) throw new n2(n7, "OutOfBounds", r6);
        if (e3 < 0 && e3 < -1 * i12.length) throw new n2(n7, "OutOfBounds", r6);
    ...
    return F4.standardFunction(n7, r6, (n8, r7, o5) => {
      ...
      throw new n2(n8, "InvalidParameter", r7);
    });
    ...
    return F4.standardFunction(n7, r6, (i11, s7, c5) => {
      if (oe(c5, 2, 3, n7, r6), o3(c5[0])) {
        const e3 = Se(c5[1]);
        if (isNaN(e3) || false === r2(e3)) throw new n2(n7, "InvalidParameter", r6);
        if (e3 < 0) throw new n2(n7, "InvalidParameter", r6);
    ...
    return F4.standardFunction(n7, r6, (a5, s7, c5) => {
      if (oe(c5, 1, 3, n7, r6), o3(c5[0])) {
        ...
        if (isNaN(e3) || false === r2(e3)) throw new n2(n7, "InvalidParameter", r6);
        if (isNaN(i11) || false === r2(i11)) throw new n2(n7, "InvalidParameter", r6);
        return c5[0].slice(e3, i11);
      }
      if (te(c5[0])) {
        const e3 = c5[0], i11 = Se(z2(c5[1], 0)), a6 = Se(z2(c5[2], e3.length()));
        if (isNaN(i11) || false === r2(i11)) throw new n2(n7, "InvalidParameter", r6);
        if (isNaN(a6) || false === r2(a6)) throw new n2(n7, "InvalidParameter", r6);
...
function j(e3, t8) {
  e3.today = function(r6, e4) {
    ...
    return t8(r6, e4, (t9, f8, m6) => {
      ...
      throw new n2(r6, "InvalidParameter", e4);
    });
    ...
    return t8(e4, i11, (t9, a5, s7) => {
      ...
      if (re(s7[0])) throw new n2(e4, "CannotChangeTimeZoneDateOnly", i11);
      if (re(s7[0])) throw new n2(e4, "CannotChangeTimeZoneTime", i11);
      const d6 = Ze(s7[0], Ke(e4));
      if (null === d6) throw new n2(e4, "InvalidParameter", i11);
    ...
    return t8(n7, r6, (e4, t9, a5) => {
      ...
      if (c5 < 0 || c5 > 6) throw new n2(n7, "InvalidParameter", r6);
...
function P6(o5, w, P8) {
  o5.domain = function(e3, r6) {
    return w(e3, r6, (o6, m6, c5) => {
      ...
      throw new n2(e3, "InvalidParameter", r6);
    });
    ...
    return w(e3, r6, (t8, o6, i11) => {
      if (i11.length < 1) throw new n2(e3, "WrongNumberOfParameters", r6);
      return P3;
    });
    ...
    return w(e3, r6, (e4, r7, t8) => {
      ...
      if (!H(o6) || !e(u3)) throw new n2(e4, "InvalidParameter", r7);
    ...
    return w(r6, t8, (r7, t9, o6) => {
      ...
      throw new n2(r7, "InvalidParameter", t9);
    });
  };
}
  ...
  C5.ringisclockwise = function(e3, t8) {
    return E4(e3, t8, (n7, a5, s7) => {
      ...
      if (o3(s7[0])) for (const i11 of s7[0]) {
        if (!(i11 instanceof _)) throw new n2(e3, "InvalidParameter", t8);
        ...
        if (!te(s7[0])) throw new n2(e3, "InvalidParameter", t8);
        for (const n8 of s7[0].toArray()) {
          if (!(n8 instanceof _)) throw new n2(e3, "InvalidParameter", t8);
    ...
    return E4(e3, t8, (a5, i11, o5) => {
      ...
      if (null !== c5 && false === c5.spatialReference.equals(e3.spatialReference)) throw new n2(e3, "WrongSpatialReference", t8);
      return je(c5);
    });
    ...
    return E4(e3, t8, (a5, i11, o5) => {
      ...
      if (null !== u3 && false === u3.spatialReference.equals(e3.spatialReference)) throw new n2(e3, "WrongSpatialReference", t8);
      return je(u3);
    });
    ...
    return E4(e3, t8, (n7, a5, i11) => {
      if (oe(i11, 2, 2, e3, t8), !H(i11[0])) throw new n2(e3, "InvalidParameter", t8);
      if (true === i11[0].immutable) throw new n2(e3, "Immutable", t8);
      if (!(i11[1] instanceof c || null === i11[1])) throw new n2(e3, "InvalidParameter", t8);
      return i11[0]._geometry = i11[1], P3;
    });
  }, C5.feature = function(e3, t8) {
    return E4(e3, t8, (i11, l6, o5) => {
      if (0 === o5.length) throw new n2(e3, "WrongNumberOfParameters", t8);
      let f8;
      if (1 === o5.length) if (e(o5[0])) f8 = I.fromJson(JSON.parse(o5[0]), e3.timeZone);
        ...
        if (!(o5[0] instanceof p2)) throw new n2(e3, "InvalidParameter", t8);
        {
          ...
          if (K(n7)) l7 = a(n7, e3.spatialReference);
            ...
            if (null != n7 && !U(n7)) throw new n2(e3, "InvalidParameter", t8);
            l7 = n7;
          }
          if (K(i12)) s7 = I.parseAttributesFromDictionary(i12);
          else {
            if (null != i12) throw new n2(e3, "InvalidParameter", t8);
            s7 = null;
          }
        ...
        if (null !== o5[1]) {
          if (!(o5[1] instanceof p2)) throw new n2(e3, "InvalidParameter", t8);
        ...
        for (let n7 = 1; n7 < o5.length; n7 += 2) {
          ...
          if (!(null == i13 || e(i13) || isNaN(i13) || ne(i13) || n4(i13) || ie(i13) || re(i13) || t2(i13))) throw new n2(e3, "InvalidParameter", t8);
          if (L2(i13) || false === V(i13)) throw new n2(e3, "InvalidParameter", t8);
    ...
    return E4(e3, t8, (a5, i11, l6) => {
      ...
      if (1 === l6.length && e(l6[0])) try {
        ...
        throw new n2(e3, "InvalidParameter", t8);
      }
      ...
      if (l6.length % 2 != 0) throw new n2(e3, "WrongNumberOfParameters", t8);
      const s7 = /* @__PURE__ */ Object.create(null);
      for (let n7 = 0; n7 < l6.length; n7 += 2) {
        const a6 = ge(l6[n7]), i12 = l6[n7 + 1];
        if (!(null == i12 || e(i12) || isNaN(i12) || ne(i12) || n4(i12) || t2(i12) || re(i12) || ie(i12) || o3(i12) || te(i12))) throw new n2(e3, "InvalidParameter", t8);
        if (L2(i12)) throw new n2(e3, "InvalidParameter", t8);
    ...
    return E4(t8, a5, (i11, o5, s7) => {
      ...
      throw new n2(t8, "InvalidParameter", a5);
    });
    ...
    return E4(e3, t8, (n7, a5, i11) => {
      if (i11 = Je(i11), oe(i11, 2, 3, e3, t8), !(i11[0] instanceof _)) throw new n2(e3, "InvalidParameter", t8);
      if (!(i11[1] instanceof _)) throw new n2(e3, "InvalidParameter", t8);
      if (i11.length > 2 && !(i11[2] instanceof _)) throw new n2(e3, "InvalidParameter", t8);
...
function g3(g5, d6) {
  ...
  g5.number = function(r6, n7) {
    ...
    return d6(u3, e3, (u4, e4, o5) => {
      if (oe(o5, 1, 2, u4, e4), o5.length >= 2 && !t2(o5[1])) throw new n2(u4, "InvalidParameter", e4);
...
function a4(u3, a5) {
  u3.stdev = function(n7, r6) {
    ...
    return a5(u4, f8, (a6, c5, m6) => {
      ...
      throw new n2(u4, "InvalidParameter", f8);
    });
  };
}
...
var b2 = "°";
function O2(e3) {
  if (false === e(e3)) throw new n2(null, "InvalidParameter", null);
  return e3;
}
function G(e3, n7) {
  const t8 = 10 ** n7;
...
function P7(e3) {
  switch (e3) {
    ...
    case 8:
      return F3;
    default:
      throw new n2(null, "LogicError", null, { reason: "unsupported evaluations" });
  }
}
var j2 = new o2([], [["NORTH", 1], ["NORTH AZIMUTH", 1], ["POLAR", 2], ["QUADRANT", 3], ["SOUTH", 4], ["SOUTH AZIMUTH", 4]]);
function z4(e3) {
  const n7 = j2.lookup(e3);
  if (null == n7) throw new n2(null, "LogicError", null, { reason: "unsupported directionType" });
  return n7;
}
...
function C4(e3) {
  ...
  if (null == n7) throw new n2(null, "LogicError", null, { reason: "unsupported units" });
  return n7;
}
var W2 = class _W {
  ...
  getField(e3) {
    switch (e3) {
      ...
      default:
        throw new n2(null, "LogicError", null, { reason: "unexpected evaluation" });
    }
  }
...
function Y2(e3, n7, r6) {
  if (3 === r6) throw new n2(null, "LogicError", null, { reason: "conversion error" });
  if (3 === n7) {
...
function ne2(e3) {
  ...
  if (n4(n7)) {
    if (isNaN(n7)) throw new n2(null, "LogicError", null, { reason: "invalid conversion" });
    return n7;
  }
  throw new n2(null, "LogicError", null, { reason: "invalid conversion" });
}
function te2(e3, n7, s7) {
  const i11 = 3 === s7;
  let o5 = null, c5 = null, a5 = 0, u3 = 0, l6 = 0;
  if (i11) {
    if (e3.length < 2) throw new n2(null, "LogicError", null, { reason: "conversion error" });
    l6 = 1;
    const n8 = $2(ge(e3[e3.length - 1]));
    if (n8 ? (o5 = n8.first, c5 = n8.second) : (a5 = 1, o5 = ee(ge(e3[0])), c5 = ee(ge(e3[e3.length - 1]))), null === o5 || null === c5) throw new n2(null, "LogicError", null, { reason: "invalid conversion" });
  }
  switch (n7) {
    case 1:
    case 4:
    case 5:
      if (0 === e3.length) throw new n2(null, "LogicError", null, { reason: "invalid conversion" });
...
function se2(e3, n7, r6) {
  ...
  throw new n2(null, "LogicError", null, { reason: "conversion error" });
}
...
function he(n7, s7, i11) {
  if (!(s7 instanceof p2)) throw new n2(null, "InvalidParameter", null);
  if (false === s7.hasField("directionType")) throw new n2(null, "LogicError", null, { reason: "missing directionType" });
  if (false === s7.hasField("angleType")) throw new n2(null, "LogicError", null, { reason: "missing angleType" });
  const o5 = z4(O2(s7.field("directiontype"))), c5 = se2(n7, C4(O2(s7.field("angletype"))), o5);
  if (!(i11 instanceof p2)) throw new n2(null, "InvalidParameter", null);
  if (false === i11.hasField("directionType")) throw new n2(null, "LogicError", null, { reason: "missing directionType" });
  if (false === i11.hasField("outputType")) throw new n2(null, "LogicError", null, { reason: "missing angleType" });
  ...
  if (!a5 || !l6) throw new n2(null, "LogicError", null, { reason: "conversion error" });
  if (!(u3 || "TEXT" === l6 && i11.hasField("format"))) throw new n2(null, "LogicError", null, { reason: "invalid unit" });
  switch (l6) {
    case "VALUE":
    ...
    default:
      throw new n2(null, "InvalidParameter", null);
  }
}
...
function B3(n7, o5, i11) {
  if (null !== n7) if (o3(n7)) {
    ...
    if (t2(n7)) o5.updateUint8Array([true === n7 ? 1 : 0, 113]);
      ...
      if (n7 instanceof t5) throw new n2(i11.context, "UnsupportedHashType", i11.node);
      if (n7 instanceof t4) throw new n2(i11.context, "UnsupportedHashType", i11.node);
      if (!(n7 instanceof p2)) {
        if (H(n7)) throw new n2(i11.context, "UnsupportedHashType", i11.node);
        ...
        if (L2(n7)) throw new n2(i11.context, "UnsupportedHashType", i11.node);
        if (B(n7)) throw new n2(i11.context, "UnsupportedHashType", i11.node);
        if (X(n7)) throw new n2(i11.context, "UnsupportedHashType", i11.node);
        if (n7 === P3) throw new n2(i11.context, "UnsupportedHashType", i11.node);
        throw new n2(i11.context, "UnsupportedHashType", i11.node);
      }
...
function E3(e3, m6) {
  e3.portal = function(e4, r6) {
    ...
    return m6(t8, e4, (r6, n7, i11) => {
      oe(i11, 1, 1, t8, e4);
      const s7 = E(i11[0]);
      if ("Unrecognized Type" === s7) throw new n2(t8, "UnrecognizedType", e4);
      return s7;
    });
  ...
  e3.guid = function(t8, e4) {
    ...
    return m6(t8, e4, (r6, n7, i11) => {
      ...
      throw new n2(t8, "InvalidParameter", e4);
    });
    ...
    return m6(t8, e4, (n7, u3, s7) => {
      if (oe(s7, 1, 1, t8, e4), false === e(s7[0])) throw new n2(t8, "InvalidParameter", e4);
    ...
    return m6(t8, e4, (r6, n7, u3) => {
      ...
      if (f8.length <= l6 || l6 < 0) throw new n2(t8, "OutOfBounds", e4);
    ...
    return m6(t8, e4, (r6, n7, o5) => {
      if (o5.length < 1) throw new n2(t8, "WrongNumberOfParameters", e4);
    ...
    return m6(e4, n7, (u3, s7, l6) => {
      ...
      throw new n2(e4, "InvalidParameter", n7);
    });
    ...
    return m6(t8, e4, (t9, e5, r6) => {
      ...
      const [n7] = r6;
      if (null == n7) return "";
      if (!e(n7)) throw new n2(t9, "InvalidParameter", e5);
...
var c4;
async function s6() {
  null == c4 && (c4 = await import("./geodeticDistanceOperator-O56LYQNT.js"), await c4.load());
}
function i10(t8) {
  const n7 = t8.track;
  if (null == n7) throw new n2(t8, "InvalidParameter", null);
  return n7;
}
...
function l5(t8, n7) {
  const e3 = f7(t8, n7);
  if (e3 < 0 || e3 >= t8.observations.length) throw new n2(null, "InvalidParameter", null);
  return e3;
}
function d5(t8, n7) {
...
//# sourceMappingURL=chunk-NQDTX3R7.js.map

...
function d3(d4, u) {
  ...
  const v = d4.vertex;
  f(v, u), d(v, u), v.uniforms.add(new e2("viewport", (e3) => e3.camera.fullViewport), new r("polygonOffset", (e3) => e3.shaderPolygonOffset), new r2("cameraGroundRelative", (e3) => e3.camera.aboveGround ? 1 : -1)), u.hasVerticalOffset && d2(v), v.code.add(t`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
...
float absCosAngle;
  ...
  `), u.draped && !u.hasVerticalOffset || p(v), u.draped || (v.uniforms.add(new r2("perDistancePixelRatio", (e3) => Math.tan(e3.camera.fovY / 2) / (e3.camera.fullViewport[2] / 2))), v.code.add(t`
...
function n(n2) {
  n2.vertex.uniforms.add(new r2("renderTransparentlyOccludedHUD", (e3) => 0 === e3.hudRenderStyle ? 1 : 1 === e3.hudRenderStyle ? 0 : 0.75), new e2("viewport", (e3) => e3.camera.fullViewport), new e("hudVisibilityTexture", (e3) => {
    var _a;
...
//# sourceMappingURL=chunk-FAD227LW.js.map

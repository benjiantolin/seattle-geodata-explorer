import {
  e as e9,
  u as u8
} from "./chunk-FPEA5TOK.js";
import {
  r as r3,
  x
} from "./chunk-LWKX43TZ.js";
import "./chunk-2LQRLZKW.js";
import {
  t as t6
...
import {
  a as a3
} from "./chunk-O3J6BYIF.js";
import {
  R
} from "./chunk-SXC2P3KJ.js";
import {
  d as d3,
  i as i9,
  i2 as i10,
  ...
  r as r4,
  t as t5
} from "./chunk-UDQANLI4.js";
import {
  O,
  a as a2,
  u as u7
} from "./chunk-XOUS672T.js";
import {
  i as i8
} from "./chunk-V34A6GYX.js";
import "./chunk-RQJ5ERUH.js";
import {
  d as d4
} from "./chunk-HW2QRXTL.js";
...
import {
  r as r5
} from "./chunk-W4AZY6J5.js";
import "./chunk-JCMADXBT.js";
import "./chunk-4X4BOGIG.js";
import "./chunk-GU5ON2MN.js";
import "./chunk-CK6YPECG.js";
...
import {
  f as f3,
  g
} from "./chunk-AZZGA4EH.js";
import "./chunk-G5IXTUNN.js";
import {
  i as i6,
  s as s7,
  u as u6
} from "./chunk-HFXEQKBZ.js";
import {
  e as e4
...
var g2 = class {
  ...
  serialize(t17) {
    ...
    return s17.message.push({ tileId: this.tileKey.id, ...r10.message }), s17.transferList.push(...r10.transferList), this._meshes.neighbors.forEach((r11, i21) => {
      const n12 = r11.serialize(), h7 = 1 << i21, o8 = f4(h7), c8 = u9(h7), a9 = new e6(this.tileKey).getNormalizedNeighbor(o8, c8, t17);
...
var e10 = class _e extends t8 {
  static async fromDictionaryRenderer(r10, o8) {
    const n12 = await s5.from(o8.dictionaryInfo, o8.userConfig, o8.fieldMap);
...
var U = class _U extends i14 {
  static async create(t17, e15, s17, a9, o8) {
    ...
    return n12.isWrappable || s7() || await Promise.all([import("./apiConverter-STYVHPY3.js"), import("./jsonConverter-P2DUL3KQ.js"), i6()]).then(([t18, e16, s18]) => {
...
var a8 = class {
  ...
  checkForUpdates() {
    ...
    if (null != t17) {
      ...
      for (const e16 of t17) i22.has(e16.objectId) || (e16.attributes[e7] = s17, e16.attributes[i7] = d10, this.store.add(e16), n12.push(e16));
    }
  ...
  _purgeByAgeReceived(t17, e15) {
    ...
    this.store.forEach((t18) => {
      t18.attributes[e7] < s17 && this._removed.push(t18.objectId);
    });
  }
  _purgeTracks() {
...
var m8 = class extends e14 {
  constructor(t17, s17, n12) {
    ...
    this._stagingStore = new t15(this.metadata.weakCloneWithAdditionalFields([{ name: i7, alias: "timeReceived", type: "esriFieldTypeDate" }]), (e15) => this.events.emit("features-updated", e15)), this._manager = new a8(this._stagingStore, this.metadata.featureIdInfo, c8, h7), this.connect();
  }
  destroy() {
...
var y8 = class {
  ...
  async queryHeatmapStatistics(e15) {
    const t17 = Math.round(u4(e15.radius));
...
//# sourceMappingURL=FeaturePipelineWorker-R46NYCLZ.js.map

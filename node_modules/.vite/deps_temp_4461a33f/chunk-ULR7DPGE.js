...
import {
  y as y3
} from "./chunk-L3SOCGF3.js";
import {
  E
} from "./chunk-BYU7VMB6.js";
import {
  i as i6
} from "./chunk-IRQOK6QT.js";
import {
  T
} from "./chunk-3BQJVKL7.js";
import {
  p2 as p4
} from "./chunk-Y42KKHAX.js";
import {
  e as e3,
  u as u7
...
import {
  p as p6
} from "./chunk-4BM6I3DX.js";
import {
  d as d2
} from "./chunk-PSADU3WX.js";
import {
  u as u6
} from "./chunk-YM4DAT4U.js";
import {
  o as o3
...
function y4(e13, t11, i16) {
  ...
  if ("default" !== e13 || s14 || (e13 = [new n5({ field: i16, order: "descending" })]), "default" !== e13 && (e13 == null ? void 0 : e13.length)) {
    e13.length;
  ...
  let A3 = class extends G2 {
    ...
    async fetchPopupFeaturesFromGraphics(e13, t11) {
      ...
      for (const l11 of e13) {
        const e14 = t2(l11.origin), s15 = n4(e14, { ...t11, checkPopupEnabled: true });
        s15 && (i16.push(l11), r12.add(s15));
      }
      if (0 === i16.length || 0 === r12.size) return [];
      const s14 = await this._createPopupQuery(r12, t11);
      return await n3(this.layer, i16, s14, { hasRequiredFields: (e14, t12) => this._popupFeatureHasRequiredFields(e14, t12), ...t11 });
    }
    _handleChange() {
    ...
    async _createPopupQuery(e13, t11) {
      ...
      for (const o14 of e13) {
        ...
        const e14 = await p2(this.layer, o14);
        s2(t11);
...
//# sourceMappingURL=chunk-ULR7DPGE.js.map

...
function F(e8) {
  ...
  const X = 9 === K, Y = X && M2;
  Y && i5.varyings.add("voccluded", "float"), Q.uniforms.add(new e5("viewport", (e9) => e9.camera.fullViewport), new e4("screenOffset", (e9, i6) => o(L, 2 * e9.screenOffset[0] * i6.camera.pixelRatio, 2 * e9.screenOffset[1] * i6.camera.pixelRatio)), new e4("anchorPosition", (e9) => B(e9)), new e2("materialColor", (e9) => e9.color), new r3("materialRotation", (e9) => e9.rotation), new e("tex", (e9) => e9.texture)), w(Q), F2 && (Q.uniforms.add(new e2("outlineColor", (e9) => e9.outlineColor)), W.uniforms.add(new e2("outlineColor", (e9) => T(e9) ? e9.outlineColor : a), new r3("outlineSize", (e9) => T(e9) ? e9.outlineSize : 0))), U2 && Q.uniforms.add(new e7("pointDistanceSphere", (e9, o3) => {
...
posProj = alignToPixelOrigin(posProj, viewport.zw);
  ...
  Q.main.add(t2`
    ...
    vsize = inputSize;
  `), W.uniforms.add(new e("tex", (e9) => e9.texture)), I && !X && W.uniforms.add(new e3("depthMap", (e9) => e9.mainDepth), new r4("occludedOpacity", (e9) => e9.hudOccludedFragmentOpacity));
...
//# sourceMappingURL=chunk-TRAK45NQ.js.map

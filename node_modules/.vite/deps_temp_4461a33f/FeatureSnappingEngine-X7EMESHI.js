...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-IZSM5EGC.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-2IAG7VIA.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-47PIPOX3.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-7FWNHGTT.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-X7EMESHI.js.map

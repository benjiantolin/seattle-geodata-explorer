...
function f(a2, f3) {
  ...
  S.uniforms.add(new r("intrinsicWidth", (e4) => e4.width));
...
return size;
    ...
    `)), f3.hasVVOpacity ? (m.add("opacityFeatureAttribute", "float"), S.constants.add("vvOpacityNumber", "int", 8), S.uniforms.add(new r3("vvOpacityValues", (e4) => e4.vvOpacity.values, u2), new r3("vvOpacityOpacities", (e4) => e4.vvOpacity.opacityValues, u2), new r("vvOpacityFallback", (e4) => e4.vvOpacity.fallback, { supportsNaN: true })), S.code.add(t`
...
function i3(i4, n3) {
  ...
  `), 2 === n3.space && (d3.constants.add("maxSegmentLengthFraction", "float", 0.45), d3.uniforms.add(new r2("perRenderPixelRatio", (e4) => e4.camera.perRenderPixelRatio)), d3.code.add(t`
...
//# sourceMappingURL=chunk-7NI37E5V.js.map

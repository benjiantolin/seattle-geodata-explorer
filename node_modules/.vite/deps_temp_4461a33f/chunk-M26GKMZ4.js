...
async function n4(i4, r8) {
  ...
  for (const { variable: t7, value: o5 } of u8) if ("color" === t7.type) s6.color = u2.toUnitRGBA(o5);
...
function u5(e6, n5, a6, s6, m8, c4) {
  ...
  const d7 = n3(p3, c4 ?? f6.transformation), I3 = o(v, d7[12], d7[13], d7[14]);
...
function g2(t7, e6, n5, a6, s6) {
  ...
  const g5 = o(v, p6[12], p6[13], p6[14]);
...
function M(t7, e6, o5, n5, r8) {
  ...
  for (let m8 = 0; m8 < g5; m8++) {
    if (S[0] = u8[h2], S[1] = u8[h2 + 1], S[2] = u8[h2 + 2], n5(d7, E3), c4 && (v3 += E3.sampledElevation), t2.TESTS_DISABLE_OPTIMIZATIONS) u8[h2] = d7.array[d7.offset], u8[h2 + 1] = d7.array[d7.offset + 1], u8[h2 + 2] = E3.z, o2(u8, o5, h2, u8, r8.spatialReference, h2, 1), u8[h2] -= I2[0], u8[h2 + 1] -= I2[1], u8[h2 + 2] -= I2[2], s6 = true;
    else {
...
var O = class {
  ...
  computeAttachmentOrigin(e6) {
    ...
    else for (const a6 of this.stageObject.geometries) a6.computeAttachmentOrigin(v2) && (E(v2, v2, s6), u4(e6.render.origin, e6.render.origin, v2), e6.render.num++);
  }
...
var m6 = class extends r7 {
  ...
  _getCombinedOpacityAndColor(t7, i4 = b3) {
    ...
    const s6 = null != t7 ? u2.toUnitRGB(t7) : _;
    return A(s6, o5);
  }
  _getDrivenUInt8Color({ color: t7, opacity: r8 }, i4, o5) {
    const { color: s6, opacity: l4 } = this._drivenProperties, p6 = u2.toUnitRGBA(i4) ?? (o5 ? s : a3), c4 = s6 ? t7 ?? p6 : null, d7 = t7 || i4 || o5, h2 = s6 ? null : p6[3];
    return A(c4, l4 && d7 ? r8 ?? h2 : null, 255);
  }
  _getDrivenUInt8ColorWithNaNSupport({ color: t7, opacity: r8 }, n5, a6) {
    const p6 = n5 ? u3(u2.toUnitRGBA(n5)) : r2(NaN, NaN, NaN, a6 ? NaN : 0);
...
//# sourceMappingURL=chunk-M26GKMZ4.js.map

...
function _(_2) {
  ...
  d2(z2.vertex, _2), z2.include(o2, _2), z2.include(o3), J && z2.include(c), G.add("vNormalWorld", "vec3"), G.add("localvpos", "vec3", { invariant: true }), z2.include(d, _2), z2.include(i, _2), z2.include(t2, _2), z2.include(r3, _2), W.include(r2), W.include(l2), W.uniforms.add(new e3("externalColor", (e5) => e5.externalColor, { supportsNaN: true })), G.add("vcolorExt", "vec4"), z2.include(_2.instancedDoublePrecision ? p4 : f5, _2), W.main.add(t`
  ...
  return z2.include(f4, _2), H.include(t3, _2), z2.include(f2, _2), H.include(p, _2), z2.include(n5, _2), d2(H, _2), t4(H), p3(H), v(H), H.uniforms.add(W.uniforms.get("localOrigin"), W.uniforms.get("view"), new e("ambient", (e5) => e5.ambient), new e("diffuse", (e5) => e5.diffuse), new r("opacity", (e5) => e5.opacity), new r("layerOpacity", (e5) => e5.layerOpacity)), Z && H.uniforms.add(new e2("tex", (e5) => e5.texture)), z2.include(n4, _2), H.include(n3, _2), H.include(i3), H.include(e4, _2), a(H), H.main.add(t`
      discardBySlice(vpos);
...
//# sourceMappingURL=chunk-MKP4ZGQB.js.map

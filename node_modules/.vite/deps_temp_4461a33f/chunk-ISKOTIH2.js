...
var _ = (_2) => {
  ...
  let E = class extends A {
    ...
    async _save(e) {
      ...
      return await Promise.all(o3.resources.pendingOperations ?? []), await this._validateAgainstJSONSchema(i4, o3, t), this.url && (this.portalItem.url = this.url), this.portalItem.title || (this.portalItem.title = this.title), T(this.portalItem, t, 0), await n(this.portalItem, i4, this.resourceReferences, o3), i2(o3), this.portalItem;
    }
...
//# sourceMappingURL=chunk-ISKOTIH2.js.map

import {
  ...
  v,
  w
} from "./chunk-STIVEBV5.js";
import {
  l,
  n
} from "./chunk-P2M5WB3T.js";
import {
  i
...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-EXMZDGMV.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-UJGSZOE3.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-OW7XWKDK.js.map

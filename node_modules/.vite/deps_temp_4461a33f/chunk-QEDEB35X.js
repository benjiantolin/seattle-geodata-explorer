...
async function f4(u7, i4, f5) {
  ...
  return l4.path += "/identify", P(c2).then((e4) => {
    const t = o3(i4, { geometry: e4 == null ? void 0 : e4[0] }), u8 = u3({ ...l4.query, f: "json", ...t }), a5 = s3(u8, f5);
...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r2 && "getSymbolAsync" in r2 ? r2.getSymbolAsync(e4).then(async (i5) => {
      ...
      n4 && (G || (G = (await import("./visualVariableUtils-2AGGNI26.js")).getSize), l4 = G(n4, e4, { view: o4.type, scale: o4.scale, shape: "simple-marker" === i5.type ? i5.style : null })), l4 || (l4 = "width" in i5 && "height" in i5 && null != i5.width && null != i5.height ? Math.max(i5.width, i5.height) : "size" in i5 ? i5.size : 16), (s4 == null ? void 0 : s4.includes(e4)) && (this._setGraphicSymbol(e4, new u2({ style: "square", size: l4, color: new u([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i5 ? i5.xoffset : 0, yoffset: "yoffset" in i5 ? i5.yoffset : 0 })), a5(e4));
    }) : a5(e4);
  }
  get _updateContext() {
...
//# sourceMappingURL=chunk-QEDEB35X.js.map

...
function M3(e3, t7) {
  var _a, _b;
  const r4 = new Array(), n8 = new Array(), s5 = new Array(), a4 = new t5(), u3 = e3.resource, c2 = r.parse(u3.version || "1.0", "wosr");
  k.validate(c2);
...
async function z(e3, r4) {
  ...
  if (r4.cache) s5 = await r4.cache.loadGLTF(o5.url, r4, !!r4.usePBR);
    ...
    const { loadGLTF: e4 } = await import("./loader-ABSWA2S2.js");
...
function X(e3, t7, o5, s5, i5, n8, l4, a4, c2) {
  ...
  if (!n8.has(x2)) {
    ...
    const o6 = y(m2.color[0]), f3 = y(m2.color[1]), d4 = y(m2.color[2]), p3 = null != m2.colorTexture && T3 ? l4.get(m2.colorTexture) : null, g3 = n6(m2), y3 = null != ((_a = m2.normalTextureTransform) == null ? void 0 : _a.scale) ? (_b = m2.normalTextureTransform) == null ? void 0 : _b.scale : a2;
...
//# sourceMappingURL=chunk-JBL2I6LS.js.map

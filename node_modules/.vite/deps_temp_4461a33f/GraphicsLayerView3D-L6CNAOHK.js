...
import {
  u as u11
} from "./chunk-ZW45B3PW.js";
import "./chunk-KR43FNGT.js";
import "./chunk-7NI37E5V.js";
import {
  r as r6
} from "./chunk-TP3NJTGJ.js";
import {
  d as d5
} from "./chunk-EFXTPNAQ.js";
import "./chunk-IEHT7IRA.js";
import {
  U as U3,
  ie,
  w as w3
} from "./chunk-6L23KBVM.js";
import "./chunk-LH5L2KSW.js";
import {
  c as c4
} from "./chunk-SPF3FOJS.js";
import "./chunk-EC56NYYL.js";
import "./chunk-H2OWINVL.js";
import {
  S,
  a2 as a7,
  e2 as e8,
...
import "./chunk-OLO4I7VT.js";
import "./chunk-VINV3WTQ.js";
import "./chunk-CQHEXI5H.js";
...
import "./chunk-2WSZ42H5.js";
import {
  u as u8
} from "./chunk-WYAKRI2A.js";
import {
  a as a6,
  r as r4,
  t as t6
...
import {
  $ as $2
} from "./chunk-VRJOI76B.js";
import "./chunk-TUGWI7QN.js";
import {
  d as d3,
  y as y2
} from "./chunk-IJYWKVOG.js";
import "./chunk-RQANYFDQ.js";
import "./chunk-R3QQ3TDY.js";
import "./chunk-I5ZFA4CL.js";
...
import "./chunk-LS6Y7ABJ.js";
import {
  d as d2,
  g as g3,
  u as u6
} from "./chunk-DBR3VXNR.js";
...
import {
  ...
  g as g5,
  p as p3
} from "./chunk-R3MHMOV5.js";
import {
  s as s9
} from "./chunk-MUMRHELB.js";
...
import "./chunk-TF3DHICB.js";
import {
  s as s3
} from "./chunk-A3EJX5MY.js";
...
import {
  _ as _3
} from "./chunk-DLRIJLUW.js";
import {
  o as o2
} from "./chunk-7Y4SZDVC.js";
...
async function l11(l15, m9, d15, j6, u20) {
  ...
  for (const { objectId: e22, points: o12 } of x4) {
    ...
    E5.setFromElevationInfo(l7(i11, I3)), R2 && E5.updateFeatureExpressionInfoContextForGraphic(R2, t15.graphic, m9);
    for (const { x: e23, y: n11, z: a16 } of o12) F4.x = e23, F4.y = n11, F4.z = a16 ?? 0, await c2(F4, U5, C, 0, { signal: u20 }), c6(U5, v7, E5, g10, P6), S4.push(P6.z);
  }
...
function u12(r15, e22) {
  const t15 = { ...g3, ...e22, cimFallbackEnabled: true };
  return l12(r15, u6(r15.symbol, t15).error);
}
function a10(e22, t15) {
  var _a;
  const s18 = { ...g3, ...t15, cimFallbackEnabled: true }, u20 = (_a = e22.uniqueValueInfos) == null ? void 0 : _a.map((r15) => u6(r15.symbol, s18).error).filter(N), a16 = u6(e22.defaultSymbol, s18);
  return a16.error && (u20 == null ? void 0 : u20.unshift(a16.error)), l12(e22, u20);
}
function i6(e22, t15) {
  const s18 = { ...g3, ...t15, cimFallbackEnabled: true }, u20 = e22.classBreakInfos.map((r15) => u6(r15.symbol, s18).error).filter(N), a16 = u6(e22.defaultSymbol, s18);
...
var d11 = class extends b {
  constructor(t15) {
    super(t15), this.events = new i2(), this.hasZ = null, this.hasM = null, this.objectIdField = null, this.featureAdapter = { getAttribute: (t16, e22) => "graphic" in t16 ? t16.graphic.attributes[e22] : e7.getAttribute(t16, e22), getAttributeAsTimestamp(t16, e22) {
      ...
      if ("graphic" in t16) {
        let r15 = null;
        null != t16.centroid ? r15 = t16.centroid : "point" === t16.graphic.geometry.type && $3(t16.graphic.geometry, l13, this.viewSpatialReference) && (r15 = l13);
...
var l14 = class extends m3 {
  constructor(e22, r15) {
    super(e22, r15, new t7(u11, () => import("./LineCallout.glsl-PPOILDHG.js")), a12.locations);
  }
...
var m7 = class extends s8 {
  constructor(e22, t15) {
    super(e22, S2), this.intersectDraped = void 0, this.produces = /* @__PURE__ */ new Map([[15, (e23) => o6(e23)], [16, (e23) => o6(e23)]]), this._configuration = new r11(t15), this._uniqueMaterialIdentifier = g6(this.parameters);
  }
  passParameters() {
...
var _O = class _O extends m5 {
  ...
  get _materialParameters() {
    ...
    if (r15.size = u4(s18.size || 0), n11.verticalOffset) {
      const { screenLength: e22, minWorldLength: i11, maxWorldLength: s19 } = n11.verticalOffset;
      r15.verticalOffset = { screenLength: u4(e22), minWorldLength: i11 || 0, maxWorldLength: null != s19 ? s19 : 1 / 0 };
    }
...
var O4 = _O;
function j3(e22) {
  const { translation: t15, centerOffset: r15 } = e22, n11 = new t4(t15 ? [t15[0], t15[1], t15[2]] : [0, 0, 0], P4, 3, true), i11 = new t4(r15 ? [r15[0], r15[1], r15[2], r15[3]] : [0, 0, 0, 1], P4, 4, true);
  return [["position", n11], ["normal", new t4([0, 0, 1], P4, 3, true)], ["centerOffsetAndDistance", i11]];
}
var P4 = [0];
...
var E3 = class extends l9 {
  constructor(e22, t15, i11 = n2(), s18 = n4(), a16 = 0, o12 = "world", l15 = 0) {
...
function i7(r15, i11, s18, f12) {
  return null != r15 && (T(i11, f12) ? (a3(s18, r15), true) : (p5[0] = r15[0], p5[1] = r15[1], p5[2] = 0, !!o5(p5, i11, 0, p5, f12, 0) && (s18[0] = p5[0], s18[1] = p5[1], p5[0] = r15[2], p5[1] = r15[3], p5[2] = 0, !!o5(p5, i11, 0, p5, f12, 0) && (s18[2] = p5[0], s18[3] = p5[1], true))));
}
var p5 = n2();

// node_modules/@arcgis/core/views/3d/layers/graphics/Graphics3DGraphic.js
var G3 = new e3(() => u3(), (e22) => k(e22, Q), null, 10, 5);
var j4 = i4();
var v3 = class {
  get labelLayers() {
  ...
  computeExtent(e22) {
    if (!this._extent) {
      ...
      this._extent = i4(), z3(t15, this._extent);
  ...
  computeAttachmentOrigin() {
    const e22 = { render: { origin: n2(), num: 0 }, draped: { origin: n6(), num: 0 } };
    for (const t15 of this.layers) null != t15 && t15.computeAttachmentOrigin(e22);
    return e22.render.num > 1 && g4(e22.render.origin, e22.render.origin, 1 / e22.render.num), e22.draped.num > 1 && l4(e22.draped.origin, e22.draped.origin, 1 / e22.draped.num), e22;
  }
  async getProjectedBoundingBox(e22, i11, r15, s18, a16) {
    return a16 || (a16 = { boundingBox: null, requiresDrapedElevation: false, screenSpaceObjects: [] }), a16.boundingBox ? q(a16.boundingBox) : a16.boundingBox = q(), a16.requiresDrapedElevation = false, await a4(this.layers, async (t15) => {
      if (null == t15) return;
...
var h6 = class extends r9 {
  ...
  async doLoad(e22) {
    ...
    const i11 = [];
    if (!m8) {
      const { make: e23 } = await import("./Graphics3DSymbolLayerFactory-DF2NSH5S.js");
      m8 = e23;
    }
...
function u17(l15, m9, u20) {
  ...
  let i11 = true;
  return e18[0] = null != l15.xmin ? l15.xmin : 0, e18[1] = null != l15.ymin ? l15.ymin : 0, e18[2] = null != l15.zmin ? l15.zmin : 0, i11 = i11 && o5(e18, l15.spatialReference, 0, e18, u20, 0), m9[0] = e18[0], m9[1] = e18[1], e18[0] = null != l15.xmax ? l15.xmax : 0, e18[1] = null != l15.ymax ? l15.ymax : 0, e18[2] = null != l15.zmax ? l15.zmax : 0, i11 = i11 && o5(e18, l15.spatialReference, 0, e18, u20, 0), m9[2] = e18[0], m9[3] = e18[1], null == l15.xmin && (m9[0] = -1 / 0), null == l15.ymin && (m9[1] = -1 / 0), null == l15.xmax && (m9[2] = 1 / 0), null == l15.ymax && (m9[3] = 1 / 0), i11;
}
var e18 = n2();
...
var ke = (_b = class extends b {
  ...
  _getConvertedSymbol(e22) {
    ...
    const r15 = u6(t15, { geometryType: ((_a = this.layer) == null ? void 0 : _a.geometryType) ?? void 0, retainId: true, hasLabelingContext: this._hasLabelingContext(t15), cimFallbackEnabled: true }), a16 = r15.symbol || null;
  ...
  runTask(e22) {
    if (this._dataUpdateQueue.runTask(e22), this._updateQueue.runTask(e22), this._applyPendingUpdates(e22), this._applyFocusAreasUpdates(e22), this.notifyChange("readyToRun"), this.readyToRun || this.notifyChange("dataUpdating"), this.notifyChange("updatingRemaining"), !e22.hasProgressed) return o7;
  }
  ...
  async _boundsForGraphics3DGraphic(e22, t15) {
    const i11 = this._viewSpatialReference, r15 = this.owner.view.renderSpatialReference, s18 = this.owner.view.basemapTerrain.spatialReference, a16 = (e23, t16, s19) => o5(e23, r15, t16, e23, i11, t16, s19), n11 = (e23, t16, r16) => o5(e23, s18, t16, e23, i11, t16, r16), o12 = this._viewElevationProvider ? { service: this._viewElevationProvider, useViewElevation: null != t15 && !!t15.useViewElevation, minDemResolution: null != t15 ? t15.minDemResolution : null, minDemResolutionForPoints: this.owner.view.resolution } : null, l15 = await e22.getProjectedBoundingBox(a16, n11, o12, t15 == null ? void 0 : t15.signal);
    if (!l15) return null;
  ...
  computeAttachmentOrigin(e22, t15) {
    ...
    let s18 = 0;
    if (r15.render.num > 0) {
      if (!n5(r15.render.origin, this.symbolCreationContext.renderCoordsHelper.spatialReference, Be, t15)) return null;
      u7(He, He, Be), s18++;
    }
    if (r15.draped.num > 0) {
      const [e23, i12] = r15.draped.origin, a16 = this._viewElevationProvider.getElevation(e23, i12, "ground") ?? 0;
      if (o4(Be, e23, i12, a16), !n5(Be, this._viewElevationProvider.spatialReference, Be, t15)) return null;
      u7(He, He, Be), s18++;
    }
    return s18 > 1 && g4(He, He, 1 / s18), new _({ x: He[0], y: He[1], z: He[2], spatialReference: t15 });
  }
  ...
  _graphicUpdateSymbolHandler(e22, t15) {
    ...
    if (r15.prepareSymbolPatch(l15), !d3(l15.diff)) return void this._recreateGraphic(i11);
  ...
  _addGraphic(e22, t15, i11) {
    var _a;
    if (this._graphicsWithoutSymbol.set(e22.uid, e22), null == (t15 == null ? void 0 : t15.symbol) || !b4(e22)) return;
    const r15 = this.stage.renderView.olidRenderHelper;
    if (r15 && this.setUidToIdOnAdd) {
      const t16 = c3(this.owner.view, this.owner.layerViewUid);
  ...
  getOrCreateGraphics3DSymbol(e22, t15) {
    ...
    if (void 0 === i11) {
      ...
      i11 = null != r15 ? r15 : e22 instanceof b3 ? new e16(e22, (e23) => this._dataUpdateQueue.push(e23, null), (e23) => this._createGraphics3DSymbol(e23, t15)) : this._createGraphics3DSymbol(e22, t15), this._symbols.set(e22.id, i11), this._symbolMaterials = null;
    }
  ...
  _applyRendererDiff(e22, t15, i11) {
    ...
    if (t15 instanceof $2 && i11 instanceof $2 && this._applyUniqueValueRendererDiff(e22, t15, i11) && 0 === Object.keys(e22.diff).length) return true;
  ...
  setClippingExtent(e22, t15) {
    const i11 = this.symbolCreationContext.clippingExtent, r15 = i4();
    return u17(e22, r15, t15) ? this.symbolCreationContext.clippingExtent = B(u3(), r15) : this.symbolCreationContext.clippingExtent = null, !H(this.symbolCreationContext.clippingExtent, i11);
  }
...
var a14 = class {
  constructor() {
    this._extents = new r({ allocator: (t15) => t15 || i4() }), this._tmpExtent = i4(), this._dirty = false;
  }
  destroy() {
    this._extents.prune();
  }
      ...
      for (let i11 = 0; i11 < e22.length; ++i11) {
        ...
        if (a17) {
          ...
          o12.forEach((i12) => {
            ...
            M(a17, i12, d15);
            const c11 = l15 + _5;
            (p(d15) - c11) / c11 < h7 && (a3(a17, d15), o12.delete(i12), e22.remove(i12), t15.madeProgress());
          }), o12.add(a17);
        }
      }
    }
...
var b8 = { dir: n2(), len: 0, clip: n6() };
function h9(r15, c11, o12, f12) {
  const l15 = b8;
  return r15 ? (o12 && f12 && (l15.len = p2(c11, o12)), s6(l15.dir, r15)) : f12 ? (l15.len = p2(c11, o12), c(l15.dir, o12, c11), g4(l15.dir, l15.dir, 1 / l15.len)) : (c(l15.dir, o12, c11), A2(l15.dir, l15.dir)), l15;
}
function v5(r15, n11, t15) {
  const i11 = P2(k3(r15), t15.dir), e22 = -X(r15, n11);
...
var G4 = class {
  ...
  update(t15, e22, i11, r15 = true) {
    ...
    this._toRenderBoundingExtent(t15, e22, i11), u7(this._center.origin, a16[0].origin, a16[2].origin), g4(this._center.origin, this._center.origin, 0.5), this._renderCoordsHelper.worldUpAtPosition(this._center.origin, this._center.direction), r15 || g4(this._center.direction, this._center.direction, -1);
    for (let n11 = 0; n11 < 4; n11++) {
      const t16 = a16[n11];
      this._renderCoordsHelper.worldUpAtPosition(t16.origin, t16.direction);
      const e23 = a16[3 === n11 ? 0 : n11 + 1];
      t16.cap.next = e23.origin, K2(t16.cap.direction, t16.origin, e23.origin), I(t16.direction, t16.cap.direction, t16.origin, this._planes[n11]), r15 || g4(t16.direction, t16.direction, -1);
    }
  ...
  isVisibleInFrustum(t15, e22, i11 = false) {
    ...
    if (0 === this._maxSpan) {
      ...
      return !(i11 || !t15.intersectsRay(k2(e23.origin, e23.direction)));
    }
    for (let n11 = 0; n11 < this._extent.length; n11++) {
      const e23 = this._extent[n11];
      if (!i11 && t15.intersectsRay(k2(e23.origin, e23.direction))) return true;
  ...
  _toRenderBoundingExtentGlobal(t15, r15, n11) {
    ...
    for (const { x0: i11, x1: s18, y0: c11, y1: l15 } of U4) for (let p8 = 0; p8 < o12; p8++) {
      const h11 = p8 / (o12 - 1);
      v6[0] = o(t15[i11], t15[s18], h11), v6[1] = o(t15[c11], t15[l15], h11), v6[2] = n11, n5(v6, r15, v6, this._renderCoordsHelper.spatialReference), E2(v6, v6, I2), l5(V, v6);
    }
...
var u18 = class extends b {
  ...
  runTask(e22) {
    if (this._set("updating", false), !this._extent) return this._set("suspended", false), o7;
...
var p7 = class extends b {
  ...
  runTask(e22) {
    ...
    if (this._extent && i11 && i11.ready && this._scaleRangeActive && this.layerScaleEnabled) {
      if (this._layerScaleRangeVisibilityQuery) return o7;
      {
  ...
  _visibleAtLayerScale(e22) {
    ...
    return !this.layerScaleEnabled || r4(e22, i11.minScale || 0, i11.maxScale || 0);
  }
  _visibleAtLabelScale(e22, i11) {
    return r4(e22, i11.minScale || 0, i11.maxScale || 0);
  }
  _graphicScale(e22) {
    let i11;
...
function e21(o12) {
  return O.isCollection(o12) ? o12.toArray() : Array.isArray(o12) ? o12 : i10(o12) || i3(o12) || c10(o12) ? [o12] : n10;
}
function i10(r15) {
...
//# sourceMappingURL=GraphicsLayerView3D-L6CNAOHK.js.map

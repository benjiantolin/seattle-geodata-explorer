...
function S4(e8, t7, r13, o8, i8) {
  ...
  return i2(t7, C3, n11), i2(t7, E5, n11), C3[0] -= r13 / 2, E5[0] += r13 / 2, C3[1] -= o8 / 2, E5[1] += o8 / 2, n4(C3, n11, C3, s9), n4(E5, n11, E5, s9), i8 ? (i8.xmin = C3[0], i8.ymin = C3[1], i8.xmax = E5[0], i8.ymax = E5[1], i8.spatialReference = s9) : i8 = new z(C3[0], C3[1], E5[0], E5[1], s9), i8;
}
function k5(e8, t7) {
  ...
  for (let l11 = 0; l11 < 4; l11++) {
    ...
    o8.intersectInfiniteManifold(k(e9.origin, e9.direction), i8, O4) || I4(O4, r13, o8, e9.endpoint, i8), j6(O4, a8, O4, m11), c8.push(r8(O4[0], O4[1]));
  }
...
function ut(s9, o8, a8, n11, i8) {
  ...
  function b9(e8) {
    const r13 = Math.PI / 2;
    return (e8 = r5.normalize(e8, -r13)) > r13 && (e8 = Math.PI - e8), e8;
  }
...
function ft(t7, e8) {
  ...
  for (let a8 = 0; a8 < 4; a8++) {
    ...
    for (let n12 = 0; n12 < C4; n12++) {
      ...
      r13.intersectManifoldClosestSilhouette(k(u6, f7), i8, Tt), j6(Tt, m11, Tt, U3), P7.push(t(Tt)), 0 !== P7.length && q7(X2(P7.at(-1), Tt));
...
function yt(t7, e8) {
  ...
  for (let n11 = 0; n11 < t7.length; n11++) {
    ...
    switch (l11) {
      ...
      case 0:
      case 1: {
        const [t8, n12, i9] = 0 === l11 ? [1, r13, s9] : [-1, s9, r13], c9 = k2(e8), m11 = q(n(), Tt, c9, t8 * o8), p8 = q(n(), Tt, c9, t8 * -o8);
...
//# sourceMappingURL=chunk-XCY74FB6.js.map

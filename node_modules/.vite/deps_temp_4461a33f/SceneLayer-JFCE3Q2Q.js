import {
  a as a5
} from "./chunk-G3QGNXNS.js";
import {
  i as i3,
  m as m7,
  t2 as t4
} from "./chunk-JXKRXMOI.js";
import "./chunk-B57ZOABP.js";
import "./chunk-6BGPU7BV.js";
import {
  $
} from "./chunk-MATXAT6J.js";
import "./chunk-2WSZ42H5.js";
import "./chunk-NIQW2C6S.js";
import {
  n as n6,
  p as p4
...
import {
  ...
  p as p3,
  y
} from "./chunk-V32OGXKE.js";
import {
  _ as _3
} from "./chunk-ISKOTIH2.js";
import {
  $ as $2,
  R,
  j as j3
} from "./chunk-TNVMVYLK.js";
import "./chunk-O2DI67DZ.js";
import "./chunk-RI7CUAOI.js";
import "./chunk-NXIH53FX.js";
import "./chunk-6XWRH6UR.js";
...
import "./chunk-KDTYOV7K.js";
import "./chunk-BQVCQNFP.js";
import "./chunk-ALKEERWI.js";
import "./chunk-VZEUC4NE.js";
import "./chunk-WV2I6IXB.js";
import "./chunk-UZ4HCBWO.js";
import "./chunk-B7AJ3VNL.js";
import "./chunk-TRJSAAQH.js";
import "./chunk-JHV6OBEB.js";
import "./chunk-ETL5PYLO.js";
import "./chunk-BKQB64W7.js";
import "./chunk-YS6W4CVU.js";
import "./chunk-W42HWIWQ.js";
import {
  s as s3
} from "./chunk-ZMXK7LMV.js";
import "./chunk-BOPPRQVH.js";
import {
  p as p5,
  s as s8
} from "./chunk-W4TDJMOM.js";
import "./chunk-PPGQA5WV.js";
import {
  s as s6
} from "./chunk-3JMPLXIC.js";
import {
  t as t3
} from "./chunk-KSEOWVMR.js";
import {
  F
} from "./chunk-77A6NW2E.js";
import {
  i as i4
} from "./chunk-O6M64RZC.js";
import {
  o as o3
} from "./chunk-BODWZCQH.js";
import {
  l as l4
...
import {
  l as l6
} from "./chunk-OCXYBJQK.js";
import {
  j as j4
} from "./chunk-52IOOCJT.js";
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-VPLJ7SCM.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Pe = s6();
var Te = class extends a7(F(_3(l4(b(j2(t(l2(s7(o3(l(b3))))))))))) {
  constructor(...e3) {
  ...
  readNodePages(e3, t6, r3) {
    return "Point" === t6.layerType && (e3 = t6.pointNodePages), null == e3 || "object" != typeof e3 ? null : p3.fromJSON(e3, r3);
  }
  ...
  async queryCachedAttributes(e3, t6) {
    var _a;
    const r3 = T(this.fieldsIndex, await p4(this, n6(this)));
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-WNNSNBDT.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    0 === s10 && r3(new i3()), s10 > 1 && r3(new m7());
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-2Y4DJIO7.js");
    s2(t6);
    const h = u5.createWithExternalSource(d5, { type: "client", files: i6 }, { vertexSpace: y3, transform: t4(d5.spatialReference), unitConversionDisabled: true }), [f3] = await this.uploadAssets([h], { ...t6, useAssetOrigin: !p6 });
    return f3;
  }
...
//# sourceMappingURL=SceneLayer-JFCE3Q2Q.js.map

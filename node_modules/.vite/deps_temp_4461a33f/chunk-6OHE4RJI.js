...
async function J2(t, r3, n4, o2) {
  ...
  if (!i2) return null;
  G2() || J(i2.spatialReference, n4) || await L2();
  const c3 = W(i2, n4);
  if (!c3) return null;
  if (o2) {
    const t2 = c3.center, e3 = t2.clone();
    e3.x = L(t2.x, o2.center.x, n4), e3.x !== t2.x && c3.centerAt(e3), o2 = o2.union(c3);
  } else o2 = c3;
  return o2;
}
function K(t) {
...
async function Y(e3, r3) {
  ...
  let l4 = null;
  (u4 == null ? void 0 : u4.targetGeometry) ? l4 = u4.targetGeometry : e3 instanceof z ? l4 = e3 : e3 instanceof c ? l4 = await J2(e3, r3, n4) : e3 && (l4 = await J2(e3.center, r3, n4) || await J2(e3.target, r3, n4) || await J2(e3, r3, n4)), !l4 && (i2 == null ? void 0 : i2.targetGeometry) ? l4 = i2.targetGeometry : !l4 && r3.extent && (l4 = r3.extent), n4 || (n4 = B2(r3.spatialReference || r3.extent || l4)), G2() || T(l4.spatialReference, n4) || J(l4.spatialReference, n4) || await L2();
  const f4 = X(l4, n4), m3 = "center" in f4 ? f4.center : f4;
  false !== r3.pickClosestTarget && "point" === m3.type && "point" === ((_a = i2.targetGeometry) == null ? void 0 : _a.type) && (m3.x = L(m3.x, i2.targetGeometry.x, m3.spatialReference));
  let y2 = 0;
...
//# sourceMappingURL=chunk-6OHE4RJI.js.map

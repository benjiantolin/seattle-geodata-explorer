...
import {
  h
} from "./chunk-J6YWIAYZ.js";
import {
  V
} from "./chunk-7HPPCBPV.js";
import {
  F as F3
} from "./chunk-6V6IZ53P.js";
...
import {
  j as j2
} from "./chunk-TUXHNNG2.js";
import {
  p as p4
} from "./chunk-2UTWCWIQ.js";
import {
  $
...
var ue = class extends V(a5(F(p2(l9(t(f3(l7(b(j3(l5(s6(o3(l(b4)))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.sublayers = new (O.ofType(X))(), this.useUniqueColorsForSublayers = true, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Table"]), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this._debouncedSaveOperations = L(async (e4, t3, r2) => {
      const { save: s7, saveAs: i4 } = await import("./featureLayerUtils-OW7XWKDK.js");
      switch (e4) {
        case 0:
          return s7(this, t3);
        case 1:
  ...
  async addAttachment(e3, t3) {
    const r2 = await F2(this, e3, t3, se);
  ...
  async createGraphicsSource(e3) {
    const { default: t3 } = await p(import("./FeatureLayerSource-MVZ3QFQW.js"), e3);
...
//# sourceMappingURL=SubtypeGroupLayer-LATYGB3L.js.map

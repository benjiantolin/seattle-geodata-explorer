...
function g(l) {
  ...
  m2.include(o), m2.fragment.uniforms.add(new e("tex", (e3) => e3.texture)), f && m2.fragment.uniforms.add(new r("opacity", (e3) => e3.opacity));
  const u = 3 === c3;
  u && (m2.fragment.uniforms.add(new e2("nearFar", (e3) => e3.camera.nearFar)), m2.fragment.include(a), m2.fragment.include(t2));
  const p = 1 === g2;
...
//# sourceMappingURL=chunk-DJOVM47R.js.map

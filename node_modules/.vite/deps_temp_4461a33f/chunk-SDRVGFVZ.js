...
import {
  ...
  m as m5,
  o as o3
} from "./chunk-SSVCB7HA.js";
import {
  d as d2
} from "./chunk-B57ZOABP.js";
import {
  U,
  d,
  j,
...
function x2(e6, o4, s4) {
  ...
  if (!t(c10)) return;
  const f8 = h2, m8 = b3;
  if (!i2(o4, m8, e6.spatialReference)) return void k(g2(), o4.spatialReference, e6.spatialReference, b2);
  if (!i2(s4, f8, e6.spatialReference)) {
    const t4 = e6.origin;
...
function v(e6, t4, r4) {
  ...
  if (!n6) return;
  const a9 = r(t4.x, t4.y, t4.z ?? 0), f8 = q({ vertexAttributes: n6, spatialReference: e6.spatialReference, vertexSpace: new i4({ origin: a9 }) }, i3.absolute);
  if (!f8) return;
...
function R(e6, t4, r4) {
  const i6 = h2, o4 = b3;
  if (i2(t4, o4, e6.spatialReference)) {
    if (!i2(r4, i6, e6.spatialReference)) {
      const t5 = e6.origin;
...
function l4(r4) {
  ...
  return f4(f8, B2, x3, y3), r3(g5, g5, x3), o2(g5, y3, 0, g5, f8, 0), c2(m4(g5), f8);
}
var x3 = e2();
var u6 = e3(24);
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-ZTFVQK2D.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
function H(t4, r4, o4) {
  ...
  if (!i2(o4, s4, n6) && (k(O4(), o4.spatialReference, n6, "Falling back to mesh origin"), !i2(t4.origin, s4, n6))) return void k(O4(), t4.origin.spatialReference, n6);
...
function I2(t4, e6, r4) {
  const o4 = Y;
  if (!i2(r4, o4, t4.spatialReference)) {
    const e7 = t4.origin;
...
function z4(e6, s4, f8) {
  ...
  if (w5.equals(f8)) o(F3, 0, 0, 0);
  else if (!P3(F3, f8, e6)) return void k(k2(), f8.spatialReference, h5, b2);
  const S2 = o(V2, s4, s4, s4), U2 = D(D2, r2, a4, S2, F3), { localMatrix: q3 } = x6, z5 = c3(D2, U2, q3);
...
function L(e6, t4, r4) {
  ...
  if (!i2(r4, n6, i6) && (k(k2(), r4.spatialReference, i6, "Falling back to mesh origin"), !i2(e6.origin, n6, i6))) return void k(k2(), e6.origin.spatialReference, i6);
...
function M4(e6, t4, r4) {
  const o4 = E2;
  if (!i2(r4, o4, e6.spatialReference)) {
    const t5 = e6.origin;
...
var Q3;
var X2 = { base: null, key: "type", defaultKeyValue: "georeferenced", typeMap: { georeferenced: i3, local: i4 } };
var Y2 = Q3 = class extends l(p2(m3(c))) {
  constructor(e6) {
    super(e6), this.components = null, this.vertexSpace = new i3(), this.transform = null, this.metadata = new a8(), this.hasZ = true, this.hasM = false, this.vertexAttributes = new c7(), this.type = "mesh";
  }
  initialize() {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-S2SMTXAX.js"), this.load(e6)]);
  ...
  static createFromPolygon(e6, t4) {
    ...
    const r4 = c8(e6);
    return new Q3({ vertexAttributes: new c7({ position: r4.position }), components: [new h({ faces: r4.faces, shading: "flat", material: (t4 == null ? void 0 : t4.material) ?? null })], spatialReference: e6.spatialReference, vertexSpace: new i3() });
  }
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-ZTFVQK2D.js"), r4);
...
//# sourceMappingURL=chunk-SDRVGFVZ.js.map

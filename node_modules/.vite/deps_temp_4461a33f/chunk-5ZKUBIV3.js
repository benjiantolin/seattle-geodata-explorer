...
}`), T && 0 !== u2 && (d6.include(r2, l3), c2.uniforms.add(1 === g ? new e3("normalTexture", (e8) => e8.textureNormal) : new e2("normalTexture", (e8) => e8.textureNormal)), v2 && (c2.uniforms.add(new e5("scale", (e8) => e8.scale ?? a)), c2.uniforms.add(new t2("normalTextureTransformMatrix", (t6) => t6.normalTextureTransformMatrix ?? r))), c2.code.add(t`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
function J(J2) {
  ...
  K2.include(s2, J2), K2.include(i4, J2), K2.include(d5, J2), K2.include(t5, J2), d3(X, J2), K2.include(o2, J2), K2.include(o3);
  const ve = 0 === re || 1 === re;
  return ve && oe && K2.include(c), K2.include(d4, J2), K2.include(d2, J2), K2.include(t3, J2), Z.add("vPositionLocal", "vec3"), K2.include(d, J2), K2.include(i, J2), K2.include(r5, J2), X.uniforms.add(new e4("externalColor", (e8) => e8.externalColor, { supportsNaN: true })), Z.add("vcolorExt", "vec4"), K2.include(i2, J2), X.include(r4), X.include(l2), K2.include(ne ? p4 : f5, J2), X.main.add(t`
  ...
  `), K2.include(f4, J2), Y.include(t4, J2), K2.include(f2, J2), Y.include(p, J2), K2.include(n5, J2), d3(Y, J2), Y.uniforms.add(X.uniforms.get("localOrigin"), new e("ambient", (e8) => e8.ambient), new e("diffuse", (e8) => e8.diffuse), new r3("opacity", (e8) => e8.opacity), new r3("layerOpacity", (e8) => e8.layerOpacity)), ce && Y.uniforms.add(new e3("tex", (e8) => e8.texture)), K2.include(n4, J2), Y.include(n3, J2), Y.include(i3), K2.include(e6, J2), Y.include(e7, J2), p3(Y), v(Y), a2(Y), Y.main.add(t`
    discardBySlice(vpos);
...
//# sourceMappingURL=chunk-5ZKUBIV3.js.map

...
import {
  p as p2
} from "./chunk-W5CJONNH.js";
import {
  h as h7
} from "./chunk-CNP46KGG.js";
import {
  a as a9,
  m as m5
} from "./chunk-TBR5WQSO.js";
import {
  l as l4,
  n as n12
} from "./chunk-VU45PQB3.js";
import {
  v as v3
} from "./chunk-KN2HKC6Z.js";
import {
  a as a11
} from "./chunk-4L4I74WR.js";
import {
  g as g3,
  o as o9
} from "./chunk-2IEUWMWQ.js";
import {
  a as a10,
  o as o8,
  u as u4
} from "./chunk-LBDNBEJP.js";
import {
  h as h6
...
var n14 = class extends m4 {
  constructor(r18, o14) {
    super(r18, o14, new t6(a11, () => import("./HighlightApply.glsl-DKCQVSC5.js")), n10(i8));
  }
  initializePipeline() {
...
var a12 = class extends m4 {
  constructor(r18, i12) {
    super(r18, i12, new t6(g3, () => import("./HighlightBlur.glsl-G6EZHOSN.js")), n10(i8));
  }
  initializePipeline() {
...
var l6 = class extends m4 {
  constructor(r18, i12) {
    super(r18, i12, new t6(a10, () => import("./HighlightDownsample.glsl-PUKBXDD2.js")), s6);
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var a13 = class extends m4 {
  constructor(r18, t15) {
    super(r18, t15, new t6(h7, () => import("./HighlightToSingle.glsl-OUJBY2FZ.js")), n10(i8));
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var q2 = class extends a8 {
  constructor() {
    super(...arguments), this.produces = j3.HIGHLIGHTS, this.consumes = { required: [j3.HIGHLIGHTS, "highlights"] }, this._downsampleDrawParameters = new o8(), this._passParameters = new e8(), this._highlightBlurDrawParameters = new o9(), this._grid = new P2();
  }
  initialize() {
  ...
  render(e9) {
    const t15 = e9.find(({ name: e10 }) => e10 === j3.HIGHLIGHTS), { techniques: r18, bindParameters: i12 } = this;
...
var v4 = class {
  ...
  _updateParallax(t15) {
    ...
    this.parallax.radiusCurvatureCorrection = 0.84 * Math.sqrt(Math.max(a16 - t3.radius * t3.radius, 0)) / Math.sqrt(a16), v2(w4, this.parallax.anchorPoint, S3), b4(this.parallax.transform, r6, S3[3], w2(S3)), v2(w4, this.parallaxNew.anchorPoint, S3), b4(this.parallaxNew.transform, r6, S3[3], w2(S3));
  }
...
var z2 = class {
  ...
  getShadowMapMatrices(t15) {
    if (!this._lastOrigin || !H(t15, this._lastOrigin)) {
      ...
      for (let s14 = 0; s14 < this._numCascades; ++s14) {
        i5(Z, this._cascades[s14].lightMat, t15);
  ...
  _constructCascade(t15, s14, e9, i12) {
    ...
    y(K, U[0]), a16.camera.viewMatrix = i5(A3, this._modelViewLight, K);
  ...
  _setupMatrices(t15, s14) {
    ...
    const e9 = 1 === this._viewingMode ? t15.eye : o3(K, 0, 0, 1);
  ...
  _computeCascadeDistances(t15, e9, i12) {
    ...
    this._numCascades = Math.min(1 + Math.floor(u3(e9 / t15, 4)), a16);
...
function lt(t15, s14, e9, i12, a16, r18, h10, n17) {
  ...
  let o14 = 0, c9 = b3(et[0], tt2);
  for (let d5 = 1; d5 < 4; ++d5) {
    const t16 = b3(et[d5], tt2);
  ...
  r5(i12, tt2), l2(rt, it, M - s14), u(i12, i12, rt);
  ...
  c6(j6 > 0, "leftArea"), c6(y4 < 0, "rightArea"), l2(nt, it, M), u(nt, nt, tt2), l2(ot, it, C2), u(ot, ot, tt2), ct[0] = -it[1], ct[1] = it[0];
  const H3 = f3(i12, t15[S4], ot, u(rt, ot, ct), 1, a16), O2 = f3(i12, t15[v7], ot, rt, 1, r18), D3 = f3(i12, t15[v7], nt, u(rt, nt, ct), 1, h10), F2 = f3(i12, t15[S4], nt, rt, 1, n17);
  c6(H3, "rayRay"), c6(O2, "rayRay"), c6(D3, "rayRay"), c6(F2, "rayRay");
}
function dt(t15, s14) {
  return 3 * s14 + t15;
}
...
var a15 = class extends m4 {
  constructor(o14, i12) {
    super(o14, i12, new t6(m5, () => import("./TextureOnly.glsl-3U23VDV6.js")), s6);
  }
...
var t13 = class extends m4 {
  constructor(r18, t15) {
    super(r18, t15, new t6(l4, () => import("./OverlayCompositing.glsl-22F3HRYR.js")), s6);
  }
};
...
var I3 = class extends n13 {
  ...
  initialize() {
    ...
    }, h), e9.resourceController.scheduler.registerTask(f2.OVERLAY_RENDERER, this)]);
  ...
  get isEmpty() {
    return !t5.OVERLAY_DRAW_DEBUG_TEXTURE && t2(this._renderers, (e9) => e9.isEmpty);
  }
  get hasWater() {
  ...
  renders(e9) {
    var _a, _b;
    if (t5.OVERLAY_DRAW_DEBUG_TEXTURE && 4 !== e9 && 2 !== e9) return true;
  ...
  _drawTarget(e9, r18) {
    ...
    if (t5.OVERLAY_DRAW_DEBUG_TEXTURE && 4 !== r18.content && 2 !== r18.content) {
  ...
  _ensureDebugPatternResources(e9, r18) {
    if (o3(this._passParameters.color, r18[0], r18[1], r18[2]), this._passParameters.texture) return;
...
function s12(o14, t15, i12, s14) {
  const p4 = "polygon" === o14.type ? 1 : 0, c9 = "polygon" === o14.type ? o14.rings : o14.paths, { position: a16, outlines: u6 } = h5(c9, !!o14.hasZ, p4, o14.spatialReference), f7 = e5(a16.length), m7 = l5(a16, o14.spatialReference, 0, f7, 0, a16, 0, a16.length / 3, t15, i12, s14), g7 = null != m7;
  return { lines: g7 ? l8(u6, a16, f7) : [], projectionSuccess: g7, sampledElevation: m7 };
}
function p3(e9, t15) {
  const r18 = "polygon" === e9.type ? 1 : 0, s14 = "polygon" === e9.type ? e9.rings : e9.paths, { position: p4, outlines: c9 } = h5(s14, false, r18), a16 = o4(p4, e9.spatialReference, 0, p4, t15, 0);
...
function l8(o14, e9, n17 = null) {
  ...
  for (const { index: i12, count: s14 } of o14) {
    ...
    r18.push({ position: i4(e9, 3 * i12, 3 * s14), mapPositions: null != n17 ? i4(n17, o15, p4) : void 0 });
  }
  return r18;
}
...
var i11 = class extends s4 {
  intersect(r18, t15, i12, s14, n17, o14) {
    return h4(r18, i12, s14, n17, void 0, o14);
  }
...
var y3 = class extends m4 {
  constructor(e9, r18) {
    super(e9, r18, new t6(v3, () => import("./ColorMaterial.glsl-SLMOG35V.js")), v5(r18).locations);
  }
...
var m6 = class extends i11 {
  constructor(t15) {
    super(t15, _5), this._configuration = new s13(), this.supportsEdges = true, this.produces = /* @__PURE__ */ new Map([[2, (t16) => this._isOpaqueMaterialPass(t16)], [3, (t16) => this._isOpaqueNoSSAODepthPass(t16)], [4, (t16) => f(t16) && this._transparent && this.parameters.writeDepth], [5, (t16) => b5(t16) && this._transparent && this.parameters.writeDepth], [8, (t16) => f(t16) && this._transparent && !this.parameters.writeDepth], [18, (t16) => u2(t16)]]);
  }
  ...
  _isOpaqueMaterialPass(t15) {
    return 9 === t15 || f(t15) && !this._transparent;
  }
...
//# sourceMappingURL=chunk-T2CIEMND.js.map

...
import {
  c as c3
} from "./chunk-VLER63FV.js";
import {
  c as c4
} from "./chunk-BVHNYCEB.js";
import {
  t as t4
...
__decorate([m({ type: String, json: { write: true } })], p8.prototype, "alias", void 0), __decorate([m({ type: String, nonNullable: true, json: { write: { isRequired: true } } })], p8.prototype, "name", void 0), __decorate([m({ types: l5, json: { write: true } })], p8.prototype, "fieldFormat", void 0), p8 = __decorate([a2("esri.layers.support.FieldConfiguration")], p8);
...
var et = class extends V(f5(c2(n7(F(a4(p4(p7(l8(e2(t(f3(l6(b3(j2(l3(s6(o3(l(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-OW7XWKDK.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  async addAttachment(e4, t5) {
    const r3 = await F2(this, e4, t5, ze);
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-MVZ3QFQW.js"), e4);
  ...
  async queryPivot(e4, t5) {
    ...
    const o7 = await import("./PivotQuery-4PXXPBEV.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-PZUQXFLP.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8 == null ? void 0 : a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-XTEY5QHS.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
  ...
  async queryTopObjectIds(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-PZUQXFLP.js");
...
} } } })], et.prototype, "fieldConfigurations", null), __decorate([m({ ...Xe.fields, json: { read: { source: "layerDefinition.fields" }, origins: { service: { name: "fields" }, "web-map": { write: { target: "layerDefinition.fields", overridePolicy: Ye } } } } })], et.prototype, "fields", void 0), __decorate([m(Xe.fieldsIndex)], et.prototype, "fieldsIndex", void 0), __decorate([m({ type: F3, json: { name: "formInfo", write: true, origins: { "web-scene": { read: false, write: false } } } })], et.prototype, "formTemplate", void 0), __decorate([m({ json: { read: { source: "layerDefinition.extent" } } })], et.prototype, "fullExtent", void 0), __decorate([m({ json: { origins: { "web-map": { write: { target: "layerDefinition.geometryType", overridePolicy: Ye, writer(e4, t5, r3) {
...
//# sourceMappingURL=chunk-ECTOI6AZ.js.map

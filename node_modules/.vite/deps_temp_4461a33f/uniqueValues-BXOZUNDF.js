import {
  T as T2
} from "./chunk-3BQJVKL7.js";
import {
  p as p6,
  v as v2
} from "./chunk-D46WDDAH.js";
import {
  m as m5,
  m2 as m6,
  m3 as m7,
  n as n4
} from "./chunk-555XK3UN.js";
...
import {
  ...
  m as m4,
  q
} from "./chunk-LNBWM6ZS.js";
import {
  a as a3,
  n as n3
} from "./chunk-UVSHTG3G.js";
import {
  s as s3
} from "./chunk-BPSN5NKI.js";
import {
  t
} from "./chunk-ONDAJ5MY.js";
import {
  n as n5
} from "./chunk-RMOPHTAQ.js";
import {
  a as a4
...
async function m8(t2, r4, e3, n8) {
  ...
  const { meshFeatureSetFromJSON: a5 } = await p(import("./meshFeatureSet-2CQDLCQW.js"), n8);
  return a5(t2, s8, r4);
}
function p7(o4, s8) {
  let a5 = b.from(o4);
...
var R3 = class extends p8 {
  ...
  async _getFilteredFeatures(e3, t2) {
    ...
    if ("intersects" === (t2 == null ? void 0 : t2.spatialRelationship) && a5) {
      const t3 = await import("./intersectionOperator-LSH5QHTU.js");
  ...
  async _uvFromMemory(e3, t2) {
    ...
    return i6 && r4 && (n8 || l4) && (y.viewInfoParams = _2(r4), y.timeZone = r4.timeZone, y.fieldInfos = p10), !n8 && !l4 && u6 && "queryUniqueValues" in u6 ? u6.queryUniqueValues(m10, y, { signal: o4 }) : n8 ? this.workerClient.uniqueValues(y, n8) : p4({ attribute: y, features: l4 });
  }
...
var ie = class extends R3 {
  ...
  async _histogramForFields(e3) {
    ...
    const s8 = "newField", r4 = e3.numBins || V, a5 = se(s8, j2(t2, i6, r4), null != e3.minValue && null != e3.maxValue), o4 = new p3({ statisticType: "count", outStatisticFieldName: "countOFExpr", onStatisticField: s8 }), n8 = new v2(), { where: l4, timeExtent: u6 } = this.createQuery();
...
var T4 = class extends ie {
  ...
  async _uvFromMemory(e3, t2) {
    ...
    return i6 && a5 && (n8 || l4) && (g4.viewInfoParams = _2(a5), g4.timeZone = a5.timeZone, g4.fieldInfos = y), !n8 && !l4 && u6 && "queryAggregateUniqueValues" in u6 ? u6.queryAggregateUniqueValues(m10, g4, { signal: o4 }) : n8 ? this.workerClient.uniqueValues(g4, n8) : p4({ attribute: g4, features: l4 });
  }
  async _histogramFromMemory(e3) {
...
var A2 = class extends p8 {
  ...
  async _getUniqueValuesFromMemory(e3, t2) {
    ...
    return e3.valueExpression && r4 && u6 && (l4.viewInfoParams = _2(r4), l4.timeZone = r4.timeZone), u6 ? this.workerClient.uniqueValues(l4, u6) : p4({ attribute: l4, features: p10 });
  }
...
//# sourceMappingURL=uniqueValues-BXOZUNDF.js.map

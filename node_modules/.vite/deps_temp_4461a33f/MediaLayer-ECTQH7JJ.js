import {
  ...
  n as n6,
  p as p6
} from "./chunk-FQ3VZX4K.js";
import {
  p as p7
} from "./chunk-RFNE6UX2.js";
import {
  r as r5
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-QHVHBJP7.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
...
//# sourceMappingURL=MediaLayer-ECTQH7JJ.js.map

...
var W = class {
  ...
  _validateBoundingVolume(t12, i8) {
    ...
    for (const s10 of this._geometries) {
      const i9 = s10.boundingInfo;
      if (null == i9) continue;
      const o8 = e10 ? s10.transformation : this.getCombinedShaderTransformation(s10), r13 = m(o8);
      E(U, i9.center, o8);
...
function T2(t12, i8, e10) {
  ...
  if (H(e10)) {
    const t13 = o(C, e10[12], e10[13], e10[14]);
...
var S2 = class extends m4 {
  constructor(e10, t12) {
    super(e10, t12, new t5(z, () => import("./RibbonLine.glsl-56BLSRZM.js")), v2(t12).locations), this.primitiveType = t12.wireframe ? _.LINES : _.TRIANGLE_STRIP;
  }
...
var J = class extends s6 {
  constructor(t12, e10) {
    super(t12, q), this.produces = /* @__PURE__ */ new Map([[2, (t13) => t2(t13) || o3(t13) && 8 === this.parameters.renderOccluded], [3, (t13) => b(t13)], [10, (t13) => a(t13) && 8 === this.parameters.renderOccluded], [11, (t13) => a(t13) && 8 === this.parameters.renderOccluded], [4, (t13) => o3(t13) && this.parameters.writeDepth && 8 !== this.parameters.renderOccluded], [8, (t13) => o3(t13) && !this.parameters.writeDepth && 8 !== this.parameters.renderOccluded], [18, (t13) => u4(t13)]]), this._configuration = new i6(e10);
  }
  ...
  intersect(i8, r13, u8, f6, d7, g4) {
    ...
    if (!m2(r13)) return void i.getLogger("esri.views.3d.webgl-engine.materials.RibbonLineMaterial").error("intersection assumes a translation-only matrix");
    ...
    o(mt[0], O3[0] - L, O3[1] + L, 0), o(mt[1], O3[0] + L, O3[1] + L, 0), o(mt[2], O3[0] + L, O3[1] - L, 0), o(mt[3], O3[0] - L, O3[1] - L, 0);
...
var X2 = class {
  ...
  write(t12, e10, i8, r13, s10, n9) {
    ...
    const C2 = new Float32Array(s10.buffer), O3 = t4(s10.buffer), L = new Uint8Array(s10.buffer), V = o8.stride / 4;
    let R2 = n9 * V;
    const x3 = R2;
    let F = 0;
    ...
    R2 += V, o(lt, l4.data[0], l4.data[1], l4.data[2]), y3 && s2(ct, w2[0], w2[1], w2[2], w2[3]), t12 && E(lt, lt, t12);
    const J2 = this._isClosed(i8);
    if (J2) {
      const e11 = l4.data.length - 3;
      o(ot, l4.data[e11], l4.data[e11 + 1], l4.data[e11 + 2]), t12 && E(ot, ot, t12);
    } else o(ht, l4.data[3], l4.data[4], l4.data[5]), t12 && E(ht, ht, t12), W2(lt, lt, ht, ct, 1, -4, 0, 0), W2(lt, lt, ht, ct, 1, 4, 0, 0), s4(ot, lt), s4(lt, ht), y3 && s2(ct, w2[4], w2[5], w2[6], w2[7]);
    const Y2 = J2 ? 0 : 1, q2 = J2 ? m7 : m7 - 1;
    for (let p5 = Y2; p5 < q2; p5++) {
      const e11 = (p5 + 1) % m7 * 3;
      o(ht, l4.data[e11], l4.data[e11 + 1], l4.data[e11 + 2]), t12 && E(ht, ht, t12), N2(ot, lt, p5), W2(ot, lt, ht, ct, 0, -1, p5, F), W2(ot, lt, ht, ct, 0, 1, p5, F);
    ...
    J2 ? (o(ht, l4.data[3], l4.data[4], l4.data[5]), t12 && E(ht, ht, t12), F = N2(ot, lt, q2), W2(ot, lt, ht, ct, 0, -1, Y2, F), W2(ot, lt, ht, ct, 0, 1, Y2, F)) : (F = N2(ot, lt, q2), W2(ot, lt, lt, ct, 0, -5, q2, F), W2(ot, lt, lt, ct, 0, 5, q2, F)), G(C2, x3 + V, C2, x3, V);
...
function l2(e10, t12, n9, o8, i8, a6, s10, l4, c7, u8, f6) {
  const d7 = b4[f6.mode];
  let m7, g4, p5 = 0;
  if (o2(e10, t12, n9, o8, c7.spatialReference, i8, l4)) return (d7 == null ? void 0 : d7.requiresAlignment(f6)) ? (p5 = d7.applyElevationAlignmentBuffer(o8, i8, a6, s10, l4, c7, u8, f6), m7 = a6, g4 = s10) : (m7 = o8, g4 = i8), o2(m7, c7.spatialReference, g4, a6, u8.spatialReference, s10, l4) ? p5 : void 0;
}
...
function l3(e10, t12) {
  if (null != e10 && !p4(e10)) {
    ...
    const n9 = t12;
    n9._geometry && (n9._geometry = u5(n9._geometry)), e10.arcade.modules.arcadeUtils.updateExecContext(e10.arcade.context, t12);
  }
}
function i7(e10) {
  if (null != e10) {
...
var f5 = class {
  ...
  _drawOriginBox(t12, i8 = r7(1, 1, 0, 1)) {
    ...
    o2(_3, this._originSR, 0, _3, r13.renderSpatialReference, 0, l4);
    const b5 = new m3(this._material, [["position", new t(_3, p5, 3, true)]], null, 2);
    f6.addGeometry(b5);
  }
  get test() {
  }
...
//# sourceMappingURL=chunk-MAATTXR5.js.map

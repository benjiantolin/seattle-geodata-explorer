...
import {
  ...
  t as t4,
  u as u4
} from "./chunk-TR7YRTK5.js";
import "./chunk-FSVSPJGS.js";
import {
  c as c4,
  f as f4,
  o as o3
...
import {
  j as j4
} from "./chunk-5TTUEJVW.js";
import {
  n as n2,
  u as u3
} from "./chunk-BCTWJMUI.js";
import {
  T,
  w
} from "./chunk-DYB7ITAX.js";
import "./chunk-V7YRGBRB.js";
import "./chunk-XDTFMAHM.js";
import {
  C,
  G,
  H,
...
function k4(e3) {
  ...
  const D2 = new z({ ...t7.extent, spatialReference: E3 }), v7 = new _(D2 ? { x: D2.xmin, y: D2.ymax, spatialReference: E3 } : { x: 0, y: 0 }), P = new l5({ blockWidth: s7, blockHeight: u8, pyramidBlockWidth: g4, pyramidBlockHeight: x2, compression: d7, origin: v7, firstPyramidLevel: m9, maximumPyramidLevel: y3, pyramidResolutions: w3, blockBoundary: T2 }), B = new _({ x: (D2.xmax - D2.xmin) / i8, y: (D2.ymax - D2.ymin) / r6, spatialReference: E3 }), C3 = _2 ? { BandProperties: _2.bandProperties, DataType: _2.dataType } : {};
  let L3 = null;
...
var Y2 = class extends p(t(b(j2(o3(s5(X2(i4(l6(l4(f3(l3(l(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-BYNGFOV6.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
...
//# sourceMappingURL=ImageryTileLayer-HEWMIGMG.js.map

...
return size;
}`), x ? (f5.add("opacityFeatureAttribute", "float"), u2.constants.add("vvOpacityNumber", "int", p4), u2.uniforms.add(new r3("vvOpacityValues", (e9) => e9.vvOpacity.values, p4), new r3("vvOpacityOpacities", (e9) => e9.vvOpacity.opacityValues, p4), new r2("vvOpacityFallback", (e9) => e9.vvOpacity.fallback, { supportsNaN: true })), u2.code.add(t`
...
return color;
}`), m ? (f5.add("colorFeatureAttribute", "float"), u2.constants.add("vvColorNumber", "int", r4), u2.uniforms.add(new r3("vvColorValues", (e9) => e9.vvColor.values, r4), new e3("vvColorColors", (e9) => e9.vvColor.colors, r4), new e2("vvColorFallback", (e9) => e9.vvColor.fallback)), u2.code.add(t`vec4 getColor() {
...
forwardLinearDepthToReadShadowMap();`)), V) {
    case 1:
    case 0:
      I2.include(n2, B2), I2.include(f2, B2), _.include(t3, B2), I2.include(e5, B2), _.include(p, B2), I2.include(n3, B2), d(_, B2), p3(_), v(_), _.uniforms.add(M.uniforms.get("localOrigin"), new e("ambient", (e8) => e8.ambient), new e("diffuse", (e8) => e8.diffuse), new r2("opacity", (e8) => e8.opacity)), _.include(e6), _.include(e7, B2), a2(_), _.main.add(t`
        discardBySlice(vpos);
...
//# sourceMappingURL=chunk-NKDYZLT5.js.map

...
import {
  f
} from "./chunk-CZGD6GZT.js";
import {
  g,
  v
} from "./chunk-AXIZYUHH.js";
import {
  r as r5
...
var l3 = class extends m2 {
  constructor(r7, t8) {
    super(r7, t8, new t2(f, () => import("./SSAOBlur.glsl-LJZHFKKR.js")), s);
  }
  initializePipeline() {
...
var l4 = class extends m2 {
  constructor(r7, t8) {
    super(r7, t8, new t2(g, () => import("./SSAO.glsl-JJRNNKYP.js")), s);
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var j2 = class extends a3 {
  ...
  render(e10) {
    const t8 = e10.find(({ name: e11 }) => "normals" === e11), s3 = t8 == null ? void 0 : t8.getTexture(), o7 = t8 == null ? void 0 : t8.getTexture(n4);
    if (!s3 || !o7) return;
...
function t7(t8, o7) {
  o7.receiveAmbientOcclusion ? (t8.uniforms.add(new e6("ssaoTex", (e10) => {
    var _a;
...
function v2(i) {
  i.uniforms.add(new r4("lightingGlobalFactor", (i2) => i2.lighting.globalFactor));
}
function f2(g3, f3) {
  ...
  switch (R && L.include(a6), L.code.add(t`
    ...
    ${n3(0 !== b, "const float GROUND_REFLECTANCE = 0.2;")}
...
inputs.groundIrradianceToSurface = GROUND_REFLECTANCE * ambientLightIrradianceComponent + mainLightIrradianceComponent + fillLightsIrradianceComponent ;`), L.uniforms.add(new r4("lightingSpecularStrength", (i) => i.lighting.mainLight.specularStrength), new r4("lightingEnvironmentStrength", (i) => i.lighting.mainLight.environmentStrength)).code.add(t`vec3 horizonRingDir = inputs.RdotNG * groundNormal - reflectedView;
...
float getBakedOcclusion() { return 1.0; }`);
  ...
  (d2 || p3) && u.include(r3, a7), n8.code.add(t`vec3 mrr;
float occlusion;`), d2 && n8.uniforms.add(1 === h2 ? new e5("texMetallicRoughness", (e10) => e10.textureMetallicRoughness) : new e4("texMetallicRoughness", (e10) => e10.textureMetallicRoughness)), p3 && n8.uniforms.add(1 === h2 ? new e5("texOcclusion", (e10) => e10.textureOcclusion) : new e4("texOcclusion", (e10) => e10.textureOcclusion)), n8.uniforms.add(1 === h2 ? new e3("mrrFactors", (e10) => e10.mrrFactors) : new e2("mrrFactors", (e10) => e10.mrrFactors)), n8.code.add(t`
    ${n3(d2, t`void applyMetallicRoughness(vec2 uv) {
            vec3 metallicRoughness = textureLookup(texMetallicRoughness, uv).rgb;
            mrr[0] *= metallicRoughness.b;
            mrr[1] *= metallicRoughness.g;
          }`)}

    ${n3(p3, "void applyOcclusion(vec2 uv) { occlusion *= textureLookup(texOcclusion, uv).r; }")}
    ...
    void applyPBRFactors() {
      ...
      ${n3(d2, `applyMetallicRoughness(${m4 ? "metallicRoughnessUV" : "vuv0"});`)}
      ${n3(p3, `applyOcclusion(${f3 ? "occlusionUV" : "vuv0"});`)}
    }
  `);
}
...
function e9(e10, n8) {
  n8.snowCover && (e10.uniforms.add(new r4("snowCover", (o7) => o7.snowCover)).code.add(t`float getSnow(vec3 normal, vec3 groundNormal) {
...
//# sourceMappingURL=chunk-MG4FAKX6.js.map

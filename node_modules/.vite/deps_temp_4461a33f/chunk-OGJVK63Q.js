...
import {
  S as S2
} from "./chunk-HDH6ASL5.js";
import {
  n as n3
} from "./chunk-NJSNWHSF.js";
import {
  c as c3
...
var le = (_a = class extends l3(s5(u)) {
  ...
  readCapabilities(e4, r4) {
    ...
    const { attachment: t2, operations: { supportsQuery: i7, supportsQueryAttachments: o3 }, query: { supportsFormatPBF: s9, supportsOrderBy: a4, supportsPagination: l6 }, data: { supportsAttachment: n5 }, queryRelated: p4 } = c3(r4, this.url);
  ...
  toExportImageJSON(e4) {
    ...
    if (o3) {
      ...
      if (i7.renderer > 2 && (e5.renderer = this.renderer ? this.renderer.toJSON() : null), i7.labelsVisible > 2 && (e5.showLabels = this.labelsVisible), this.labelsVisible && i7.labelingInfo > 2) if (this.labelingInfo) {
        ...
        null != this.geometryType && (r5 = c2(this.labelingInfo, y.toJSON(this.geometryType))), e5.showLabels = true, e5.labelingInfo = r5.filter((e6) => e6.labelPlacement).map((e6) => e6.toJSON({ origin: "service", layer: this.layer }));
...
//# sourceMappingURL=chunk-OGJVK63Q.js.map

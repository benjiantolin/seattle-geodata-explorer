...
function s2(r7, s4) {
  ...
  const T6 = c2(r7), { absoluteZ: k6 } = y3(w8, M6, C3, g6, s4, T6);
...
function U7(t8, n5, e8 = []) {
  ...
  let r7 = null;
  return (a8) => {
    "start" === a8.action && (r7 = t8.toMap(a8.screenStart, { exclude: e8 }), null != r7 && (r7.z = x(r7, t8, n5)));
    const o6 = t8.toMap(a8.screenEnd, { exclude: e8 });
    null != o6 && (o6.z = x(o6, t8, n5));
    const l11 = null != r7 && null != o6 ? { sceneStart: r7, sceneEnd: o6 } : null;
    return { ...a8, scenePoints: l11 };
  };
}
function G4(t8, n5, e8) {
  const r7 = n5.elevationProvider.getElevation(t8.x, t8.y, t8.z ?? 0, t8.spatialReference, "scene") ?? 0, a8 = x2(t8);
  return a8.z = r7, a8.hasZ = true, a8.z = x(a8, n5, e8), a8;
}
function q4(t8, n5) {
  if ("2d" === t8.type) return (t9) => t9;
  let e8 = null;
...
var A4 = class extends l2 {
  ...
  get committableVertex() {
    ...
    return "polygon" === n5 && i5(t8, i10) || i5(t8, e8) ? null : t8;
  }
  get updating() {
    return this._updatingHandles.updating;
  }
...
var c8 = class {
  ...
  mapToScreen(e8) {
    const t8 = t(e8.x, e8.y, E(this._view, e8, this._elevationInfo), e8.spatialReference);
    return this._view.toScreen(t8);
  }
  constrainZ(e8) {
    const { defaultZ: t8 } = this;
    return null != t8 && e8.z !== t8 && ((e8 = x2(e8)).z = t8), e8;
  }
};
var l10 = class {
  ...
  screenToMap(e8) {
    ...
    return null != t8 && (t8.z = x(t8, this.view, this.elevationInfo)), t8;
  }
  mapToScreen(e8) {
    let t8 = e8;
    return null != this.elevationInfo && (t8 = t(e8.x, e8.y, E(this.view, e8, this.elevationInfo), e8.spatialReference)), this.view.toScreen(t8);
  }
  constrainZ(e8) {
    return e8;
  }
...
var h7 = class {
  ...
  constrainZ(e8) {
    const { defaultZ: t8 } = this;
    return this.hasZ && e8.z !== t8 && ((e8 = x2(e8)).z = t8), e8;
  }
};
var _u = class _u {
  screenToMap(e8) {
...
function S4(a8, m5, g6, p5, u5 = false) {
  p5 || (p5 = z());
  const l11 = o2(t2.get(), a8[1], -a8[0]), j8 = o2(t2.get(), Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY), d6 = o2(t2.get(), Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY), x6 = t2.get(), V6 = m5.allVerticesUnordered;
  V6.forEach(({ pos: s4 }) => {
    o2(x6, j2(a8, s4), j2(l11, s4)), f2(j8, j8, x6), M(d6, d6, x6);
  });
  const T6 = 1e-6, E8 = o2(t2.get(), d6[0] - j8[0] < T6 ? g6 / 2 : 0, d6[1] - j8[1] < T6 ? g6 / 2 : 0);
...
//# sourceMappingURL=chunk-XORMTMCB.js.map

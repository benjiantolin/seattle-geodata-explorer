...
function t5(t6, a2) {
  a2.instancedColor ? (t6.attributes.add("instanceColor", "vec4"), t6.vertex.include(r3), t6.vertex.include(e4), t6.vertex.include(c), t6.vertex.code.add(t`
...
function p3(r6, n5) {
  ...
  const _ = r6.vertex;
  u2 && (_.include(e3, n5), _.uniforms.add(new e5("viewOriginHi", (e7) => o3(o(M, e7.camera.viewInverseTransposeMatrix[3], e7.camera.viewInverseTransposeMatrix[7], e7.camera.viewInverseTransposeMatrix[11]), M)), new e5("viewOriginLo", (e7) => r4(o(M, e7.camera.viewInverseTransposeMatrix[3], e7.camera.viewInverseTransposeMatrix[7], e7.camera.viewInverseTransposeMatrix[11]), M)))), _.code.add(t`
...
function i2(i4, s) {
  i4.varyings.add("colorMixMode", "int"), i4.varyings.add("opacityMixMode", "int"), i4.vertex.uniforms.add(new o4("symbolColorMixMode", (o7) => l[o7.colorMixMode])), s.hasSymbolColors ? (i4.vertex.include(r3), i4.vertex.include(e4), i4.vertex.include(c), i4.attributes.add("symbolColor", "vec4"), i4.vertex.code.add(t`
...
function f3(o7, r6) {
  l2(o7, r6, new r2("textureAlphaCutoff", (o8) => o8.textureAlphaCutoff));
}
...
function f4(f5, g) {
  ...
  switch (C) {
    case 2:
      f(x2, g), f5.include(o2), O.include(p, g), f5.include(d, g), V && O.uniforms.add(new e2("tex", (o7) => o7.texture)), x2.main.add(t`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`), f5.include(f3, g), O.main.add(t`
    ...
    case 7:
    case 10:
      f(x2, g), f5.include(o2), f5.include(d, g), f5.include(u, g), f5.include(a, g), O.include(p, g), f5.include(d2, g), i(f5), j2.add("depth", "float", { invariant: true }), V && O.uniforms.add(new e2("tex", (o7) => o7.texture)), x2.main.add(t`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`), f5.include(f3, g), O.main.add(t`
      ...
      break;
    case 3: {
      f(x2, g), f5.include(o2), f5.include(o6, g), f5.include(d4, g), f5.include(d, g), f5.include(u, g), V && O.uniforms.add(new e2("tex", (o8) => o8.texture)), 2 === b && j2.add("vPositionView", "vec3", { invariant: true });
      const o7 = 0 === b || 1 === b;
      x2.main.add(t`
    ...
    case 9:
      f(x2, g), f5.include(o2), f5.include(d, g), f5.include(u, g), V && O.uniforms.add(new e2("tex", (o7) => o7.texture)), x2.main.add(t`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
//# sourceMappingURL=chunk-T7E3PGVA.js.map

...
var G2 = class _G {
  ...
  projectedArea(e6, s2, i, n5) {
    ...
    for (let t2 = 0; t2 < p3; t2++) {
      const a3 = V2[M2 + t2];
      o(X4, ((1 & a3) << 1) - 1, (2 & a3) - 1, ((4 & a3) >> 1) - 1), N2(X4, X4, ct2), u(E3, b2, X4), E3[3] = 1, z(E3, E3, s2);
  ...
  transform(t2, a3, e6, s2 = 0, i = a2(e6), r4 = a2(a3), n5 = C(a3, r4)) {
    if (e6 === i) a3.isGeographic ? et2(this, t2, a3, s2, r4) : at2(this, t2, a3, s2, r4, n5);
      ...
      i2[2] += s2, o2(i2, a3, 0, i2, e6, 0), t2.center = i2, this !== t2 && (t2.quaternion = this.getQuaternion(O4), t2.halfSize = this.getHalfSize(ht2));
    }
  }
};
var I2 = e5();
...
function K2(t2, a3, e6, s2, i) {
  ...
  if (1 === s2) {
    ...
    u(ut2, ft2, h2);
    const r4 = r2(ut2);
    if (s3 < e6) i.center = o4, o(mt2, e6, e6, e6), i.halfSize = u(mt2, h2, mt2);
    else {
...
function L2(t2, a3, e6, s2, i) {
  ...
  const r4 = a2(e6);
  o2(nt2, t2, 0, nt2, r4, 0), tt2(r4, a3, nt2, e6, s2);
}
...
function tt2(a3, e6, s2, i, r4) {
  ...
  o2(st2, a3, 0, st2, i, 0, 8), J2(it2, r4);
}
function at2(t2, a3, e6, s2, i = a2(e6), o4 = C(e6, i)) {
  ...
  a3.quaternion = x(I2, I2, m3), O2(I2, I2), o(ft2, 0, 0, 0);
...
function et2(t2, a3, e6, s2, i = a2(e6)) {
  ...
  t2.getCenter(rt2), rt2[2] += s2, o2(rt2, e6, 0, rt2, i, 0), a3.center = rt2;
  const h2 = t2.getQuaternion(O4);
  a3.quaternion = h2, O2(I2, h2), o(mt2, 0, 0, 1), Q(mt2, mt2, I2);
  const _2 = t2.getHalfSize(ht2);
  o(mt2, _2[0] * Math.abs(mt2[0]), _2[1] * Math.abs(mt2[1]), _2[2] * Math.abs(mt2[2])), g(mt2, mt2, n5.inverseFlattening), u(mt2, _2, mt2), a3.halfSize = g(mt2, mt2, o4);
}
...
//# sourceMappingURL=chunk-WV2I6IXB.js.map

...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)), w(W), j2.include(e6), W.main.add(t`
    ...
    }`), U.include(p, b2), j2.include(n2, b2), U.include(e5), U.uniforms.add(new e3("intrinsicColor", ({ color: e7 }) => e7), new e("tex", ({ markerTexture: e7 }) => e7)).constants.add("texelSize", "float", 1 / i2).code.add(t`float markerAlpha(vec2 samplePos) {
...
//# sourceMappingURL=chunk-2PPAJZ37.js.map

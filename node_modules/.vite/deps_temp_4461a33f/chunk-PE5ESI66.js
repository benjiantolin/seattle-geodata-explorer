...
var G = class extends u {
  ...
  async applyEdits(e2, t3) {
    ...
    await i2(this.layer.url, g3, true);
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: r2 } = await import("./uploadAssets-B5FSBDEA.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t2(t4)) s4.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: r3 } = await import("./convertMeshVertexSpace-H46NDKZ6.js"), n = await r3(e3, new i3({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-PE5ESI66.js.map

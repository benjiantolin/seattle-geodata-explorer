...
import {
  ...
  u,
  v
} from "./chunk-LEHWJAD5.js";
import "./chunk-UWXZYS2W.js";
import {
  s
...
var j2 = class extends s2(B) {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-7BBOJ2KZ.js"), flow: () => import("./calcite-flow-4SLCKMBT.js"), "flow-item": () => import("./calcite-flow-item-H2BQKH45.js"), list: () => import("./calcite-list-632IXF55.js"), notice: () => import("./calcite-notice-7DYFHPEL.js"), tooltip: () => import("./calcite-tooltip-K5LQSGST.js") });
  }
  destroy() {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-FVVFN347.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-5US66M3H.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

...
function u2(n5, t4, r8) {
  const u9 = o(t4, r8);
  if (0 === u9) return o(t4, n5);
  const i8 = (t4[0] - n5[0]) * (r8[1] - n5[1]) - (t4[1] - n5[1]) * (r8[0] - n5[0]);
  return i8 * i8 / u9;
}
function i4(n5, t4, r8, o6, u9) {
...
function s2(t4, r8, o6, u9) {
  if (m2(m4(t4 - r8), 0)) return o6 ? [t4, t4] : [t4, u9 ? t4 - c3 : t4 + c3];
  const [i8, e10] = u9 ? [t4 - c3, t4] : [t4, t4 + c3];
...
function s3(s7, i8, n5) {
  ...
  const j3 = r4([0, 0], s7, i8, u9);
  return { t: u9, curvePoint: j3, distance: Math.sqrt(o(j3, n5)) };
}
...
function u3(t4, s7) {
  ...
  const { cx: o6, cy: c9, thetaStart: h12, thetaEnd: u9 } = t4, [d6, f11] = s7, l8 = h4(f4(h12, u9), Math.atan2(f11 - c9, d6 - o6)), M2 = e6(t4, l8);
  return { t: (l8 - h12) / (u9 - h12), curvePoint: M2, distance: Math.sqrt(o(s7, M2)) };
}
function d(n5, a9) {
  ...
  const d6 = f4(h12, u9), f11 = Math.PI / 2;
  let l8 = 0;
  for (const i8 of [[r8 + c9, s7], [r8, s7 + c9], [r8 - c9, s7], [r8, s7 - c9]]) l8 = x(d6, l8), l8 > d6.min && l8 < d6.max && f3(n5, i8), l8 += f11;
  return n5;
}
function f5(t4) {
...
var e7 = e3();
function m5(r8, c9, i8) {
  const [o6, s7] = r8, [m9, l8] = c9, [u9, f11] = i8;
  r3(e7, o6, m9, u9, s7, l8, f11, 1, 1, 1);
  const h12 = e2(e7), M2 = 4 * h12 / (o(r8, c9) + o(c9, i8) + o(i8, r8));
...
function l3(t4, n5) {
  const [r8, i8] = n5.c, a9 = m5(t4, i8, r8), e10 = null == a9, l8 = a9 ?? r4([], t4, r8, 0.5), [u9, f11] = t4, [h12, M2] = i8, [p5, b4] = r8, [j3, x7] = l8, d6 = u9 - j3, g3 = f11 - x7, I3 = Math.sqrt(d6 * d6 + g3 * g3), P3 = e5(f11 - x7, u9 - j3), U = e5(M2 - x7, h12 - j3);
  let q3 = e5(b4 - x7, p5 - j3);
  return (U - P3) * (q3 - U) < 0 && (q3 += 2 * Math.sign(P3 - q3) * Math.PI), new c4(j3, x7, I3, P3, q3, e10);
}
function u4(t4, n5, r8) {
  const c9 = h5(t4, r8 / 2), o6 = h5(t4, r8), s7 = h5(t4, (r8 + 1) / 2);
  return [{ c: [o6, c9] }, { c: [[...n5.c[0]], s7] }];
}
function f6(t4, n5) {
  const [r8] = n5.c, { cx: c9, cy: i8, thetaStart: o6, thetaEnd: s7, radius: a9, isInvalid: e10 } = l3(t4, n5);
...
function h6(r8, h12) {
  const [n5, c9, i8, e10] = h12.a, [m9, M2] = r8, [f11, l8] = n5, [p5, u9] = c9, j3 = m9 - p5, U = M2 - u9, b4 = Math.sqrt(j3 * j3 + U * U), q3 = f11 - p5, x7 = l8 - u9, I3 = Math.sqrt(q3 * q3 + x7 * x7), P3 = 0 === b4 || 0 === I3 || !A(b4, I3), d6 = b4, [w3, y5] = s2(e5(M2 - u9, m9 - p5), Math.atan2(l8 - u9, f11 - p5), i8, e10);
  return new c4(p5, u9, d6, w3, y5, P3);
}
function n2(t4, a9, o6) {
  const { cx: s7, cy: h12, thetaStart: n5, thetaEnd: c9 } = t4, [i8, e10, m9, M2] = a9.a, f11 = n5 * (1 - o6) + c9 * o6;
  return [{ a: [h5(t4, o6), [s7, h12], Math.abs(f11 - n5) < Math.PI ? 1 : 0, M2] }, { a: [[...i8], [s7, h12], Math.abs(c9 - f11) < Math.PI ? 1 : 0, M2] }];
}
...
function p2(t4, n5, o6) {
  ...
  return h7(r8, c9, u9, s7, o6);
}
function M(t4, n5, o6) {
  const r8 = t4, [s7, c9, u9] = n5.b, f11 = r4([0, 0], r8, c9, o6), a9 = r4(i6, c9, u9, o6), h12 = r4([0, 0], u9, s7, o6), m9 = r4([0, 0], f11, a9, o6), p5 = r4([0, 0], a9, h12, o6);
  return [{ b: [r4([], m9, p5, o6), f11, m9] }, { b: [[...s7], p5, h12] }];
}
function b2(o6, r8, s7) {
  const c9 = o6, [u9, e10, i8] = r8.b, a9 = l2(s7, [0.1, 0.5, 0.9], (t4) => {
    const n5 = 1 - t4, [o7, r9] = h7(c9, e10, i8, u9, t4);
  ...
  let m9 = 1 / 0;
  const p5 = a9.map((t4) => {
    const n5 = h7(c9, e10, i8, u9, t4), [o7, r9] = n5, f11 = s7[0] - o7, a10 = s7[1] - r9, p6 = Math.sqrt(f11 * f11 + a10 * a10);
...
function l4(t4, n5, u9) {
  ...
  for (const o6 of q(e10[0], i8[0], a9[0], f11[0])) o6 > 0 && o6 < 1 && m3(t4, m6(e10[0], i8[0], a9[0], f11[0], o6));
  for (const o6 of q(e10[1], i8[1], a9[1], f11[1])) o6 > 0 && o6 < 1 && h2(t4, m6(e10[1], i8[1], a9[1], f11[1], o6));
  return t4;
}
...
function d2(t4, n5, o6) {
  ...
  for (let e10 = 0; e10 < r8; e10++) {
    ...
    let e11 = 0;
    for (const t5 of c9) {
      const [o7, r10, c10] = t5.b, f11 = Math.sqrt(o(n6, o7));
      s7 += (f11 + (Math.sqrt(o(n6, r10)) + Math.sqrt(o(r10, c10)) + Math.sqrt(o(c10, o7)))) / 2, e11 += f11, n6 = o7;
    }
...
function p3(t4, s7) {
  const [n5, a9, r8, o6, i8, c9, h12] = s7.a, [u9, m9] = t4, [M2, l8] = n5, [p5, R2] = a9, d6 = c9 * h12, x7 = Math.cos(i8), q3 = Math.sin(i8), [I3, g3] = s2(e5(1 / d6 * (m9 - R2) * x7 - 1 / d6 * (u9 - p5) * q3, 1 / c9 * (m9 - R2) * q3 + 1 / c9 * (u9 - p5) * x7), Math.atan2(1 / d6 * (l8 - R2) * x7 - 1 / d6 * (M2 - p5) * q3, 1 / c9 * (l8 - R2) * q3 + 1 / c9 * (M2 - p5) * x7), r8, o6);
...
function q2(t4, s7) {
  const { a: n5, b: a9, cosR: r8, sinR: o6, u1: i8, u2: c9 } = t4, e10 = Math.PI / 6, f11 = l2(s7, [1 * e10, 2 * e10, 4 * e10, 5 * e10, 7 * e10, 8 * e10, 10 * e10, 11 * e10], (s8) => {
  ...
  }), m9 = f4(i8, c9), M2 = new Set(f11.map((t5) => x(m9, t5)).filter((t5) => t5 > m9.min && t5 < m9.max));
  M2.add(i8), M2.add(c9);
  let b4, p5, d6 = 1 / 0;
  for (const h12 of M2) {
...
function I(t4, s7, n5) {
  ...
  const b4 = Math.atan2(-o6 * m9, r8 * f11), d6 = b4 + Math.PI, x7 = Math.atan2(o6 * f11, r8 * m9), q3 = x7 + Math.PI, I3 = f4(c9, e10);
  for (const u9 of [b4, d6, x7, q3].map((t5) => x(I3, t5))) u9 > I3.min && u9 < I3.max && f3(t4, R(a9, u9));
  return t4;
}
function g(t4, s7, n5) {
...
function n3(n5, p5, u9) {
  if (i5(u9)) return f3(n5, p5), f3(n5, u9), n5;
  if (t(u9)) return l4(n5, p5, u9);
  if (u5(u9)) {
    const r8 = l3(p5, u9);
    return d(n5, r8);
  }
...
function y3(t4, o6, u9, c9) {
  ...
  let l8, h12, f11, x7, [g3, v5] = f7(o6[0][0]), y5 = g3, d6 = v5;
  for (let p5 = 0; p5 < o6.length; p5++) {
    const t5 = o6[p5];
    for (let o7 = 0; o7 < t5.length; o7++) {
      const p6 = f7(t5[o7]), [M2, z3] = p6;
      if (g3 = m7(g3, M2), v5 = m7(v5, z3), y5 = a6(y5, M2), d6 = a6(d6, z3), u9 && p6.length > 2) {
        const n5 = p6[2];
        l8 = m7(l8, n5), h12 = a6(h12, n5);
      }
      if (c9 && p6.length > s7) {
        const n5 = p6[s7];
        f11 = m7(l8, n5), x7 = a6(h12, n5);
      }
      const P3 = t5[o7];
      if (i5(P3) || o7 < 1) continue;
      const j3 = f7(t5[o7 - 1]), R2 = e(g3, v5, y5, d6);
      [g3, v5, y5, d6] = n3(R2, j3, P3);
    }
  }
...
function p4(n5, t4, i8, r8, e10, o6) {
  ...
  for (let p5 = 0; p5 < t4.length; p5++) {
    ...
    if (g3 = m7(g3, i9), v5 = m7(v5, r9), y5 = a6(y5, i9), d6 = a6(d6, r9), s7 && n6.length > 2) {
      const t5 = n6[2];
      l8 = m7(l8, t5), h12 = a6(h12, t5);
    }
    if (c9 && n6.length > u9) {
      const t5 = n6[u9];
      f11 = m7(l8, t5), x7 = a6(h12, t5);
    }
  }
...
function x4(t4, n5, e10) {
  ...
  for (; e10.nextPoint(); ) s7 = e10.x - r8, h12 = e10.y - l8, o6 = 0.5 * a7 * (s7 * i8 - h12 * u9), t4[0] += o6 * (u9 + s7), t4[1] += o6 * (i8 + h12), u9 = s7, i8 = h12;
...
//# sourceMappingURL=chunk-RXMBJ5AR.js.map

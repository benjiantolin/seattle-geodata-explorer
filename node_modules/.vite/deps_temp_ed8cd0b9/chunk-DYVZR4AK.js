...
var c5 = i()({ barchart: "bar-chart", columnchart: "column-chart", linechart: "line-chart", piechart: "pie-chart" });
...
var U = class extends l(n) {
  ...
  castContent(t2) {
    return Array.isArray(t2) ? t2.map((t3) => S(P, t3)) : "string" == typeof t2 || "function" == typeof t2 || t2 instanceof HTMLElement || C(t2) ? t2 : (i2.getLogger(this).error("content error", "unsupported content value", { value: t2 }), null);
  }
  readContent(t2, e2) {
...
//# sourceMappingURL=chunk-DYVZR4AK.js.map

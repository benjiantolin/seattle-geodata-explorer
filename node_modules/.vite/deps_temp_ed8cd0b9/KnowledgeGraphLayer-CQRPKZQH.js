import {
  ...
  f as f3,
  w
} from "./chunk-I2YFZJTV.js";
import "./chunk-BYU7VMB6.js";
import "./chunk-XV545ST4.js";
import "./chunk-ACOYYY3T.js";
import {
  ue
} from "./chunk-L2W42SET.js";
import "./chunk-6PJFUVQQ.js";
import "./chunk-DDG2NIE7.js";
import "./chunk-TY53BONF.js";
import "./chunk-GG5NLSNK.js";
import "./chunk-7J7T5A43.js";
import "./chunk-VXEULSG2.js";
import "./chunk-G65QEP6R.js";
import "./chunk-QPIPAI3K.js";
import "./chunk-MBQEPUQX.js";
import "./chunk-IMBCGA3J.js";
import "./chunk-G5IXTUNN.js";
import "./chunk-SBPD4RZE.js";
import "./chunk-DKZ64KLX.js";
import "./chunk-7PIFITKB.js";
import "./chunk-FMM43AKO.js";
import "./chunk-5QX5RZU4.js";
import "./chunk-IWWO3PMY.js";
import "./chunk-QRYOCJK2.js";
import "./chunk-H454RK3Q.js";
...
var R = class extends p2(t2(f2(l3(b(j(l2(s2(b2)))))))) {
  ...
  _validateInclusionModeDefinition() {
    ...
    if ((i2 == null ? void 0 : i2.size) > 0) i2.forEach((e3, t3) => {
  ...
  _setMemberTypes() {
    var _a, _b;
    let e2 = [], i2 = [];
    const { inclusionModeDefinition: t3 } = this, a2 = t3 == null ? void 0 : t3.namedTypeDefinitions;
    !t3 || t3.generateAllSublayers ? (e2 = ((_a = this.knowledgeGraph.dataModel) == null ? void 0 : _a.entityTypes) ?? [], i2 = ((_b = this.knowledgeGraph.dataModel) == null ? void 0 : _b.relationshipTypes) ?? []) : a2 && a2.size > 0 && a2.forEach((t4, a3) => {
      const s3 = this._graphTypeLookup.get(a3);
      switch (s3 == null ? void 0 : s3.type) {
        case "relationship":
          i2.push(s3);
          break;
        case "entity":
  ...
  _forEachGraphType(e2) {
    var _a, _b;
    [...((_a = this.knowledgeGraph.dataModel) == null ? void 0 : _a.entityTypes) ?? [], ...((_b = this.knowledgeGraph.dataModel) == null ? void 0 : _b.relationshipTypes) ?? []].forEach((i2) => {
      e2(i2);
    });
  }
  _refreshNamedTypes() {
  ...
  writeDefinitionSetMap(e2, i2, t3, a2) {
    const s3 = a2 == null ? void 0 : a2.portalItem, o2 = a2 == null ? void 0 : a2.resources, r3 = r(a2 == null ? void 0 : a2.origin);
    if (!s3 || !o2 || null == r3) return void (e2 && (i2[t3] = m(e2, a2)));
  ...
  loadLayerAssumingLocalCache() {
    ...
    this.layers.length || 0 === this.originIdOf("tables") ? 0 === this.originIdOf("layers") ? this._createSublayers(e2, this.layers, (e3) => !!e3.geometryType) : this._updateSublayers(e2, this.layers) : this.layers = new O(), this.tables.length || 0 === this.originIdOf("layers") ? 0 === this.originIdOf("tables") ? this._createSublayers(e2, this.tables, (e3) => !e3.geometryType) : this._updateSublayers(e2, this.tables) : this.tables = new O(), (_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.forEach((e3, i2) => {
      var _a2;
  ...
  convertSublayerToDynamicData(e2) {
    ...
    (i2 == null ? void 0 : i2.useAllData) ? i.getLogger(this).warn("This Knowledge Graph Layer already uses dynamic membership for the sublayer - no conversion was made") : (this.dataManager.inclusionModeDefinition.namedTypeDefinitions.set(e2, { useAllData: true }), this.sublayerIdsCache.delete(e2), this._refreshNamedTypes());
  }
  ...
  async removeRecords(e2) {
    ...
    await this.load();
    const i2 = [];
    for (const t3 of e2) false === ((_c = (_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.get(t3.typeName)) == null ? void 0 : _c.useAllData) && ((_g = (_f = (_e = (_d = this.dataManager.inclusionModeDefinition) == null ? void 0 : _d.namedTypeDefinitions) == null ? void 0 : _e.get(t3.typeName)) == null ? void 0 : _f.members) == null ? void 0 : _g.has(t3.id)) && i2.push(t3);
    this.dataManager.removeFromLayer(i2);
    for (const t3 of i2) (_h = this.sublayerIdsCache.get(t3.typeName)) == null ? void 0 : _h.delete(t3.id);
    return this._refreshNamedTypes(), i2;
  }
};
__decorate([m2()], R.prototype, "dataManager", void 0), __decorate([m2({ json: { write: { ignoreOrigin: true, writerEnsuresNonNull: true } } })], R.prototype, "definitionSetMap", void 0), __decorate([o("definitionSetMap")], R.prototype, "readDefinitionSetMap", null), __decorate([r2("definitionSetMap")], R.prototype, "writeDefinitionSetMap", null), __decorate([m2()], R.prototype, "inclusionModeDefinition", null), __decorate([m2()], R.prototype, "knowledgeGraph", void 0), __decorate([m2({ type: O.ofType(Ne), json: { write: { ignoreOrigin: true } } })], R.prototype, "layers", void 0), __decorate([m2()], R.prototype, "memberEntityTypes", void 0), __decorate([m2()], R.prototype, "memberRelationshipTypes", void 0), __decorate([m2({ type: ["KnowledgeGraphLayer"] })], R.prototype, "operationalLayerType", void 0), __decorate([m2()], R.prototype, "sublayerCapabilities", null), __decorate([m2()], R.prototype, "sublayerIdsCache", void 0), __decorate([m2({ type: O.ofType(Ne), json: { write: { ignoreOrigin: true } } })], R.prototype, "tables", void 0), __decorate([m2({ json: { read: false } })], R.prototype, "type", void 0), __decorate([m2(y)], R.prototype, "url", void 0), R = __decorate([a("esri.layers.KnowledgeGraphLayer")], R);
var O2 = R;
async function K(e2) {
  const i2 = await w(e2);
...
//# sourceMappingURL=KnowledgeGraphLayer-CQRPKZQH.js.map

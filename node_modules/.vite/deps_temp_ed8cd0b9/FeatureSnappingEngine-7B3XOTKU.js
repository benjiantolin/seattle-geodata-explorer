...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-YW3NGIFD.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-UWT2AAM7.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-NJQDUUYZ.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-RX6OWIZR.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-7B3XOTKU.js.map

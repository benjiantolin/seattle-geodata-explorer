import {
  R,
  q
} from "./chunk-MWDMZYIY.js";
import {
  t as t4
} from "./chunk-6KLVBCTW.js";
import {
  d as d4
} from "./chunk-IUEBMTGN.js";
import {
  t as t3
...
function g3(n15) {
  var _a, _b;
  return n15 && _4() ? m(n15) ?? ((_a = w3(`0° 0' 0" N | ${n15}`)) == null ? void 0 : _a.longitude) ?? ((_b = w3(`0 N | ${n15}`)) == null ? void 0 : _b.longitude) ?? null : null;
}
function m4(n15) {
  var _a, _b;
  return n15 && _4() ? m(n15) ?? ((_a = w3(`${n15} | 0° 0' 0" E`)) == null ? void 0 : _a.latitude) ?? ((_b = w3(`${n15} | 0 E`)) == null ? void 0 : _b.latitude) ?? null : null;
}
function k(e6) {
...
__decorate([m3()], a4.prototype, "hidden", void 0), __decorate([m3()], a4.prototype, "mode", void 0), __decorate([m3()], a4.prototype, "title", void 0), __decorate([m3()], a4.prototype, "value", void 0), a4 = __decorate([a("esri.views.interactive.tooltip.components.TooltipField")], a4);
...
__decorate([m3()], a5.prototype, "left", void 0), __decorate([m3()], a5.prototype, "divider", void 0), __decorate([m3()], a5.prototype, "right", void 0), a5 = __decorate([a("esri.views.interactive.tooltip.components.ValueByValue")], a5);
...
function M3(r4, e6, a6, n15 = 2, u2 = "abbr") {
  return D(r4, s5(e6, a6).value, a6, n15, u2);
}
...
function R2(r4, t6, e6 = 2, a6 = "abbr") {
  return d6(r4, t6.value, t6.unit, e6, a6);
}
...
function z2(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return A2(r4, t6, a6, n15);
    case "metric":
      return I(r4, t6, a6, n15);
    default:
      return M3(r4, t6, e6, a6, n15);
  }
}
function B3(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return T3(r4, t6, a6, n15);
    case "metric":
...
function E2(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    ...
    case "metric":
      return R2(r4, t6, a6, n15);
    default:
      return M3(r4, t6, e6, a6, n15);
  }
}
function G(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
...
var y4 = 6;
function D4(t6, l4) {
  return { angleRelative: x2, direction: j2, directionRelative: R3, directionRelativeBilateral: $3, latitudeDecimalDegrees: L2, longitudeDecimalDegrees: F3, area: (n15, e6) => G(t6, n15, e6 ?? l4.area), length: (n15, e6, i6) => k2(t6, n15, e6 ?? l4.length, i6), lengthRelative: (n15, e6) => z2(t6, n15, e6 ?? l4.length), totalLength: (n15, e6) => k2(t6, n15, e6 ?? l4.length), verticalLength: (n15, r4) => B3(t6, n15, r4 ?? l4.verticalLength), verticalLengthRelative: (e6, r4) => E2(t6, e6, r4 ?? l4.verticalLength), percentage: z3, scalar: Z2, scale: T4 };
}
function x2(t6) {
...
function R3(t6) {
  const n15 = R(t6);
  return c(n15, { style: "unit", unitDisplay: "narrow", unit: "degree", signDisplay: n15 > 0 ? "never" : "exceptZero", ...b2(v3) });
}
function $3(t6) {
  return F2(t6, t6.rotationType, v3);
}
...
var I2 = " ";
var M4 = [];
for (const P5 of [",", "\\|", "\\s+"]) for (const t6 of ["\\.", ",", ""]) for (const n15 of ["", ",", "\\.", I2, "\\s+"]) P5 !== t6 && P5 !== n15 && t6 !== n15 && M4.push({ separator: P5, decimal: t6, thousands: n15, pattern: E3({ decimal: t6, thousands: n15, separator: P5 }) });
function Q(t6) {
  for (const { decimal: n15, thousands: e6, pattern: r4 } of M4) {
    r4.lastIndex = 0;
    const i6 = t6.match(r4);
    if (!i6) continue;
    const o4 = m(k3(i6[1], n15, e6)), l4 = m(k3(i6[2], n15, e6));
...
function G2(t6) {
  if (!t6 || null != m(t6) || !_4()) return null;
...
var S2 = class extends B {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-7BBOJ2KZ.js"), icon: () => import("./calcite-icon-J7CTACBF.js"), input: () => import("./calcite-input-QTCYTGXQ.js") });
  }
...
__decorate([e2("esri/core/t9n/Units"), m3()], S2.prototype, "_messagesUnits", void 0), __decorate([e2("esri/views/interactive/tooltip/t9n/Tooltip"), m3()], S2.prototype, "_messagesTooltip", void 0), __decorate([m3()], S2.prototype, "info", void 0), __decorate([m3()], S2.prototype, "tooltip", void 0), __decorate([m3()], S2.prototype, "_mode", void 0), __decorate([m3()], S2.prototype, "mode", null), __decorate([m3()], S2.prototype, "_displayUnits", null), __decorate([m3()], S2.prototype, "_inputUnitInfos", null), __decorate([m3()], S2.prototype, "_formatters", null), __decorate([m3()], S2.prototype, "fieldContext", null), __decorate([m3()], S2.prototype, "_renderedContent", null), __decorate([m3()], S2.prototype, "_renderedActions", null), __decorate([m3()], S2.prototype, "_renderedHelpMessage", null), __decorate([m3()], S2.prototype, "_defaultHelpMessage", null), S2 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContent")], S2);
var O2 = 20;

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentDrawCircle.js
var n6 = class extends S2 {
  _renderContent() {
    const { area: t6, radius: o4, xSize: s15, ySize: n15, visibleElements: a6 } = this.info, p6 = this._messagesTooltip.sketch, m6 = this._formatters;
    return n(i, null, a6.radius && null != o4 ? n(a4, { title: p6.radius, value: m6.length(o4) }) : null, a6.size && null != s15 && null != n15 ? n(a4, { title: p6.size, value: n(a5, { left: m6.length(s15), right: m6.length(n15) }) }) : null, a6.area ? n(a4, { title: p6.area, value: m6.area(t6) }) : null);
  }
};
...
var _6 = class extends B {
  constructor() {
    super(...arguments), this._input = null, this._lock = null, this._onLockClick = () => {
      ...
      t6.key === d5.discard && "input" === this.mode && this._input && this.context.onDiscard(this._input);
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-7BBOJ2KZ.js"), icon: () => import("./calcite-icon-J7CTACBF.js"), input: () => import("./calcite-input-QTCYTGXQ.js"), "input-message": () => import("./calcite-input-message-DNFUHDTB.js") });
  }
  render() {
...
__decorate([m3()], _6.prototype, "field", void 0), __decorate([m3()], _6.prototype, "context", void 0), __decorate([m3()], _6.prototype, "mode", void 0), __decorate([m3()], _6.prototype, "_input", void 0), __decorate([m3()], _6.prototype, "_lock", void 0), __decorate([m3()], _6.prototype, "_formattedValue", null), __decorate([m3()], _6.prototype, "_rawDisplayValue", null), __decorate([m3()], _6.prototype, "_suffix", null), __decorate([m3()], _6.prototype, "_title", null), __decorate([m3()], _6.prototype, "_messages", null), __decorate([m3()], _6.prototype, "_renderedLockButton", null), _6 = __decorate([a("esri.views.interactive.tooltip.components.TooltipEditableField")], _6);
var m5 = "—";
...
var p5 = class extends B {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-7BBOJ2KZ.js"), dropdown: () => import("./calcite-dropdown-H4VSYMUD.js"), "dropdown-item": () => import("./calcite-dropdown-item-Z6Z2HQKQ.js"), "dropdown-group": () => import("./calcite-dropdown-group-MUIQVPXG.js") });
  }
...
function l3(t6) {
  ...
  } }, n("calcite-button", { alignment: "end", appearance: "transparent", iconStart: e5[e6], kind: "neutral", label: i6, scale: "s", slot: "trigger", title: i6 }), n("calcite-dropdown-group", { selectionMode: "single" }, n("calcite-dropdown-item", { "data-mode": c7, "data-testid": "tooltip-direction-mode-relative", iconStart: e5.relative, key: "relative", selected: e6 === c7 }, (_c = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _c.relative), n("calcite-dropdown-item", { "data-mode": r4, "data-testid": "tooltip-direction-mode-absolute", iconStart: e5.absolute, key: "absolute", selected: e6 === r4 }, (_d = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _d.absolute)));
}
__decorate([e2("esri/views/interactive/tooltip/t9n/Tooltip"), m3()], p5.prototype, "messages", void 0), __decorate([m3()], p5.prototype, "sketchOptions", void 0), __decorate([m3()], p5.prototype, "visibleElements", void 0), p5 = __decorate([a("esri.views.interactive.tooltip.components.DrawHeaderActions")], p5);
...
var n9 = class extends S2 {
  _renderContent() {
    const { area: t6, xSize: o4, ySize: s15, visibleElements: n15 } = this.info, p6 = this._messagesTooltip.sketch, a6 = this._formatters;
    return n(i, null, n15.size && null != o4 && null != s15 ? n(a4, { title: p6.size, value: n(a5, { left: a6.length(o4), right: a6.length(s15) }) }) : null, n15.area ? n(a4, { title: p6.area, value: a6.area(t6) }) : null);
  }
};
...
var s14 = class extends S2 {
  _renderContent() {
    const { distance: t6, elevation: e6, area: l4, totalLength: s15, visibleElements: a6 } = this.info, n15 = this._messagesTooltip.sketch, p6 = this._formatters;
    return n(i, null, a6.distance ? n(a4, { title: n15.distance, value: p6.length(t6) }) : null, a6.elevation && null != (e6 == null ? void 0 : e6.actual) ? n(a4, { title: n15.elevation, value: p6.verticalLength(e6.actual) }) : null, a6.area && null != l4 ? n(a4, { title: n15.area, value: p6.area(l4) }) : null, a6.totalLength && null != s15 ? n(a4, { title: n15.totalLength, value: p6.length(s15) }) : null);
  }
};
...
var P3 = class extends l {
  ...
  initialize() {
    ...
    this.addHandles([l2(() => {
      ...
      s15.add(v4.base), s15.toggle(v4.rtl, n15), s15.toggle(v4.ltr, !n15), s15.toggle(v4.debug, i6), this.outerContainer.style.setProperty("--offset", `${o4}px`), s3(t7), x3(t7, e6);
...
__decorate([m3({ nonNullable: true })], P3.prototype, "view", void 0), __decorate([m3()], P3.prototype, "info", void 0), __decorate([m3()], P3.prototype, "options", void 0), __decorate([m3()], P3.prototype, "position", void 0), __decorate([m3()], P3.prototype, "content", void 0), __decorate([m3({ readOnly: true })], P3.prototype, "mode", null), __decorate([m3()], P3.prototype, "_focused", void 0), __decorate([m3({ readOnly: true })], P3.prototype, "focused", null), __decorate([m3({ readOnly: true })], P3.prototype, "outerContainer", void 0), __decorate([m3({ readOnly: true })], P3.prototype, "contentContainer", null), __decorate([m3({ readOnly: true })], P3.prototype, "effectivePlacement", null), __decorate([m3()], P3.prototype, "debug", void 0), __decorate([m3()], P3.prototype, "updating", null), __decorate([m3()], P3.prototype, "_lastPosition", void 0), __decorate([m3()], P3.prototype, "_screenPoint", null), __decorate([m3()], P3.prototype, "_rtl", void 0), __decorate([m3()], P3.prototype, "_effectiveOffset", null), __decorate([m3()], P3.prototype, "_outerContainerStyle", null), P3 = __decorate([a("esri.views.interactive.Tooltip")], P3);
...
function V2(t6, o4) {
  const e6 = t3(o4.vertexSpace), { scale: n15, orientation: l4 } = t6, { transform: a6 } = o4, s15 = T5(a6);
  e6 && null != s15 ? (l4.actual = c5(s15, "degrees", "arithmetic"), l4.visible = true) : (l4.actual = null, l4.visible = false), e6 ? (n15.actual = i3(G3(a6)), n15.visible = true) : (n15.actual = null, n15.visible = false);
}
function z4(t6, o4, e6) {
  if (!o4 || !t3(o4.vertexSpace)) return;
  const n15 = o4.transform ?? (o4.transform = new d4());
  D5(t6, n15, e6), P4(t6, n15, e6);
}
...
function P4(t6, o4, e6) {
  var _a;
  const n15 = (_a = t6.scale.actual) == null ? void 0 : _a.value, r4 = G3(o4);
...
function H2(t6, o4) {
  return !("key-down" !== t6.type || t6.key !== d5.enterInputMode || !o4 || !O4(o4.info)) && (o4.enterInputMode(), t6.preventDefault(), t6.stopPropagation(), true);
}
function O4(t6) {
...
__decorate([m3()], r3.prototype, "sketchOptions", void 0), __decorate([m3()], r3.prototype, "visibleElements", null), __decorate([m3()], r3.prototype, "helpMessage", void 0), __decorate([m3()], r3.prototype, "viewType", void 0), __decorate([m3()], r3.prototype, "allFields", null), __decorate([m3()], r3.prototype, "editableFields", null), r3 = __decorate([a("esri.views.interactive.tooltip.infos.SketchTooltipInfo")], r3);
...
//# sourceMappingURL=chunk-ZY3E4TDG.js.map

...
import {
  l as l6
} from "./chunk-R7AEQCGA.js";
import {
  j as j4
} from "./chunk-PHS5QSL2.js";
import "./chunk-W3Z2QLX4.js";
...
var Te = class extends a7(F(_2(l4(b(j2(t(l2(s6(o3(l(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-MD6OPC5C.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-QOPHQDLL.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-NKJFB7RX.js.map

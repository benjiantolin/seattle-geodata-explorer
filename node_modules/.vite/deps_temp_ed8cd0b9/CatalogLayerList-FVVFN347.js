...
var p = class extends l {
  ...
  initialize() {
    ...
    }, () => this._compileList(), h), a2(() => {
      var _a;
      return (_a = this.catalogLayer) == null ? void 0 : _a.dynamicGroupLayer.layers;
    }, "change", () => this._compileList()), l2(() => [this.listItemCreatedFunction, this.checkPublishStatusEnabled, this.listModeDisabled], () => this._recompileList())]);
  }
  destroy() {
...
var P = M = class extends s2(B) {
  ...
  async _createTableList(e5) {
    const { default: t3 } = await import("./TableList-5US66M3H.js"), { headingLevel: o, selectionMode: i3 } = this;
...
//# sourceMappingURL=CatalogLayerList-FVVFN347.js.map

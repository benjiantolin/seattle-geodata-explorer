...
var S = class extends p(l2(b(j(l(b2))))) {
  ...
  async queryElevation(e, r2) {
    const { query: t3 } = await import("./ElevationQuery-XGH2TVIR.js");
    return s2(r2), t3(this, e, r2);
  }
  async createElevationSampler(e, r2) {
    const { createSampler: t3 } = await import("./ElevationQuery-XGH2TVIR.js");
    return s2(r2), t3(this, e, r2);
  }
...
//# sourceMappingURL=ElevationLayer-DQ3MXXJ4.js.map

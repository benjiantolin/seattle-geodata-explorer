import {
  ...
  calciteSpacingSm,
  calciteSpacingXxs
} from "./chunk-LLEWDIJU.js";
import "./chunk-QWYJUWHW.js";
import "./chunk-LXP5ZYSZ.js";
import {
  syncHiddenFormInput
} from "./chunk-WYM7KF46.js";
import {
...
} from "./chunk-IH6L645S.js";
import {
  Validation
} from "./chunk-ZNL27HGK.js";
import {
  InternalLabel
} from "./chunk-2NP7P54B.js";
import "./chunk-Q7RMWARJ.js";
import "./chunk-DESE3BVM.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-6UQ7KG5D.js";
import {
  useFocusTrap
} from "./chunk-YWXOCNA6.js";
import {
  FloatingCSS,
  connectFloatingUI,
  ...
  hideFloatingUI,
  reposition
} from "./chunk-6ZEXEDYR.js";
import "./chunk-35DKD7C5.js";
import {
  isActivationKey,
  numberKeys
...
import {
  toggleOpenClose
} from "./chunk-ZDH34TJ5.js";
import "./chunk-SSDV2DEP.js";
import {
  keyed
} from "./chunk-7VZAGOPA.js";
import {
  HiddenFormInputSlot,
  connectForm,
  disconnectForm,
  ...
  submitForm
} from "./chunk-AWBVVFVA.js";
import {
  InteractiveContainer,
  updateHostInteraction
} from "./chunk-RDFW2HWH.js";
import {
  useSetFocus
} from "./chunk-RLDOWXOF.js";
import {
  getIconScale
} from "./chunk-WIJ7WJDB.js";
import "./chunk-VRDIC5MJ.js";
import "./chunk-3E7NMEGB.js";
import "./chunk-IXMCKFGG.js";
import {
  ...
  setRequestedIcon,
  toAriaBoolean
} from "./chunk-5A4CPHI4.js";
import "./chunk-GDVMWJXK.js";
import {
  useT9n
} from "./chunk-N3PXFSVT.js";
import {
  useWatchAttributes
} from "./chunk-UNGL64C3.js";
import {
  guid
...
var _DatePickerDay = class _DatePickerDay extends LitElement {
  ...
  render() {
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html`<div aria-hidden=true class=${safeClassMap(CSS2.dayWrapper)}><span class=${safeClassMap(CSS2.day)}><span class=${safeClassMap(CSS2.text)}>${formattedDay}</span></span></div>` });
  }
};
...
var _DatePickerMonthHeader = class _DatePickerMonthHeader extends LitElement {
  ...
  render() {
    return html`<div class=${safeClassMap(CSS3.header)}>${this.renderContent()}</div>`;
  }
  renderContent() {
    ...
    return html`${this.position && html`<div class=${safeClassMap({ [CSS3.chevronContainer]: true })}>${this.position === "start" && this.renderChevron("left") || ""}</div>` || ""}<div class=${safeClassMap({
      [CSS3.monthYearContainer]: true,
      [CSS3.rangeCalendar]: !!this.position
    })}>${this.renderMonthYearContainer(reverse)}</div>${!this.position && html`<div class=${safeClassMap({ [CSS3.chevronContainer]: true })}>${this.renderChevron("left")}</div>` || ""}<div class=${safeClassMap({ [CSS3.chevronContainer]: true })}>${this.position !== "start" && this.renderChevron("right") || ""}</div>`;
  }
  ...
  renderMonthPicker() {
    ...
    return html`<calcite-select class=${safeClassMap(CSS3.monthPicker)} .label=${this.messages.monthMenu} @calciteSelectChange=${this.handleMonthChange} width=auto ${ref(this.monthPickerRef)}>${monthData.map((month, index) => {
  ...
  renderYearInput() {
    ...
    return html`<span class=${safeClassMap(CSS3.yearContainer)}><input .ariaLabel=${this.messages.year} class=${safeClassMap({ [CSS3.year]: true })} inputmode=numeric maxlength=4 minlength=1 @change=${this.onYearChange} @input=${this.onYearInput} @keydown=${this.onYearKey} pattern=\\d* type=text .value=${live(localizedYear ?? "")} ${ref(this.yearInputRef)}>${suffix && html`<span class=${safeClassMap(CSS3.suffix)}>${suffix}</span>` || ""}</span>`;
  }
...
_DatePickerMonthHeader.styles = styles3;
...
var _DatePickerMonth = class _DatePickerMonth extends LitElement {
  ...
  render() {
    ...
    return html`<div class=${safeClassMap({ [CSS4.calendarContainer]: true })} role=grid>${this.renderCalendar(adjustedWeekDays, days)}${this.range && this.calendars === 2 && this.renderCalendar(adjustedWeekDays, nextMonthDays, true) || ""}</div>`;
  }
  renderDateDay({ active, currentMonth, currentDay, date, day, dayInWeek }, key) {
    const isDateInRange = inRange(date, this.min, this.max);
    return keyed(key, html`<div class=${safeClassMap({ [CSS4.dayContainer]: true })} role=gridcell><calcite-date-picker-day .active=${active} class=${safeClassMap({
      [CSS4.currentDay]: currentDay,
      [CSS4.insideRangeHover]: this.isHoverInRange(),
      [CSS4.outsideRangeHover]: !this.isHoverInRange(),
      [CSS4.noncurrent]: this.range && !currentMonth
  ...
  renderCalendar(weekDays, days, isEndCalendar = false) {
    return html`<div class=${safeClassMap({
      [CSS4.calendar]: true,
      [CSS4.calendarStart]: !isEndCalendar
  ...
  renderMonthCalendar(weekDays, days, isEndCalendar = false) {
    ...
    return html`<div class=${safeClassMap({ [CSS4.month]: true })} @keydown=${this.keyDownHandler}><div class=${safeClassMap({ [CSS4.weekHeaderContainer]: true })} role=row>${weekDays.map((weekday) => html`<span class=${safeClassMap({ [CSS4.weekHeader]: true })} role=columnheader>${weekday}</span>`)}</div><div class=${safeClassMap({ [CSS4.weekDays]: true })} role=row>${days.map((day, index) => this.renderDateDay(day, isEndCalendar ? endCalendarStartIndex + index : index))}</div></div>`;
  }
};
...
_DatePickerMonth.styles = styles4;
...
var _DatePicker = class _DatePicker extends LitElement {
  ...
  render() {
    ...
    return html`<div aria-hidden class=${safeClassMap(CSS5.container)} tabindex=-1>${this.renderMonth(startCalendarActiveDate, this.maxAsDate, minDate, date, endDate)}</div>`;
  }
...
var _InputDatePicker = class _InputDatePicker extends LitElement {
  constructor() {
    ...
    this.dialogId = IDS2.dialog(guid());
    ...
    this.placeholderTextId = IDS2.placeholder(guid());
  ...
  onInputWrapperClick(event) {
    ...
    const wasToggleClicked = path.find((el) => {
      var _a;
      return (_a = el.classList) == null ? void 0 : _a.contains(CSS6.toggleIcon);
    });
    if (wasToggleClicked) {
  ...
  render() {
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html`${this.labelText && InternalLabel({ labelText: this.labelText, onClick: this.onLabelClick, required: this.required, tooltipText: this.messages.required }) || ""}<div class=${safeClassMap(CSS6.container)}><div aria-label=${getLabelText(this) ?? nothing} .ariaRequired=${this.required} class=${safeClassMap(CSS6.inputContainer)} role=group><div class=${safeClassMap(CSS6.inputWrapper)} data-position=${POSITION.start} @click=${this.onInputWrapperClick} @pointerdown=${this.onInputWrapperPointerDown} ${ref(this.setStartWrapper)}><calcite-input-text aria-controls=${this.dialogId ?? nothing} aria-describedby=${this.placeholderTextId ?? nothing} aria-errormessage=${IDS2.validationMessage} aria-autocomplete=none .ariaExpanded=${this.open} aria-haspopup=dialog .ariaInvalid=${this.status === "invalid"} class=${safeClassMap({
      [CSS6.input]: true,
      [CSS6.inputNoBottomBorder]: this.layout === "vertical" && this.range,
      [CSS6.inputNoRightBorder]: this.range
    })} .disabled=${disabled} .icon=${ICONS.calendar} .label=${this.range ? this.messages.startDate : this.messages.date} @calciteInputTextInput=${this.calciteInternalInputInputHandler} @calciteInternalInputTextBlur=${this.calciteInternalInputBlurHandler} @calciteInternalInputTextFocus=${this.startInputFocus} .placeholder=${(_a = this.localeData) == null ? void 0 : _a.placeholder} .readOnly=${readOnly} role=combobox .scale=${this.scale} .status=${this.status} ${ref(this.startInputRef)}></calcite-input-text>${!this.readOnly && !this.range && this.renderToggleIcon(this.open && this.focusedInput === "start") || ""}<span aria-hidden=true class=${safeClassMap(CSS6.assistiveText)} id=${this.placeholderTextId ?? nothing}>${messages.dateFormat.replace("{format}", (_b = this.localeData) == null ? void 0 : _b.placeholder)}</span></div><div .ariaHidden=${!this.open} .ariaLabel=${messages.chooseDate} aria-live=polite aria-modal=true class=${safeClassMap(CSS6.menu)} id=${this.dialogId ?? nothing} role=dialog ${ref(this.setFloatingEl)}><div class=${safeClassMap({
      [CSS6.calendarWrapper]: true,
      [FloatingCSS.animation]: true,
      [FloatingCSS.animationActive]: this.open
    })} ${ref(this.setTransitionEl)}><calcite-date-picker .activeDate=${this.datePickerActiveDate} .activeRange=${this.focusedInput} .calendars=${this.calendars} .headingLevel=${this.headingLevel} .layout=${this.layout} .max=${this.max} .maxAsDate=${this.maxAsDate} .messageOverrides=${this.messageOverrides} .min=${this.min} .minAsDate=${this.minAsDate} .monthStyle=${this.monthStyle} .numberingSystem=${numberingSystem} @calciteDatePickerChange=${this.handleDateChange} @calciteDatePickerRangeChange=${this.handleDateRangeChange} .proximitySelectionDisabled=${this.proximitySelectionDisabled} .range=${this.range} .scale=${this.scale} tabindex=${(this.open ? void 0 : -1) ?? nothing} .valueAsDate=${this.valueAsDate} ${ref(this.setDatePickerRef)}></calcite-date-picker></div></div>${this.range && html`<div class=${safeClassMap(CSS6.dividerContainer)}><div class=${safeClassMap(CSS6.divider)}></div></div>` || ""}${this.range && html`<div class=${safeClassMap(CSS6.inputWrapper)} data-position=${POSITION.end} @click=${this.onInputWrapperClick} @pointerdown=${this.onInputWrapperPointerDown} ${ref(this.setEndWrapper)}><calcite-input-text aria-controls=${this.dialogId ?? nothing} aria-autocomplete=none .ariaExpanded=${this.open} aria-haspopup=dialog class=${safeClassMap({
      [CSS6.input]: true,
      [CSS6.inputNoTopBorder]: this.layout === "vertical" && this.range,
      [CSS6.inputNoLeftBorder]: this.layout === "horizontal" && this.range,
      [CSS6.inputNoRightBorder]: this.layout === "vertical" && this.range
    })} .disabled=${disabled} .icon=${ICONS.calendar} .label=${this.messages.endDate} @calciteInputTextInput=${this.calciteInternalInputInputHandler} @calciteInternalInputTextBlur=${this.calciteInternalInputBlurHandler} @calciteInternalInputTextFocus=${this.endInputFocus} .placeholder=${(_c = this.localeData) == null ? void 0 : _c.placeholder} .readOnly=${readOnly} role=combobox .scale=${this.scale} .status=${this.status} ${ref(this.endInputRef)}></calcite-input-text>${!this.readOnly && this.layout === "horizontal" && this.renderToggleIcon(this.open) || ""}</div>` || ""}</div>${this.range && this.layout === "vertical" && html`<div class=${safeClassMap(CSS6.verticalChevronContainer)}><calcite-icon .icon=${this.open ? ICONS.chevronUp : ICONS.chevronDown} .scale=${getIconScale(this.scale)}></calcite-icon></div>` || ""}</div>${HiddenFormInputSlot({ component: this })}${this.validationMessage && this.status === "invalid" ? Validation({ icon: this.validationIcon, id: IDS2.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}` });
  }
  renderToggleIcon(open) {
    return html`<span class=${safeClassMap(CSS6.toggleIcon)} tabindex=-1><calcite-icon class=${safeClassMap(CSS6.chevronIcon)} .icon=${open ? ICONS.chevronUp : ICONS.chevronDown} .scale=${getIconScale(this.scale)}></calcite-icon></span>`;
  }
};
...
_InputDatePicker.styles = styles6;
...
@esri/calcite-components/dist/components/calcite-input-date-picker/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=calcite-input-date-picker-DOYVYAWG.js.map

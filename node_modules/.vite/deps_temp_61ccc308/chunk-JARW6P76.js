...
function x2(e6, o4, s4) {
  ...
  if (!t(c10)) return;
  const f8 = h2, m8 = b3;
  if (!i4(o4, m8, e6.spatialReference)) return void k(g2(), o4.spatialReference, e6.spatialReference, b2);
  if (!i4(s4, f8, e6.spatialReference)) {
    const t4 = e6.origin;
    return f8[0] = t4.x, f8[1] = t4.y, f8[2] = t4.z, void k(g2(), s4.spatialReference, e6.spatialReference, b2);
  }
  const u9 = c4(A3, m8, f8);
  c10.origin = u3(n3(), c10.origin, u9);
}
function v(e6, t4, r4) {
  const i6 = r(r4.x, r4.y, r4.z ?? 0), n6 = q(e6, new i3({ origin: i6 }));
  if (!n6) return;
  const a9 = r(t4.x, t4.y, t4.z ?? 0), f8 = q({ vertexAttributes: n6, spatialReference: e6.spatialReference, vertexSpace: new i3({ origin: a9 }) }, i2.absolute);
  if (!f8) return;
...
function R(e6, t4, r4) {
  const i6 = h2, o4 = b3;
  if (i4(t4, o4, e6.spatialReference)) {
    if (!i4(r4, i6, e6.spatialReference)) {
      const t5 = e6.origin;
      return i6[0] = t5.x, i6[1] = t5.y, i6[2] = t5.z, void k(g2(), r4.spatialReference, e6.spatialReference, b2);
    }
    j2(e6.vertexAttributes.position, o4, i6), e6.vertexAttributesChanged();
  } else k(g2(), t4.spatialReference, e6.spatialReference, b2);
}
...
function l4(r4) {
  ...
  if (t(l5) && r4.transform && r3(g5, g5, r4.transform.localMatrix), "georeferenced" === l5.type) {
    const r5 = l5.origin;
    return r5 && a6(g5, g5, r5), c2(m4(g5), f8);
  }
  const y3 = a7(f8), B2 = l5.origin;
  if (!J(y3, f8)) {
    const [r5, t4, e6] = B2;
    return new z({ xmin: r5, ymin: t4, zmin: e6, xmax: r5, ymax: t4, zmax: e6, spatialReference: f8 });
  }
  return f5(f8, B2, x3, y3), r3(g5, g5, x3), o(g5, y3, 0, g5, f8, 0), c2(m4(g5), f8);
}
var x3 = e2();
var u6 = e3(24);
...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-4QRFZBC7.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
var a8 = class extends f {
  ...
  getExternalSourcesOnService(e6) {
    return this.externalSources.items.filter((r4) => f4(r4, e6));
  }
...
function G2(t4, e6, r4) {
  ...
  else if (!P3(d5, r4, t4)) return void k(O4(), r4.spatialReference, f8, b2);
  b(Z, w(e6), z3(e6));
...
function H(t4, r4, o4) {
  const i6 = t4.spatialReference, n6 = a7(i6), s4 = Y;
  if (!i4(o4, s4, n6) && (k(O4(), o4.spatialReference, n6, "Falling back to mesh origin"), !i4(t4.origin, s4, n6))) return void k(O4(), t4.origin.spatialReference, n6);
  ...
  f5(n6, s4, W, n6), n2(X, W);
  const g5 = Q2;
  N(w(Q2), w(r4), X), g5[3] = r4[3], V(a9, i6, m8, n6) && (null == l5 || null == f8 || w2(l5, a9, i6, m8, n6, f8)) && (null == c10 || null == p6 || F(c10, a9, i6, m8, n6, p6)) ? (J2(m8, g5, 3, s4), x(m8, n6, a9, i6) && (null == l5 || null == f8 || (J2(f8, g5, 3), M(f8, a9, i6, m8, n6, l5))) && (null == c10 || null == p6 || (J2(p6, g5, 4), P2(p6, a9, i6, m8, n6, c10))) ? t4.vertexAttributesChanged() : k(O4(), n6, i6)) : k(O4(), i6, n6);
}
function I2(t4, e6, r4) {
  const o4 = Y;
  if (!i4(r4, o4, t4.spatialReference)) {
    const e7 = t4.origin;
    return o4[0] = e7.x, o4[1] = e7.y, o4[2] = e7.z, void k(O4(), r4.spatialReference, t4.spatialReference, b2);
  }
...
function z4(e6, s4, f8) {
  ...
  else if (!P3(F3, f8, e6)) return void k(k2(), f8.spatialReference, h5, b2);
  const S2 = o2(V2, s4, s4, s4), U2 = D(D2, r2, a4, S2, F3), { localMatrix: q3 } = x6, z5 = c3(D2, U2, q3);
...
function L(e6, t4, r4) {
  const o4 = e6.spatialReference, i6 = a7(o4), n6 = E2;
  if (!i4(r4, n6, i6) && (k(k2(), r4.spatialReference, i6, "Falling back to mesh origin"), !i4(e6.origin, n6, i6))) return void k(k2(), e6.origin.spatialReference, i6);
  ...
  V(s4, o4, c10, i6) && (null == a9 || null == f8 || w2(a9, s4, o4, c10, i6, f8)) && (null == l5 || null == m8 || F(l5, s4, o4, c10, i6, m8)) ? (P4(c10, t4, n6), x(c10, i6, s4, o4) && (null == a9 || null == f8 || M(f8, s4, o4, c10, i6, a9)) && (null == l5 || null == m8 || P2(m8, s4, o4, c10, i6, l5)) ? e6.vertexAttributesChanged() : k(k2(), i6, o4)) : k(k2(), o4, i6);
}
function M4(e6, t4, r4) {
  const o4 = E2;
  if (!i4(r4, o4, e6.spatialReference)) {
    const t5 = e6.origin;
    return o4[0] = t5.x, o4[1] = t5.y, o4[2] = t5.z, void k(k2(), r4.spatialReference, e6.spatialReference, b2);
  }
...
var Q3;
var X2 = { base: null, key: "type", defaultKeyValue: "georeferenced", typeMap: { georeferenced: i2, local: i3 } };
var Y2 = Q3 = class extends l(p2(m3(c))) {
  constructor(e6) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-V2P34XGL.js"), this.load(e6)]);
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-4QRFZBC7.js"), r4);
...
__decorate([m({ type: [h], json: { write: true } })], Y2.prototype, "components", void 0), __decorate([m({ nonNullable: true, types: X2, constructOnly: true, json: { write: true }, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.vertexSpace) ?? e6.clone(t4);
} })], Y2.prototype, "vertexSpace", void 0), __decorate([m({ type: d2, clonable: (e6, t4) => {
  const r4 = n4(t4);
  return r4 && "transform" in r4 ? r4.transform : (e6 == null ? void 0 : e6.clone()) ?? e6;
}, json: { write: true } })], Y2.prototype, "transform", void 0), __decorate([m({ constructOnly: true, type: a8, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.metadata) ?? e6.clone();
} })], Y2.prototype, "metadata", void 0), __decorate([m()], Y2.prototype, "hasExtent", null), __decorate([m()], Y2.prototype, "_transformedExtent", null), __decorate([m()], Y2.prototype, "_untransformedBounds", null), __decorate([m()], Y2.prototype, "origin", null), __decorate([m({ readOnly: true, json: { read: false } })], Y2.prototype, "extent", null), __decorate([m({ readOnly: true, json: { read: false, write: true, default: true } })], Y2.prototype, "hasZ", void 0), __decorate([m({ readOnly: true, json: { read: false, write: true, default: false } })], Y2.prototype, "hasM", void 0), __decorate([m({ type: c7, nonNullable: true, json: { write: true }, clonable: (e6, t4) => {
  var _a;
  return ((_a = n4(t4)) == null ? void 0 : _a.vertexAttributes) ?? e6.clone(t4);
} })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q3 = __decorate([a("esri.geometry.Mesh")], Y2);
var $ = j();

export {
  Y2 as Y
};
//# sourceMappingURL=chunk-JARW6P76.js.map

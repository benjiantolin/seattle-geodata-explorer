...
var f4 = { key: "type", base: a5, errorContext: "renderer", typeMap: { simple: p4, "unique-value": $, "class-breaks": j2 } };
var i2 = s2({ types: f4 });
function c3(e3, r2) {
  var _a;
...
var X = class extends l5(l(s3(u2))) {
  constructor(e3) {
...
var ue = class extends V(a4(F2(p2(l8(t(f3(l7(b(j3(l5(s5(o3(l(b4)))))))))))))) {
  constructor(...e3) {
    super(...e3), this._sublayerLookup = /* @__PURE__ */ new Map(), this.fields = null, this.fieldsIndex = null, this.outFields = null, this.sublayers = new (O.ofType(X))(), this.useUniqueColorsForSublayers = true, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Table"]), this.timeInfo = null, this.title = "Layer", this.type = "subtype-group", this._debouncedSaveOperations = L(async (e4, t3, r2) => {
      const { save: s7, saveAs: i4 } = await import("./featureLayerUtils-FB47YSUD.js");
      switch (e4) {
        case 0:
          return s7(this, t3);
        case 1:
    ...
    }), this.addHandles(l2(() => this.sublayers, (e4, t3) => this._handleSublayersChange(e4, t3), U));
  }
  destroy() {
    var _a;
  ...
  async createGraphicsSource(e3) {
    const { default: t3 } = await p(import("./FeatureLayerSource-ILHCGZAU.js"), e3);
...
//# sourceMappingURL=SubtypeGroupLayer-SH7O2QUK.js.map

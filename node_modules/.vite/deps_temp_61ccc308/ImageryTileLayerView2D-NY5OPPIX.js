...
import {
  ...
  i as i6,
  u as u3
} from "./chunk-IRRPBUHO.js";
import {
  h as h4
} from "./chunk-LAGO6HXE.js";
import {
  $,
  I,
  me,
...
var m5 = class extends e4 {
  ...
  setTransform(t10) {
    ...
    M(a10, a10, r3(o6, n7)), M(a10, a10, r3(d8 / 2, _8 / 2)), h2(a10, a10, -x6), M(a10, a10, r3(-d8 / 2, -_8 / 2)), b2(a10, a10, r3(d8, _8)), i4(this.transforms.displayViewScreenMat3, t10.displayViewMat3, a10);
  }
...
var S7 = class extends b {
  ...
  attach() {
    const e8 = t2();
    this._maxIndexedColormapSize = 4 * (e8.maxTextureSize || 4096), this._initializeTileInfo(), this._tileInfoView = new h6(this.layerView.tileInfo, this.layerView.fullExtent);
    ...
    this._tileStrategy = new r4({ cachePolicy: "purge", acquireTile: (e9) => this.acquireTile(e9), releaseTile: (e9) => this.releaseTile(e9), cacheSize: i15, tileInfoView: this._tileInfoView }), this._updateBlockCacheRegistry();
  }
  detach() {
  ...
  async updateTileSource(e8, t10) {
    ...
    if (t(f10)) {
      ...
      if (t11) {
        ...
        r16 && (d8.mask = h4({ srcExtent: r16, geometry: t11, size: [d8.width, d8.height] }));
      }
    }
...
//# sourceMappingURL=ImageryTileLayerView2D-NY5OPPIX.js.map

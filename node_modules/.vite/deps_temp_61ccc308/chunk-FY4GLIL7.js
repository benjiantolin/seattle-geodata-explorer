...
import {
  c as c3,
  u
} from "./chunk-RKUS3E5D.js";
import {
  c as c2
} from "./chunk-54TKK2NL.js";
import {
  L,
  R
...
var v = class extends g2 {
  constructor(t2, r2) {
    ...
    const s = n();
    g(s, this.tangentFrameForwardWS, P2(e3, this.tangentFrameForwardWS)), c(this.localFrameRightWS, e3, s), A(this.localFrameRightWS, this.localFrameRightWS), _2(this.localFrameUpWS, this.tangentFrameForwardWS, this.localFrameRightWS), R(this.worldToLocalTransform, this.localFrameRightWS, this.tangentFrameRightWS), L(this.localToWorldTransform, this.worldToLocalTransform);
  }
  get doUnnormalization() {
...
function k(t2, e3, o, r2) {
  ...
  let h3 = 0;
  if (p(e3.spatialReference)) h3 = m3 * c2(u4, f3);
  else {
...
//# sourceMappingURL=chunk-FY4GLIL7.js.map

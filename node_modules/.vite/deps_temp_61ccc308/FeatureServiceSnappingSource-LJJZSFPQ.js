import {
  i as i3,
  o as o4
} from "./chunk-K6QUELIM.js";
import "./chunk-6X2X2SPG.js";
...
var d3 = class extends b {
  constructor(e5) {
    super(e5), this.updating = false, this.enablePolygons = true, this.enableLabels = true, this._polygons = /* @__PURE__ */ new Map(), this._labels = /* @__PURE__ */ new Map(), this._symbols = u4.map((e6) => new m3({ color: [e6[0], e6[1], e6[2], 0.6], outline: { color: "black", width: 1 } })), this._enabled = true;
  }
  initialize() {
    this.update();
  }
...
var O2 = class extends b {
  ...
  get configuration() {
    ...
    return this._layerView && "effectiveDisplayFilter" in this._layerView && (s2.where = l2(s2.where, (_a = this._layerView.effectiveDisplayFilter) == null ? void 0 : _a.where)), { filter: s2, customParameters: t3 ? { ...i4, token: t3 } : i4, viewType: r2 };
  }
  get availability() {
    var _a;
  ...
  _getOrLoadWhereFields(e5, t3) {
    ...
    if (!this._loadWhereModuleTask && !r2) {
      const e6 = d(async () => {
        const e7 = await import("./WhereClause-7WKPLVXL.js");
...
//# sourceMappingURL=FeatureServiceSnappingSource-LJJZSFPQ.js.map

...
import {
  U as U2,
  p as p2
} from "./chunk-EINLZVIV.js";
import {
  e
} from "./chunk-KKO4Z4UN.js";
import {
  o as o2
...
function L(e2) {
  ...
  return o4(e2, { BoundingBox: (e3) => {
    ...
    const i2 = e3.getAttribute("crs").toLowerCase(), n3 = N2(i2), l5 = i2.includes("epsg") && o3(n3.wkid);
    let r3, a4, c, u2;
...
function F(e2, t3) {
  const i2 = N2(t3), [n3, r3] = M("TopLeftCorner", e2).split(" ").map((e3) => parseFloat(e3)), s3 = t3.includes("epsg") && o3(i2.wkid);
...
//# sourceMappingURL=WMTSLayer-R65XSZUH.js.map

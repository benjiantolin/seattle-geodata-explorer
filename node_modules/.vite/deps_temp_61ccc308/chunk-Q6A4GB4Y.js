...
var a7 = class {
  ...
  async loadDependencies() {
    for (const { effect: e9 } of this.effectInfos || []) await l4(e9);
  }
...
var l11 = { createComputedParams: (t4) => t4, optionalAttributes: s14.optionalAttributes, attributes: { ...s14.attributes, bitset: { count: 1, type: R.UNSIGNED_BYTE, pack: n9 }, width: { count: 1, type: R.HALF_FLOAT, pack: (t4) => p5(t4).width }, height: { count: 1, type: R.HALF_FLOAT, pack: (t4) => p5(t4).height }, offset: { count: 2, type: R.HALF_FLOAT, pack: ({ offsetX: e9, offsetY: o16 }) => [u(e9), -u(o16)] }, scale: { count: 2, type: R.UNSIGNED_BYTE, packPrecisionFactor: 16, pack: ({ scaleX: t4, scaleY: e9 }) => [t4, e9] }, angle: { count: 1, type: R.UNSIGNED_BYTE, pack: ({ angle: t4 }) => l2(t4) } } };
...
var i11 = class {
  constructor(i12) {
    ...
    if (this.offsetX = o16, this.offsetY = e9, this.postAngle = f9, this.fontSize = Math.min(h9, s16), this.haloSize = n12 ?? 0, this.outlineSize = l15 ?? 0, this.transforms = a14, a14 && a14.infos.length > 1) {
      const i13 = q(h9, f9, false, o16, e9, a14, false);
...
var E2 = class extends a7 {
  ...
  _getShaping(o16) {
    ...
    const s19 = u(i12.fontSize), n12 = u(i12.offsetX), p8 = u(i12.offsetY), m7 = r(u(r12.lineWidth), It, Jt), d5 = l3 * r(r12.lineHeightRatio, 0.25, 4);
    return z(r12.glyphs, { scale: s19 / q2, angle: i12.postAngle, xOffset: n12, yOffset: p8, horizontalAlignment: r12.horizontalAlignment, verticalAlignment: o16 || r12.verticalAlignment, maxLineWidth: m7, lineHeight: d5, decoration: r12.decoration, borderLineSizePx: u(r12.boxBorderLineSize), hasBackground: !!r12.boxBackgroundColor, useCIMAngleBehavior: r12.useCIMAngleBehavior });
  }
...
var o14 = class _o {
  ...
  static fromComplexMeshParams(i12) {
    ...
    if (r12 && r12.infos.length > 0) {
      const t4 = q(n12, l15, Y, p8, g6, r12);
...
//# sourceMappingURL=chunk-Q6A4GB4Y.js.map

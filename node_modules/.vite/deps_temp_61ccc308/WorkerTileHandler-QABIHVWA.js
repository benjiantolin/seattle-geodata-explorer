  ...
  static addDecoration(t8, e5) {
    ...
    for (let n6 = 1; n6 < i4; n6++) {
      ...
      if (i5.y !== h5) {
        ...
        t8.push({ codePoint: 0, x: c4, y: h5 + e5 - o5, vertical: false, glyphMosaicItem: { sdf: true, rect: new t4(4, 0, 4, 8), metrics: { width: l5 - c4, height: 2 + 2 * o5, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } }), h5 = i5.y, c4 = i5.x + i5.glyphMosaicItem.metrics.left;
      }
    }
    const l4 = t8[i4 - 1].x + t8[i4 - 1].glyphMosaicItem.metrics.left + t8[i4 - 1].glyphMosaicItem.metrics.width;
    t8.push({ codePoint: 0, x: c4, y: h5 + e5 - o5, vertical: false, glyphMosaicItem: { sdf: true, rect: new t4(4, 0, 4, 8), metrics: { width: l4 - c4, height: 2 + 2 * o5, left: 0, top: 0, advance: 0 }, page: 0, code: 0 } });
  }
...
var f2 = class {
  ...
  _placeGlyph(t8, i4, o5, h5, r7, c4, g, m3, x2) {
    let d4 = c4;
    const w2 = d4 < 0 ? a2(t8.angle + o, e2) : t8.angle;
    let y3 = 0;
    o5 < 0 && (d4 *= -1, o5 *= -1, y3 = o), d4 > 0 && ++r7;
    let f3 = new i(t8.x, t8.y), u3 = h5[r7], b = r;
    if (h5.length <= r7) return b;
    for (; ; ) {
      const e5 = u3.x - f3.x, t9 = u3.y - f3.y, n6 = Math.sqrt(e5 * e5 + t9 * t9), s4 = Math.max(o5 / n6, i4), c5 = e5 / n6, I = t9 / n6, T2 = a2(Math.atan2(I, c5) + y3, e2);
...
var o3 = class extends t3 {
  constructor(t8) {
    super(t8);
  }
  add(t8, o5, r7, u3, h5, a6, n6, d4, e5, p3, i4, c4) {
    const M = this.array;
    let l4 = t3.i1616to32(t8, o5);
    M.push(l4);
    const m3 = 31;
    l4 = t3.i8888to32(Math.round(m3 * r7), Math.round(m3 * u3), Math.round(m3 * h5), Math.round(m3 * a6)), M.push(l4), l4 = t3.i8888to32(Math.round(m3 * n6), Math.round(m3 * d4), Math.round(m3 * e5), Math.round(m3 * p3)), M.push(l4), l4 = t3.i1616to32(i4, 0), M.push(l4), c4 && M.push(...c4);
  }
};
var r3 = class extends t3 {
  ...
  add(t8, o5, r7) {
    const u3 = this.array;
    u3.push(t3.i1616to32(t8, o5)), r7 && u3.push(...r7);
  }
};
var u = class extends t3 {
  constructor(t8) {
    super(t8);
  }
  add(t8, o5, r7, u3, h5, a6, n6) {
    const d4 = this.array, e5 = this.index;
    let p3 = t3.i1616to32(t8, o5);
    d4.push(p3);
    const i4 = 15;
    return p3 = t3.i8888to32(Math.round(i4 * r7), Math.round(i4 * u3), h5, a6), d4.push(p3), n6 && d4.push(...n6), e5;
  }
};
var h4 = class extends t3 {
  ...
  add(o5, r7, u3, h5, a6, n6, d4, e5, p3, i4, c4, M) {
    const l4 = this.array;
    let m3 = t3.i1616to32(o5, r7);
    l4.push(m3), m3 = t3.i1616to32(Math.round(8 * u3), Math.round(8 * h5)), l4.push(m3), m3 = t3.i8888to32(a6 / 4, n6 / 4, e5, p3), l4.push(m3), m3 = t3.i8888to32(0, f(d4), 10 * i4, Math.min(10 * c4, 255)), l4.push(m3), M && l4.push(...M);
  }
};
var a5 = class extends t3 {
  ...
  add(t8, o5, r7, u3, h5) {
    const a6 = this.array, n6 = t3.i1616to32(2 * t8 + r7, 2 * o5 + u3);
...
var e4 = class {
  constructor(e5, s4, r7) {
    this.layerExtent = t2, this._features = [], this.layer = e5, this.zoom = s4, this._spriteInfo = r7, this._filter = e5.getFeatureFilter();
  }
  pushFeature(t8) {
...
var n4 = class _n extends e4 {
  ...
  _processFill(r7, l4, n6, s4, o5) {
    ...
    const h5 = e(d4, a6, 2);
    if (s4 && e.deviation(d4, a6, 2, h5) > 0) {
...
var _u = class _u extends e4 {
  ...
  processFeatures(e5) {
    ...
    for (const o5 of this._symbolFeatures) {
      ...
      for (let t8 of o5.geometry) {
        ...
        for (const i4 of s5) {
          if (i4.x < 0 || i4.x > t2 || i4.y < 0 || i4.y > t2) continue;
  ...
  static _pushCentroid(e5, t8) {
    const n6 = 0, s4 = 0, i4 = t2, o5 = t2, r7 = t8.length - 1;
...
//# sourceMappingURL=WorkerTileHandler-QABIHVWA.js.map

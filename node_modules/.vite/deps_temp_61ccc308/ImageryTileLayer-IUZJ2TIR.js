...
import {
  ...
  t as t4,
  u as u3
} from "./chunk-LK7POITB.js";
import "./chunk-IRRPBUHO.js";
import {
  T,
  w
} from "./chunk-TSHHVJ4G.js";
import "./chunk-LAGO6HXE.js";
import "./chunk-RQIHF4E4.js";
import {
  c as c4,
  f as f4,
  o as o3
...
var f6 = class extends X {
  ...
  async _buildMDimStats(t7, e3, s7) {
    for (let i8 = 0; i8 < e3.variables.length; i8++) {
      ...
      }), a2 = C(o6, e3), n5 = null == a2 ? null : t7[a2];
      if (null == n5) continue;
...
function c6(e3) {
  ...
  const r6 = o4(t7, "PolynomialOrder") ?? 1, a2 = u3(t7, "CoeffX/Double"), c7 = u3(t7, "CoeffY/Double"), m9 = u3(t7, "InverseCoeffX/Double"), p6 = u3(t7, "InverseCoeffY/Double"), S4 = u6(a2, c7), C3 = u6(m9, p6);
  return { spatialReference: n5, transform: S4 && C3 && S4.length && C3.length ? new u4({ spatialReference: n5, polynomialOrder: r6, forwardCoefficients: S4, inverseCoefficients: C3 }) : null };
}
function m8(e3) {
  var _a;
  ...
  t7.documentElement.childNodes.forEach((e3) => {
    if (1 === e3.nodeType) {
      if (i6(e3, "SRS")) {
        ...
        n2(e3, "MDI").forEach((e4) => n5.metadata[e4.getAttribute("key")] = t4(e4));
      }
...
var h2 = class extends X {
  ...
  async _open(t7) {
    ...
    const l7 = !e3;
    l7 && (e3 = new f2({ wkid: 3857 })), (o6 == null ? void 0 : o6.length) && null == r6 && (r6 = v4(o6));
  ...
  async _fetchAuxiliaryData(t7) {
    ...
    if (!f7.transform) {
      ...
      f7.transform = 6 === (t8 == null ? void 0 : t8.length) ? new u4({ forwardCoefficients: [t8[4], t8[5], t8[0], -t8[1], t8[2], -t8[3]] }) : null;
    }
    return f7;
  }
};
...
var g3 = class extends X {
  ...
  async fetchRawTile(e3, t7, i8, s7 = {}) {
    ...
    return v3(d7, { x: j5, y: _2 }, { width: O - j5, height: R2 - _2 }), d7;
  }
  getSliceIndex(e3) {
...
function S2(e3) {
  ...
  t7.xmin > -1 && t7.xmax > 181 && (i8 == null ? void 0 : i8.wkid) && i8.isGeographic && (e3.nativeExtent = e3.extent, e3.transform = new n3(), e3.extent = e3.transform.forwardTransform(t7));
}
...
var b4 = class extends X {
  ...
  async _open(t7) {
    ...
    if (!a2.includes("aux.xml") && !i8) {
      ...
      null != e4 && (s7.statistics = e4.statistics ?? s7.statistics, s7.histograms = e4.histograms, e4.histograms && null == s7.statistics && (s7.statistics = v4(e4.histograms)));
    }
...
var E2 = class extends X {
  ...
  async _open(e3) {
    ...
    const { imageInfo: u8, rasterInfo: c7 } = k4(f7), h3 = G(f7), p6 = v2(f7);
  ...
  async _fillOffsets(e3, t7, i8, r6) {
    ...
    if (f7) {
      ...
      return void s7.forEach((i9) => N3(e4, t7, i9, n5));
    }
  ...
  _getTileLocation(e3, t7, i8, r6 = false) {
    ...
    if (!f7) return null;
    const l7 = C2(f7, o6), u8 = S3(f7, "TILEOFFSETS");
...
function D(e3, t7) {
  if (t7.statistics = e3.statistics ?? t7.statistics, t7.histograms = e3.histograms, e3.histograms && null == t7.statistics && (t7.statistics = v4(e3.histograms)), e3.transform && null == t7.transform) {
...
var Y2 = class extends p(t(b(j2(o3(s5(X2(i4(l5(l4(f3(l3(l(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-RVZ4NAOX.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
  ...
  async generateRasterInfo(e3, t7) {
    var _a;
    if (e3 = m(N2, e3), await this.load(), !e3 || "none" === ((_a = e3.functionName) == null ? void 0 : _a.toLowerCase())) return this.serviceRasterInfo;
    try {
...
//# sourceMappingURL=ImageryTileLayer-IUZJ2TIR.js.map

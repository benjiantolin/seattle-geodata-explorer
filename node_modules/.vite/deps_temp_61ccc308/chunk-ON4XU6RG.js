...
async function g(t) {
  ...
  const o2 = null != n2 && null != i3 ? n2 + (i3 - n2) / 2 : 0, { getColor: r3 } = await import("./visualVariableUtils-44VWCCUD.js");
  return r3(e2, o2) ?? null;
}
async function w(t, e2) {
  const n2 = t.trailCap, i3 = t.trailWidth || 1, o2 = e2 || await g(t) || t.color;
  return new m2({ cap: n2, color: o2, width: i3 });
}
function y(t, e2) {
  var _a, _b;
  if (!e2) return null;
...
function V(t, n2, o2) {
  ...
  return r3 ? (F(r3.fieldType) && (h(t) ? r3.fieldFormat ?? (r3.fieldFormat = new i({ dateStyle: "short", timeStyle: "short-date-short-time" === U(n2) ? "short" : null })) : r3.format ?? (r3.format = new m({ dateFormat: U(n2) }))), r3) : null;
}
function j(t, e2, n2) {
  var _a, _b;
...
//# sourceMappingURL=chunk-ON4XU6RG.js.map

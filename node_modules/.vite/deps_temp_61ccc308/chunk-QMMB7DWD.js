...
var S2 = class extends m4 {
  constructor(e10, t12) {
    super(e10, t12, new t5(z, () => import("./RibbonLine.glsl-RS4SPPVJ.js")), v2(t12).locations), this.primitiveType = t12.wireframe ? _.LINES : _.TRIANGLE_STRIP;
  }
  ...
  initializePipeline(e10) {
    if (e10.occluder) {
      ...
      this._occluderPipelineTransparent = T({ blending: r10, polygonOffset: t12, depthTest: n5, depthWrite: null, colorWrite: d, stencilWrite: null, stencilTest: r13 ? e6 : null, drawBuffers: g2(i8) }), this._occluderPipelineOpaque = T({ blending: r10, polygonOffset: t12, depthTest: r13 ? n5 : a3, depthWrite: null, colorWrite: d, stencilWrite: r13 ? i5 : null, stencilTest: r13 ? u5 : null, drawBuffers: g2(i8) }), this._occluderPipelineMaskWrite = T({ blending: null, polygonOffset: t12, depthTest: a3, depthWrite: null, colorWrite: null, stencilWrite: r13 ? f2 : null, stencilTest: r13 ? t6 : null, drawBuffers: g2(i8) });
    }
...
var J = class extends s6 {
  constructor(t12, e10) {
    super(t12, q), this.produces = /* @__PURE__ */ new Map([[2, (t13) => t3(t13) || o3(t13) && 8 === this.parameters.renderOccluded], [3, (t13) => b(t13)], [10, (t13) => a(t13) && 8 === this.parameters.renderOccluded], [11, (t13) => a(t13) && 8 === this.parameters.renderOccluded], [4, (t13) => o3(t13) && this.parameters.writeDepth && 8 !== this.parameters.renderOccluded], [8, (t13) => o3(t13) && !this.parameters.writeDepth && 8 !== this.parameters.renderOccluded], [18, (t13) => u4(t13)]]), this._configuration = new i6(e10);
  }
...
function l3(e10, t12) {
  if (null != e10 && !p4(e10)) {
    ...
    const n9 = t12;
    n9._geometry && (n9._geometry = u6(n9._geometry)), e10.arcade.modules.arcadeUtils.updateExecContext(e10.arcade.context, t12);
  }
}
function i7(e10) {
  if (null != e10) {
...
//# sourceMappingURL=chunk-QMMB7DWD.js.map

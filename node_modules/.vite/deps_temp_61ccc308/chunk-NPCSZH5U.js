...
function f4(f5, n4, p4 = 1) {
  ...
  if (u3(n4)) {
    const r2 = l(f5, n4);
    return r2.isInvalid ? Math.sqrt(o(f5, n4.c[0])) : f(r2);
  }
  if (c2(n4)) {
    const r2 = h(f5, n4);
    return r2.isInvalid ? Math.sqrt(o(f5, n4.a[0])) : f(r2);
  }
  return g(f5, n4, p4);
}
...
function v2(t2, i3, s4, e2) {
  const u5 = l(t2, i3);
  if (u5.isInvalid) return [o2(i3)];
  const { t: f5, distance: l2 } = u(u5, s4);
  return l2 <= e2 ? u2(u5, i3, f5) : [o2(i3)];
}
function A(t2, i3, n4, o6) {
  const s4 = h(t2, i3);
  if (s4.isInvalid) return [o2(i3)];
  const { t: e2, distance: u5 } = u(s4, n4);
  return u5 <= o6 ? n(s4, i3, e2) : [o2(i3)];
}
function I2(t2, i3, r2, n4) {
  const o6 = p(t2, i3);
  if (o6.isInvalid) return [o2(i3)];
  const { t: s4, distance: e2 } = q(o6, r2);
  return e2 <= n4 ? x(o6, i3, s4) : [o2(i3)];
}
function h3(t2, i3, r2, n4) {
  return i(i3) ? [o2(i3)] : t(i3) ? U(t2, i3, r2, n4) : u3(i3) ? v2(t2, i3, r2, n4) : c2(i3) ? A(t2, i3, r2, n4) : I2(t2, i3, r2, n4);
}
...
function P4(e2, n4, o6) {
  ...
  else if (null !== e2[0] || null !== e2[1]) throw new n2(n4, "InvalidParameter", o6);
}
function x3(e2) {
...
var I4 = (n4, o6, i3) => {
  ...
  let u5 = i3[0];
  if ((o4(i3[0]) || te(i3[0])) && (u5 = ve(i3[0], n4.spatialReference)), null === u5) return null;
  if (!(u5 instanceof c)) throw new n2(n4, "InvalidParameter", o6);
  if (!(u5 instanceof y)) throw new n2(n4, "InvalidParameter", o6);
  if (!n3(i3[1])) throw new n2(n4, "InvalidParameter", o6);
  const c3 = M4(u5, i3[1]);
...
var R3 = (n4, o6, i3) => {
  ...
  if (!(c3 instanceof _)) throw new n2(n4, "InvalidParameter", o6);
  const m2 = W2(u5, c3);
...
var k3 = new o3(["geodesic", "great-elliptic", "loxodrome", "normal-section", "shape-preserving"]);
function D(e2) {
  return null == e2 ? "geodesic" : k3.get(ge(e2));
}
var A2 = new o3(["geometric", "labelPoint"]);
function O(e2) {
  return null == e2 ? "geometric" : A2.get(ge(e2));
}
var T = new o3(["round", "bevel", "miter", "square"]);
function z4(e2) {
...
//# sourceMappingURL=chunk-NPCSZH5U.js.map

...
__decorate([m({ type: String, json: { write: true } })], u2.prototype, "description", void 0), __decorate([m({ type: String, json: { write: true } })], u2.prototype, "label", void 0), __decorate([m(y)], u2.prototype, "symbol", void 0), __decorate([m({ type: [l3], json: { type: [[String]], read: { reader: (r3) => r3 ? r3.map((r4) => new l3({ value: r4[0], value2: r4[1], value3: r4[2] })) : null }, write: { writer: (r3, e2) => {
  const t = [];
  for (const s3 of r3) {
...
//# sourceMappingURL=chunk-UG5JX53Z.js.map

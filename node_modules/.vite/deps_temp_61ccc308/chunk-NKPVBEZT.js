...
var r8 = class extends e10 {
  constructor(t10, e16, s9, r14, o9, n17, h9 = o9, d6 = n17) {
    super(), this.tileDebugInfoTexture = null, this.debugInfo = { display: { length: 0, minOrderedLength: 0, minUnorderedLength: 0, triangleCount: 0 }, memory: { bytesUsed: 0, bytesReserved: 0 } }, this._destroyed = false, this.key = new e3(t10), this.resolution = e16, this.x = s9, this.y = r14, this.width = o9, this.height = n17, this.rangeX = h9, this.rangeY = d6;
  }
  destroy() {
...
var j = class extends r8 {
  ...
  setTransform(m4) {
    ...
    const x4 = r5(n7(), d6, 0, 0, u7, f5, p2);
    e5(this.transforms.labelMat2d, m4.viewMat2d, x4);
    const M3 = [0, 0];
  ...
  _createTransforms() {
    return { labelMat2d: n7(), tileMat3: e7(), displayViewScreenMat3: e7(), tileUnitsToPixels: e7() };
  }
...
var o8 = class {
  ...
  _getGPUBuffer(t10, i7, r14 = false) {
    if (this.bufferSize) {
      ...
      return this._gpu ?? (this._gpu = "index" === this.bufferType ? o4.createIndex(t10, 35048, this._cpu.array) : i7 && new r4(t10, i7, this._cpu.array, 35048)), this._gpu;
    }
  }
  getView(t10, i7) {
  ...
  _createComputeBuffer(t10) {
    ...
    return o4.createIndex(t10, i7, r14);
  }
};
...
function s8(e16) {
  if (!e16) return null;
  return { entities: n6(new t7(e16.entities), e4), vertexData: e16.data.map(a8) };
}
function a8(t10) {
  ...
  const f5 = t10.metrics ? n6(new t7(t10.metrics), h4) ?? [] : [];
...
var b = class extends j {
  constructor(e16, i7, r14, o9, n17, d6, h9 = false) {
    super(e16, i7, r14, o9), this._fader = n17, this._labelInstanceId = d6, this._meshes = /* @__PURE__ */ new Map(), this._entities = [], this._entityIndex = /* @__PURE__ */ new Map(), this._invalidated = false, this._nextUploadAllowed = false, this.tileAge = g++, this._metrics = [], this._metricsVisibility = /* @__PURE__ */ new Set(), this._entityIds = /* @__PURE__ */ new Set(), this._entityIdsFromBuffer = /* @__PURE__ */ new Set(), this._attributeEpoch = 0, this._encounteredEnd = false, this._decluttered = false, this._objectIdMap = null, this.isCoverage = false, this.rendering = false, this.visible = true, this.transforms.labelMat2d = n7(), this.transforms.tileUnitsToPixels = e7(), this.enableDeferredUploads = h9;
  }
  destroy() {
  ...
  get usedMemory() {
    ...
    if (this._entities.length) {
      ...
      const i7 = t10 / s9;
      e16 += e4.estimateMemory(i7) * this._entities.length, e16 += 4 * this._entities.length;
    }
  ...
  _onAppendMessage(e16) {
    ...
    const t10 = n6(new t7(e16.append.entities), e4);
  ...
  _onUpdateMessage(e16) {
    ...
    const t10 = n6(new t7(e16.modify.entities), e4), s9 = t10.map((e17) => e17.id), i7 = e16.isPixelBuffer ?? false, r14 = [...e16.remove, ...s9];
  ...
  copyPixelBufferedEntitesFrom(e16, t10, s9, i7) {
    ...
    for (const n17 of e16._entities) {
      ...
      for (const i8 of n17.records) if (i8.overlaps & t10) {
        ...
        s10 || (s10 = new e4(n17.id, n17.sortKey), this._entityIdsFromBuffer.add(n17.id), this._entityIndex.set(s10.id, s10), this._entities.push(s10)), s10.records.push(d6);
      }
    }
  ...
  _insertVertexData(e16) {
    ...
    for (const s9 of e16) {
      ...
      if (s9.metrics) {
        const e18 = n6(new t7(s9.metrics), h4) ?? [];
...
var n15 = class extends t8 {
  ...
  _initialize(e16) {
    ...
    const r14 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), i7 = new r4(e16, s6, r14), n17 = new h5(e16, i7);
...
var x2 = class extends t8 {
  ...
  _loadWGLResources(e16) {
    ...
    const t10 = new Int8Array([0, 0, 1, 0, 1, 1, 0, 1]), r14 = new r4(e16, s6, t10);
    this._outlineVertexArrayObject = new h5(e16, r14), this._outlineProgram = e9(e16, e13, this._outlineVertexArrayObject.locations);
    const s9 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), l7 = new r4(e16, s6, s9);
...
var m2 = class extends t8 {
  ...
  _loadWGLResources(t10) {
    if (this._vao) return;
    const { context: r14, styleLayer: e16 } = t10, o9 = e16.backgroundMaterial, i7 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), s9 = new r4(r14, o9.geometryLayout, i7);
...
var c4 = class extends t8 {
  ...
  _drawText(e16, a11, s9) {
    ...
    this._glyphTextureSize || (this._glyphTextureSize = r3(c6.width / 4, c6.height / 4));
...
var u6 = ({ coords: e16, lengths: r14 }, o9) => {
  ...
  for (let s9 = 0, i7 = 0; s9 < r14.length; i7 += r14[s9], s9 += 1) {
    ...
    const f5 = e16.slice(2 * c6, 2 * (i7 + r14[s9])), m4 = e2(f5, a11, 2);
...
var x3 = class _x {
  ...
  getIndexBuffer(e16, r14 = 35044) {
    var _a;
    return (_a = this._cache).indexBuffer ?? (_a.indexBuffer = o4.createIndex(e16, r14, this.indices)), this._cache.indexBuffer;
  }
  getVertexBuffers(e16, r14) {
    var _a;
    return (_a = this._cache).vertexBuffer ?? (_a.vertexBuffer = new r4(e16, r14, this.vertices)), this._cache.vertexBuffer;
  }
};
...
//# sourceMappingURL=chunk-NKPVBEZT.js.map

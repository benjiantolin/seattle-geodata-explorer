import {
  ...
  ee,
  oe
} from "./chunk-5EHVVKWO.js";
import "./chunk-Y2QJFDQ5.js";
import {
  d as d3
} from "./chunk-CZAZ6SBT.js";
import {
  E,
  N
} from "./chunk-JUVXVRIC.js";
...
var S = class {
  ...
  async load(e, r2 = {}) {
    ...
    return this._queryEngine = new W({ fieldsIndex: this._fieldsIndex, geometryType: i2, hasM: false, hasZ: false, featureIdInfo: F2, spatialReference: _, timeInfo: null, featureStore: new f2({ geometryType: i2, hasM: false, hasZ: false }) }), this._queryEngine.featureStore.addMany(w.features), { warnings: E2(w), extent: (await this._queryEngine.fetchRecomputedExtents()).fullExtent };
  }
  async applyEdits() {
  ...
  async refresh(t) {
    ...
    return this._customParameters = t.customParameters, this._maxRecordCount = t.maxRecordCount, this._maxTotalRecordCount = t.maxTotalRecordCount, this._maxPageCount = t.maxPageCount, (_a = this._snapshotTask) == null ? void 0 : _a.abort(), this._snapshotTask = d2((e) => this._snapshotFeatures({ signal: e })), this._snapshotTask.promise.then((e) => {
      ...
      ((_a2 = e.errors) == null ? void 0 : _a2.length) && i.getLogger(F).warn(new s2("wfs-layer:refresh-error", "Refresh completed with errors", { errors: e.errors }));
    }, () => {
...
//# sourceMappingURL=WFSSourceWorker-Q6LYWSG2.js.map

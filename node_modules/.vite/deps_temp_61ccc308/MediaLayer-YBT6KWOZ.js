...
import {
  p as p7
} from "./chunk-4ENS6IP5.js";
import {
  o as o5
} from "./chunk-5C5PXJZ5.js";
import "./chunk-7PIFITKB.js";
import {
  r as r5
} from "./chunk-HXIHEW2U.js";
...
import {
  p as p4
} from "./chunk-RYUZAXFW.js";
import {
  p as p5
} from "./chunk-U26WUT3R.js";
...
var T2 = class extends a2(c3) {
  ...
  readControlPoints(t3, o6) {
    const e3 = f2.fromJSON(o6.spatialReference), r6 = n3(...o6.coefficients, 1);
    return t3.map((t4) => (o3(N2, t4.x, t4.y), j2(N2, N2, r6), { sourcePoint: t4, mapPoint: new _2({ x: N2[0], y: N2[1], spatialReference: e3 }) }));
  }
  ...
  set coords(t3) {
    ...
    O2(p9) && O2(u7) && O2(m4) && O2(f3) && (B(C, p9, u7, m4, f3), this.controlPoints = this.controlPoints.map(({ sourcePoint: t4 }) => (o3(N2, t4.x, t4.y), j2(N2, N2, C), { sourcePoint: t4, mapPoint: new _2({ x: N2[0], y: N2[1], spatialReference: o6 }) })));
  }
  ...
  toSource(t3) {
    ...
    const o6 = this.controlPoints[0].mapPoint.spatialReference;
    return t3 = t3.normalize(), null == (t3 = X(t3, o6).geometry) ? null : (o3(N2, t3.x, t3.y), j2(N2, N2, this.inverseTransform), i2(N2[0], N2[1]));
  }
...
var z2 = Math.PI / 2;
function A(t3, o6, e3) {
  o3(t3, e3.sourcePoint.x, e3.sourcePoint.y), o3(o6, e3.mapPoint.x, e3.mapPoint.y);
}
...
function x2(t3, e3, r6) {
  const o6 = u(r6), n7 = Math.cos(o6), s5 = Math.sin(o6);
...
__decorate([m()], E2.prototype, "animationOptions", void 0), __decorate([m({ readOnly: true })], E2.prototype, "content", void 0), __decorate([m({ readOnly: true })], E2.prototype, "contentWidth", null), __decorate([m({ readOnly: true })], E2.prototype, "contentHeight", null), __decorate([m(x3)], E2.prototype, "image", void 0), __decorate([o("image", ["url"])], E2.prototype, "readImage", null), __decorate([r3("image")], E2.prototype, "writeImage", null), __decorate([m(g)], E2.prototype, "type", void 0), E2 = __decorate([a("esri.layers.support.ImageElement")], E2);
...
var V3 = (_a2 = class extends u6 {
  ...
  set currentTime(e3) {
    ...
    const t3 = r2(e3, 0, this.content.duration);
...
var I3 = class extends p2(m3(l)) {
  ...
  async load(e3) {
    if (s2(e3), !this.spatialReference) {
      ...
      this._set("spatialReference", e4 ? e4.georeference.coords.spatialReference : f2.WGS84);
    }
  ...
  async queryElements(e3, t3) {
    ...
    for (const n7 of r6) this._index.forEachInBounds(o2(n7), ({ normalizedCoords: e4, element: t4 }) => {
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-ID7BQSHL.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
...
} } } })], L4.prototype, "source", null), __decorate([s3("source")], L4.prototype, "castSource", null), __decorate([o("source", ["url"])], L4.prototype, "readSource", null), __decorate([r3("source")], L4.prototype, "writeSource", null), __decorate([m()], L4.prototype, "spatialReference", void 0), __decorate([m({ readOnly: true })], L4.prototype, "type", void 0), L4 = __decorate([a("esri.layers.MediaLayer")], L4);
var O3 = L4;
export {
  O3 as default
};
//# sourceMappingURL=MediaLayer-YBT6KWOZ.js.map

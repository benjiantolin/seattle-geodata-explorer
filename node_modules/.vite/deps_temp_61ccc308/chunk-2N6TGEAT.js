...
var r9 = class {
  constructor(i8 = o2(), r13 = r5(0.57735, 0.57735, 0.57735)) {
    this.intensity = i8, this.direction = r13;
  }
};
var c4 = class {
  constructor(i8 = o2(), r13 = r5(0.57735, 0.57735, 0.57735), c8 = true, n11 = 1, o8 = 1) {
...
var _3 = class {
  constructor() {
    this._shOrder = 2, this._legacy = new m5(), this.globalFactor = 0.5, this.noonFactor = 0.5, this._sphericalHarmonics = new n7(), this._mainLight = new c4(n(), r5(1, 0, 0), false);
  }
  get legacy() {
    return this._legacy;
  }
...
var m6 = class {
  ...
  initializePipeline(e8) {
    return T2({ blending: l4, colorWrite: d });
  }
};
function g4(e8, r13) {
...
var u3 = class {
  constructor(t7) {
    this.options = new e5(), this._results = new _4(), this.transform = new v3(), this.camera = new tt(), this.tolerance = m7, this.verticalOffset = null, this._ray = b4(), this._rayEnd = n(), this._rayBeginTransformed = n(), this._rayEndTransformed = n(), this.viewingMode = t7 ?? 1;
  }
  get results() {
  ...
  resetWithRay(s9, i8) {
    this.camera = i8, s9 !== this._ray && v(s9, this._ray), 0 !== this.options.verticalOffset ? 2 === this.viewingMode ? this._ray.origin[2] -= this.options.verticalOffset : this.verticalOffset = this.options.verticalOffset : this.verticalOffset = null, u(this._rayEnd, this._ray.origin, this._ray.direction), this._results.init(this._ray);
  }
...
var _4 = class {
  constructor() {
    this.min = new f4(b4()), this.max = new f4(b4()), this.hud = { min: new o4(b4()), max: new o4(b4()), all: new Array() }, this.ground = new f4(b4()), this.all = [];
  }
  init(t7) {
...
function S4(e8, t7, r13, o8, i8) {
  ...
  return i2(t7, C3, n11), i2(t7, E5, n11), C3[0] -= r13 / 2, E5[0] += r13 / 2, C3[1] -= o8 / 2, E5[1] += o8 / 2, n5(C3, n11, C3, s9), n5(E5, n11, E5, s9), i8 ? (i8.xmin = C3[0], i8.ymin = C3[1], i8.xmax = E5[0], i8.ymax = E5[1], i8.spatialReference = s9) : i8 = new z(C3[0], C3[1], E5[0], E5[1], s9), i8;
}
function k5(e8, t7) {
...
var i5 = r5(parseFloat(Number(5802e-9).toFixed(6)), parseFloat(Number(13558e-9).toFixed(6)), parseFloat(Number(331e-7).toFixed(6)));
var m8 = 3;
var s7 = r5(m8 * parseFloat(Number(65e-8).toFixed(6)), m8 * parseFloat(Number(1881e-9).toFixed(6)), m8 * parseFloat(Number(85e-9).toFixed(6)));
var p5 = r5(parseFloat(Number(i5[0] + s7[0]).toFixed(6)), parseFloat(Number(i5[1] + s7[1]).toFixed(6)), parseFloat(Number(i5[2] + s7[2]).toFixed(6)));
...
function l10(e8, r13, u5) {
  const i8 = r13 / u5, s9 = s2(e8), l11 = Math.sin(i8 / 2), a8 = Math.cos(s9), c8 = 2 * l(Math.sqrt(l11 * l11 / (a8 * a8)));
  return M(c8);
}

// node_modules/@arcgis/core/chunks/cameraUtilsSpherical.js
var tt2 = r5(0, 0, 1);
var et3 = A3(n(), r5(1, 1, 1));
var rt2 = e3();
var st2 = n();
var ot2 = n();
...
function it2(t7, r13, o8, a8) {
  ...
  if (Math.abs(m11) < 1e-8) M4 = c8 + g7;
    ...
    const t8 = g7 / f6, e8 = l(c8 / t8), r14 = Math.PI - m11 - e8;
    M4 = t8 * Math.sin(r14);
  }
...
function mt(t7, e8, o8) {
  const a8 = r7(e8), n11 = Math.sqrt(o8 * o8 + a8 * a8 - 2 * o8 * a8 * Math.cos(Math.PI - t7)), i8 = l(o8 / (n11 / Math.sin(t7)));
  return M(t7 - i8);
}
function pt(t7, r13, o8) {
  const a8 = s2(t7), n11 = r7(r13);
  return l(o8 / (n11 / Math.sin(a8))) + a8;
}
function ut(s9, o8, a8, n11, i8) {
  ...
  function b9(e8) {
    const r13 = Math.PI / 2;
    return (e8 = r3.normalize(e8, -r13)) > r13 && (e8 = Math.PI - e8), e8;
  }
...
function yt(t7, e8) {
  ...
  for (let n11 = 0; n11 < t7.length; n11++) {
    const a9 = t7[n11], i8 = n11 === t7.length - 1 ? t7[0] : t7[n11 + 1], c8 = b5(a9, i8, Rt), l11 = Z2(e8, c8.origin, c8.vector, 0, Tt);
    switch (l11) {
      case 2:
        r13.push(a9);
        break;
...
var a7 = class extends b {
  ...
  initialize() {
    this.addHandles([l2(() => this.view.ready, (e8) => {
      var _a;
...
//# sourceMappingURL=chunk-2N6TGEAT.js.map

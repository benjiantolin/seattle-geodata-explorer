...
var n14 = class extends m4 {
  constructor(r18, o14) {
    super(r18, o14, new t6(a11, () => import("./HighlightApply.glsl-7XDK53BG.js")), n11(i8));
  }
  initializePipeline() {
...
var a12 = class extends m4 {
  constructor(r18, i12) {
    super(r18, i12, new t6(g3, () => import("./HighlightBlur.glsl-LNATT2SL.js")), n11(i8));
  }
  initializePipeline() {
...
var a13 = class extends m4 {
  constructor(r18, t15) {
    super(r18, t15, new t6(h7, () => import("./HighlightToSingle.glsl-OUJBY2FZ.js")), n11(i8));
  }
  initializePipeline() {
    return T({ colorWrite: d });
  }
...
var a14 = class {
  constructor(e9, t15, i12, s14) {
    this._textures = e9, this._techniques = t15, this.materialChanged = i12, this.requestRender = s14, this._id2glMaterialRef = new t5();
  }
  dispose() {
...
var v4 = class {
  constructor() {
    this.startTime = 0, this._data = r4(null), this.coverage = 0, this.absorption = 0, this._readChannels = 0, this.parallax = new g4(), this.parallaxNew = new g4(), this._anchorPoint = n5(), this._fadeState = r4(0), this._fadeFactor = r4(1);
  }
  get data() {
  ...
  fade(t15, e9, s14) {
    this.isFading && this.fadeFactor < 1 && (this._fadeFactor.value = s14 ? r3((e9 - this.startTime) / (b6 * s14), 0, 1) : 1, 1 === this.fadeFactor && this._endFade()), this._evaluateState(t15, e9), this._updateParallax(t15);
  }
...
var z2 = class {
  ...
  set maxCascades(s14) {
    this.settings.maxNumCascadesHighQuality = r3(Math.floor(s14), 1, 4);
  }
  get maxCascades() {
  ...
  _computeTextureHeight({ pixelRatio: t15, fullWidth: s14, fullHeight: e9 }, i12, a16) {
    ...
    return n10(Math.max(s14, e9) * r18 * h10, this._maxTextureWidth / this._numCascades);
  }
  _ensureFbo() {
    var _a, _b, _c, _d;
...
function lt(t15, s14, e9, i12, a16, r18, h10, n17) {
  ...
  const H3 = f(i12, t15[S4], ot, u(rt, ot, ct), 1, a16), O2 = f(i12, t15[v7], ot, rt, 1, r18), D3 = f(i12, t15[v7], nt, u(rt, nt, ct), 1, h10), F2 = f(i12, t15[S4], nt, rt, 1, n17);
...
var I3 = class extends n13 {
  ...
  initialize() {
    ...
    }, h), e9.resourceController.scheduler.registerTask(f4.OVERLAY_RENDERER, this)]);
  ...
  get isEmpty() {
    return !t8.OVERLAY_DRAW_DEBUG_TEXTURE && t(this._renderers, (e9) => e9.isEmpty);
  }
  get hasWater() {
  ...
  renders(e9) {
    var _a, _b;
    if (t8.OVERLAY_DRAW_DEBUG_TEXTURE && 4 !== e9 && 2 !== e9) return true;
  ...
  _drawTarget(e9, r18) {
    ...
    if (t8.OVERLAY_DRAW_DEBUG_TEXTURE && 4 !== r18.content && 2 !== r18.content) {
...
var y3 = class extends m4 {
  constructor(e9, r18) {
    super(e9, r18, new t6(v3, () => import("./ColorMaterial.glsl-HAFVQF4W.js")), v5(r18).locations);
  }
  _createPipeline(e9, r18) {
    ...
    return T({ blending: o5(i12) && l9 ? a7(o14) : null, culling: _3(h10), depthTest: j6 ? null : { func: p(o14) }, depthWrite: i7(e9), drawBuffers: g2(i12, d2(o14, i12)), colorWrite: d, stencilWrite: S4 ? f3 : null, stencilTest: S4 ? r18 ? t7 : c7 : null, polygonOffset: v7 ? y4 ? T2 : null : m3(e9) });
  }
  initializePipeline(e9) {
...
var m6 = class extends i11 {
  constructor(t15) {
    super(t15, _5), this._configuration = new s13(), this.supportsEdges = true, this.produces = /* @__PURE__ */ new Map([[2, (t16) => this._isOpaqueMaterialPass(t16)], [3, (t16) => this._isOpaqueNoSSAODepthPass(t16)], [4, (t16) => f2(t16) && this._transparent && this.parameters.writeDepth], [5, (t16) => b5(t16) && this._transparent && this.parameters.writeDepth], [8, (t16) => f2(t16) && this._transparent && !this.parameters.writeDepth], [18, (t16) => u3(t16)]]);
  }
  ...
  _isOpaqueMaterialPass(t15) {
    return 9 === t15 || f2(t15) && !this._transparent;
  }
...
//# sourceMappingURL=chunk-YVLS3GKG.js.map

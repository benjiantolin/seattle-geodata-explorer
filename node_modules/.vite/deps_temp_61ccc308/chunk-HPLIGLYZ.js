...
function c(t2) {
  ...
  for (const o3 of r.polygons) {
    const t3 = o3.count, l = o3.index, f2 = i(r.position, 3 * l, 3 * t3), h3 = o3.holeIndices.map((n) => n - l), g3 = t(e2(f2, h3, 3));
    i3.push({ position: f2, faces: g3 }), c2 += f2.length, a2 += g3.length;
  }
  const g2 = f(i3, c2, a2), u = Array.isArray(g2.position) ? e3(g2.position, 3, { originalIndices: g2.faces }) : e3(g2.position.buffer, 6, { originalIndices: g2.faces });
...
//# sourceMappingURL=chunk-HPLIGLYZ.js.map

...
function A(t3, o4, e6, i4, s2) {
  ...
  if (U(t3.field)) return U(t3.stops) ? 2 === t3.stops.length && n2(t3.stops[0].size) && n2(t3.stops[1].size) ? (R(t3.stops[0].size, t3.stops[1].size, t3.stops[0].value, t3.stops[1].value, o4, e6), o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: stops only supported with 2 elements"), false) : n2(r5) && n2(n5) && U(t3.minDataValue) && U(t3.maxDataValue) ? (R(r5, n5, t3.minDataValue, t3.maxDataValue, o4, e6), o4.type[e6] = 1, true) : "unknown" === t3.valueUnit ? (D(s2, "Could not convert size info: proportional size not supported"), false) : null != m3[t3.valueUnit] ? (o4.minSize[e6] = -1 / 0, o4.maxSize[e6] = 1 / 0, o4.offset[e6] = 0, o4.factor[e6] = 1 / m3[t3.valueUnit], o4.type[e6] = 1, true) : (D(s2, "Could not convert size info: scale-dependent size not supported"), false);
  if (!U(t3.field)) {
    if (((_a = t3.stops) == null ? void 0 : _a[0]) && n2(t3.stops[0].size)) return o4.minSize[e6] = t3.stops[0].size, o4.maxSize[e6] = t3.stops[0].size, o4.offset[e6] = o4.minSize[e6], o4.factor[e6] = 0, o4.type[e6] = 1, true;
    if (n2(r5)) return o4.minSize[e6] = r5, o4.maxSize[e6] = r5, o4.offset[e6] = r5, o4.factor[e6] = 0, o4.type[e6] = 1, true;
  }
...
function Y(t3, s2) {
  const r5 = new X(t3);
  return r5.vvSize && (r5.vvSymbolAnchor = s2.anchor, o2(st), F(s2.rotation[2], s2.rotation[0], s2.rotation[1], st), r5.vvSymbolRotationMatrix = r5.vvSymbolRotationMatrix || e(), n(r5.vvSymbolRotationMatrix, st)), r5;
}
function Z(t3, o4, e6) {
...
//# sourceMappingURL=chunk-URJACLF7.js.map

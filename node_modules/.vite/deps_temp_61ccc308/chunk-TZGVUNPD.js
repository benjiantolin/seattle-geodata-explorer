...
import {
  f as f6
} from "./chunk-3RXCOTVV.js";
import {
  W as W2
} from "./chunk-Y6YP74NN.js";
import {
  p as p7
} from "./chunk-3XBROSZY.js";
import {
  V,
  i as i4,
  ie,
  ...
  n as n7,
  r as r2
} from "./chunk-QKXFU3S3.js";
import {
  i as i5,
  p as p6
} from "./chunk-JSXOYOR2.js";
import {
  u as u5
...
import {
  c as c2,
  p as p5
} from "./chunk-6ORGDMTZ.js";
import {
  a as a5
} from "./chunk-PGBVPNWI.js";
import {
  A,
  l as l7,
  n as n6
...
var n9 = null;
function r4() {
  return e5 || (e5 = import("./lclayout-4VA2OH2Z.js").then((t7) => t7.l).then(({ default: e7 }) => e7({ locateFile: (e8) => n(`esri/libs/linkchartlayout/${e8}`) })).then((t7) => {
    s6(t7);
  }), e5);
}
function s6(t7) {
    ...
    if (n12 = e7 || new b2({ where: "1=1", outFields: ["*"] }), "link-chart" === t7.parentCompositeLayer.type) {
      ...
      return s8.forEach((i12) => {
        if (this.relationshipTypeNames.has(t7.objectType.name)) {
          ...
          i12.attributes[E] = Number(s9 && a10);
        } else {
          ...
          n13 && i12.attributes[n13.name] ? i12.attributes[E] = 1 : i12.attributes[E] = 0;
        }
...
var Ne = class extends p12(a3(f4(c(p(p5(l6(t(f3(l(b3)))))))))) {
  constructor(e7) {
    super(e7), this.blendMode = "normal", this.charts = null, this.definitionExpression = null, this.displayFilterEnabled = true, this.displayFilterInfo = null, this.effect = null, this.elevationInfo = null, this.featureEffect = null, this.graphType = null, this.labelsVisible = true, this.layerType = null, this.legendEnabled = true, this.maxScale = 0, this.minScale = 0, this.objectIdField = _2, this.objectType = null, this.opacity = 1, this.orderBy = null, this.parent = null, this.parentCompositeLayer = null, this.persistenceEnabled = true, this.popupEnabled = true, this.popupTemplate = null, this.refreshInterval = 0, this.source = { openPorts: () => this.load().then(() => {
      ...
      return new E2(e8.port1, { channel: e8, client: { queryFeatures: (e9, t7 = {}) => {
  ...
  get fields() {
    ...
    }), e7.push(m2.fromJSON({ name: this.objectIdField, type: "esriFieldTypeString", alias: this.objectIdField, editable: false }), m2.fromJSON({ name: o3, type: "esriFieldTypeInteger", alias: o3, editable: false }), m2.fromJSON({ name: E, type: "esriFieldTypeInteger", alias: E, editable: false })), e7;
  }
  get formTemplate() {
  ...
  get renderer() {
    ...
    if ("link-chart" === ((_d = this.parentCompositeLayer) == null ? void 0 : _d.type)) {
      if ("relationship" === this.graphType) return new p4({ type: "simple", symbol: T3(r7) });
      const e8 = t2(u5(y2.toJSON("point")).renderer);
      return L(e8.symbol, r7), e8;
    }
    const i10 = t2(u5(y2.toJSON(this.geometryType)).renderer);
...
}, isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], Ne.prototype, "layerType", void 0), __decorate([m(Ie(a(d)))], Ne.prototype, "legendEnabled", void 0), __decorate([m(Ie(a(v)))], Ne.prototype, "maxScale", void 0), __decorate([m(Ie(a(j)))], Ne.prototype, "minScale", void 0), __decorate([m()], Ne.prototype, "objectIdField", void 0), __decorate([m()], Ne.prototype, "objectType", void 0), __decorate([m(Ie(a(w)))], Ne.prototype, "opacity", void 0), __decorate([m(Ie(a(c2)))], Ne.prototype, "orderBy", void 0), __decorate([m({ clonable: false })], Ne.prototype, "parent", void 0), __decorate([m()], Ne.prototype, "parentCompositeLayer", void 0), __decorate([m(Ie(a(l3)))], Ne.prototype, "popupEnabled", void 0), __decorate([m({ type: q, json: { name: "popupInfo", write: { ignoreOrigin: true } } })], Ne.prototype, "popupTemplate", void 0), __decorate([m({ type: Number, json: { write: { overridePolicy: Le } } })], Ne.prototype, "refreshInterval", void 0), __decorate([m({ types: m3, json: { name: "layerDefinition.drawingInfo.renderer", write: Se() } })], Ne.prototype, "renderer", null), __decorate([m()], Ne.prototype, "source", void 0), __decorate([m()], Ne.prototype, "spatialReference", null), __decorate([m()], Ne.prototype, "templates", null), __decorate([m({ type: u4, json: { name: "layerDefinition.timeInfo", write: { overridePolicy: Le }, origins: { "web-document": { name: "layerDefinition.timeInfo", read: true, write: { overridePolicy: Le } }, "portal-item": { name: "layerDefinition.timeInfo", read: true, write: { overridePolicy: Le } } } } })], Ne.prototype, "timeInfo", null), __decorate([m({ type: String, json: { write: { isRequired: true, ignoreOrigin: true, writerEnsuresNonNull: true } } })], Ne.prototype, "title", null), __decorate([r("title")], Ne.prototype, "writeTitle", null), __decorate([m({ json: { read: false } })], Ne.prototype, "type", void 0), __decorate([m(Ie(a(f5)))], Ne.prototype, "useViewTime", void 0), __decorate([m({ type: Boolean, json: { name: "visibility", write: Se() } })], Ne.prototype, "visible", void 0), Ne = __decorate([a2("esri.layers.knowledgeGraph.KnowledgeGraphSublayer")], Ne);
...
//# sourceMappingURL=chunk-TZGVUNPD.js.map

...
var x = class extends e2 {
  ...
  _updateMatricesAndLocalOrigin(t) {
    ...
    i(O, O, m), M(O, O, r2(B / 2, y / 2)), f(O, O, r4(u2[0] / j, -y / M2, 1)), h(O, O, -d);
  }
  _updateBufferData(t, e3) {
    ...
    const f2 = b();
    this._vertexBuffer ? this._vertexBuffer.setData(o4.buffer) : this._vertexBuffer = new r3(t, f2.bufferLayout, o4.buffer, 35048), this._indexBuffer ? this._indexBuffer.setData(a2) : this._indexBuffer = o2.createIndex(t, 35048, a2), this._vao || (this._vao = new h2(t, this._vertexBuffer, this._indexBuffer));
  }
};
...
//# sourceMappingURL=chunk-54OEQ2E4.js.map

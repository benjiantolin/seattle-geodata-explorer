...
import {
  ...
  u,
  v
} from "./chunk-4SZKSPCU.js";
import "./chunk-THX6MV3J.js";
import {
  e as e4
} from "./chunk-QAEDVDIY.js";
import "./chunk-KXTMLIVP.js";
import "./chunk-VY5ZRXDE.js";
import "./chunk-KKVU4G4R.js";
import {
  s
...
var j2 = class extends s2(B) {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-HCSYA3Y7.js"), flow: () => import("./calcite-flow-YHR3TT2U.js"), "flow-item": () => import("./calcite-flow-item-CM6V6UC4.js"), list: () => import("./calcite-list-77NAKOXR.js"), notice: () => import("./calcite-notice-XSMZ3FDQ.js"), tooltip: () => import("./calcite-tooltip-K5LQSGST.js") });
  }
  destroy() {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-5D2JPMU7.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-65OOBA2Y.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

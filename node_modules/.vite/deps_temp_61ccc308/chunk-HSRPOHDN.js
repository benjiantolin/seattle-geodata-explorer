...
var G;
async function H3() {
  null == G && (G = await import("./operators-M7AOLGJB.js"), await G.loadAll());
}
function F(H6, F4) {
  H6.disjoint = function(e5, n7) {
    ...
    return F4(e5, t5, (a3, l4, o6) => {
      ...
      return h2(M2, s9, G.geodeticArea.execute(u3, { curveType: d6 }));
    });
...
async function nn() {
  return Ze([await import("./geomasync-G575GRUV.js")], "async"), true;
}
...
var _i = class _i {
  ...
  normalizeModuleUri(t5) {
    ...
    if (t5.startsWith("portal+")) {
      ...
      return i7 = new M({ url: u3 }).restUrl + "/content/items/" + n7 + "/resources/" + d6 + ".arc", { url: i7, scheme: "portal", uri: "PO:" + i7 };
    }
...
async function q3() {
  await nn(), x2 = await import("./arcadeAsyncRuntime-WB6NHDDH.js");
...
async function X2() {
  await N2();
  const [e5, t5, n7, s9, a3, o6] = await Promise.all([import("./featureSetUtils-54ONCDV3.js"), import("./featuresetbase-CA2AUA23.js"), import("./featuresetgeom-7LSZ444Y.js"), import("./featuresetstats-Q5VXZGA2.js"), import("./featuresetstring-VELN6YPK.js"), import("./knowledgegraph-QNYZTIDP.js")]);
...
//# sourceMappingURL=chunk-HSRPOHDN.js.map

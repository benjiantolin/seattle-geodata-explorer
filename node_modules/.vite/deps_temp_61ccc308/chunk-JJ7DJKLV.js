...
import {
  R,
  q
} from "./chunk-IGBAJKE4.js";
import {
  t as t4
} from "./chunk-TNVMVYLK.js";
import {
  d as d4
} from "./chunk-QQ4JUYPJ.js";
import {
  t as t3
...
var a4 = class extends B {
  ...
  render() {
    return n2("div", { class: this.classes({ [d7.base]: true, [d7.inputMode]: "input" === this.mode }) }, n2("div", { class: d7.title, key: "title" }, this.title), n2("div", { class: d7.value, key: "value" }, this.value));
  }
};
...
var a5 = class extends B {
  ...
  render() {
    return n2("div", { class: p3.base }, n2("span", null, this.left), n2("span", null, this.divider), n2("span", null, this.right));
  }
};
...
var S2 = class extends B {
  ...
  render() {
    ...
    return n2("div", { class: v(t5, r4 && n6), onkeydown: this._onKeyDown, tabIndex: -1 }, r4 && n17 && t6.header ? n2("div", { class: _5, "data-testid": "tooltip-header", key: "header", onpointerdown: this._onHeaderPointerDown }, n2("calcite-button", { appearance: "transparent", "data-testid": "tooltip-back-button", iconFlipRtl: "both", iconStart: "chevron-left", key: "discard-button", kind: "neutral", onclick: this._onDiscard, scale: "s", tabIndex: -1 }), o4.length > 0 ? n2(i, null, n2("div", { class: a3, key: "spacer" }), n2("div", { class: o3, key: "actions" }, o4)) : null) : null, s15 ? n2("div", { class: c6, key: "content" }, ...e6) : null, i7);
  }
  destroy() {
    var _a;
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-HCSYA3Y7.js"), icon: () => import("./calcite-icon-J7CTACBF.js"), input: () => import("./calcite-input-WRUPHNTM.js") });
  }
  ...
  get _renderedHelpMessage() {
    ...
    return n2("div", { class: $2, key: "help-message" }, i7 ? n2("calcite-icon", { class: h4, icon: i7, scale: "s" }) : null, n2("div", { class: r2 }, o4));
  }
...
var n7 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, a6.radius && null != o4 ? n2(a4, { title: p6.radius, value: m6.length(o4) }) : null, a6.size && null != s15 && null != n17 ? n2(a4, { title: p6.size, value: n2(a5, { left: m6.length(s15), right: m6.length(n17) }) }) : null, a6.area ? n2(a4, { title: p6.area, value: m6.area(t6) }) : null);
  }
};
...
var _6 = class extends B {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-HCSYA3Y7.js"), icon: () => import("./calcite-icon-J7CTACBF.js"), input: () => import("./calcite-input-WRUPHNTM.js"), "input-message": () => import("./calcite-input-message-DNFUHDTB.js") });
  }
  render() {
    const { field: t6, mode: e6 } = this, i7 = "input" === e6, { locked: o4, readOnly: n17 } = t6;
    return n2("div", { class: this.classes({ [d9.base]: true, [d9.feedbackMode]: "feedback" === e6, [d9.inputMode]: "input" === e6, [d9.locked]: o4, [d9.readOnly]: n17 }) }, n2("div", { class: d9.title, key: "title" }, this._title), n2("div", { class: d9.value, key: "value", onkeydown: this._onKeyDown }, i7 ? this._renderValueInputMode() : this._renderValueFeedbackMode()));
  }
  get _formattedValue() {
  ...
  _renderValueFeedbackMode() {
    return n2(i, null, n2("div", { class: d9.valueContent, key: "value-feedback" }, this._formattedValue), this.field.locked && "input" !== this.mode ? n2("calcite-icon", { class: d9.lockIcon, icon: h5.lock, key: "icon", scale: "s" }) : null);
  }
  _renderValueInputMode() {
    return this.field.readOnly ? this._renderValueReadOnly() : this._renderValueWritable();
  }
  _renderValueReadOnly() {
    return n2("div", { class: this.classes(d9.valueContent, d9.valueContentReadOnly), key: "value-read-only" }, this._formattedValue);
  }
  _renderValueWritable() {
    const { field: t6 } = this, e6 = this._messages, { name: i7, invalid: o4 } = t6;
    return n2(i, null, n2("div", { class: d9.inputWrapper, key: "value-input" }, n2("calcite-input", { afterCreate: this._onAfterCreate, afterRemoved: this._onAfterRemoved, class: d9.input, "data-field-name": i7, "data-testid": `tooltip-field-${i7}`, key: "input", onblur: this._onInputBlur, onfocus: this._selectText, onkeydown: this._onInputKeyDown, scale: "s", status: o4 ? "invalid" : "idle", type: "text", value: this._rawDisplayValue ?? m5, onCalciteInputInput: this._onInput }), o4 ? n2("calcite-input-message", { class: d9.inputMessage, scale: "s", status: "invalid" }, e6.invalidValue) : null), n2("div", { class: d9.inputSuffix, key: "suffix" }, this._suffix), this._renderedLockButton);
  }
  get _renderedLockButton() {
    const { name: t6, locked: e6, lockable: i7 } = this.field;
    if (!i7) return n2("div", { key: "no-lock-button" });
...
function i4(i7) {
  ...
  return 0 === l4.length ? null : n2(i, null, l4.map((e6) => n2(_6, { context: i7.context, field: e6, key: e6.id, mode: i7.mode })));
}
...
var s7 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0, s15.orientation ? t6.orientation : void 0, s15.scale ? t6.scale : void 0], mode: i7 });
  }
};
...
var s8 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: o4, fields: [n17.coordinates ? t6.effectiveX : void 0, n17.coordinates ? t6.effectiveY : void 0, n17.elevation ? s15 : void 0], mode: r4 });
  }
};
...
var p5 = class extends B {
  ...
  render() {
    return n2("div", { class: s6 }, this._isElementVisible("direction") ? n2(l3, { messages: this.messages, sketchOptions: this.sketchOptions }) : null);
  }
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-HCSYA3Y7.js"), dropdown: () => import("./calcite-dropdown-AY3PBIOS.js"), "dropdown-item": () => import("./calcite-dropdown-item-FPJ4OGEJ.js"), "dropdown-group": () => import("./calcite-dropdown-group-MUIQVPXG.js") });
  }
...
function l3(t6) {
  ...
  return n2("calcite-dropdown", { key: "direction-mode", placement: "bottom-end", scale: "s", widthScale: "s", onCalciteDropdownSelect: (e7) => {
    var _a2, _b2;
  ...
  } }, n2("calcite-button", { alignment: "end", appearance: "transparent", iconStart: e5[e6], kind: "neutral", label: i7, scale: "s", slot: "trigger", title: i7 }), n2("calcite-dropdown-group", { selectionMode: "single" }, n2("calcite-dropdown-item", { "data-mode": c8, "data-testid": "tooltip-direction-mode-relative", iconStart: e5.relative, key: "relative", selected: e6 === c8 }, (_c = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _c.relative), n2("calcite-dropdown-item", { "data-mode": r4, "data-testid": "tooltip-direction-mode-absolute", iconStart: e5.absolute, key: "absolute", selected: e6 === r4 }, (_d = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _d.absolute)));
}
...
var n8 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: o4, fields: [..."direction-distance" === r4 ? [n17.direction ? t6.direction : void 0, n17.distance ? t6.distance : void 0] : [n17.coordinates ? t6.effectiveX : void 0, n17.coordinates ? t6.effectiveY : void 0], n17.elevation ? t6.elevation : void 0, n17.area ? t6.area : void 0], mode: e6 });
  }
  _renderActions() {
    const { xyMode: o4, sketchOptions: t6 } = this.info;
    return n2(p5, { sketchOptions: t6, visibleElements: { direction: "direction-distance" === o4 } });
  }
};
...
var n9 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: e6 } = this, { xyMode: r4, visibleElements: n17 } = t6;
    return n2(i4, { context: o4, fields: [..."direction-distance" === r4 ? [n17.direction ? t6.direction : void 0, n17.distance ? t6.distance : void 0] : [n17.coordinates ? t6.effectiveX : void 0, n17.coordinates ? t6.effectiveY : void 0], n17.elevation ? t6.elevation : void 0, n17.totalLength ? t6.totalLength : void 0], mode: e6 });
  }
  _renderActions() {
    const { xyMode: o4, sketchOptions: t6 } = this.info;
    return n2(p5, { sketchOptions: t6, visibleElements: { direction: "direction-distance" === o4 } });
...
var n10 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, n17.size && null != o4 && null != s15 ? n2(a4, { title: p6.size, value: n2(a5, { left: a6.length(o4), right: a6.length(s15) }) }) : null, n17.area ? n2(a4, { title: p6.area, value: a6.area(t6) }) : null);
  }
};
...
var s9 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: o4, fields: [s15.elevation ? t6.elevation : void 0], mode: r4 });
  }
};
...
var n11 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, o4.rotation ? n2(a4, { title: e6.rotation, value: this._formatters.angleRelative(t6) }) : null);
  }
};
...
var n12 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, e6.size ? n2(a4, { title: r4.size, value: n2(a5, { left: n17.length(t6.xSize), right: n17.length(t6.ySize) }) }) : null, e6.scale ? n2(a4, { title: r4.scale, value: n2(a5, { left: n17.scale(t6.xScale), right: n17.scale(t6.yScale) }) }) : null);
  }
};
...
var s10 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: i7 } = this, { visibleElements: s15 } = t6;
    return n2(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0], mode: i7 });
  }
};
...
var i5 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: t6, fields: [i7.distance ? o4.distance : void 0, i7.area ? o4.area : void 0, i7.totalLength ? o4.totalLength : void 0], mode: r4 });
  }
};
...
var s11 = class extends S2 {
  _renderContent() {
    ...
    return n2(i4, { context: o4, fields: [s15.coordinates ? e6.effectiveX : void 0, s15.coordinates ? e6.effectiveY : void 0, s15.elevation ? e6.elevation : void 0, s15.area && "polygon" === e6.geometryType ? e6.area : null, s15.totalLength && "polyline" === e6.geometryType ? e6.totalLength : null], mode: r4 });
  }
};
...
var s13 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: i7 } = this, { visibleElements: s15 } = t6;
    return n2(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0, s15.orientation ? t6.orientation : void 0, s15.size ? t6.size : void 0], mode: i7 });
  }
};
...
var n13 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, o4.distance ? n2(a4, { title: r4.distance, value: n17.length(t6.distance) }) : null);
  }
};
...
var s14 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, a6.distance ? n2(a4, { title: n17.distance, value: p6.length(t6) }) : null, a6.elevation && null != (e6 == null ? void 0 : e6.actual) ? n2(a4, { title: n17.elevation, value: p6.verticalLength(e6.actual) }) : null, a6.area && null != l4 ? n2(a4, { title: n17.area, value: p6.area(l4) }) : null, a6.totalLength && null != s15 ? n2(a4, { title: n17.totalLength, value: p6.length(s15) }) : null);
  }
};
...
var n15 = class extends S2 {
  _renderContent() {
    ...
    return n2(i, null, o4.distance ? n2(a4, { title: s15.distance, value: this._formatters.verticalLengthRelative(t6.distance) }) : null);
  }
};
...
//# sourceMappingURL=chunk-JJ7DJKLV.js.map

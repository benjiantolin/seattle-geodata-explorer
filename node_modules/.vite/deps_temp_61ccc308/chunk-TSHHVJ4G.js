...
var u10 = i6 = class extends p2 {
  castColormapName(o9) {
    ...
    return n2.includes(r11) ? r11 : null;
  }
  readColorRamp(o9) {
    return p(o9);
  }
  readColorRampName(o9, r11) {
    if (!o9) return null;
    const e9 = m4.jsonValues.find((r12) => r12.toLowerCase() === o9.toLowerCase());
    return e9 ? m4.fromJSON(e9) : null;
  }
  clone() {
    var _a;
...
__decorate([m({ type: [[Number]], json: { write: true } })], u10.prototype, "colormap", void 0), __decorate([m({ type: String, json: { write: true } })], u10.prototype, "colormapName", void 0), __decorate([s2("colormapName")], u10.prototype, "castColormapName", null), __decorate([m({ types: m3, json: { write: true } })], u10.prototype, "colorRamp", void 0), __decorate([o("colorRamp")], u10.prototype, "readColorRamp", null), __decorate([m({ type: m4.apiValues, json: { type: m4.jsonValues, write: m4.write } })], u10.prototype, "colorRampName", void 0), __decorate([o("colorRampName")], u10.prototype, "readColorRampName", null), u10 = i6 = __decorate([a2("esri.layers.support.rasterFunctions.ColormapFunctionArguments")], u10);
var d6 = u10;
...
function e5(t6, o9) {
  ...
  return w({ type: "multipart", colorRamps: e9 }, { numColors: s11, weights: o9 = o9 ?? n21 });
}
function n7() {
...
var a12 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    return e9 ? (this.lookup = { indexedColormap: e9, offset: s11 }, { success: true, supportsGPU: a4(e9) }) : { success: false, supportsGPU: false, error: "colormap-to-rgb-function: the colormap is not supported" };
  }
  _processPixels(t6) {
    var _a;
...
var u12 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    return this.lookup = u2(o9, e9), { success: true, supportsGPU: true };
  }
  _processPixels(t6) {
    var _a;
    const s11 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
...
var u14 = class extends p3 {
  ...
  _processPixels(t6) {
    ...
    const { zFactor: e9, curvatureType: s11 } = this.functionArguments, { extent: o9, primaryPixelSizes: u20 } = t6, c35 = u20 == null ? void 0 : u20[0], a29 = c35 ?? (o9 ? { x: o9.width / r11.width, y: o9.height / r11.height } : { x: 1, y: 1 }), p18 = this.isGCS && e9 >= 1 ? e9 * n3 : e9;
    return f4(r11, { zFactor: p18, curvatureType: s11, resolution: a29 });
  }
  _getWebGLParameters() {
    const { zFactor: t6, curvatureType: r11 } = this.functionArguments;
    return { curvatureType: r11, zFactor: this.isGCS && t6 >= 1 ? t6 * n3 : t6 };
  }
};
...
var c23 = class extends p3 {
  ...
  _processPixels(t6) {
    ...
    const s11 = (_a = t6.pixelBlocks) == null ? void 0 : _a[0];
    if (!s11) return null;
    const { extent: e9, primaryPixelSizes: r11 } = t6, o9 = r11 == null ? void 0 : r11[0], i25 = o9 ?? (e9 ? { x: e9.width / s11.width, y: e9.height / s11.height } : { x: 1, y: 1 }), p18 = d2(this.functionArguments, i25, this.isGCS), a29 = r5(s11, p18);
    return a29.pixelType = this.outputPixelType, a29;
  }
  _getWebGLParameters() {
    const t6 = d2(this.functionArguments, { x: 1, y: 1 }, this.isGCS), s11 = a5(t6), { slopeType: e9, zFactor: o9, pixelSizeFactor: i25, pixelSizePower: u20 } = this.functionArguments, c35 = "scaled" === e9, l22 = r3(this.outputPixelType);
    return { ...s11, zFactor: o9, gcsFactor: this.isGCS ? n3 : 1, pixelSizeFactor: c35 ? i25 : 0, pixelSizePower: c35 ? u20 : 0, isOutputRounded: l22 };
  }
};
...
var l18 = class extends p3 {
  ...
  _processPixels(t6) {
    ...
    return w2(e9, { includedRanges: r11, noDataValues: u20, outputPixelType: s11, matchAll: 1 === n21, lookups: o9 });
  }
  _getWebGLParameters() {
    var _a;
...
var g3 = class extends p3 {
  ...
  _processPixels(t6) {
    ...
    return m6(e9, { inputRanges: o9, outputValues: a29, noDataRanges: u20, outputPixelType: n21, allowUnmatched: i25, isLastInputRangeInclusive: m19, replacementValue: c35 });
  }
  _getWebGLParameters() {
...
var l19 = a25 = class extends m16 {
  readColorRamp(o9) {
    if ("string" == typeof o9) {
      const r11 = m4.jsonValues.find((r12) => r12.toLowerCase() === o9.toLowerCase());
      return r11 ? d(m4.fromJSON(r11)) : null;
    }
...
var h5 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    const p18 = D(o9);
    return this.lookup = { indexedColormap: o9, offset: n21, hsvMap: p18 }, { success: true, supportsGPU: a4(o9) };
  }
  _processPixels(e9) {
    var _a, _b, _c;
    const t6 = (_a = e9.pixelBlocks) == null ? void 0 : _a[0];
    ...
    const r11 = d2(this.functionArguments, s11, this.isGCS), o9 = r5(t6, r11), i25 = ((_c = this.sourceRasterInfos[0].statistics) == null ? void 0 : _c[0]) ?? { min: 0, max: 8e3 };
    return c4(o9, t6, this.lookup.hsvMap, i25), o9.pixelType = this.outputPixelType, o9;
  }
  _getWebGLParameters() {
    var _a;
    const e9 = d2(this.functionArguments, { x: 1, y: 1 }, this.isGCS), t6 = a5(e9), { slopeType: s11, zFactor: o9, pixelSizeFactor: i25, pixelSizePower: n21 } = this.functionArguments, a29 = "scaled" === s11, { indexedColormap: u20, offset: m19 } = this.lookup, d9 = (_a = this.sourceRasterInfos[0].statistics) == null ? void 0 : _a[0], f9 = r3(this.outputPixelType);
    return { ...t6, indexedColormap: u20, offset: m19, zFactor: o9, gcsFactor: this.isGCS ? n3 : 1, pixelSizeFactor: a29 ? i25 : 0, pixelSizePower: a29 ? n21 : 0, minValue: (d9 == null ? void 0 : d9.min) ?? 0, maxValue: (d9 == null ? void 0 : d9.max) ?? 8e3, isOutputRounded: f9 };
  }
};
...
var u18 = class extends p3 {
  ...
  _getWebGLParameters() {
    ...
    return { zFactor: this.isGCS && t6 >= 1 ? t6 * n3 : t6, slopeType: e9, pixelSizeFactor: s11 ?? 0, pixelSizePower: o9 ?? 0, isOutputRounded: r3(this.outputPixelType) };
  }
};
...
var c33 = class extends p3 {
  ...
  _bindSourceRasters() {
    ...
    if (!r11 && ["u8", "u16", "s8", "s16"].includes(s11)) {
      ...
      this.lookup = l4({ pixelType: s11, ...r12, gamma: i25 ? u20 : null, rounding: a30 }), this.cutOffs = r12;
...
//# sourceMappingURL=chunk-TSHHVJ4G.js.map

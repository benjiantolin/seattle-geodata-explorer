...
var G = class extends u {
  ...
  async applyEdits(e2, t3) {
    ...
    await i3(this.layer.url, g3, true);
    ...
    w && (S2.authMode = "immediate", S2.query.returnEditMoment = true, S2.query.sessionId = t);
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: r2 } = await import("./uploadAssets-V3Y3WEJN.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t2(t4)) s4.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: r3 } = await import("./convertMeshVertexSpace-L6C2XG6K.js"), n = await r3(e3, new i4({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-46AHQM2Z.js.map

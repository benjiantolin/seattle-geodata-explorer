...
import {
  e as e9,
  u as u8
} from "./chunk-UMHR7PB5.js";
import {
  t as t6
} from "./chunk-YYGF76T3.js";
import {
  n2 as n7
} from "./chunk-X5M5NH5S.js";
import "./chunk-RQGBRVDD.js";
import "./chunk-R7ZVQFHI.js";
import {
  d as d4,
  i as i9,
  i2 as i10,
  ...
  r as r5,
  t as t5
} from "./chunk-BZP4RCT7.js";
import {
  O,
  a as a3,
  u as u7
} from "./chunk-D725L7HJ.js";
import {
  i as i8
} from "./chunk-22SBTWYJ.js";
import "./chunk-QFQ2IMDQ.js";
import {
  i as i7,
  s as s7,
  u as u6
} from "./chunk-4N3FLXE3.js";
import {
  d as d3
} from "./chunk-BOYMSJFH.js";
import {
  r as r3
} from "./chunk-HQDN4CBB.js";
import {
  _ as _2,
  e as e6,
  i as i6,
...
import {
  a as a2
} from "./chunk-YUDM3MW7.js";
import {
  R
} from "./chunk-XRGGMUAQ.js";
import "./chunk-CZAZ6SBT.js";
import "./chunk-JUVXVRIC.js";
...
import "./chunk-B6P6WNQW.js";
import {
  f as f3,
  g
} from "./chunk-OAU2H7MN.js";
import "./chunk-WJ5RYEGC.js";
import {
  _
} from "./chunk-HWI5HXAT.js";
import "./chunk-24OKWLX2.js";
import "./chunk-VR6BKZKE.js";
import "./chunk-BD4RQBM6.js";
...
import {
  c as c2,
  y as y3
} from "./chunk-XTDYOEHO.js";
import {
  b as b3,
  h
} from "./chunk-LJRYNWEX.js";
import {
  n as n3
...
var e10 = class _e extends t8 {
  static async fromDictionaryRenderer(r10, o8) {
    const n12 = await s6.from(o8.dictionaryInfo, o8.userConfig, o8.fieldMap);
...
var i14 = class extends e12 {
  constructor(r10, t17, s17, n12, i21) {
    super(r10, t17, i21), this.spatialReference = s17, this.aggregateFields = n12, this._arcadeDependencies = /* @__PURE__ */ new Set(), this.events = new i4(), this.featureAdapter = e5;
    for (const e15 of n12) u5(this._arcadeDependencies, e15.computed);
  }
  ...
  async *_update(e15, t17) {
    ...
    for (const c8 of i21.values()) {
      ...
      if (e16) e16.attributes = c8.getAttributes();
        ...
        e16 = new s5(t18, c8.getAttributes(), null, c8.id), t18 || (e16.centroid = c8.getGeometricCentroid(this.spatialReference, d10)), e16.displayId = this._attributeStore.createDisplayIdForObjectId(`${e16.objectId}.${u12}`), o8.set(c8.id, e16);
      }
      l11.push(e16);
    }
...
var S = class {
  ...
  *aggregatesWorldSpace() {
    for (const e15 of this._clusters.values()) {
      const s17 = e15.inner.getCentroid(null), i21 = new s5(s17, e15.inner.getAttributes(), null, e15.inner.id, e15.displayId);
      yield i21;
    }
  }
  clusters() {
  ...
  updateChunks(e15, t17) {
    ...
    const i21 = { xMin: 1 / 0, yMin: 1 / 0, xMax: -1 / 0, yMax: -1 / 0 }, r10 = r5(this._indexOptions.spatialReference, this._scale), n12 = this._indexOptions.cellSize;
  ...
  createAggregateFeatures(e15, i21) {
    ...
    for (const o8 of this._clusters.values()) {
      ...
      if (null != u12) if (1 === u12) {
        const n13 = new e3([], [e16, i22]), l12 = new s5(n13, o8.inner.getAttributes(), null, c8, h7);
        l12.geometry.coords[0] -= o, a9.push(l12);
        const d11 = new e3([], [e16, i22]), u13 = new s5(d11, o8.inner.getAttributes(), null, c8, h7);
        u13.geometry.coords[0] += o, a9.push(u13);
      } else e16 > o + o / 2 ? e16 -= u12 * o : e16 < -256 && (e16 += u12 * o);
      if (e16 < o + m5 && e16 >= -m5 && i22 < o + m5 && i22 >= -m5) {
        const r10 = new e3([], [e16, i22]), n13 = new s5(r10, o8.inner.getAttributes(), null, c8, h7);
        a9.push(n13);
      }
    }
  ...
  _clusterCells(e15) {
    ...
    this._clusters.clear();
    const i21 = this._clusterRadius * (1 / r5(this._indexOptions.spatialReference, this._scale)), r10 = 1 + this._clusterRadius / this._indexOptions.cellSize, n12 = /* @__PURE__ */ new Set();
  ...
  *previousObservations() {
  ...
  commitObservations(t17, e15, r10) {
    ...
    if (null != c8) {
      ...
      const d10 = new s5(n13.readGeometryWorldSpace(), { ...n13.readAttributes(), [r2]: 1 }, null, i22, o9);
  ...
  getLatestObservationFeatureForTile(t17) {
    ...
    return new s5(a9, i21, null, e15, s17);
  }
...
var U = class _U extends i14 {
  static async create(t17, e15, s17, a9, o8) {
    ...
    return n12.isWrappable || s7() || await Promise.all([import("./apiConverter-F32TOH5T.js"), import("./jsonConverter-N2AA5VQM.js"), i7()]).then(([t18, e16, s18]) => {
...
function q(t17, e15, s17) {
  ...
  if (s17.isWrappable) {
    ...
    if (r11) {
      const r12 = a2({ paths: [e15], spatialReference: s17 });
  ...
  if (null != i21) {
    const e16 = u6(r10, 1e6, i21, e4.geodesic);
    if (null != e16) {
...
var b5 = class {
  ...
  async update(t17, s17, r10, i21, o8) {
    ...
    has("esri-2d-update-debug") && console.debug(`Version[${this._version}] SymbolProcessor.update`, { changes: y2(this._schema, n12), schema: n12 }), this._schema = n12;
...
var I = class _I extends O {
  ...
  get usedMemory() {
    var _a;
    return s4 + (((_a = this._cache.geometry) == null ? void 0 : _a.usedMemory) ?? 0);
  }
  ...
  _readAttributeAtIndex(e15) {
    ...
    if (t17 || (t17 = new a3(this.getSize()), this._parseCaches[e15] = t17), t17.has(this._featureIndex)) return t17.get(this._featureIndex);
...
var f6 = class extends c6 {
  async executeQuery(t17, s17) {
    ...
    if (null != t17.quantizationParameters && !u12.supportsQuantization) {
      const u13 = t17.clone(), c9 = s3(u13.quantizationParameters);
      u13.quantizationParameters = null;
      const { data: m10 } = await y3(i21, u13, this._metadata.spatialReference, s17), l11 = at(m10, this._metadata.featureIdInfo);
      return mt(c9, l11), u7.fromOptimizedFeatureSet(l11, this._metadata);
    }
    const { data: c8 } = await y3(i21, t17, this._metadata.spatialReference, s17);
...
var h6 = class extends c6 {
  async executeQuery(t17, a9) {
    if (t17.quantizationParameters && !this.service.queryMetadata.supportsQuantization) {
      const i22 = t17.clone(), o8 = s3(i22.quantizationParameters);
...
var u11 = class extends e14 {
  ...
  async _insert(e15) {
    const s17 = await d3(e15, { geometryInfo: this._service.geometryInfo, outSpatialReference: this._service.outSpatialReference, getCustomParameters: () => this._schema.full.customParameters }), i21 = this._files.size;
...
var i20 = class extends i10 {
  ...
  getTileReader(e15) {
    if (this._tile.key.id === e15.key.id) {
      ...
      const i21 = d4.from(this.reader, r10);
...
var _5 = class __ {
  static async create(e15, t17, i21, a9, s17, r10) {
    const n12 = await Promise.all(e15.map((e16) => d3(e16, { geometryInfo: i21.geometryInfo, outSpatialReference: i21.outSpatialReference, getCustomParameters: r10 })));
...
var a8 = class {
  ...
  checkForUpdates() {
    ...
    if (null != t17) {
      ...
      for (const e16 of t17) i22.has(e16.objectId) || (e16.attributes[e6] = s17, e16.attributes[i6] = d10, this.store.add(e16), n12.push(e16));
    }
  ...
  _purgeByAgeReceived(t17, e15) {
    ...
    this.store.forEach((t18) => {
      t18.attributes[e6] < s17 && this._removed.push(t18.objectId);
    });
  }
  _purgeTracks() {
...
var _6 = class {
  ...
  async normalizeOverrides(e15) {
    const t17 = { historicMoment: e15.historicMoment, commands: { updateWeak: e15.commands.updateWeak.map(s5.fromJSON), removeWeak: e15.commands.removeWeak, update: e15.commands.update.map(s5.fromJSON), remove: e15.commands.remove, release: e15.commands.release } }, r10 = e15.commands.updateByIdWeak, s17 = await this._queryOptimizedFeatures(r10);
...
//# sourceMappingURL=FeaturePipelineWorker-SCOOZGC4.js.map

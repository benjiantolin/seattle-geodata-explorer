...
import {
  ...
  n3,
  s as s10
} from "./chunk-KDMVVSY7.js";
import {
  l2 as l9,
  u as u4
} from "./chunk-WNUS3FLV.js";
import "./chunk-UEXDDXQX.js";
import {
  c as c2
} from "./chunk-7ANRKZRD.js";
import {
  $ as $2,
  V as V2,
  a as a5,
  ...
  p as p3,
  v as v2
} from "./chunk-XGVRWHSL.js";
import "./chunk-RIXOC2FJ.js";
import "./chunk-QNN2XBH3.js";
import {
  $,
  R,
  j as j2
...
import "./chunk-C2SDGZZF.js";
import "./chunk-KX4HGABW.js";
import "./chunk-TBEQWJEZ.js";
import "./chunk-NNK2Y52N.js";
import {
  i as i3,
  s as s8
} from "./chunk-VDXCLZFX.js";
import {
  s as s9
} from "./chunk-O6OARNME.js";
import "./chunk-XTDYOEHO.js";
import "./chunk-LJRYNWEX.js";
import "./chunk-KL5R6FKC.js";
import "./chunk-UUB4WLND.js";
import "./chunk-ZT4KW2M5.js";
import {
  t as t2
} from "./chunk-SE4IXQOK.js";
...
import {
  ...
  s as s6,
  u
} from "./chunk-2ZY7PTJB.js";
import "./chunk-E5B7PBPK.js";
import "./chunk-VZYJZNPE.js";
import "./chunk-SNXTUMI2.js";
import {
  t as t3
} from "./chunk-R4TLHDS7.js";
import {
  l as l6
} from "./chunk-EPQZNI53.js";
import {
  l as l7
} from "./chunk-NXCX4HDY.js";
import "./chunk-ZRHZ2A47.js";
import {
  o as o3,
  s as s4
} from "./chunk-J5P4ZI2J.js";
import {
  s as s5
} from "./chunk-66TSTH25.js";
import {
  j
} from "./chunk-OCVLB3W3.js";
import "./chunk-2U5Y4M5N.js";
import {
  g
} from "./chunk-AFWHDTMC.js";
import "./chunk-MIQEE3N2.js";
import {
  f as f4
} from "./chunk-ICHPWGSN.js";
import {
  p
} from "./chunk-OAGWACR3.js";
import {
  t
} from "./chunk-NU2PBXEI.js";
import {
  b2 as b,
  d,
  l as l5,
...
import {
  l as l4
} from "./chunk-KGYLZORI.js";
import "./chunk-OUQ3NM7X.js";
...
import "./chunk-6V3MSAE6.js";
import "./chunk-UG5JX53Z.js";
import {
  V
} from "./chunk-UB2PSBEQ.js";
...
__decorate([m2({ type: Number, json: { write: true } })], i9.prototype, "area", void 0), __decorate([m2({ types: l3, json: { name: "shape", write: true } })], i9.prototype, "geometry", void 0), __decorate([o("geometry")], i9.prototype, "readGeometry", null), i9 = __decorate([a3("esri.rest.support.ImageBoundaryResult")], i9);
...
__decorate([m2({ types: l3, json: { name: "Shape", read: f3, write: true } })], i11.prototype, "geometry", void 0), __decorate([m2({ json: { name: "Length", write: true } })], i11.prototype, "length", void 0), __decorate([m2({ json: { name: "Area", write: true } })], i11.prototype, "area", void 0), __decorate([m2({ type: _, json: { name: "Center", write: true } })], i11.prototype, "center", void 0), __decorate([o("center")], i11.prototype, "readCenter", null), i11 = __decorate([a3("esri.rest.support.MeasureAreaFromImageResult")], i11);
...
__decorate([m2({ types: l3, json: { name: "fromGeometry", read: f3, write: true } })], y9.prototype, "geometry", void 0), __decorate([r("geometry")], y9.prototype, "writeGeometry", null), __decorate([m2({ json: { write: true } })], y9.prototype, "rasterId", void 0), y9 = c12 = __decorate([a3("esri.rest.support.MeasureFromImageParameters")], y9);
...
__decorate([m2({ types: l3, json: { name: "Shape", read: f3, write: true } })], m10.prototype, "geometry", void 0), __decorate([m2({ json: { name: "Length", write: true } })], m10.prototype, "length", void 0), m10 = __decorate([a3("esri.rest.support.MeasureLengthFromImageResult")], m10);
...
async function k(r3, o6, a10) {
  ...
  const p19 = f5(r3), u9 = u({ ...p19.query, f: "json", ...s13 }), c13 = s6(u9, a10), { data: f11 } = await H(`${p19.path}/calculateVolume`, c13);
...
async function z2(o6, a10, s13) {
  ...
  const u9 = f5(o6), l16 = u({ ...u9.query, f: "json", ...p19 }), g4 = s6(l16, s13), { data: y10 } = await H(`${u9.path}/computeAngles`, g4);
...
async function E2(r3, o6, a10) {
  ...
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...s13 }), f11 = s6(c13, a10), { data: l16 } = await H(`${u9.path}/computePixelLocation`, f11);
...
async function Q(r3, o6, s13) {
  ...
  const f11 = f5(r3), l16 = u({ ...f11.query, f: "json", ...p19 }), g4 = s6(l16, s13), { data: y10 } = await H(`${f11.path}/getSamples`, g4), j4 = y10.samples.map((t6) => {
...
async function W2(r3, o6, s13) {
  ...
  return P2(u9).then((e5) => {
    ...
    const n11 = u({ ...p19.query, f: "json", ...r4 }), u10 = s6(n11, s13);
...
async function et(e5, r3, o6, s13) {
  ...
  const f11 = u({ ...p19.query, f: "json", ...c13 }), l16 = s6(f11, s13), { data: g4 } = await H(p19.path + "/measure", l16);
  return g4;
}
...
async function at(r3, o6, a10) {
  o6 = m(y9, o6);
  const s13 = f5(r3), p19 = o6.toJSON(), u9 = u({ ...s13.query, f: "json", ...p19 }), c13 = s6(u9, a10), { data: f11 } = await H(s13.path + "/measureFromImage", c13);
  return f11;
}
function st(t6) {
  var _a;
...
async function it(r3, o6, a10) {
  ...
  const u9 = u({ ...s13.query, f: "json", ...p19 }), c13 = s6(u9, a10), { data: f11 } = await H(s13.path + "/queryBoundary", c13);
...
async function pt(r3, o6, s13) {
  ...
  f11 && (p19.inSR = mt(f11));
  const l16 = f5(r3), g4 = u({ ...l16.query, f: "json", ...p19 }), y10 = s6(g4, s13), { data: j4 } = await H(`${l16.path}/queryGPSInfo`, y10);
...
async function ut(r3, a10, s13) {
  ...
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...p19 }), f11 = s6(c13, s13), { data: l16 } = await H(`${u9.path}/imageToMap`, f11);
  return f3(l16);
}
async function ct(r3, a10, s13) {
  ...
  const u9 = f5(r3), c13 = u({ ...u9.query, f: "json", ...p19 }), f11 = s6(c13, s13), { data: l16 } = await H(`${u9.path}/imageToMapMultiray`, f11);
  return f3(l16);
}
async function ft(r3, s13, p19) {
  ...
  l16 && (u9.inSR = mt(l16));
  const g4 = f5(r3), y10 = u({ ...g4.query, f: "json", ...u9 }), j4 = s6(y10, p19), { data: d8 } = await H(`${g4.path}/mapToImage`, j4);
  return f3(d8);
}
async function lt(r3, o6, a10) {
  const s13 = (o6 = m(p17, o6)).toJSON(), p19 = f5(r3), u9 = u({ ...p19.query, f: "json", ...s13 }), c13 = s6(u9, a10), { data: f11 } = await H(`${p19.path}/getImageUrl`, c13);
...
async function gt(r3, o6, s13) {
  ...
  const l16 = f5(r3), g4 = u({ ...l16.query, f: "json", ...c13 }), y10 = s6(g4, s13), { data: j4 } = await H(`${l16.path}/find`, y10);
...
async function n10(n11, m11, p19) {
  var _a, _b;
  const f11 = f5(n11), u9 = u({ ...f11 == null ? void 0 : f11.query, f: "json" }), h3 = s6(u9, p19), d8 = `${f11 == null ? void 0 : f11.path}/${m11}/info`, c13 = H(`${d8}`, h3), g4 = H(`${d8}/keyProperties`, h3), x3 = await Promise.allSettled([c13, g4]), y10 = "fulfilled" === x3[0].status ? x3[0].value.data : null, v4 = "fulfilled" === x3[1].status ? x3[1].value.data : null;
  let P4 = null;
  ((_a = y10.statistics) == null ? void 0 : _a.length) && (P4 = y10.statistics.map((e5) => ({ min: e5[0], max: e5[1], avg: e5[2], stddev: e5[3] })));
  const S2 = z.fromJSON(y10.extent), j4 = Math.ceil(S2.width / y10.pixelSizeX - 0.1), w3 = Math.ceil(S2.height / y10.pixelSizeY - 0.1), b7 = S2.spatialReference, k2 = new _({ x: y10.pixelSizeX, y: y10.pixelSizeY, spatialReference: b7 }), z3 = ((_b = y10.histograms) == null ? void 0 : _b.length) ? y10.histograms : null, L3 = new l8({ origin: y10.origin, blockWidth: y10.blockWidth, blockHeight: y10.blockHeight, firstPyramidLevel: y10.firstPyramidLevel, maximumPyramidLevel: y10.maxPyramidLevel });
  return new m6({ width: j4, height: w3, bandCount: y10.bandCount, extent: S2, spatialReference: b7, pixelSize: k2, pixelType: y10.pixelType.toLowerCase(), statistics: P4, histograms: z3, keyProperties: v4, storageInfo: L3 });
}
...
var He = (m11) => {
  ...
  let He2 = class extends h3 {
    ...
    async highlightPixels(e5, t6) {
      ...
      r3 ? await r3.highlightPixels({ ...e5, highlightOptions: i12 }, t6) : u4(e5.pixelBlock, e5.renderedPixelBlock, i12);
    }
    destroy() {
    ...
    async queryRasters(e5, t6) {
      ...
      const i12 = await s9(this.url, e5, t6), r3 = this.graphicOrigin;
    ...
    async queryRasterCount(e5, t6) {
      return { query: e5, requestOptions: t6 } = await this._prepareForQuery(e5, t6), s8(this.url, e5, t6);
    }
    ...
    async _fetchService(e5) {
      ...
      return Promise.all([i12, r3, s13]).then((e6) => {
        e6[1] ? this._set("rasterInfo", e6[1]) : this._set("rasterInfo", e6[0]), e6[2] && this._set("rasterFunctionInfos", e6[2]), this.internalRenderer && !this._isSupportedRenderer(this.internalRenderer) && (this._set("internalRenderer", null), i.getLogger(this).warn("ArcGISImageService", "Switching to the default renderer. Renderer applied is not valid for this Imagery Layer")), this._set("internalRenderer", this._configRenderer(this.renderer)), this.addHandles([l2(() => this.rasterFunction, (e7) => {
    ...
    _decodePixelBlock(e5, t6, i12) {
      return this._rasterJobHandler ? this._rasterJobHandler.decode({ data: e5, options: t6 }) : R2(e5, t6, i12);
    }
    ...
    async _requestArrayBuffer(e5) {
      ...
      const c13 = { signal: a10 }, h4 = "gif" === p19 || "bmp" === p19 || p19.includes("png") && ("png" === m12 || "jpg" === m12) ? R2(u9, { useCanvas: true, ...t6 }, c13) : this._decodePixelBlock(u9, { width: t6.width, height: t6.height, planes: null, pixelType: null, noDataValue: null, format: p19 }, c13);
    ...
    _updateFeatureWithMagDirValues(e5, t6) {
      ...
      const a10 = "esriImageServiceDataTypeVector-MagDir" === this.serviceDataType ? [n11.pixels[0][0], n11.pixels[1][0]] : l9([n11.pixels[0][0], n11.pixels[1][0]]);
...
var $3 = class extends p(l7(t(b(j(o5(He(i7(f4(s5(l6(l4(l(b5))))))))))))) {
  constructor(...e5) {
    super(...e5), this.graphicOrigin = new s11(this), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.type = "imagery", this._debouncedSaveOperations = L(async (e6, r3, t6) => {
      const { save: o6, saveAs: i12 } = await import("./imageryUtils-RVZ4NAOX.js");
      switch (e6) {
        case 0:
          return o6(this, r3);
        case 1:

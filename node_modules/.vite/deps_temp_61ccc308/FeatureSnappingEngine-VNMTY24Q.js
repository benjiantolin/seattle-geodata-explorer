...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-LJJZSFPQ.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-V6OXKX5G.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-6MTVK7U6.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-DE6WFX5V.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-VNMTY24Q.js.map

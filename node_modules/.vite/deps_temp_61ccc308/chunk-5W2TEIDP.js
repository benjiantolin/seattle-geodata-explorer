...
var w = class extends o4 {
  ...
  _writePlacedMarkers(s9, n5) {
    ...
    for (; null != m3; ) {
      ...
      if (Math.abs(e4) > r2 || Math.abs(t) > r2) {
        m3 = c4.next();
        continue;
      }
...
var F2 = class extends E {
  ...
  _placeStraightAlong(e4, i7, n5, a8) {
    ...
    if (l8.metricStart(this._createLineLabelMetric(c4, n5, a8, e4.x, e4.y)), x4) {
      ...
      if (!this._verticalPlacement || this._verticalPlacement === this._current.offsetDirection) {
        const t = r(_6, -1 * x5), [i8, r8] = h6.shapeBackground(i2(n2(), f7, t));
      ...
      if (!this._verticalPlacement || this._verticalPlacement !== this._current.offsetDirection) {
        const t = r(_6, x5), [i8, r8] = h6.shapeBackground(i2(n2(), f7, t));
  ...
  _placeFirst(e4, i7, s9, a8, l8 = false) {
    const { out: c4, id: h6, shaping: m3, zoomRange: u7, referenceBounds: f6 } = this._current, g3 = m3.glyphs, _5 = u2(this.evaluatedMeshParams.offsetX), p3 = u2(this.evaluatedMeshParams.offsetY), b2 = r(_5, p3), x4 = M(n2(), -e4.angle);
    S(b2, b2, x4);
    for (const t of g3) {
  ...
  _placeOnSegment(e4, i7, s9, a8, l8, c4, h6) {
    const { out: m3, id: u7, shaping: f6, referenceBounds: g3 } = this._current, _5 = f6.glyphs, p3 = e4.dx / e4.length, b2 = e4.dy / e4.length, x4 = { x: e4.x + s9 * -l8 * p3, y: e4.y + s9 * -l8 * b2 }, M3 = u2(this.evaluatedMeshParams.offsetX), P2 = u2(this.evaluatedMeshParams.offsetY), y3 = r(M3, P2), w2 = M(n2(), -e4.angle);
    S(y3, y3, w2);
    for (const t of _5) {
...
//# sourceMappingURL=chunk-5W2TEIDP.js.map

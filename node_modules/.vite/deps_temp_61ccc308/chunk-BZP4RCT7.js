...
var d2 = class _d extends O {
  ...
  setTransformForDisplay(r8) {
    ...
    if (null == t4) return void (this._displayTransform = u(r8));
    const s4 = u(t4), a4 = u(r8), [i8, d4] = s4.scale, [n8, o7] = s4.translate, [h3, u6] = a4.scale, [_2, l3] = a4.translate, c4 = i8 / h3, y = d4 / u6, p = (n8 - _2) / h3, m = (o7 - l3) / u6;
...
var a3 = class _a {
  static async create(t4) {
    const { metadata: s4, definitionExpression: r8 } = t4, i8 = r8 ? await u2(r8, s4.fieldsIndex) : null;
...
//# sourceMappingURL=chunk-BZP4RCT7.js.map

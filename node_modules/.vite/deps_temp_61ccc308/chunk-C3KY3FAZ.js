  ...
  evaluateNodeToWhereClause(e3, t4, r4 = null, s5 = null, a4) {
    ...
    switch (e3.type) {
      ...
      case "parameter": {
        ...
        if (f3(r5)) return T(r5, t4);
        if (Array.isArray(r5)) {
          const e4 = [];
          for (let s6 = 0; s6 < r5.length; s6++) "string" == typeof r5[s6] ? e4.push("'" + r5[s6].toString().replaceAll("'", "''") + "'") : c2(r5[s6]) || m2(r5[s6]) ? e4.push(A2(r5[s6], t4)) : d(r5[s6]) ? e4.push(E(r5[s6], t4)) : a2(r5[s6]) ? e4.push(y(r5[s6], t4)) : f3(r5[s6]) ? e4.push(T(r5[s6], t4)) : e4.push(r5[s6].toString());
          return e4;
        }
        return r5.toString();
      }
      ...
      if (r4 == null ? void 0 : r4.relatedRecordGroups) {
        ...
        for (const s6 of r4.relatedRecordGroups) {
          ...
          for (const t6 of s6.relatedRecords) {
            ...
            const r5 = new _({ geometry: t6.geometry ? f2(t6.geometry) : null, attributes: t6.attributes });
            n5.push(r5);
          }
...
//# sourceMappingURL=chunk-C3KY3FAZ.js.map

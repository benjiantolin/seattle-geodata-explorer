...
function t4() {
  return r3 ?? (r3 = (async () => {
    const { default: r6 } = await import("./draco_mesh_decoder-UNDL4Z5M.js");
...
var Y = class _Y {
  ...
  getNodeTransform(e7) {
    ...
    if (!t7) {
      ...
      o4.matrix ? t7 = c(e2(), r6, o4.matrix) : o4.translation || o4.rotation || o4.scale ? (t7 = t(r6), o4.translation && i2(t7, t7, o4.translation), o4.rotation && (J2[3] = v(J2, o4.rotation), b(t7, t7, J2[3], J2)), o4.scale && f(t7, t7, o4.scale)) : t7 = t(r6), this._nodeTransformCache.set(e7, t7);
    }
    return t7;
  }
  _resolveUri(e7) {
...
//# sourceMappingURL=chunk-44CVCRRQ.js.map

...
import {
  p as p2
} from "./chunk-HWCO567J.js";
import "./chunk-KKO4Z4UN.js";
import {
  j as j4
} from "./chunk-OMHBQBW7.js";
import {
  e as e2
} from "./chunk-LIPV7WRV.js";
...
var l5 = class {
  ...
  _getIndexedDataKey(e4, t3) {
    ...
    let i2 = t3;
    for (; 0 !== i2.level; ) i2 = new e3(i2.level - 1, i2.row >> 1, i2.col >> 1, i2.world), l8.push(i2);
...
var l6 = class {
  ...
  dataKey(e4, t3) {
    const { level: l8, row: s6, col: o6 } = e4, n3 = new e3(e4);
...
var l7 = class {
  ...
  getData(t3) {
    var _a;
    (null == this._promise || a3((_a = this._abortController) == null ? void 0 : _a.signal)) && (this._promise = this._makeRequest(this._tileUrl));
...
var B = class extends p(t(f3(p2(l3(b(j3(s4(o3(l(b2)))))))))) {
  ...
  load(e4) {
    const r3 = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: false }, e4).catch(f).then(async () => {
      ...
      (await H(r4, { ...e4, query: { f: "json", ...this.customParameters, token: this.apiKey }, authMode: this.portalItem.portal.authMode })).data && this.read({ url: r4 }, e2(this.portalItem, "portal-item"));
...
//# sourceMappingURL=VectorTileLayer-33GHAKPO.js.map

import {
  ...
  o as o2,
  o2 as o3
} from "./chunk-N3HD64V7.js";
import {
  e as e4
} from "./chunk-7QPS6ATI.js";
import {
  l as l4
} from "./chunk-44CVCRRQ.js";
import {
  t
...
function r3(s3, r4) {
  return new s3(new ArrayBuffer(r4 * s3.ElementCount * e4(s3.ElementType)));
}
...
async function G(e9, t7, r4) {
  ...
  return { mesh: { transform: null, vertexSpace: T3, components: u6.components, spatialReference: e9.spatialReference, vertexAttributes: new c({ ...j2, color: d == null ? void 0 : d.typedBuffer, uv: x == null ? void 0 : x.typedBuffer }) }, meta: s3.meta };
}
function K(e9) {
...
function H2(e9) {
  ...
  return { vertexAttributes: { position: r3(U, t7), normal: has.normal ? r3(o, t7) : null, tangent: has.tangent ? r3(T2, t7) : null, color: has.color ? r3(g2, t7) : null, texCoord0: has.texCoord0 ? r3(y, t7) : null }, parts: s3, components: [] };
}
function J(e9) {
  return new g({ data: (t(e9.data), e9.data), wrap: _(e9.parameters.wrap) });
}
function W(t7, r4) {
  const o6 = new u(re(t7.color, t7.opacity)), n3 = t7.emissiveFactor ? new u(oe(t7.emissiveFactor)) : null, a = (e9) => e9 ? new p2({ scale: e9.scale ? [e9.scale[0], e9.scale[1]] : [1, 1], rotation: M(e9.rotation ?? 0), offset: e9.offset ? [e9.offset[0], e9.offset[1]] : [0, 0] }) : null;
  return new u2({ color: o6, colorTexture: r4.get(t7.colorTexture), normalTexture: r4.get(t7.normalTexture), emissiveColor: n3, emissiveTexture: r4.get(t7.emissiveTexture), occlusionTexture: r4.get(t7.occlusionTexture), alphaMode: Z(t7.alphaMode), alphaCutoff: t7.alphaCutoff, doubleSided: t7.doubleSided, metallic: t7.metallicFactor, roughness: t7.roughnessFactor, metallicRoughnessTexture: r4.get(t7.metallicRoughnessTexture), colorTextureTransform: a(t7.colorTextureTransform), normalTextureTransform: a(t7.normalTextureTransform), occlusionTextureTransform: a(t7.occlusionTextureTransform), emissiveTextureTransform: a(t7.emissiveTextureTransform), metallicRoughnessTextureTransform: a(t7.metallicRoughnessTextureTransform) });
}
function X(e9, t7, r4) {
...
function Y(e9, t7) {
  ...
  if (e3(r4.slice(f4, d), m.position, p3), null != m.normal && null != o6) {
  ...
  if (null != m.tangent && null != n3) {
    ...
    n2(t8, m.tangent, e10), T(e10) && u4(t8, t8);
  ...
  if (null != m.texCoord0 && null != u6 ? o2(u6.slice(f4, d), m.texCoord0) : null != u6 && l2(u6, 0, 0, { dstIndex: f4, count: d }), null != m.color && null != s3) {
    ...
    if (4 === e10.elementCount) e10 instanceof T2 ? c2(t8, e10, 1, 255) : (e10 instanceof g2 || e10 instanceof M2) && c2(t8, e10, 1 / 255, 255);
    else {
      f3(t8, 255, 255, 255, 255);
      const r5 = O.fromTypedArray(t8.typedBuffer, t8.typedBufferStride);
      e10 instanceof o ? u3(r5, e10, 1, 255) : (e10 instanceof O || e10 instanceof V) && u3(r5, e10, 1 / 255, 255);
    }
...
//# sourceMappingURL=loadGLTFMesh-4QRFZBC7.js.map

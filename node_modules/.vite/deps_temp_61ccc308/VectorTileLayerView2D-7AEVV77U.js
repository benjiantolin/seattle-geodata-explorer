...
var e7 = class {
  constructor(e8, t7) {
    this._width = 0, this._height = 0, this._free = [], this._width = e8, this._height = t7, this._free.push(new t2(0, 0, e8, t7));
  }
  get width() {
    return this._width;
  }
  ...
  allocate(e8, t7) {
    if (e8 > this._width || t7 > this._height) return new t2();
    let i6 = null, s6 = -1;
    for (let h8 = 0; h8 < this._free.length; ++h8) {
      const w = this._free[h8];
      e8 <= w.width && t7 <= w.height && (null === i6 || w.y <= i6.y && w.x <= i6.x) && (i6 = w, s6 = h8);
    }
    return null === i6 ? new t2() : (this._free.splice(s6, 1), i6.width < i6.height ? (i6.width > e8 && this._free.push(new t2(i6.x + e8, i6.y, i6.width - e8, t7)), i6.height > t7 && this._free.push(new t2(i6.x, i6.y + t7, i6.width, i6.height - t7))) : (i6.width > e8 && this._free.push(new t2(i6.x + e8, i6.y, i6.width - e8, i6.height)), i6.height > t7 && this._free.push(new t2(i6.x, i6.y + t7, e8, i6.height - t7))), new t2(i6.x, i6.y, e8, t7));
  }
  release(h8) {
...
var h3 = class {
  ...
  getGlyphItems(s6, i6) {
    ...
    return n8.forEach((t7) => {
      ...
      for (const o4 of i6) {
        ...
        const l2 = a7.metrics;
        let c4;
        if (0 === l2.width) c4 = new t2(0, 0, 0, 0);
        else {
  ...
  bind(t7, e8, h8, r4 = 0) {
    if (!this._textures[h8]) {
      const e9 = new h(this.width, this.height);
...
var r3 = class _r {
  ...
  bind(t7, i6, s6 = 0, a6 = 0) {
    ...
    if (!this._textures[s6]) {
      const i7 = new h(this._size[s6][0], this._size[s6][1]);
...
var u3 = class extends n4 {
  ...
  setStyleResources(e8, t7, r4, o3) {
    if (this._spriteMosaic = e8, this._glyphMosaic = t7, this._styleRepository = r4, this.tileInfoView = o3, this._computeDisplayInfoView(o3), null == this._symbolFader) {
      ...
      this._symbolFader = new n3("vector-tile", this._styleRepository, e9, this.children, t);
    }
  ...
  _renderBackgroundLayers(t7, i6, l2) {
    ...
    for (const { row: a6, colFrom: h8, colTo: I2 } of g) for (let t8 = h8; t8 <= I2; t8++) {
      if (T2 < C.length) R = C[T2], R.key.set(_3, a6, b3.normalizeCol(t8), b3.getWorldForColumn(t8)), m4.getTileBounds(F, R.key, false), R.x = F[0], R.y = F[3], R.resolution = m4.getTileResolution(_3);
        ...
        R = new t5(i7, n9, l3[0], l3[3], o2, o2, t, t), C.push(R);
      }
...
var m3 = class _m {
  ...
  async queryAttributes(e8, t7, s6, i6, o3) {
    ...
    null === this._index && (this._index = new s2(100, f3), await this._indexLayers());
    const l2 = [];
  ...
  _indexLayer(e8, t7, r4, i6, n8, h8) {
    ...
    for (; g.next(); ) switch (g.tag()) {
      case 3: {
        ...
        const y3 = s6.getData(), w = s6.extent / i6, b3 = w * h8 - p5, x = w * n8 - p5, L = b3 + w + 2 * p5, v = x + w + 2 * p5, I2 = w / o2, T2 = t / w, D2 = w * h8, P2 = w * n8;
        for (; y3.nextTag(2); ) {
  ...
  _getSymbolAttributes(e8, t7, r4, i6, o3, n8) {
    ...
    for (; m4.next(); ) switch (m4.tag()) {
      case 3: {
        ...
        const f4 = s6.getData(), d6 = s6.extent / i6, _3 = t / d6, p5 = d6 * n8, g = d6 * o3;
        let w = 0;
        for (; f4.nextTag(2); ) {
...
//# sourceMappingURL=VectorTileLayerView2D-7AEVV77U.js.map

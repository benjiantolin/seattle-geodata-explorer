import {
  de
} from "./chunk-BC64JFSF.js";
import "./chunk-QHASFKEY.js";
import "./chunk-RIOHB6DZ.js";
import {
  c as c3
} from "./chunk-ICCIKCUP.js";
import "./chunk-N6VCR6JK.js";
import "./chunk-CGCTWHIE.js";
import "./chunk-UAU5YLNR.js";
import {
  j as j2
} from "./chunk-FY4GLIL7.js";
import "./chunk-XQYQ4KH2.js";
import {
  e as e4
} from "./chunk-OC6SAGIM.js";
import "./chunk-BFMCYGM4.js";
import "./chunk-3ZF5AOEZ.js";
import "./chunk-NXXZ2D2L.js";
import "./chunk-PXYPSB4F.js";
import "./chunk-NKRLUQCY.js";
import "./chunk-GPJ7JPVW.js";
import "./chunk-ZTXOWDR2.js";
import "./chunk-6XYB45HC.js";
import "./chunk-BNY4OFUS.js";
import "./chunk-OL6EYE44.js";
import "./chunk-H5UOYBJB.js";
import "./chunk-Z5AGYOIE.js";
import "./chunk-ULZ654EJ.js";
import {
  R,
  j,
  q,
...
var d3 = class extends b {
  constructor(t6) {
    super(t6), this._graphic = new _3(), this._layer = new n2({ listMode: "hide", internal: true }), this._updateGeometryThrottled = l3((t7) => {
      var _a;
  ...
  initialize() {
    this._layer.add(this._graphic), this.addHandles([f3(() => !this.analysisViewData.visible, () => {
  ...
  get _colorUpdateParameters() {
    ...
    return t6 ? { color: t6.toArray(), contrastColor: I(t6).toArray() } : null;
  }
  _updateColor(t6) {
...
async function y4(e10, t6, s6, o10, i5, a6, h4) {
  ...
  let v3 = 0;
  if (!j5) {
    const { execute: t7 } = await import("./lengthOperator-NWHWT7SG.js");
    s2(h4), v3 = t7(e10, { unit: "meters" }), s2(h4);
  }
  const P3 = 1 / ae(o10);
  if (j5) {
    await N3([{ source: y6, dest: o10 }, { source: y6, dest: f4.WGS84 }], h4);
    const n9 = q2(e10);
    p2 = R([n9], "meters")[0];
    const r6 = w3(p2, i5);
...
function R2(e10, t6, n9) {
  ...
  const r6 = e10.spatialReference, s6 = t6.mode, o10 = h2(t6, r6);
  let i5 = null;
  switch (n9.type) {
    case "2d":
      i5 = j3(e10, s6, o10);
...
function O2({ from: e10, to: t6, distance: n9 }, r6) {
  return I2([0, 0, 0], e10, t6, r6 / n9);
}
function q2(e10) {
  return y3(e10.spatialReference) ? e10 : W(e10, f4.WGS84);
}
function B(e10) {
...
function S2(e10) {
  return new _4({ priority: f5.ELEVATION_PROFILE, concurrency: 1, scheduler: e10, process: async (e11) => {
    s2(e11.parameters);
    try {
      await U4(e11);
    } catch (t6) {
...
var L2 = class extends b {
  constructor(e10) {
    super(e10), this._sketchViewModels = new O(), this._updatingHandles = new h3(), this._operationManager = new s5();
  }
  initialize() {
    const { view: e10 } = this;
  ...
  _ensureUpdatedSketchGraphic() {
    ...
    const s6 = this.sketchGraphic ?? (this.sketchGraphic = new _3({ symbol: this._lineSymbol, geometry: e10 }));
...
//# sourceMappingURL=ElevationProfileAnalysisView2D-6ZXLOMYW.js.map

...
import {
  u as u11
} from "./chunk-2PWFYOVL.js";
import "./chunk-OQCI6YCQ.js";
import "./chunk-GNPZDMA5.js";
import {
  r as r6
} from "./chunk-TSLT57S3.js";
import {
  d as d5
} from "./chunk-BVQZV6AW.js";
import "./chunk-F7X3664Z.js";
import {
  U as U3,
  ie,
  w as w3
} from "./chunk-H2RVWUUC.js";
import "./chunk-PMRXQHDJ.js";
import {
  c as c5
...
import "./chunk-7F6P4WYR.js";
import "./chunk-RFGF7PID.js";
import "./chunk-AO76W5ZH.js";
...
import "./chunk-ADB7BSME.js";
import {
  u as u8
} from "./chunk-AFBEX4BJ.js";
import {
  o as o6,
  t2 as t5
...
import "./chunk-N3JWGMFF.js";
import "./chunk-AF3MS4TP.js";
import {
  s as s10,
  t as t8
} from "./chunk-EFAFQXXH.js";
import "./chunk-BPSN5NKI.js";
import {
  a as a8,
  g as g4,
  p as p3
} from "./chunk-U3WUQFII.js";
import {
  s as s9
} from "./chunk-W6HDQKG4.js";
import {
  h as h5
...
import "./chunk-PLAGXEMV.js";
import {
  s as s3
} from "./chunk-SNXTUMI2.js";
import {
  n as n3
...
import {
  $ as $2
} from "./chunk-UG5JX53Z.js";
import "./chunk-UB2PSBEQ.js";
import {
  d as d3,
  y as y2
} from "./chunk-HDUVVW32.js";
...
async function l11(l14, m9, d15, j6, u19) {
  ...
  s2(u19);
  const S4 = [], b9 = /* @__PURE__ */ new Set(), z5 = /* @__PURE__ */ new Set(), E5 = new o9(), F4 = t3(0, 0, 0, f3.WGS84), P6 = new x(), U5 = n2();
  ...
  for (const { objectId: e22, points: o12 } of x4) {
    ...
    E5.setFromElevationInfo(l7(i10, I3)), R2 && E5.updateFeatureExpressionInfoContextForGraphic(R2, t15.graphic, m9);
...
var d11 = class extends b {
  constructor(t15) {
    super(t15), this.events = new i2(), this.hasZ = null, this.hasM = null, this.objectIdField = null, this.featureAdapter = { getAttribute: (t16, e22) => "graphic" in t16 ? t16.graphic.attributes[e22] : e9.getAttribute(t16, e22), getAttributeAsTimestamp(t16, e22) {
      const r15 = this.getAttribute(t16, e22);
      return "number" == typeof r15 ? r15 : new Date(r15).getTime();
    }, getAttributes: (t16) => "graphic" in t16 ? t16.graphic.attributes : e9.getAttributes(t16), getObjectId: (t16) => "graphic" in t16 ? R(t16.graphic, this.objectIdField) ?? void 0 : e9.getObjectId(t16), getGeometry: (t16) => "graphic" in t16 ? t16.getAsOptimizedGeometry(this.hasZ, this.hasM) : e9.getGeometry(t16), getCentroid: (t16, e22) => {
      if ("graphic" in t16) {
        let r15 = null;
        null != t16.centroid ? r15 = t16.centroid : "point" === t16.graphic.geometry.type && $3(t16.graphic.geometry, l12, this.viewSpatialReference) && (r15 = l12);
      ...
      return e9.getCentroid(t16, e22);
    }, cloneWithGeometry: (t16, e22) => "graphic" in t16 ? new s5(e22, this.featureAdapter.getAttributes(t16), null, this.featureAdapter.getObjectId(t16)) : e9.cloneWithGeometry(t16, e22) };
  }
...
var l13 = class extends m3 {
  constructor(e22, r15) {
    super(e22, r15, new t7(u11, () => import("./LineCallout.glsl-AV7V65C4.js")), a11.locations);
  }
  initializePipeline(e22) {
    const { hudDepth: t15, terrainDepthTest: r15 } = e22, o12 = { func: r15 ? 519 : 513 };
    return T3(t15 ? { depthTest: o12, depthWrite: c4 } : { blending: e8(1, 770, 771, 771), depthTest: o12, colorWrite: d4 });
  }
};
...
var m7 = class extends s7 {
  constructor(e22, t15) {
    super(e22, S2), this.intersectDraped = void 0, this.produces = /* @__PURE__ */ new Map([[15, (e23) => o6(e23)], [16, (e23) => o6(e23)]]), this._configuration = new r11(t15), this._uniqueMaterialIdentifier = g5(this.parameters);
  }
  passParameters() {
...
var O3 = [r5(0, 0), r5(1, 0), r5(0, 1), r5(1, 0), r5(1, 1), r5(0, 1)];
var $4 = class {
  constructor() {
    this.layout = a11;
  }
  ...
  write(e22, t15, r15, i10, s18, n11) {
    z3(r15.get("position"), e22, s18.position, n11, 6), S(r15.get("normal"), t15, s18.normal, n11, 6), h4(r15.get("centerOffsetAndDistance"), s18.centerOffsetAndDistance, n11, 6);
...
var _O = class _O extends m5 {
  ...
  get _materialParameters() {
    ...
    if (s18.color) {
      const t15 = u5.toUnitRGBA(s18.color);
    ...
    r15.borderColor = null != ((_a = s18.border) == null ? void 0 : _a.color) ? u5.toUnitRGBA(s18.border.color) : null;
  ...
  createGraphics3DGraphic(e22, t15) {
    ...
    if ("point-3d" === s18.type && s18.symbolLayers.every((e23) => "text" === e23.type && !l6(e23))) return null;
...
var O4 = _O;
function j3(e22) {
  const { translation: t15, centerOffset: r15 } = e22, n11 = new t4(t15 ? [t15[0], t15[1], t15[2]] : [0, 0, 0], P4, 3, true), i10 = new t4(r15 ? [r15[0], r15[1], r15[2], r15[3]] : [0, 0, 0, 1], P4, 4, true);
  return [["position", n11], ["normal", new t4([0, 0, 1], P4, 3, true)], ["centerOffsetAndDistance", i10]];
}
var P4 = [0];
...
var E3 = class extends l9 {
  constructor(e22, t15, i10 = n2(), s18 = n4(), a15 = 0, o12 = "world", l14 = 0) {
...
function e14(o12, l14) {
  if (!o3(o12)) return t10().error("Graphics3DCalloutSymbolLayerFactory#make", `symbol of type '${o12.type}' does not support callouts`), null;
...
function i6(r15, i10, s18, f12) {
  return null != r15 && (T(i10, f12) ? (a3(s18, r15), true) : (p5[0] = r15[0], p5[1] = r15[1], p5[2] = 0, !!o4(p5, i10, 0, p5, f12, 0) && (s18[0] = p5[0], s18[1] = p5[1], p5[0] = r15[2], p5[1] = r15[3], p5[2] = 0, !!o4(p5, i10, 0, p5, f12, 0) && (s18[2] = p5[0], s18[3] = p5[1], true))));
}
var p5 = n2();
...
var v3 = class {
  ...
  computeExtent(e22) {
    if (!this._extent) {
      ...
      this._extent = i3(), z4(t15, this._extent);
  ...
  computeAttachmentOrigin() {
    ...
    return e22.render.num > 1 && g3(e22.render.origin, e22.render.origin, 1 / e22.render.num), e22.draped.num > 1 && l4(e22.draped.origin, e22.draped.origin, 1 / e22.draped.num), e22;
  }
  async getProjectedBoundingBox(e22, i10, r15, s18, a15) {
    return a15 || (a15 = { boundingBox: null, requiresDrapedElevation: false, screenSpaceObjects: [] }), a15.boundingBox ? q(a15.boundingBox) : a15.boundingBox = q(), a15.requiresDrapedElevation = false, await a4(this.layers, async (t15) => {
      if (null == t15) return;
...
var h6 = class extends r9 {
  ...
  async doLoad(e22) {
    ...
    const i10 = [];
    if (!m8) {
      const { make: e23 } = await import("./Graphics3DSymbolLayerFactory-UIMO3BRQ.js");
      m8 = e23;
    }
    ...
    if (await a4(this.symbolLayers, async (e23, t15) => {
      if (null != e23) try {
...
var g6 = class extends l2 {
  ...
  elevationInfoChanged() {
    ...
    if (null != e22 && "on-the-ground" !== e22.mode) {
      const t15 = ne(this.layer.spatialReference), r15 = n3(e22.unit ?? "meters");
...
function u16(l14, m9, u19) {
  ...
  let i10 = true;
  return e18[0] = null != l14.xmin ? l14.xmin : 0, e18[1] = null != l14.ymin ? l14.ymin : 0, e18[2] = null != l14.zmin ? l14.zmin : 0, i10 = i10 && o4(e18, l14.spatialReference, 0, e18, u19, 0), m9[0] = e18[0], m9[1] = e18[1], e18[0] = null != l14.xmax ? l14.xmax : 0, e18[1] = null != l14.ymax ? l14.ymax : 0, e18[2] = null != l14.zmax ? l14.zmax : 0, i10 = i10 && o4(e18, l14.spatialReference, 0, e18, u19, 0), m9[2] = e18[0], m9[3] = e18[1], null == l14.xmin && (m9[0] = -1 / 0), null == l14.ymin && (m9[1] = -1 / 0), null == l14.xmax && (m9[2] = 1 / 0), null == l14.ymax && (m9[3] = 1 / 0), i10;
}
var e18 = n2();
...
var ke = (_b = class extends b {
  ...
  _getConvertedSymbol(e22) {
    ...
    const r15 = u6(t15, { geometryType: ((_a = this.layer) == null ? void 0 : _a.geometryType) ?? void 0, retainId: true, hasLabelingContext: this._hasLabelingContext(t15), cimFallbackEnabled: true }), a15 = r15.symbol || null;
  ...
  async _initializeAsync() {
    ...
    }, w)]), this._frameTaskHandle = t15.resourceController.scheduler.registerTask(f6.GRAPHICS_CORE, this), this.layer && "featureReduction" in this.layer && this.addHandles(l3(() => this.layer.featureReduction, () => {
      var _a2;
  ...
  _updateStageLayerVisibility() {
    var _a, _b2;
    const e22 = this._visible && (null == this.layer.opacity || this.layer.opacity >= o7);
  ...
  runTask(e22) {
    if (this._dataUpdateQueue.runTask(e22), this._updateQueue.runTask(e22), this._applyPendingUpdates(e22), this._applyFocusAreasUpdates(e22), this.notifyChange("readyToRun"), this.readyToRun || this.notifyChange("dataUpdating"), this.notifyChange("updatingRemaining"), !e22.hasProgressed) return o8;
  }
  ...
  async _boundsForGraphics3DGraphic(e22, t15) {
    const i10 = this._viewSpatialReference, r15 = this.owner.view.renderSpatialReference, s18 = this.owner.view.basemapTerrain.spatialReference, a15 = (e23, t16, s19) => o4(e23, r15, t16, e23, i10, t16, s19), n11 = (e23, t16, r16) => o4(e23, s18, t16, e23, i10, t16, r16), o12 = this._viewElevationProvider ? { service: this._viewElevationProvider, useViewElevation: null != t15 && !!t15.useViewElevation, minDemResolution: null != t15 ? t15.minDemResolution : null, minDemResolutionForPoints: this.owner.view.resolution } : null, l14 = await e22.getProjectedBoundingBox(a15, n11, o12, t15 == null ? void 0 : t15.signal);
    if (!l14) return null;
  ...
  computeAttachmentOrigin(e22, t15) {
    ...
    if (r15.draped.num > 0) {
      ...
      if (o5(Be, e23, i11, a15), !n6(Be, this._viewElevationProvider.spatialReference, Be, t15)) return null;
      u7(He, He, Be), s18++;
    }
    return s18 > 1 && g3(He, He, 1 / s18), new _({ x: He[0], y: He[1], z: He[2], spatialReference: t15 });
  }
  ...
  _graphicUpdateSymbolHandler(e22, t15) {
    ...
    if (r15.prepareSymbolPatch(l14), !d3(l14.diff)) return void this._recreateGraphic(i10);
  ...
  _addGraphic(e22, t15, i10) {
    var _a;
    if (this._graphicsWithoutSymbol.set(e22.uid, e22), null == (t15 == null ? void 0 : t15.symbol) || !b6(e22)) return;
    ...
    if (r15 && this.setUidToIdOnAdd) {
      ...
      r15.setUidToObjectAndLayerId(e22.objectId, e22.uid, this.layer.id, this.owner.layerViewUid, o2(this.layer) && !!this.layer.popupEnabled && !t16 && u8(this.layer, (_a = this.owner.view.popup) == null ? void 0 : _a.defaultPopupTemplateEnabled));
    }
  ...
  _hasLabelingContext(e22) {
    if (e22 instanceof f4 || e22 instanceof g2) {
  ...
  _hasValidSymbolCreationContext(e22) {
    return !(e22 instanceof f4 && !this._hasLabelingContext(e22)) || (i.getLogger(this).error("LabelSymbol3D is only valid as part of a LabelClass. Using LabelSymbol3D as a renderer symbol is not supported."), false);
  }
  _getRenderingInfo(e22, t15 = true) {
    ...
    const r15 = this.rendererHasGeometryOperations ? c5(e22, this.layer, null) : e22;
    let a15;
  ...
  _getRenderingInfoAsync(e22, t15) {
    ...
    const i10 = this.rendererHasGeometryOperations ? c5(e22, this.layer, null) : e22;
  ...
  _createGraphics3DSymbol(e22, t15) {
    ...
    if (null != t15 && "backgroundFillSymbol" in t15 && t15.backgroundFillSymbol) {
      const e23 = u6(t15.backgroundFillSymbol, { ignoreDrivers: true });
  ...
  getOrCreateGraphics3DSymbol(e22, t15) {
    ...
    if (void 0 === i10) {
      ...
      i10 = null != r15 ? r15 : e22 instanceof b3 ? new e16(e22, (e23) => this._dataUpdateQueue.push(e23, null), (e23) => this._createGraphics3DSymbol(e23, t15)) : this._createGraphics3DSymbol(e22, t15), this._symbols.set(e22.id, i10), this._symbolMaterials = null;
    }
  ...
  _applySymbolSetDiff(e22, t15, i10) {
    ...
    for (const s18 of t15) {
      ...
      t16 && t16.forEach((a15, n11) => {
        const o12 = a15.graphic, l14 = this.layer instanceof b5 ? this.layer : null, h11 = this._arcadeOnDemand;
        if (s18 === i10.defaultSymbol && i10.getSymbol(c5(o12, l14, null), { arcade: h11 }) === i10.defaultSymbol) return;
  ...
  _applyRendererDiff(e22, t15, i10) {
    ...
    if (t15 instanceof $2 && i10 instanceof $2 && this._applyUniqueValueRendererDiff(e22, t15, i10) && 0 === Object.keys(e22.diff).length) return true;
...
var a13 = class {
  ...
  add(t15) {
    this._contains(t15) || (this._removeContained(t15), a3(this._extents.pushNew(), t15), this._dirty = true);
  }
  pop() {
      ...
      for (let i10 = 0; i10 < e22.length; ++i10) {
        ...
        if (a16) {
          ...
          o12.forEach((i11) => {
            ...
            M(a16, i11, d15);
            const c11 = l14 + _5;
            (p(d15) - c11) / c11 < h7 && (a3(a16, d15), o12.delete(i11), e22.remove(i11), t15.madeProgress());
          }), o12.add(a16);
        }
      }
    }
...
function p6(t15) {
  return null == t15 ? f6.ELEVATION_ALIGNMENT : "relative-to-scene" === t15 ? f6.ELEVATION_ALIGNMENT_SCENE : f6.ELEVATION_ALIGNMENT;
}
...
var b8 = { dir: n2(), len: 0, clip: n5() };
function h9(r15, c11, o12, f12) {
  const l14 = b8;
  return r15 ? (o12 && f12 && (l14.len = p2(c11, o12)), s6(l14.dir, r15)) : f12 ? (l14.len = p2(c11, o12), c2(l14.dir, o12, c11), g3(l14.dir, l14.dir, 1 / l14.len)) : (c2(l14.dir, o12, c11), A2(l14.dir, l14.dir)), l14;
}
...
var G4 = class {
  ...
  update(t15, e22, i10, r15 = true) {
    ...
    this._toRenderBoundingExtent(t15, e22, i10), u7(this._center.origin, a15[0].origin, a15[2].origin), g3(this._center.origin, this._center.origin, 0.5), this._renderCoordsHelper.worldUpAtPosition(this._center.origin, this._center.direction), r15 || g3(this._center.direction, this._center.direction, -1);
    for (let n11 = 0; n11 < 4; n11++) {
      const t16 = a15[n11];
      this._renderCoordsHelper.worldUpAtPosition(t16.origin, t16.direction);
      const e23 = a15[3 === n11 ? 0 : n11 + 1];
      t16.cap.next = e23.origin, K2(t16.cap.direction, t16.origin, e23.origin), I(t16.direction, t16.cap.direction, t16.origin, this._planes[n11]), r15 || g3(t16.direction, t16.direction, -1);
    }
  ...
  isVisibleInFrustum(t15, e22, i10 = false) {
    ...
    for (let n11 = 0; n11 < this._extent.length; n11++) {
      ...
      if (t15.intersectsLineSegment(b4(e23.origin, e23.cap.next, k4), e23.cap.direction)) return true;
    }
  ...
  _toRenderBoundingExtentGlobal(t15, r15, n11) {
    ...
    o5(this._extent[0].origin, V[0], V[1], V[2]), o5(this._extent[1].origin, V[3], V[1], V[2]), o5(this._extent[2].origin, V[3], V[4], V[2]), o5(this._extent[3].origin, V[0], V[4], V[2]);
    for (let e22 = 0; e22 < 4; ++e22) E2(this._extent[e22].origin, this._extent[e22].origin, F3);
  }
  _toRenderBoundingExtentLocal(t15, e22, i10) {
    i6(t15, e22, P5, this._renderCoordsHelper.spatialReference), o5(this._extent[0].origin, P5[0], P5[1], i10), o5(this._extent[1].origin, P5[2], P5[1], i10), o5(this._extent[2].origin, P5[2], P5[3], i10), o5(this._extent[3].origin, P5[0], P5[3], i10);
  }
...
var u17 = class extends b {
  ...
  initialize() {
    ...
    this.addHandles([t15.on("resize", () => this._viewChange()), l3(() => t15.state.camera, () => this._viewChange(), U2), o12.registerTask(f6.FRUSTUM_VISIBILITY, this), l3(() => n11.visibleElevationBounds, () => this._elevationBoundsChange())]), "local" === t15.viewingMode ? this._isVisibleBelowSurface = true : this.addHandles([l3(() => {
      var _a, _b2, _c;
  ...
  runTask(e22) {
    if (this._set("updating", false), !this._extent) return this._set("suspended", false), o8;
...
var p7 = class extends b {
  constructor(e22) {
    super(e22), this._scaleRangeActive = false, this._layerScaleRangeVisibilityQuery = false, this._extent = null, this._updatingHandles = new h5(), this.graphicsCoreOwner = null, this.layer = null, this.queryGraphicUIDsInExtent = null, this.graphicsCore = null, this.basemapTerrain = null, this.layerScaleEnabled = true, this.suspended = false, this._dirty = true;
  }
  initialize() {
    this.updateScaleRangeActive();
    const e22 = this.graphicsCoreOwner.view.resourceController.scheduler;
    this.addHandles(e22.registerTask(f6.SCALE_VISIBILITY, this)), this._updatingHandles.add(() => this.layer.effectiveScaleRange, () => this.layerMinMaxScaleChangeHandler());
  }
  destroy() {
  ...
  runTask(e22) {
    ...
    if (this._extent && i10 && i10.ready && this._scaleRangeActive && this.layerScaleEnabled) {
      if (this._layerScaleRangeVisibilityQuery) return o8;
      {
  ...
  _visibleAtLayerScale(e22) {
    ...
    return !this.layerScaleEnabled || r4(e22, i10.minScale || 0, i10.maxScale || 0);
  }
  _visibleAtLabelScale(e22, i10) {
    return r4(e22, i10.minScale || 0, i10.maxScale || 0);
  }
  _graphicScale(e22) {
    let i10;
...
var S3 = class extends b {
  constructor(i10) {
    super(i10), this.drapeSourcePriorityOffset = 0, this.type = "graphics-3d", this.graphicsCore = null, this.drapeSourceType = 1, this.scaleVisibilityEnabled = false, this.frustumVisibilityEnabled = false, this._suspendResumeExtent = null, this._updatingHandles = new h5();
  }
  initialize() {
    const { layer: i10 } = this, t15 = "effectiveScaleRange" in i10 ? i10 : null, e22 = !a6() && this.scaleVisibilityEnabled && null != t15, r15 = new ke({ owner: this, layer: this.owner.layer, preferredUpdatePolicy: 1, graphicSymbolSupported: true, componentFactories: { elevationAlignment: (i11, t16) => new h8({ graphicsCoreOwner: this, graphicsCore: i11, queryGraphicUIDsInExtent: t16, elevationProvider: this.view.elevationProvider }), scaleVisibility: e22 ? (i11, e23) => new p7({ graphicsCoreOwner: this, layer: t15, queryGraphicUIDsInExtent: e23, graphicsCore: i11, basemapTerrain: this.owner.view.basemapTerrain }) : null, objectStates: (i11) => new a14(i11) } });
  ...
  getHit(i10, t15) {
    if (this.owner.loadedGraphics) {
      ...
      if (e22) {
        const i11 = this.layer instanceof b5 ? this.layer : null, r15 = c5(e22, i11, t15);
...
var y4 = class extends l10(d5) {
  ...
  get visibleAtCurrentScale() {
    var _a;
    return a6() ? t6(this.layer.effectiveScaleRange, this.view.scale) : !((_a = this.processor) == null ? void 0 : _a.scaleVisibilitySuspended);
  }
  get slicePlaneEnabled() {
...
//# sourceMappingURL=GraphicsLayerView3D-GGOWHWZB.js.map

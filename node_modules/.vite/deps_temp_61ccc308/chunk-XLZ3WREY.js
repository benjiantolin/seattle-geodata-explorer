...
import {
  n as n2
} from "./chunk-OAWACHGE.js";
import {
  c as c2
} from "./chunk-DMLUJ27J.js";
import {
  i as i3
} from "./chunk-BAIFDY7P.js";
import {
  c as c3
...
var _a;
var le = (_a = class extends l4(s5(u)) {
  constructor(e4) {
  ...
  async queryAttachments(e4, r4) {
    ...
    if (!((_a2 = t2 == null ? void 0 : t2.data) == null ? void 0 : _a2.supportsAttachment)) throw new s2("queryAttachments:not-supported", "this layer doesn't support attachments");
    ...
    if (!((_b = t2 == null ? void 0 : t2.operations) == null ? void 0 : _b.supportsQueryAttachments)) {
      if ((i7 == null ? void 0 : i7.length) > 0 || (a4 == null ? void 0 : a4.length) > 0 || (n5 == null ? void 0 : n5.length) > 0 || l6 || p4 || u4) throw new s2("queryAttachments:option-not-supported", "when 'capabilities.operations.supportsQueryAttachments' is false, only objectIds is supported", e4);
    }
    if (!((s9 == null ? void 0 : s9.length) || (a4 == null ? void 0 : a4.length) || u4)) throw new s2("queryAttachments:invalid-query", "'objectIds', 'globalIds', or 'where' are required to perform attachment query", e4);
  ...
  _handleSublayersChange(e4, r4) {
    r4 && (r4.forEach((e5) => {
      ...
      var _a2, _b, _c;
      (((_c = (_b = (_a2 = this.layer) == null ? void 0 : _a2.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c.supportsSublayersChanges) ?? 1) || (i.getLogger(this).error(new s2("sublayer:sublayers-non-modifiable", "Sublayer can't be added, moved, or removed from the layer's sublayers", { sublayer: this, layer: this.layer })), e5.preventDefault());
    })]));
  }
  _logLockedError(e4, r4) {
    const { layer: t2, declaredClass: i7 } = this;
    i.getLogger(i7).error(new s2("sublayer:locked", `Property '${String(e4)}' can't be changed on Sublayer from the layer '${t2 == null ? void 0 : t2.id}'`, { reason: r4, sublayer: this, layer: t2 }));
  }
  _getLayerDomain(e4) {
    var _a2;
...
var m5 = (m6) => {
  ...
  let v = class extends S3 {
    constructor(...e4) {
      super(...e4), this.allSublayers = new l2({ getCollections: () => [this.sublayers], getChildrenFunction: (e5) => e5.sublayers }), this.sublayersSourceJSON = { 2: {}, 3: {}, 4: {}, 5: {}, 6: {} }, this.subtables = null, this.addHandles([l(() => this.sublayers, (e5, r4) => this._handleSublayersChange(e5, r4), U), l(() => this.subtables, (e5, r4) => this._handleSublayersChange(e5, r4), U)]);
    }
    destroy() {
...
//# sourceMappingURL=chunk-XLZ3WREY.js.map

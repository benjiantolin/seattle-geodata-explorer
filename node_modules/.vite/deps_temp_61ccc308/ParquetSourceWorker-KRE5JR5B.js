...
var T = class {
  ...
  async *_fetchChunks(e, t3) {
    for (const s3 of this._fileInfos.values()) {
      ...
      for (let i5 = 0; i5 < o; i5++) {
        ...
        for (const e2 of o2) {
          const t4 = new i4(this._metadata, this._fieldsIndex, e2, 0, s3.index), r5 = M2([new t(t4, null, 0, false)], this._queryEngineParams);
          yield r5;
        }
      }
    }
  ...
  async _executeQuery(e, t3) {
    ...
    if ((_a = e.objectIds) == null ? void 0 : _a.length) for (const n2 of this._fileInfos.values()) {
      const r4 = [], o2 = M2((await n2.file.readChunksByRowId(new Uint32Array(e.objectIds), s3.fields, s3.returnGeometry, t3)).map((e2, t4) => new i4(this._metadata, this._fieldsIndex, e2, t4, n2.index)).map((e2, t4) => new t(e2, null, t4, false)), this._queryEngineParams), i6 = await o2.executeQueryForOpaqueFeatures(e, t3);
...
//# sourceMappingURL=ParquetSourceWorker-KRE5JR5B.js.map

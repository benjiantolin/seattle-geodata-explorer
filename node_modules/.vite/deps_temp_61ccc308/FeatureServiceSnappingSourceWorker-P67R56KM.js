...
var j2 = class extends b {
  ...
  async _queryFeaturesPBF(e5, t2) {
    const { sourceSpatialReference: i5 } = this, { data: s3 } = await f6(this.url, e5, new a2({ sourceSpatialReference: i5 }), { query: this._configuration.customParameters, timeout: x, signal: t2 });
    return ht(s3);
  }
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-P67R56KM.js.map

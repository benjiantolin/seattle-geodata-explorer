...
function t4() {
  return new b2({ material: new p2({ color: new u4("red") }) });
}
function n9() {
  return new n5();
}
...
var v2 = class {
  ...
  async _load() {
    ...
    if (a10.externalColor = s6, a10.instanced = true, this._isPrimitive) {
      const e13 = new j3();
      e13.layerOpacity = r4, a10 = { ...a10, cullFace: w2(A2(e13)) };
    }
  ...
  async createAddCommand(e12) {
    ...
    const o7 = this._isPrimitive, s13 = this._primitive || d3, u9 = u2(c2(s13)), h8 = u3(p(u9)), y = u3(t2(h8, { isPrimitive: o7, width: 100, depth: null, height: null })), C2 = new Float64Array(16 * n13), b6 = new Float64Array(16 * n13), g6 = a5(e12), x2 = await i5.applyElevationAlignmentTo(g6);
  ...
  async createUpdateLayerViewOpacityCommand(e12) {
    ...
    if (this._isPrimitive) {
      const e13 = new j3();
      e13.layerOpacity = a10, n13 = { ...n13, cullFace: w2(A2(e13)) };
    }
...
var u7 = class {
  constructor(e12) {
    this._reader = new n6(new Uint8Array(e12), new DataView(e12)), this._index = g5(this._reader);
  }
  get featureCount() {
...
//# sourceMappingURL=Feature3DPipelineWorker-TG7NX4VC.js.map

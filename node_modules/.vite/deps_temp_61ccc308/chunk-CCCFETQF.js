...
import {
  p as p2
} from "./chunk-KAVXF7PW.js";
import {
  d as d2
} from "./chunk-Z7ICZT47.js";
import {
  u as u6
} from "./chunk-2S6WAY2O.js";
import {
  p as p6
...
var d4 = class {
  constructor(t11, i16, s14, n14, r12, d10) {
    this.getStage = t11, this.getSubscriptionVersion = i16, this.version = s14, this._fader = n14, this._container = r12, this._tileInfoView = d10, this._pendingUpdates = new t4(o5), this._locked = false, this._tiles = /* @__PURE__ */ new Map();
  }
  destroy() {
...
var l5 = class extends s6 {
  constructor(e13) {
    super(e13.view.featuresTilingScheme), this.updatingHandles = new h2(), this._hitTestsRequests = [], this._store = new n6(), this._visibleTiles = /* @__PURE__ */ new Set(), this._subscriptions = /* @__PURE__ */ new Map(), this._updateStatisticsRequests = [], this._lockStatisticUpdates = false, this._shouldUnlockAttributeView = false, this._layerView = e13, this.addTransitionable(this._layerView.featureEffectView);
  }
  destroy() {
...
async function t7(t11) {
  const o14 = await p6("FeaturePipelineWorker", { client: t11, strategy: "dedicated" });
  return new n7(o14);
}
var n7 = class {
  constructor(e13) {
...
var s10 = class {
  ...
  async executeExceedsLimitQuery(t11, e13, r12) {
    const s14 = i6.createFeature(t11.metadata), i16 = u7.create(t11, e13, s14).createQuery();
...
async function i13(t11, r12, a10, o14) {
  ...
  try {
    return (await p3(t11, s14, { query: a10.customParameters })).data.count > o14.maxFeatureCount;
  } catch (n14) {
    return true;
  }
}
...
function x3(e13) {
  ...
  const i16 = Y2.fromSimpleMarker(e13);
...
async function C(e13, i16) {
  ...
  if ("path" === e13.style || e13.outline && "solid" !== e13.outline.style && "none" !== e13.outline.style) {
    const l12 = Y2.fromSimpleMarker(e13);
...
function j2(e13, i16) {
  const { outline: a10 } = e13, { uniforms: l11, schemaOptions: r12 } = i16, { store: t11 } = r12, s14 = [], n14 = Y2.createPictureFillRasterizationParam(e13);
  if (!n14) return [];
  ...
  let A3 = class extends G2 {
    ...
    async fetchPopupFeaturesFromGraphics(e13, t11) {
      ...
      for (const l11 of e13) {
        const e14 = t2(l11.origin), s15 = n5(e14, { ...t11, checkPopupEnabled: true });
    ...
    async _updateRequiredFields() {
      var _a, _b, _c, _d;
      if (!this.layer || !this.view) return;
      const e13 = "3d" === this.view.type, { layer: i16, layer: { fieldsIndex: r12 } } = this, s14 = "renderer" in i16 && i16.renderer, l11 = "orderBy" in i16 && i16.orderBy, o14 = "featureReduction" in i16 ? i16.featureReduction : null, n14 = /* @__PURE__ */ new Set(), a10 = [s14 ? s14.collectRequiredFields(n14, r12) : null, Y(n14, i16), e13 && "elevationInfo" in i16 ? L(n14, i16) : null, null != this.filter ? R(n14, i16, this.filter) : null, e13 || null == this.featureEffect ? null : R(n14, i16, this.featureEffect.filter), !e13 && o14 ? j(n14, i16, o14) : null, !e13 && l11 ? V(n14, i16, l11) : null];
      ...
      if ("floorInfo" in i16 && i16.floorInfo && w2(n14, i16.fieldsIndex, [i16.floorInfo.floorField]), "featureTitleFields" in i16 && ((_b = (_a = this.view) == null ? void 0 : _a.requiredFieldsOptions) == null ? void 0 : _b.featureTitleFields) && i16.featureTitleFields && w2(n14, i16.fieldsIndex, i16.featureTitleFields), "feature" === i16.type && i16.globalIdField && ((_d = (_c = this.view) == null ? void 0 : _c.requiredFieldsOptions) == null ? void 0 : _d.globalIdField) && w2(n14, i16.fieldsIndex, [i16.globalIdField]), this.displayFilterEnabled && a10.push(X(n14, i16, i16.displayFilterInfo)), "feature" === i16.type && e13 && null != i16.infoFor3D && (null == i16.globalIdField && i2.getLogger(this).error("globalIdField missing on 3DObjectFeatureLayer"), w2(n14, i16.fieldsIndex, [i16.globalIdField])), "subtype-group" === i16.type) {
        ...
        const e14 = i16.sublayers.map((e15) => {
          var _a2;
          return Promise.all([(_a2 = e15.renderer) == null ? void 0 : _a2.collectRequiredFields(n14, r12), Y(n14, e15)]);
        });
    ...
    async _createPopupQuery(e13, t11) {
      ...
      for (const o14 of e13) {
        ...
        const e14 = await p4(this.layer, o14);
        s2(t11);
...
`);
  ...
  _getEffectiveAvailableFields(e13) {
    ...
    return this._lastAvailableFields = t11, h(this.layer.fieldsIndex, t11);
  }
...
//# sourceMappingURL=chunk-CCCFETQF.js.map

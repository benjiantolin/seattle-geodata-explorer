...
var E2 = class {
  ...
  async createQueryResponse() {
    ...
    if (this.query.returnQueryGeometry) {
      ...
      p(this.query.outSR) && !T(t6.spatialReference, this.query.outSR) ? e5.queryGeometry = h2({ spatialReference: this.query.outSR, ...g2(t6, t6.spatialReference, this.query.outSR) }) : e5.queryGeometry = h2({ spatialReference: this.query.outSR, ...t6 });
    }
    return e5;
  }
  ...
  _createFeatureQueryResponse(e5) {
    ...
    return { exceededTransferLimit: y5, features: this._createFeatures(e5, t6), fields: g4, geometryType: i3, hasM: s7 && p5, hasZ: a4 && f7, objectIdFieldName: n5, spatialReference: h2(c4 || o2), transform: m8 && s3(m8) || null };
  }
  ...
  async _createAutoIntervalBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7, normalizationField: a4, numBins: r5, normalizationType: n5, normalizationTotal: o2, start: l7, end: u5 } = e5, c4 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), m8 = G2(c4, { field: s7, normalizationField: a4, normalizationType: n5, normalizationTotal: o2, numBins: r5, minValue: h(l7, false), maxValue: h(u5, false) }), d6 = this._calculateHistogramBins(c4, m8, i3);
    return this._createFeaturesFromHistogramBins(d6, t6);
  }
  async _createDateBinsResponse(e5, t6, i3) {
    var _a, _b;
    const { field: s7, interval: a4, start: r5, end: n5, snapToData: o2, returnFullIntervalBin: l7 } = e5, u5 = a4.unit, c4 = await this._getDataValues({ field: e5.field, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), m8 = xe(this.fieldsIndex.get(s7)), d6 = s4.toJSON(u5), f7 = c4.filter(Boolean).sort((e6, t7) => e6 - t7), p5 = null != r5 ? h(r5, m8) : f7[0], y5 = null != n5 ? h(n5, m8) : f7[f7.length - 1], g4 = [];
    if (null != p5 && null != y5) {
  ...
  async _createFixedBoundariesBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7 } = e5, a4 = await this._getDataValues({ field: s7, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), r5 = xe(this.fieldsIndex.get(s7)), n5 = e5.boundaries.map((e6) => h(e6, r5)).sort((e6, t7) => e6 - t7), o2 = [];
  ...
  async _createFixedIntervalBinsResponse(e5, t6, i3) {
    var _a;
    const { field: s7, interval: a4, start: r5, end: n5 } = e5, o2 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: (_a = t6.outTimeReference) == null ? void 0 : _a.ianaTimeZone }, i3), l7 = xe(this.fieldsIndex.get(s7)), u5 = G2(o2, { field: s7, classificationMethod: "defined-interval", definedInterval: a4, minValue: h(r5, l7), maxValue: h(n5, l7) }, true), c4 = this._calculateHistogramBins(o2, u5, i3);
...
var W = class {
  ...
  async *_executeQueryForSnapping(e5, t6) {
    ...
    const d6 = (await P(f2(i3), null, { signal: t6 }))[0];
    yield;
    const m8 = (await P(f2(y5), null, { signal: t6 }))[0];
...
function Y(e5, t6, i3, r5, s7) {
  const a4 = { xmin: e5[0], ymin: e5[1], xmax: e5[3], ymax: e5[4], spatialReference: h2(r5) };
  s7 && isFinite(e5[2]) && isFinite(e5[5]) && (a4.zmin = e5[2], a4.zmax = e5[5], a4.hasZ = true);
  const n5 = g2(a4, t6, i3);
  if (n5.spatialReference = h2(i3), n5.xmax - n5.xmin === 0) {
...
//# sourceMappingURL=chunk-Y6YP74NN.js.map

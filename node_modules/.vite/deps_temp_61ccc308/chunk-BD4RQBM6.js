...
var o3 = P2(() => import("./bufferOperator-HNMGSQXK.js"));
var s7 = P2(() => import("./convexHullOperator-5I6G5BAL.js"));
var m2 = P2(() => import("./lengthOperator-AVLLIQF5.js"));
var i8 = P2(() => import("./generalizeOperator-DGHURAZL.js"));
var n5 = P2(() => import("./graphicBufferOperator-4WVO77LV.js"));
var p3 = P2(() => import("./offsetOperator-CEFNNYWW.js"));
var f4 = P2(() => import("./simplifyOperator-ZV6QLXIP.js"));
var c3 = 512;
var a3;
function l7(e17) {
  switch (e17.type) {
...
var w2 = class {
  ...
  get bounds() {
    if (!this._bounds) {
      ...
      const a11 = e4(n3(), this._rotationT, this._transform);
      e5(r13, r13, a11);
  ...
  _setOffsets() {
    ...
    const t16 = e4(n3(), this._rotationT, this._transform);
...
var R2 = class {
  ...
  setRotation(i18) {
    ...
    this._rotation = i18;
    const e17 = this._transform, h8 = M(n3(), i18);
    e4(e17, h8, e17);
  ...
  get boundsT() {
    const t16 = this.bounds, s17 = o(n2(), t16.x, t16.y);
  ...
  _createGlyphTransform(t16, s17) {
    const h8 = p5 * s17.angle, n23 = n3(), f6 = n2();
...
var V2 = class {
  ...
  static _getTextInflatedSize(e17, t16, r13) {
    ...
    const { lineGapType: s17, lineGap: i18 } = t16, n23 = s17 ? _t2(s17, i18 ?? 0, o9) : 0, l12 = "CIMBackgroundCallout" === ((_a = t16.callout) == null ? void 0 : _a.type), c5 = z(a11.glyphMosaicItems, { scale: o9 / q, angle: I2(t16.angle), xOffset: I2(t16.offsetX), yOffset: I2(t16.offsetY), horizontalAlignment: t16.horizontalAlignment, verticalAlignment: t16.verticalAlignment, maxLineWidth: a10(t16.lineWidth), lineHeight: l5 * Math.max(0.25, Math.min(n23 || 1, 4)), decoration: t16.font.decoration || "none", useCIMAngleBehavior: true, hasBackground: l12 }).boundsT, m5 = Math.sqrt(c5.width * c5.width + c5.height * c5.height);
...
//# sourceMappingURL=chunk-BD4RQBM6.js.map

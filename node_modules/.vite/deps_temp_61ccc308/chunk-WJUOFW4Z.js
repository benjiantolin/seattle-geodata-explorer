...
var u = p = class extends t {
  ...
  forwardTransform(e) {
    if ("point" === e.type) {
      const r3 = a2(this.forwardCoefficients, e, this.polynomialOrder);
  ...
  inverseTransform(e) {
    if ("point" === e.type) {
      const r3 = a2(this.inverseCoefficients, e, this.polynomialOrder);
      return new _({ x: r3.x, y: r3.y, spatialReference: e.spatialReference });
    }
...
__decorate([r2({ GCSShiftXform: "gcs-shift" })], n2.prototype, "type", void 0), __decorate([m()], n2.prototype, "tolerance", void 0), n2 = a3 = __decorate([a("esri.layers.support.rasterTransforms.GCSShiftTransform")], n2);
...
//# sourceMappingURL=chunk-WJUOFW4Z.js.map

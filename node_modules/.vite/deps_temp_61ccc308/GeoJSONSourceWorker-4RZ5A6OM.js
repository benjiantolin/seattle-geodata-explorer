...
var A = class {
  ...
  async load(e, t = {}) {
    ...
    this._queryEngine = new W({ fieldsIndex: Z.fromLayerJSON({ fields: o, timeInfo: c, dateFieldsTimeReference: b }), geometryType: l2, hasM: false, hasZ: u2, featureIdInfo: w, spatialReference: p2, timeInfo: c, featureStore: new f2({ geometryType: l2, hasM: false, hasZ: u2 }) });
  ...
  async applyEdits(e) {
    ...
    return await Promise.all([E2(t, s2), f(e.adds, t), f(e.updates, t)]), await this._waitSnapshotComplete(), this._applyEdits(e);
  }
...
//# sourceMappingURL=GeoJSONSourceWorker-4RZ5A6OM.js.map

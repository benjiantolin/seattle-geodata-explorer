...
import {
  ...
  m as m4,
  q
} from "./chunk-IVC6FGPW.js";
import {
  a as a3,
  n as n3
} from "./chunk-QNN2XBH3.js";
import {
  T
} from "./chunk-WTCJLDP2.js";
import {
  m as m5,
  m2 as m6,
  m3 as m7,
  n as n5
} from "./chunk-B6P6WNQW.js";
import "./chunk-OAU2H7MN.js";
import {
  p as p4,
  v
} from "./chunk-ASB4YTOL.js";
import {
  s as s3
} from "./chunk-BPSN5NKI.js";
import {
  at
} from "./chunk-QLTH5U7X.js";
import "./chunk-QSGJ3ECU.js";
import "./chunk-WDTGOP77.js";
import "./chunk-52SEOH5H.js";
import {
  n as n4
} from "./chunk-GB6LGU7M.js";
import {
  a as a4
...
import {
  t
} from "./chunk-OOSCZ2XX.js";
import {
  p as p6
} from "./chunk-E5B7PBPK.js";
...
import "./chunk-NG5TTAYP.js";
import "./chunk-C5GEAHW4.js";
...
async function m8(t2, r4, e3, n8) {
  ...
  const { meshFeatureSetFromJSON: a5 } = await p(import("./meshFeatureSet-ZGAUSESD.js"), n8);
  return a5(t2, s8, r4);
}
function p7(o4, s8) {
  let a5 = b.from(o4);
...
function r2(e3, t2) {
  ...
  const c6 = new p3({ statisticType: "min", onStatisticField: n8 }), f3 = new p3({ statisticType: "max", onStatisticField: n8 }), m10 = new b({ outStatistics: [c6, f3] });
...
async function D(t2, n8) {
  ...
  for (const e3 of i6) {
    ...
    let c7 = i7;
    o4 && (c7 = `${m4(c7)}${a5}${m4(s9)}`, r4 && (c7 = `${c7}${a5}${m4(u7)}`)), null == d4[c7] ? d4[c7] = { count: n9, data: c7 } : d4[c7].count = d4[c7].count + n9;
  }
  if (l4 && p10) {
    const t3 = l4 + " is NULL";
    try {
...
function G(t2, e3, n8 = true) {
  var _a;
  const { fields: i6, filter: l4 } = e3, { include: o4, exclude: r4 } = e3.outStatisticTypes || {}, s8 = c2.filter((t3) => (!o4 || o4.includes(t3)) && (!r4 || !r4.includes(t3)) && ("median" !== t3 || n8)), c6 = new v();
  c6.where = U2((_a = t2.createQuery()) == null ? void 0 : _a.where, e3.sqlWhere) ?? void 0;
  const m10 = "new_value";
  return c6.outPivots = [new p4({ sourceFields: i6, valueFieldName: m10 })], c6.outStatistics = J(t2, s8, m10), X(c6, l4), c6;
}
function X(t2, e3) {
  var _a;
...
function Y(t2, e3) {
  const n8 = "countOF" + (t2 || "Expr"), i6 = new p3();
...
async function M4(i6, t2, a5, o4, d4) {
  ...
  if (F2) {
    ...
    return new m6({ field: p10, expression: f3, interval: { unit: h ? "seconds" : "days", value: Math.ceil(h ? i7 : n8) }, start: a5, end: o4 });
  }
  if ("defined-interval" === z3) return new m7({ field: p10, expression: f3, normalizationField: c6, normalizationTotal: d4, normalizationType: x2, interval: i6.definedInterval ?? Math.ceil((o4 - a5) / B2), start: x2 ? null : a5, end: x2 ? null : o4, normalizationMinValue: x2 ? a5 : null, normalizationMaxValue: x2 ? o4 : null });
  ...
  if ("natural-breaks" === z3 || "quantile" === z3 || "standard-deviation" === z3) {
    ...
    return new n5({ field: x2 ? null : p10, expression: x2 ? n8 : f3, boundaries: l4 });
  }
  return new m5({ field: p10, normalizationField: c6, normalizationTotal: d4, normalizationType: x2, expression: f3, numBins: B2, start: x2 ? null : a5, end: x2 ? null : o4, normalizationMinValue: x2 ? a5 : null, normalizationMaxValue: x2 ? o4 : null });
}
...
async function b3(e3, n8, r4, l4) {
  ...
  const h = new p3({ statisticType: "count", outStatisticFieldName: V2, onStatisticField: "1" }), { where: F2, timeExtent: B2 } = l4 || {}, j5 = U2(F2, x2.sqlWhere), E4 = "lowerBoundary", I5 = "upperBoundary", b5 = new T({ binParameters: await M4(e3, n8, v3, T5, r4), outStatistics: [h], binOrder: e3.sortOrder, where: j5, timeExtent: B2, lowerBoundaryAlias: E4, upperBoundaryAlias: I5, outTimeZone: (f3 == null ? void 0 : f3.timeZone) && z3 ? O(f3.timeZone) : null });
...
var R3 = class extends p8 {
  ...
  async _getFilteredFeatures(e3, t2) {
    ...
    if ("intersects" === (t2 == null ? void 0 : t2.spatialRelationship) && a5) {
      const t3 = await import("./intersectionOperator-MPTRDJBO.js");
  ...
  async _uvFromMemory(e3, t2) {
    ...
    return i6 && r4 && (n8 || l4) && (y.viewInfoParams = _2(r4), y.timeZone = r4.timeZone, y.fieldInfos = p10), !n8 && !l4 && u6 && "queryUniqueValues" in u6 ? u6.queryUniqueValues(m10, y, { signal: o4 }) : n8 ? this.workerClient.uniqueValues(y, n8) : p5({ attribute: y, features: l4 });
  }
  ...
  async _histogramFromQueryAttributeBinsFromMemory(e3) {
    ...
    if (!n8 || !("queryAttributeBins" in n8) || s8 || o4) {
      ...
      return s8 ? this.workerClient.histogram(t3, s8) : v2({ attribute: t3, features: o4 });
    }
  ...
  async _histogramFromMemory(e3) {
    ...
    return !i6 && !s8 && o4 && "queryHistogram" in o4 ? o4.queryHistogram(n8, u6, { signal: r4 }) : i6 ? this.workerClient.histogram(u6, i6) : v2({ attribute: u6, features: s8 });
  }
  ...
  async _heatmapStatsFromMemory(e3) {
    ...
    const { featuresJSON: n8, graphics: l4 } = await this._processStatsFromMemoryParams({ ...e3, returnGeometry: true }), u6 = new m3({ extent: t2.extent, tolerance: "2d" === t2.type ? t2.state.resolution : (_a = t2.pixelSizeAt) == null ? void 0 : _a.call(t2, t2.center) }), p10 = { field: r4, radius: a5, transform: s3(u6), spatialReference: (_b = t2.spatialReference) == null ? void 0 : _b.toJSON(), size: t2.size };
...
var ie = class extends R3 {
  ...
  async _summaryStatsForFieldsAdvanced(e3, t2) {
    ...
    for (let u6 = 0; u6 < s8.length; u6 += o4) {
      ...
      r5.outStatistics = [];
      for (const e4 of i7) {
        const i8 = `sumOfSquares_${e4}`, s9 = `(power(${M(this.layer, e4) ? N2(e4) : e4} - ${t2.avg}, 2))`, a6 = new p3({ statisticType: "sum", onStatisticField: s9, outStatisticFieldName: i8 });
  ...
  _histogramForExpr(e3) {
    return this._getNormalizationTotal(e3.field, e3.normalizationType, e3.filter, e3.signal).then((t2) => {
      ...
      return g3(i6, this, e3.minValue, e3.maxValue).then((s8) => {
        ...
        const o4 = e3.numBins || V, n8 = j2(r4, a5, o4), l4 = se(i6.sqlExpression, n8, null != e3.minValue && null != e3.maxValue), u6 = new p3({ statisticType: "count", outStatisticFieldName: "countOFExpr", onStatisticField: "1" }), c6 = this.layer.createQuery();
  ...
  async _histogramForFields(e3) {
    ...
    const s8 = "newField", r4 = e3.numBins || V, a5 = se(s8, j2(t2, i6, r4), null != e3.minValue && null != e3.maxValue), o4 = new p3({ statisticType: "count", outStatisticFieldName: "countOFExpr", onStatisticField: s8 }), n8 = new v(), { where: l4, timeExtent: u6 } = this.createQuery();
    return n8.where = U2(l4, e3.sqlWhere), n8.outPivots = [new p4({ sourceFields: e3.fields, valueFieldName: s8 })], n8.outStatistics = [o4], n8.groupByFieldsForStatistics = [a5], n8.orderByFields = [a5], n8.timeExtent = u6, X(n8, e3.filter), this._isStatsSupportedOnService().then(() => this.layer.queryPivot(n8, { signal: e3.signal })).then((e4) => R2(e4, t2, i6, r4));
  }
...
var u3 = class extends ie {
  ...
  async _createGenerateRendererResult(e3, r4, i6, n8, l4) {
    ...
    if ("class-breaks-definition" === (l4 == null ? void 0 : l4.type)) {
      ...
      return a3({ definition: l4, values: e4, normalizationTotal: d4 });
    }
...
var T4 = class extends ie {
  ...
  async _uvFromMemory(e3, t2) {
    ...
    return i6 && a5 && (n8 || l4) && (g4.viewInfoParams = _2(a5), g4.timeZone = a5.timeZone, g4.fieldInfos = y), !n8 && !l4 && u6 && "queryAggregateUniqueValues" in u6 ? u6.queryAggregateUniqueValues(m10, g4, { signal: o4 }) : n8 ? this.workerClient.uniqueValues(g4, n8) : p5({ attribute: g4, features: l4 });
  }
  async _histogramFromMemory(e3) {
    ...
    return r4 && t2 && (s8 || o4) && (m10.viewInfoParams = _2(t2), m10.timeZone = t2.timeZone, m10.fieldInfos = u6), "percent-of-total" === e3.normalizationType && null == e3.normalizationTotal && (m10.normalizationTotal = await this._getNormalizationTotalFromMemory(a5, { featuresJSON: s8, graphics: o4, layerView: n8, query: l4 }, i6)), !s8 && !o4 && n8 && "queryAggregateHistogram" in n8 ? n8.queryAggregateHistogram(l4, m10, { signal: i6 }) : s8 ? this.workerClient.histogram(m10, s8) : v2({ attribute: m10, features: o4 });
  }
  async _classBreaksFromMemory(e3) {
...
var A2 = class extends p8 {
  ...
  async _getUniqueValuesFromMemory(e3, t2) {
    ...
    return e3.valueExpression && r4 && u6 && (l4.viewInfoParams = _2(r4), l4.timeZone = r4.timeZone), u6 ? this.workerClient.uniqueValues(l4, u6) : p5({ attribute: l4, features: p10 });
  }
  ...
  async _getHistogramFromMemory(e3) {
    ...
    return e3.valueExpression && t2 && a5 && (i6.viewInfoParams = _2(t2), i6.timeZone = t2.timeZone), "percent-of-total" === e3.normalizationType && null == e3.normalizationTotal && (i6.normalizationTotal = await this._getNormalizationTotal(r4, a5, s8)), a5 ? this.workerClient.histogram(i6, a5) : v2({ attribute: i6, features: s8 });
  }
  getField(e3) {
    return this.layer.getField(e3 ?? "");
  }
...
async function u5(u6) {
  ...
  await c6.load(x2);
  const y = await w({ field: q4.field, field2: q4.field2, field3: q4.field3, valueExpression: q4.valueExpression }), E4 = T2(c6, y, "unique-values:invalid-parameters");
  if (E4) throw E4;
...
//# sourceMappingURL=uniqueValues-S2Y34VX5.js.map

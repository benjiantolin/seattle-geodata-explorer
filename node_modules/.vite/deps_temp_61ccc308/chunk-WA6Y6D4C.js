...
var o8 = class {
  constructor(r10, t9) {
    ...
    for (const e9 in t9.vertex) {
      const { data: s12, layout: o19 } = t9.vertex[e9], n16 = new r3(r10, o19, s12);
      this.vertexBuffers.set(e9, n16);
    }
    for (const s12 in t9.index) {
      const { data: i10 } = t9.index[s12], o19 = o3.createIndex(r10, 35044, i10);
...
var H2 = class extends B4 {
  _vertexPreamble(i10, t9, e9) {
    ...
    const V4 = s12.z, x9 = h5(i10.bitset, o6.bitset.isStroke), z6 = s12.w, j6 = h5(i10.bitset, o6.bitset.scaleSymbolsProportionally), T6 = J3(l10, 0, h12), _5 = Tt([Ct(h5(i10.bitset, o6.bitset.isMapAligned), new C2(1)), this.view.rotation.divide(180).multiply(Math.PI)], [true, new C2(0)]), O4 = new nt(oe(_5), un(_5.multiply(-1)), un(_5), oe(_5)).multiply(T6.xy), C8 = T6.z.subtract(_5).subtract(t9.multiply(o7)), M3 = T6.w, A8 = h5(i10.bitset, o6.bitset.isSDF), F10 = l3(this, o19, new C2(b8)).divide(new C2(b8));
...
var g5 = class extends H2 {
  ...
  _vertexPoly(t9) {
    ...
    const D6 = J3(o19, 4, s12).a, T6 = J3(o19, 5, s12).a, _5 = r8(this, t9.id, j6, At(k(t9.bitset, o6.bitset.colorLocked), new J2(c8))), C8 = _e(_5, k7, z6), F10 = n4(this, t9.id), A8 = _e(F10, D6, T6), W4 = C8.multiply(A8), L5 = this.clip(t9.id, t9.zoomRange).add(f14.multiply(2)), O4 = m12.multiply(d9);
...
function D3(t9) {
  return Xe(new C2(r5).multiply(ln(t9, new C2(s3))), new C2(1));
}
function G4(t9, i10) {
...
function L3(t9, i10) {
  ...
  if (t5(t9)) {
    ...
    return new C2(0.5).multiply(o19.divide(Xe(l10, new C2(h2)))).multiply(a8);
  }
  return o19;
}
function T2(t9, i10) {
...
var U2 = class extends H2 {
  ...
  vertex(t9, e9) {
    ...
    const P10 = J3(o19, 4, l10).a, N4 = J3(o19, 5, l10).a, R8 = r8(this, t9.id, _5, At(k(t9.bitset, o6.bitset.colorLocked), new J2(p9))), F10 = _e(R8, z6, C8), j6 = n4(this, t9.id), T6 = _e(j6, P10, N4), U3 = F10.multiply(T6), q7 = this.clip(t9.id, t9.zoomRange).add(v7.multiply(2)), A8 = h12.multiply(x9);
...
var C5 = class extends P2 {
  ...
  vertex(t9) {
    const o19 = new rt(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new Y2(t9.pos.xy.divide(o4), 1)), i10 = wn(this.draw.locations, o19.xy), r10 = Xe(this.instance.dotSize.divide(2), new C2(1));
    let s12 = new C2(0);
...
var O2 = class extends B4 {
  ...
  vertex(t9) {
    const e9 = new rt(2 / o4, 0, 0, 0, -2 / o4, 0, -1, 1, 1).multiply(new Y2(t9.pos, 1)), s12 = this.clip(t9.id), i10 = new _3(e9.xy, s12, 1), r10 = this.storage.getVVData(t9.id).multiply(this.instance.isActive.get(0)).multiply(t9.inverseArea), l10 = this.storage.getDataDrivenData0(t9.id).multiply(this.instance.isActive.get(1)).multiply(t9.inverseArea), d9 = this.draw.tileZoomFactor.multiply(o4).divide(this.draw.pixelRatio), n16 = this._dotThreshold(r10, this.instance.dotValue, this.draw.tileDotsOverArea), c8 = this._dotThreshold(l10, this.instance.dotValue, this.draw.tileDotsOverArea), u18 = t9.pos.add(0.5).divide(d9);
...
var m6 = class {
  ...
  getFBO(t9) {
    if (null == this._dotFBO) {
      const s12 = o4, r10 = o4, i10 = new h(s12, r10);
  ...
  getDotDensityMesh(t9) {
    if (null == this._dotMesh) {
      const o19 = o4, r10 = o19 * o19, n16 = 2, d9 = new Int16Array(r10 * n16);
...
var A6 = class extends x3 {
  ...
  fragment(t9) {
    const { tlbr: e9, relativePosition: i10, gradientMethod: r10, gradientSize: o19, isDiscrete: g13 } = t9, w7 = zt(Gt(g13, new C2(0.5)), o19.subtract(1), new X(0)), b8 = Tt([Ct(r10, new C2(r6.rectangular)), () => {
      const t10 = Qt(i10).add(w7).divide(o19);
      return E3(Xe(t10.x, t10.y));
    }], [Ct(r10, new C2(r6.circular)), E3(hn(we(i10, i10)).add(w7.x).divide(o19.x))], [true, E3(i10.x.add(w7.x).divide(o19.x))]), S7 = new X(se(b8, new C2(0), new C2(1)), 0.5), j6 = _e(e9.xy, e9.zw, S7).divide(this.mosaicInfo.size), z6 = wn(this.mosaicInfo.texture, j6), F10 = t9.color.a;
...
var m7 = class {
  ...
  ensureAccumulateFBO(e9, r10, t9) {
    if (null == this._accumulateFramebuffer) {
      const { dataType: s12, samplingMode: l10, pixelFormat: n16, internalFormat: m12 } = this.loadQualityProfile(e9), f14 = new h(r10, t9);
...
var et = class extends B4 {
  ...
  vertex(t9, e9) {
    const i10 = tt(t9.sizing.x), o19 = tt(t9.sizing.y), s12 = tt(t9.sizing.z), l10 = t9.placementAngle, r10 = h5(t9.bitset, o6.bitset.isSDF), y6 = h5(t9.bitset, o6.bitset.isMapAligned), h12 = h5(t9.bitset, o6.bitset.scaleSymbolsProportionally), c8 = k(t9.bitset, o6.bitset.colorLocked), x9 = n4(this, t9.id), v7 = r8(this, t9.id, t9.color, c8).multiply(x9), f14 = this.view.displayViewScreenMat3.multiply(new Y2(t9.pos.xy, 1)), V4 = l3(this, t9.id, s12).divide(s12), w7 = i10.multiply(V4), S7 = t9.offset.xy.multiply(V4);
    let b8 = o19.multiply(h12.multiply(V4.subtract(1)).add(1));
    b8 = Ye(b8, Xe(w7.subtract(0.99), new C2(0)));
    const g13 = Xe(b8, new C2(1)), C8 = Ye(b8, new C2(1)), z6 = rt.fromRotation(l10.multiply(o7)), _5 = u5(this, t9.id), R8 = this._getViewRotationMatrix(y6).multiply(_5).multiply(z6).multiply(new Y2(S7.xy, 0)), U3 = this.clip(t9.id, t9.zoomRange), N4 = new _3(f14.xy.add(R8.xy), U3, 1), D6 = t9.textureUV.divide(this.mosaicInfo.size), F10 = t9.outlineColor.multiply(C8), I3 = h5(t9.bitset, o6.bitset.overrideOutlineColor), O4 = t9.sdfDecodeCoeff.multiply(w7);
...
function s11(e9, r10) {
  const t9 = t3();
  return { type: "multi", target: "feature", keyField: r4, filters: r10, capabilities: { maxTextureSize: t9.maxTextureSize }, bindings: { 0: o18(e9.trackLines.renderer), 1: o18(e9.latestObservations.renderer), 2: o18(e9.previousObservations.renderer) } };
}
function a7(e9) {
  switch (e9) {
    case "opacity":
...
//# sourceMappingURL=chunk-WA6Y6D4C.js.map

...
function s3(s5) {
  ...
  const a4 = null != s5.offset ? s5.offset : a3, n8 = null != s5.rotation ? s5.rotation : 0, e3 = null != s5.scale ? s5.scale : i4, f2 = n2(1, 0, 0, 0, 1, 0, a4[0], a4[1], 1), c2 = n2(Math.cos(n8), -Math.sin(n8), 0, Math.sin(n8), Math.cos(n8), 0, 0, 0, 1), m2 = n2(e3[0], 0, 0, 0, e3[1], 0, 0, 0, 1), u3 = e();
...
function M3(e3, t7) {
  var _a, _b;
  const r4 = new Array(), n8 = new Array(), s5 = new Array(), a4 = new t3(), u3 = e3.resource, c2 = r.parse(u3.version || "1.0", "wosr");
  k.validate(c2);
...
async function U(e3, t7) {
  ...
  for (const o5 in e3) {
    ...
    const a4 = n9.encoding + ";base64," + s6, i5 = "/textureDefinitions/" + o5, l4 = "rgba" === n9.channels ? n9.alphaChannelUsage || "transparency" : "none", u3 = { noUnpackFlip: true, wrap: { s: 10497, t: 10497 }, preMultiplyAlpha: 1 !== I2(l4) }, c2 = (t7 == null ? void 0 : t7.disableTextures) ? Promise.resolve(null) : t4(a4, t7);
...
async function z(e3, r4) {
  ...
  if (r4.cache) s5 = await r4.cache.loadGLTF(o5.url, r4, !!r4.usePBR);
    ...
    const { loadGLTF: e4 } = await import("./loader-CXCVCPR2.js");
  ...
  const l4 = !!r4.usePBR, a4 = s5.meta.isEsriSymbolResource ? { usePBR: l4, isSchematic: false, treeRendering: n8, mrrFactors: s2 } : { usePBR: l4, isSchematic: false, treeRendering: false, mrrFactors: t5 }, u3 = { ...r4.materialParameters, treeRendering: n8 }, { engineResources: c2, referenceBoundingBox: m2 } = J(s5, a4, u3, r4, o5.specifiedLodIndex, n8);
...
function X(e3, t7, o5, s5, i5, n8, l4, a4, c2) {
  ...
  if (!n8.has(x2)) {
    ...
    const o6 = y(m2.color[0]), f3 = y(m2.color[1]), d4 = y(m2.color[2]), p3 = null != m2.colorTexture && T3 ? l4.get(m2.colorTexture) : null, g3 = n7(m2), y3 = null != ((_a = m2.normalTextureTransform) == null ? void 0 : _a.scale) ? (_b = m2.normalTextureTransform) == null ? void 0 : _b.scale : a2;
...
function Y(e3, r4) {
  const t7 = e3.attributes.position.count, n8 = o3(e3.indices || t7, e3.primitiveType), l4 = n6(3 * t7), { typedBuffer: a4, typedBufferStride: u3 } = e3.attributes.position;
  r3(l4, a4, e3.transform, 3, u3);
  const c2 = [["position", new t2(l4, n8, 3, true)]];
  if (null != e3.attributes.normal) {
    const r5 = n6(3 * t7), { typedBuffer: i5, typedBufferStride: l5 } = e3.attributes.normal;
    j(Z, e3.transform), n4(r5, i5, Z, 3, l5), T(Z) && d(r5, r5), c2.push(["normal", new t2(r5, n8, 3, true)]);
  }
  if (null != e3.attributes.tangent) {
    const r5 = n6(4 * t7), { typedBuffer: s5, typedBufferStride: l5 } = e3.attributes.tangent;
    n(Z, e3.transform), o2(r5, s5, Z, 4, l5), T(Z) && d(r5, r5, 4), c2.push(["tangent", new t2(r5, n8, 4, true)]);
  }
  if (null != e3.attributes.texCoord0) {
    const r5 = n6(2 * t7), { typedBuffer: o5, typedBufferStride: s5 } = e3.attributes.texCoord0;
    n5(r5, o5, 2, s5), c2.push(["uv0", new t2(r5, n8, 2, true)]);
  }
  ...
  for (let o5 = 0; o5 < r4.model.lods.length; ++o5) {
    ...
    for (const i5 of s5.parts) {
      ...
      for (let l4 = 0; l4 < u3; l4++) {
        ...
        const a4 = h3[2], u4 = r2(h3), x2 = Math.min(0.45 + 0.55 * u4 * u4, 1) ** p;
...
//# sourceMappingURL=chunk-MZHWXFMY.js.map

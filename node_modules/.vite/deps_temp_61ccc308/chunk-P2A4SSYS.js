...
import {
  ...
  d as d2,
  z as z3
} from "./chunk-NPCSZH5U.js";
import {
  t as t4
} from "./chunk-B7RTXPWS.js";
import {
  t as t5
} from "./chunk-2HR4MWNC.js";
import {
  d,
  x,
  y as y2
} from "./chunk-A2GBXFUE.js";
import {
  l as l2
...
function j(e3, t8) {
  e3.today = function(r6, e4) {
    return t8(r6, e4, (t9, o5, i11) => {
      ...
      return a5.setHours(0, 0, 0, 0), m2.dateJSAndZoneToArcadeDate(a5, Ke(r6));
    });
  }, e3.time = function(r6, e4) {
    return t8(r6, e4, (t9, f8, m6) => {
      switch (oe(m6, 0, 4, r6, e4), m6.length) {
        case 0: {
          const e5 = m2.nowToArcadeDate(Ke(r6));
    ...
    return t8(e4, i11, (t9, a5, s7) => {
      ...
      const h4 = h2(Z2(ge(s7[1]), e4), false);
      if (null === h4) return null;
      const N2 = m2.arcadeDateAndZoneToArcadeDate(d6, h4);
    ...
    return t8(r6, e4, (t9, o5, i11) => {
      oe(i11, 0, 0, r6, e4);
      const a5 = m2.nowToArcadeDate(Ke(r6));
    ...
    return t8(e4, o5, (t9, s7, d6) => {
      if (oe(d6, 0, 8, e4, o5), 3 === d6.length) {
        if (re(d6[0]) && ie(d6[1]) && e(d6[2])) {
          const t10 = h2(Z2(ge(d6[2]) ?? "unknown", e4), false);
          return null === t10 ? null : S(m2.fromParts(d6[0].year, d6[0].month, d6[0].day, d6[1].hour, d6[1].minute, d6[1].second, d6[1].millisecond, t10));
        }
        return S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), 0, 0, 0, 0, Ke(e4)));
      }
      if (4 === d6.length) return S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), Se(d6[3]), 0, 0, 0, Ke(e4)));
      if (5 === d6.length) return S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), Se(d6[3]), Se(d6[4]), 0, 0, Ke(e4)));
      if (6 === d6.length) return S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), Se(d6[3]), Se(d6[4]), Se(d6[5]), 0, Ke(e4)));
      if (7 === d6.length) return S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), Se(d6[3]), Se(d6[4]), Se(d6[5]), Se(d6[6]), Ke(e4)));
      if (8 === d6.length) {
        const t10 = h2(Z2(ge(d6[7]) ?? "unknown", e4), false);
        return null === t10 ? null : S(m2.fromParts(Se(d6[0]), Se(d6[1]) + 1, Se(d6[2]), Se(d6[3]), Se(d6[4]), Se(d6[5]), Se(d6[6]), t10));
      }
      if (2 === d6.length) {
        if (re(d6[0]) && e(d6[1])) {
          const t11 = h2(Z2(ge(d6[1]) ?? "unknown", e4), false);
          return null === t11 ? null : S(m2.fromParts(d6[0].year, d6[0].month, d6[0].day, 0, 0, 0, 0, t11));
        }
        ...
        let t10, o6 = ge(d6[1]);
        return "" === o6 ? null : (o6 = ce(o6, true), t10 = "X" === o6 ? DateTime.fromSeconds(Se(d6[0])) : "x" === o6 ? DateTime.fromMillis(Se(d6[0])) : DateTime.fromFormat(ge(d6[0]), o6, { locale: l(), numberingSystem: "latn" }), t10.isValid ? m2.dateTimeToArcadeDate(t10) : null);
      }
      if (1 === d6.length) {
      ...
      return 0 === d6.length ? m2.nowToArcadeDate(Ke(e4)) : null;
    });
    ...
    return t8(r6, e4, (t9, o5, i11) => {
      ...
      let N2 = z2(i11[3], "");
      return "" !== N2 && null !== N2 ? (N2 = Z2(ge(N2), r6), s7 = m2.arcadeDateAndZoneToArcadeDate(s7, N2), h4 = m2.arcadeDateAndZoneToArcadeDate(h4, N2)) : s7.timeZone !== h4.timeZone && (s7.isUnknownTimeZone ? s7 = m2.arcadeDateAndZoneToArcadeDate(s7, h4.timeZone) : h4 = (h4.isUnknownTimeZone, m2.arcadeDateAndZoneToArcadeDate(h4, s7.timeZone))), s7.diff(h4, U2(i11[2]));
    });
  ...
  o5.domain = function(e3, r6) {
    return w(e3, r6, (o6, m6, c5) => {
      if (oe(c5, 2, 3, e3, r6), H(c5[0])) {
        ...
        return r7 && r7.domain ? "coded-value" === r7.domain.type || "codedValue" === r7.domain.type ? p2.convertObjectToArcadeDictionary({ type: "codedValue", name: r7.domain.name, dataType: P2[r7.field.type], codedValues: r7.domain.codedValues.map((e4) => ({ name: e4.name, code: e4.code })) }, Ke(e3)) : p2.convertObjectToArcadeDictionary({ type: "range", name: r7.domain.name, dataType: P2[r7.field.type], min: r7.domain.minValue, max: r7.domain.maxValue }, Ke(e3)) : null;
      }
    ...
    return w(r6, t8, (r7, t9, o6) => {
      if (oe(o6, 1, 1, r7, t9), H(o6[0])) {
        if (o6[0].hasField(i6)) {
          ...
          return n4(t10) ? m2.epochToArcadeDate(t10, r7.timeZone ?? "system") : ne(t10) ? t10 : null;
        }
        return null;
      }
  ...
  C5.ringisclockwise = function(e3, t8) {
    ...
    return E4(e3, t8, (a5, i11, o5) => {
      ...
      if (oe(o5, 1, 1, e3, t8), o5[0] instanceof p2) {
        ...
        t9 && !t9.spatialReference && (t9.spatialReference = e3.spatialReference), c5 = De(new P(t9), e3.spatialReference);
      }
    ...
    return E4(e3, t8, (a5, i11, o5) => {
      ...
      if (oe(o5, 1, 1, e3, t8), o5[0] instanceof p2) {
        ...
        const t9 = JSON.parse(o5[0]);
        t9 && !t9.spatialReference && (t9.spatialReference = e3.spatialReference), c5 = De(new m(t9), e3.spatialReference);
      }
      if (null !== c5 && false === c5.spatialReference.equals(e3.spatialReference)) throw new n3(e3, "WrongSpatialReference", t8);
      return je(c5);
    });
    ...
    return E4(e3, t8, (a5, i11, o5) => {
      ...
      } else if (o5[0] instanceof P) u3 = f2((_a = o5[0].extent) == null ? void 0 : _a.toJSON());
      else if (o5[0] instanceof y) u3 = f2((_b = o5[0].extent) == null ? void 0 : _b.toJSON());
      else if (o5[0] instanceof m) u3 = f2((_c = o5[0].extent) == null ? void 0 : _c.toJSON());
...
var c4;
async function s6() {
  null == c4 && (c4 = await import("./geodeticDistanceOperator-UDFAYNAO.js"), await c4.load());
}
function i10(t8) {
  const n7 = t8.track;
...
function b3(r6, c5) {
  r6[r3("TrackIndex")] = function(t8, n7) {
    ...
    return c5(n7, r7, (n8, r8, o5) => (oe(o5, 0, 0, n8, r8), m2.epochToArcadeDate(i10(n8).observations[0].startTime, n8.timeZone ?? "system")));
  }, r6[r3("TrackCurrentTime")] = function(n7, r7) {
    return c5(n7, r7, (n8, r8, o5) => {
      oe(o5, 0, 0, n8, r8);
      const a5 = i10(n8);
      return m2.epochToArcadeDate(a5.observations[a5.currentObservationIndex].startTime, n8.timeZone ?? "system");
    });
...
//# sourceMappingURL=chunk-P2A4SSYS.js.map

...
var X = class extends n {
  ...
  async open(e2) {
    return this._openPromise ?? (this._openPromise = j2().then(() => this._open(e2))), this._openPromise;
  }
  ...
  getSliceIndex(e2) {
    ...
    return null == t3 || null == e2 || 0 === e2.length ? null : C(e2, t3);
  }
  ...
  identifyPixelLocation(e2, t3, i5, o3) {
    const { spatialReference: r5, nativeExtent: n4, storageInfo: s4 } = this.rasterInfo, { maximumPyramidLevel: l6, origin: a3, transposeInfo: c2 } = s4, f2 = o3 && null != c2 ? c2.tileSize[0] : s4.blockWidth, m5 = o3 && null != c2 ? c2.tileSize[1] : s4.blockHeight, u5 = W2(e2, r5, i5);
  ...
  async _fetchPixels(e2, t3, i5, o3 = {}) {
    ...
    C3 && !this.rasterJobHandler && await j2();
    ...
    if (this.rasterJobHandler) {
      ...
      D4 = O2 ? N2(e3, { width: t3, height: i5 }, E.coefficients, A, o3.interpolation) : e3, C3 && E.gcsGrid && (Q4 = D2({ width: t3, height: i5 }, E.gcsGrid), D4 = u2(D4, this.rasterInfo.dataType, Q4));
    }
  ...
  _getSourceDataInfo(e2, t3, i5, o3 = {}) {
    ...
    if (u5 || h4 || (0 === s4 || 0 === l6)) {
      ...
      let l7 = C2(s5, this.rasterInfo.spatialReference, e2, r5.datumTransformation);
  ...
  _processIdentifyResult(e2, t3) {
    ...
    if (f2) {
      const e3 = r2(u5, m5.multidimensionalDefinition, m5.timeExtent);
    ...
    return { location: i5, value: null, dataSeries: u5.map((e3, t4) => {
      const i6 = { value: 0 === (x3 == null ? void 0 : x3[t4]) ? null : a3.map((e4) => e4[t4]), multidimensionalDefinition: e3.multidimensionalDefinition.map((e4) => new p({ ...e4, isSlice: true })) };
...
var m4 = class extends X {
  ...
  async fetchPixels(t3, e2, r5, s4 = {}) {
    ...
    if (!l6 || null == y4 || null == g4) {
      ...
      return !s4.noClip && null != y4 && t4 && (y4 = await r3(y4, f2, t4)), { ...u5[0], pixelBlock: y4 };
    }
    ...
    } else R2 = N2(y4, { width: e2, height: r5 }, g4.coefficients, x3, c2);
    const w2 = s4.noClip ? null : this.getClippingGeometry(t3.spatialReference);
    return s4.noClip || null == R2 || null == w2 || (R2 = await r3(R2, t3, w2)), { extent: t3, srcExtent: u5[0].srcExtent, pixelBlock: R2 };
  }
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t3.clippingType) {
      const { extent: t4 } = this.rasterInfo, r5 = await import("./densifyOperator-MIRPC7AG.js"), s4 = await import("./differenceOperator-O35DXLZV.js");
...
var X2 = (X3) => {
  ...
  let Z = class extends Y {
    ...
    async computeStatisticsHistograms(e2, t3) {
      await this.load(t3), e2 = m(j, e2).clone();
      ...
      const l6 = e2.pixelSize ?? new _2({ x: r5.pixelSize.x, y: r5.pixelSize.y, spatialReference: a3 }), { extent: u5, width: c2, height: p6 } = p4(r5, n4, l6), d2 = await this.fetchPixels(u5, c2, p6, { ...t3, interpolation: "nearest" });
      if (null == d2.pixelBlock) throw new s("imagery-tile-mixin:compute-statistics-histograms", "failed to fetch pixels");
      const h4 = await r3(d2.pixelBlock, u5, n4), f2 = this._rasterJobHandler;
    ...
    getMultidimensionalSubsetVariables(e2) {
      ...
      return D(this.multidimensionalSubset, t3);
    }
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r5) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i6 = await import("./densifyOperator-MIRPC7AG.js"), s5 = (await import("./lengthOperator-NWHWT7SG.js")).execute(t3, { unit: "meters" }), n5 = Math.min(e2.sampleCount || 100, Q3);
    ...
    _configDefaultRenderer(e2 = "no") {
      ...
      if (!this.bandIds && t3.bandCount > 1 && (this.bandIds = (n4 == null ? void 0 : n4.bandIds) ?? W(t3)), !this.renderer || "override" === e2) {
...
//# sourceMappingURL=chunk-LK7POITB.js.map

...
function Re(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return h(i5) || (i5 = i5.slice().reverse()), new P({ rings: [i5], spatialReference: o2, hasZ: n4, hasM: r4 });
  }
  return e4;
}
function ve(e4, t3) {
...
var p3 = class _p {
  ...
  setField(e4, i5) {
    ...
    i5 instanceof Date && (i5 = m2.dateJSToArcadeDate(i5));
  ...
  async castAsJsonAsync(e4 = null, s4 = null) {
    ...
    for (let o2 in this.attributes) {
      ...
      (s4 == null ? void 0 : s4.keyTranslate) && (o2 = s4.keyTranslate(o2)), void 0 !== u && (V(u) || u instanceof c || u instanceof m2 ? r4[o2] = Ge(u, s4) : i5.push(this.castDictionaryValueAsJsonAsync(r4, o2, u, e4, s4)));
    }
...
//# sourceMappingURL=chunk-4PKSIBCO.js.map

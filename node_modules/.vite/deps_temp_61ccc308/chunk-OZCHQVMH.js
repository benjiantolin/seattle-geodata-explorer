...
function t(r2, t2, f2, c3, i, m2) {
  return e[0] = r2, e[1] = t2, e[2] = f2, o3(e, c3, 0, i, m2, 0);
}
var e = n();
...
async function L(n2) {
  null == k && (k = Promise.all([import("./projectOperator-EBC3OZ6R.js").then((n3) => (v = n3, v.load())), import("./projectOperator-IKGXF2MJ.js").then((n3) => (P2 = n3, P2.load())), import("./geographicTransformationUtils-CVM4OHXV.js").then((n3) => (A = n3, A.load()))])), await k, s2(n2), E.notify();
}
function W(n2, e2, r2) {
...
function F(n2, e2) {
  try {
    ...
    const t2 = o2(r2.type, n2.spatialReference, e2);
...
function _2(n2, e2, r2, t2, o4) {
  fn[0] = n2.x, fn[1] = n2.y;
  const i = n2.z;
  return fn[2] = void 0 !== i ? i : o4, o3(fn, e2, 0, fn, t2, 0) ? (r2.x = fn[0], r2.y = fn[1], r2.spatialReference = t2, void 0 !== i || U(t2) ? (r2.z = fn[2], r2.hasZ = true) : (r2.z = void 0, r2.hasZ = false), void 0 === n2.m ? (r2.m = void 0, r2.hasM = false) : (r2.m = n2.m, r2.hasM = true), r2) : null;
}
...
function en(n2, e2, r2, t2, o4) {
  ...
  if (!o3(c3, e2, 0, c3, t2, 0, f2)) return null;
  const p2 = s4 || U(t2);
  for (let u = 0; u < f2; ++u) {
...
function un(n2, e2, r2, t2, o4, i, s4 = 0) {
  ...
  if (!o3(a2, t2, 0, a2, i, 0)) return false;
  let l = 0;
  o4.length = 0;
  const f2 = e2 || U(i);
  for (const u of n2) {
...
//# sourceMappingURL=chunk-OZCHQVMH.js.map

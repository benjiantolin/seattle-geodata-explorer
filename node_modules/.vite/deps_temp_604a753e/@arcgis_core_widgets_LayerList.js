...
import {
  ...
  u,
  v
} from "./chunk-YD4JWQML.js";
import "./chunk-NPBFSMWM.js";
...
var y = class extends l2 {
  ...
  initialize() {
    ...
    }, () => this._viewHandles(), h), l(() => [this.listItemCreatedFunction, this.checkPublishStatusEnabled, this.listModeDisabled], () => this._recompileList()), l(() => e5(this.view) ? this.view.inGeographicLayout : null, () => this._compileList())], m3.view);
  }
  destroy() {
  ...
  _compileList() {
    var _a, _b;
    const e7 = (_b = (_a = this.view) == null ? void 0 : _a.map) == null ? void 0 : _b.layers, t3 = e5(this.view) && !this.view.inGeographicLayout ? e7 == null ? void 0 : e7.filter(({ type: e8 }) => "link-chart" === e8) : e7;
...
var j2 = class extends s2(B) {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-HCSYA3Y7.js"), flow: () => import("./calcite-flow-YHR3TT2U.js"), "flow-item": () => import("./calcite-flow-item-7LSUH5ES.js"), list: () => import("./calcite-list-77NAKOXR.js"), notice: () => import("./calcite-notice-XSMZ3FDQ.js"), tooltip: () => import("./calcite-tooltip-K5LQSGST.js") });
  }
  destroy() {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-FCQWMWLH.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-UN4ZO732.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

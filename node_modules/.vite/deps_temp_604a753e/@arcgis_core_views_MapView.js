import {
  ...
  n as n13,
  o as o11
} from "./chunk-N7IKB7HN.js";
import "./chunk-GQGQDZ2T.js";
import {
  c as c6,
  g as g2,
  s as s10
} from "./chunk-T3ZMUUFN.js";
import {
  i as i11,
  n as n14,
  o as o12,
...
import "./chunk-26MV3Z4V.js";
import "./chunk-SXJ272YJ.js";
import {
  h as h4,
  s as s8
...
import {
  L as L3
} from "./chunk-QHZ53B56.js";
import "./chunk-GEGX35PE.js";
import "./chunk-5G7CCJQT.js";
import "./chunk-MAXCKUF6.js";
import "./chunk-F2GK6G5A.js";
import {
  n as n11
} from "./chunk-GDCECZPL.js";
import "./chunk-NPYFNHY2.js";
import {
  l as l9
} from "./chunk-KUFWSQSS.js";
import "./chunk-7A7VUO6T.js";
import "./chunk-NXLCRIGA.js";
import "./chunk-CV7X5ZEU.js";
import "./chunk-LVAL6BQE.js";
import "./chunk-ILTVDVM6.js";
import "./chunk-LTQI5XVS.js";
import "./chunk-EKOZXMWW.js";
import {
  m as m8
} from "./chunk-HF2XPLQI.js";
import "./chunk-IGXCWBJT.js";
import {
  m as m7
...
import "./chunk-3622T4Z6.js";
import {
  b as b5
} from "./chunk-HE7VCYYN.js";
import {
  o as o5
...
import {
  r as r5
} from "./chunk-TQTQO7NN.js";
import {
  n as n5
} from "./chunk-JSIIAR2E.js";
import "./chunk-SKQGVNYC.js";
...
var V = (u19) => {
  ...
  let _12 = class extends V5 {
    ...
    initialize() {
      ...
      }, f5.WIDGET)]), j(() => this.ready && this.popupEnabled && !this.updating).then(() => import("./Popup-EYFJGI5G.js"));
    }
    destroy() {
    ...
    async setupPopup() {
      ...
      if ((_a4 = this._popupSetupTask) == null ? void 0 : _a4.abort(), this.popup && !i12(this.popup)) return this._popupSetupTask = d3(async (p27) => {
        if (!this.popupEnabled || !p5(this.popupElement)) if (this.dependencies.popup && "function" == typeof this.dependencies.popup) await this.dependencies.popup(), s2(p27), customElements.get("arcgis-popup") || i.getLogger(this).error(new s("view:undefined-popup-element", "`arcgis-popup` custom element is undefined and can't be opened")), this.popupElement = document.createElement("arcgis-popup");
          ...
          const { default: e30 } = await import("./Popup-EYFJGI5G.js");
...
function r27() {
  return Promise.all([import("./webglDeps-DLZVGKQ6.js"), import("./mapViewDeps-G2N7APUE.js")]);
}
var a26 = () => r27().then(() => import("./TileLayerView2D-UGZ62U3I.js"));
var t22 = () => r27().then(() => import("./FeatureLayerView2D-XDYCV5DH.js"));
var i29 = { "base-dynamic": () => r27().then(() => import("./BaseDynamicLayerView2D-ECG65RSQ.js")), "base-tile": a26, "bing-maps": a26, catalog: () => r27().then(() => import("./CatalogLayerView2D-AGYKY64F.js")), "catalog-dynamic-group": () => r27().then(() => import("./CatalogDynamicGroupLayerView2D-HNG36A6Y.js")), "catalog-footprint": () => r27().then(() => import("./CatalogFootprintLayerView2D-XZBL4J2T.js")), csv: t22, "geo-rss": () => r27().then(() => import("./GeoRSSLayerView2D-B7HUAQ4U.js")), feature: t22, geojson: t22, parquet: t22, graphics: () => r27().then(() => import("./GraphicsLayerView2D-JXHLHTI6.js")), group: () => r27().then(() => import("./GroupLayerView2D-BPZ2LWLI.js")), imagery: () => r27().then(() => import("./ImageryLayerView2D-IANZJJYX.js")), "imagery-tile": () => r27().then(() => import("./ImageryTileLayerView2D-Y5WN7QOG.js")), kml: () => r27().then(() => import("./KMLLayerView2D-EU5ZXURE.js")), "knowledge-graph": () => r27().then(() => import("./KnowledgeGraphLayerView2D-CZ4XZBIQ.js")), "link-chart": () => r27().then(() => import("./KnowledgeGraphLayerView2D-CZ4XZBIQ.js")), "knowledge-graph-sublayer": t22, "map-image": () => r27().then(() => import("./MapImageLayerView2D-MYQ6AFWB.js")), "map-notes": () => r27().then(() => import("./MapNotesLayerView2D-MWBVNG2G.js")), media: () => r27().then(() => import("./MediaLayerView2D-QUUWN2WD.js")), "ogc-feature": () => r27().then(() => import("./OGCFeatureLayerView2D-WOAFQJ6C.js")), "open-street-map": a26, "oriented-imagery": t22, route: () => r27().then(() => import("./RouteLayerView2D-WAQJWQ7L.js")), stream: () => r27().then(() => import("./StreamLayerView2D-JQEMMWRI.js")), "subtype-group": () => r27().then(() => import("./SubtypeGroupLayerView2D-HU5J3HB5.js")), tile: a26, "vector-tile": () => r27().then(() => import("./VectorTileLayerView2D-QDG5IITJ.js")), video: () => r27().then(() => import("./VideoLayerView2D-MOEQKDD4.js")), wcs: () => r27().then(() => import("./ImageryTileLayerView2D-Y5WN7QOG.js")), "web-tile": a26, wfs: t22, wms: () => r27().then(() => import("./WMSLayerView2D-JOKRDJWY.js")), wmts: () => r27().then(() => import("./WMTSLayerView2D-J3OOWTH5.js")), "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "gaussian-splat": null, "integrated-mesh-3dtiles": null, "integrated-mesh": null, "line-of-sight": null, "point-cloud": null, scene: null, unknown: null, unsupported: null, viewshed: null, voxel: null };
function s31(r29) {
...
var l21 = { "area-measurement": null, dimension: null, "direct-line-measurement": null, "elevation-profile": () => import("./ElevationProfileAnalysisView2D-NJJQUR7Y.js"), "line-of-sight": null, slice: null, viewshed: null, "volume-measurement": null };
function n29(n34) {
...
var ie;
async function re() {
  const [, { GraphicsView2D: e30, GraphicContainer: t27, LabelManager: i30, MapViewNavigation: r29, MagnifierView2D: s35, GridView2D: a31, Stage: n34 }] = await Promise.all([import("./webglDeps-DLZVGKQ6.js"), import("./mapViewDeps-G2N7APUE.js")]);

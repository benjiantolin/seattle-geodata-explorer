...
import {
  h as h3,
  h2 as h4
} from "./chunk-EVPSRI7M.js";
import {
  r as r5,
  s as s3
} from "./chunk-RMC3L32V.js";
import {
  p as p3
} from "./chunk-GH6WUDX5.js";
import {
  n as n6
} from "./chunk-E2TSHXK6.js";
import {
  i as i3
} from "./chunk-EV2XYHPJ.js";
import {
  e as e4
} from "./chunk-UYWK5YQZ.js";
import {
  i as i2
} from "./chunk-WKL24YYX.js";
import {
  g as g3,
  v as v3,
  y as y3
...
var q3 = class extends l2 {
  ...
  async _createSelfSnappingEngine(e8) {
    const [{ SelfSnappingEngine: t6 }, n11] = await Promise.all([import("./SelfSnappingEngine-RJSG6ELR.js"), g4()]);
  ...
  async _createGridSnappingEngine(e8) {
    ...
    const { GridSnappingEngine: n11 } = await import("./GridSnappingEngine-6GYIJ5LC.js");
    return s2(e8), { type: "grid", engine: new n11({ view: t6, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e8) {
    const { FeatureSnappingEngine: t6 } = await import("./FeatureSnappingEngine-CXSLTNHX.js");
    s2(e8);
...
async function o2() {
  const e8 = await import("./geometryEngine-DMIL72WW.js");
  return s4(e8);
}
function n7(t6) {
...
var pe = { defaultZ: 0 };
var le = { reshapeOptions: { edgeOperation: "split", shapeOperation: "move", vertexOperation: "move" }, enableMoveAllGraphics: true, enableRotation: true, enableScaling: true, multipleSelectionEnabled: true, preserveAspectRatio: false, toggleToolOnClick: true, enableZ: true, highlightOptions: { enabled: true, name: c }, tool: "transform" };
var he = Symbol();
var ce = Symbol();
var de2 = class extends l2 {
  ...
  initialize() {
    this.addHandles([a2(() => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e8 && (this.snappingManager || (this._defaultSnappingManager = new q3({ view: e8, options: this.snappingOptions })), "2d" === e8.type ? import("./editingTools-23RKDKUA.js") : "3d" === e8.type && (import("./editingTools-MGSLB6TI.js"), import("./GraphicsLayerView3D-IO3YUY3M.js")));
    }, w), l(() => {
      var _a;
  ...
  async _makeDrawGraphicTool2D(e8) {
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-23RKDKUA.js")), u5(), c5()]);
  ...
  async _makeDrawGraphicTool3D(e8) {
    var _a;
    const [t6, o3, a11] = await Promise.all([this._requireModule(import("./editingTools-MGSLB6TI.js")), u5(), c5()]);
  ...
  _setupCreateOperationHandle(e8, t6) {
    ...
    const i5 = e8.forceUniformSize, s7 = e8.centered, n11 = [o3.on("key-down", (t7) => {
      if (t7.key === c2.pan) t7.stopPropagation(), t7.repeat || (e8.enabled = false);
      else if (t7.key === c2.complete) t7.stopPropagation(), e8.completeCreateOperation();
      else if (t7.key !== c2.vertexAdd || t7.repeat) t7.key === c2.undo ? (t7.stopPropagation(), p7.undo()) : t7.key === c2.redo ? (t7.stopPropagation(), p7.redo()) : t7.key !== c2.constraint || "rectangle" !== e8.geometryType && "circle" !== e8.geometryType || t7.repeat ? t7.key === c2.center && (t7.repeat || (e8.centered = !s7, t7.stopPropagation())) : (e8.forceUniformSize = !i5, t7.stopPropagation());
      else {
      ...
      t7.key === c2.pan ? e8.enabled = true : t7.key !== c2.constraint || "rectangle" !== e8.geometryType && "circle" !== e8.geometryType ? t7.key === c2.center && (e8.centered = s7, t7.stopPropagation()) : (e8.forceUniformSize = i5, t7.stopPropagation());
  ...
  async _setupMove3DOperation(e8, t6, o3, a11, i5 = false) {
    const [s7, n11] = await Promise.all([this._requireModule(import("./editingTools-MGSLB6TI.js")), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _setupPointTransform3DOperation(e8, t6, o3) {
    const a11 = "transform", { enableRotation: i5, enableScaling: s7, enableZ: n11 } = t6, p7 = await this._requireModule(import("./editingTools-MGSLB6TI.js"));
    if (Ge(p7)) return p7;
  ...
  async _setupPolyTransform3DOperation(e8, t6, o3, a11 = false) {
    ...
    return v5.push(...this._getHandlesForComponent(f4, t6), o3.on("immediate-click", (e9) => this._getCommonUpdateOperationClickHandlers(f4, e9, t6), f2.WIDGET), o3.on("key-down", (e9) => this._getCommonUpdateOperationKeyDownHandlers(f4, e9), f2.WIDGET), o3.on("key-down", (e9) => {
      e9.key !== c2.constraint || e9.repeat || (g6.preserveAspectRatio = !g6.preserveAspectRatio, e9.stopPropagation());
    }, f2.WIDGET), o3.on("key-up", (e9) => {
      e9.key === c2.constraint && (g6.preserveAspectRatio = !g6.preserveAspectRatio, e9.stopPropagation());
    }, f2.WIDGET)), f4;
  }
  async _setupMove2DOperation(e8, t6, o3) {
    ...
    const p7 = [o3.on("immediate-click", (e9) => this._getCommonUpdateOperationClickHandlers(s7, e9, t6), f2.WIDGET), o3.on("key-down", (e9) => {
      this._getCommonUpdateOperationKeyDownHandlers(s7, e9), e9.key !== c2.constraint || e9.repeat || (n11 = true, i5.enableMoveAllGraphics = !i5.enableMoveAllGraphics);
    }, f2.WIDGET), o3.on("key-up", (e9) => {
      e9.key === c2.constraint && n11 && (n11 = false, i5.enableMoveAllGraphics = !i5.enableMoveAllGraphics);
    }, f2.WIDGET)], l8 = this._getHandlesForComponent(s7, t6);
    return s7;
  }
  async _setupReshape3DOperation(e8, t6, o3, a11 = false) {
    const i5 = "reshape", [s7, n11, p7] = await Promise.all([this._requireModule(import("./editingTools-MGSLB6TI.js")), u5(), c5()]);
    if (Ge(s7)) return s7;
  ...
  async _getGraphicMover(e8, t6, o3) {
    const { enableMoveAllGraphics: a11, highlightOptions: i5 } = t6, r9 = await this._requireModule(import("./GraphicMover-UQ3SDGVL.js"));
  ...
  async _getBox(e8, t6, o3) {
    var _a, _b;
    const { enableRotation: a11, enableScaling: i5, highlightOptions: r9, preserveAspectRatio: s7 } = t6, [n11, p7] = await Promise.all([this._requireModule(import("./Box-U46TT3ZG.js")), c5()]);
    if (Ge(n11)) return n11;
    const l8 = (_b = (_a = this.view) == null ? void 0 : _a.inputManager) == null ? void 0 : _b.isModifierKeyDown(c2.constraint);
  ...
  async _getReshape(e8, t6, o3) {
    const { highlightOptions: a11, reshapeOptions: i5 } = t6, r9 = "split" === (i5 == null ? void 0 : i5.edgeOperation), s7 = "move" === (i5 == null ? void 0 : i5.shapeOperation), n11 = !!(i5 == null ? void 0 : i5.enableCreateCurveFromStraightEdge), [p7, l8, h7] = await Promise.all([this._requireModule(import("./Reshape-R7NFEQ64.js")), u5(), c5()]);
  ...
  _getCommonUpdateOperationKeyDownHandlers(e8, t6) {
    if (!e8) return;
    const o3 = t6.key;
    o3 === c2.undo && e8.canUndo() ? (t6.stopPropagation(), e8.undo()) : o3 === c2.redo && e8.canRedo() ? (t6.stopPropagation(), e8.redo()) : o3 === c2.cancel ? (t6.stopPropagation(), e8.cancel()) : this.allowDeleteKey && c2.delete.includes(o3) && this._onDeleteKey(t6);
  }
  _onDeleteKey(e8) {
    var _a;
...
//# sourceMappingURL=chunk-GIPMFJFW.js.map

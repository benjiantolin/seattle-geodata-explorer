...
import {
  p as p4
} from "./chunk-WA6OZLR6.js";
import {
  p as p5
} from "./chunk-F2GK6G5A.js";
import {
  p as p3
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-PMGJAJ4N.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
...
//# sourceMappingURL=MediaLayer-GYEIKYC4.js.map

import {
  de
} from "./chunk-GIPMFJFW.js";
import "./chunk-ETPJPHLS.js";
import "./chunk-RIOHB6DZ.js";
import {
  c as c3
} from "./chunk-LWA6THOK.js";
import "./chunk-UAU5YLNR.js";
import {
  j as j2
} from "./chunk-4CYY35OP.js";
import {
  e as e4
} from "./chunk-PUNZ2XP7.js";
import "./chunk-NKIGQKZS.js";
import "./chunk-BCMAT5DP.js";
import "./chunk-EVPSRI7M.js";
import "./chunk-RMC3L32V.js";
import "./chunk-PXYPSB4F.js";
import "./chunk-GH6WUDX5.js";
import "./chunk-VL4B5WMX.js";
import "./chunk-E2TSHXK6.js";
import "./chunk-ZNHSRWJV.js";
import "./chunk-EV2XYHPJ.js";
import "./chunk-UYWK5YQZ.js";
import "./chunk-WKL24YYX.js";
...
__decorate([m2({ constructOnly: true })], n4.prototype, "parent", void 0), __decorate([m2({ constructOnly: true })], n4.prototype, "view", void 0), __decorate([m2({ type: Boolean })], n4.prototype, "interactive", null), __decorate([m2()], n4.prototype, "_userInteractive", void 0), __decorate([m2({ readOnly: true })], n4.prototype, "updating", null), __decorate([m2()], n4.prototype, "visible", null), __decorate([m2()], n4.prototype, "_interactiveViewModelCount", void 0), n4 = __decorate([a3("esri.views.analysis.AnalysisView")], n4);

// node_modules/@arcgis/core/views/2d/analysis/AnalysisView2D.js
var e5 = class extends n4 {
};
e5 = __decorate([a3("esri.views.2d.analysis.AnalysisView2D")], e5);
...
__decorate([m2({ constructOnly: true })], e6.prototype, "view", void 0), __decorate([m2({ constructOnly: true })], e6.prototype, "analysisViewData", void 0), __decorate([m2()], e6.prototype, "updating", null), e6 = __decorate([a3("esri.views.2d.analysis.ElevationProfile.ElevationProfileInputVisualization2D")], e6);
...
var d3 = class extends b {
  ...
  initialize() {
    ...
    }), l(() => this._colorUpdateParameters, (t6) => this._updateColor(t6), w2), l(() => this.analysisViewData.analysis.geometry, () => {
      this._graphic.visible = false;
    }, w2), l(() => this._geometryUpdateParameters, (t6) => this._updateGeometryThrottled(t6), w2), this._updateGeometryThrottled]);
  }
  destroy() {
    var _a;
...
__decorate([m2({ constructOnly: true })], d3.prototype, "view", void 0), __decorate([m2({ constructOnly: true })], d3.prototype, "analysisViewData", void 0), __decorate([m2()], d3.prototype, "updating", null), __decorate([m2()], d3.prototype, "_result", null), __decorate([m2()], d3.prototype, "_geometryUpdateParameters", null), __decorate([m2()], d3.prototype, "_colorUpdateParameters", null), d3 = __decorate([a3("esri.views.2d.analysis.ElevationProfile.ElevationProfileLineVisualization2D")], d3);
...
var l6 = class extends b {
  ...
  initialize() {
    var _a;
    this.addHandles([l(() => this._screenLocation, (o10) => {
      o10 && (this.element.style.transform = `translate(${o10.x}px, ${o10.y}px)`);
    }, w2), l(() => this.color.toCss(), (o10) => {
...
__decorate([m2()], l6.prototype, "position", void 0), __decorate([m2({ type: u3 })], l6.prototype, "color", void 0), __decorate([m2()], l6.prototype, "view", void 0), __decorate([m2()], l6.prototype, "_screenLocation", null), l6 = __decorate([a3("esri.views.analysis.ElevationProfile.ElevationProfileHoveredPointVisualization")], l6);
...
var l7 = class extends b {
  ...
  initialize() {
    ...
    }, (o11) => this._update(o11), w2), l(() => t6.geometry, () => this._update([]), w2)]);
  }
  destroy() {
...
__decorate([m2()], l7.prototype, "view", void 0), __decorate([m2()], l7.prototype, "analysisViewData", void 0), __decorate([m2()], l7.prototype, "_hoveredPoints", void 0), __decorate([m2()], l7.prototype, "updating", null), l7 = __decorate([a3("esri.views.analysis.ElevationProfile.ElevationProfileHoveredPointsVisualization")], l7);
...
__decorate([m2()], n5.prototype, "view", void 0), __decorate([m2()], n5.prototype, "analysisViewData", void 0), __decorate([m2()], n5.prototype, "updating", null), n5 = __decorate([a3("esri.views.2d.analysis.ElevationProfile.ElevationProfileVisualization2D")], n5);
...
async function y4(e10, t6, s6, o10, i5, a6, h4) {
  ...
  let v3 = 0;
  if (!j5) {
    const { execute: t7 } = await import("./lengthOperator-3IZUVFAL.js");
...
var k2 = class extends b {
  ...
  initialize() {
    ...
    }), l(() => this._updateParameters, (t7) => this._updateThrottled(t7), w2), this._updateThrottled]);
  ...
  onElevationChange(t6) {
    const { view: e10 } = this;
    return "3d" === (e10 == null ? void 0 : e10.type) ? a2(() => e10.elevationProvider, "elevation-change", t6, { onListenerAdd: t6, onListenerRemove: t6 }) : e();
  }
  get _tileCache() {
    var _a;
...
__decorate([m2()], u7.prototype, "minDemResolution", null), __decorate([m2()], u7.prototype, "available", null), __decorate([m2()], u7.prototype, "_queryElevationDependencies", null), __decorate([m2()], u7.prototype, "_ground", null), u7 = __decorate([a3("esri.views.analysis.ElevationProfile.ElevationProfileLineGroundComputation")], u7);
...
var u8 = class extends p {
  ...
  initialize() {
    ...
    this.addHandles([l(() => this._queryElevationDependencies, e10, U), this.controller.onElevationChange(e10)]);
  }
...
__decorate([m2()], u8.prototype, "_queryElevationDependencies", null), u8 = __decorate([a3("esri.views.analysis.ElevationProfile.ElevationProfileLineInputComputation")], u8);
...
__decorate([m2({ readOnly: true })], n8.prototype, "minDemResolution", null), __decorate([m2()], n8.prototype, "available", null), n8 = __decorate([a3("esri.views.analysis.ElevationProfile.ElevationProfileLineQueryComputation")], n8);
...
var L2 = class extends b {
  ...
  initialize() {
    const { view: e10 } = this;
    this._graphicsLayer = new n2({ listMode: "hide", internal: true }), this.addHandles([l(() => ({ map: e10.map, internalGraphicsLayer: this._graphicsLayer, state: this.state, geometryVisualizationVisible: this._analysis.viewOptions.geometryVisualizationVisible, visible: this.analysisViewData.visible }), ({ map: e11, internalGraphicsLayer: t6, state: s6, geometryVisualizationVisible: i5, visible: a6 }) => {
      I4(e11, t6);
    ...
    }, w2), l(() => this._analysis.elevationInfo, (e11) => {

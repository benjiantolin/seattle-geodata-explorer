...
var N = class extends l2 {
  ...
  initialize() {
    ...
    }), l(() => t3 == null ? void 0 : t3.scale, () => {
      this._updateRotateGraphic(), this._updateRotateLineGraphic();
    }), l(() => this.graphics, () => this.refresh()), l(() => this.layer, (t4, e2) => {
    ...
    }, w), l(() => this.view.effectiveTheme.accentColor, () => this._updateSymbolsForTheme(), h2), this.on("move-start", (t4) => {
      var _a, _b;
...
//# sourceMappingURL=Box-U46TT3ZG.js.map

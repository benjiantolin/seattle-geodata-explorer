import {
  r as r3,
  x
} from "./chunk-J7CXEDCE.js";
import "./chunk-5GJH3R5Q.js";
import {
  e as e9,
  u as u8
...
import {
  ...
  p,
  s as s8
} from "./chunk-XNBKU7WM.js";
import {
  n2 as n7
} from "./chunk-E5FD3U6T.js";
import "./chunk-RQGBRVDD.js";
import "./chunk-R7ZVQFHI.js";
import {
  a as a3
} from "./chunk-GX2LJSJ2.js";
import {
  R
} from "./chunk-2CFYXQYX.js";
import {
  d as d3,
  i as i9,
  i2 as i10,
  ...
  r as r4,
  t as t5
} from "./chunk-JXDW5RQL.js";
import {
  O,
  a as a2,
  u as u7
} from "./chunk-LVZKODX3.js";
import {
  i as i8
} from "./chunk-45BLOVAO.js";
import {
  d as d4
} from "./chunk-FDDMBRUF.js";
import {
  _ as _2,
  e as e4,
  i as i6,
...
import "./chunk-RDCFIXQD.js";
import {
  r as r5
} from "./chunk-C7S6E3JQ.js";
import "./chunk-JCMADXBT.js";
import "./chunk-JBQ7BLSJ.js";
import "./chunk-EIWKPVCB.js";
...
import {
  f as f3,
  g
} from "./chunk-E3XBBDIF.js";
import "./chunk-4X4BOGIG.js";
import {
  i as i7,
  s as s5,
  u as u5
} from "./chunk-P3I2PPIY.js";
import {
  e as e5
...
var U = class _U extends i14 {
  static async create(t17, e15, s17, a9, o8) {
    ...
    return n12.isWrappable || s5() || await Promise.all([import("./apiConverter-3ZEREECH.js"), import("./jsonConverter-TUZI5AXE.js"), i7()]).then(([t18, e16, s18]) => {
...
var l9 = class {
  constructor(e15, o8) {
    this.subscription = e15, this._tileIdToResult = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._handles = t([w(e15.signal, () => this._controller.abort()), w(o8, () => this._controller.abort())]);
  }
  destroy() {
...
var l10 = class {
  constructor(t17, o8) {
    this.subscription = t17, this._pages = /* @__PURE__ */ new Set(), this._controller = new AbortController(), this._done = false, this._handles = t([w(t17.signal, () => this._controller.abort()), w(o8, () => this._controller.abort())]);
  }
  destroy() {
    this._controller.abort(), this._handles.remove();
  }
...
var m8 = class extends e14 {
  ...
  connect() {
    ...
    this._streamConnection = r5(this._service.source, s17, this._service.outSpatialReference, e15, a9, o8, i21, r10, c8), this._handlesGroup = t([this._streamConnection.on("data-received", (e16) => this._onFeature(e16)), this._streamConnection.on("message-received", (e16) => this._onWebSocketMessage(e16))]), this._connectionState.connection = this._streamConnection;
  }
  clear() {
...
var y8 = class {
  ...
  onAttach(e15) {
    ...
    this._tileInfoView = new h2(i21), this._source = new _6(this._aggregateAdapter, this._subscriptions, s17, this._cachedObjectIds), this._processor = new b5(s17, this._source), this._handles = t([this._source.store.events.on("changed", () => this._requestUpdate()), this._source.store.events.on("refresh", () => this._requestRefresh()), l(() => this._source.updateTracking.updating, () => {
  ...
  async getSampleFeatures(e15) {
    ...
    const s17 = /* @__PURE__ */ new Set(), i21 = [], r10 = t17.map((e16) => e16.reader.getCursor()), o8 = new t2(), u12 = 3 * e15.sampleSize;
...
//# sourceMappingURL=FeaturePipelineWorker-DO42VAF3.js.map

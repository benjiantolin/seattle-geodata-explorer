...
var H = class extends b {
  ...
  _loadSourceModule(e4) {
    ...
    switch (e4) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-UAMYVJIY.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-HBZIPMNN.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-55J4HCO5.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-SHTPEDLD.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-DFH2S6YS.js.map

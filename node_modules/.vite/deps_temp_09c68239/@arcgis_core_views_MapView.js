...
import {
  L as L3
} from "./chunk-KN6N677X.js";
import "./chunk-GEGX35PE.js";
import "./chunk-IBZHQR3A.js";
import "./chunk-KKBEHV6Q.js";
import "./chunk-IZVO43B4.js";
import {
  n as n11
} from "./chunk-RDZ3M3SK.js";
import "./chunk-NPYFNHY2.js";
import {
  m as m8
} from "./chunk-6R4QEWGX.js";
import "./chunk-SBT2TIJ4.js";
import {
  m as m7
...
import "./chunk-IY7BT6LH.js";
import "./chunk-QXG5LO3E.js";
import "./chunk-LSKEZLRL.js";
import {
  t as t5
...
import {
  L as L2
} from "./chunk-4NQRIQQN.js";
import "./chunk-VKFEAGUN.js";
import "./chunk-OHC5I2U3.js";
import "./chunk-PJMKQQF6.js";
import {
  l as l9
} from "./chunk-B6DJZBIB.js";
import {
  b as b4
...
import "./chunk-7CBMHDRH.js";
import {
  b as b5
} from "./chunk-IJV5NZUE.js";
import {
  o as o5
...
var V = (u19) => {
  ...
  let _12 = class extends V5 {
    ...
    initialize() {
      ...
      }, f5.WIDGET)]), j(() => this.ready && this.popupEnabled && !this.updating).then(() => import("./Popup-MDKVVNBE.js"));
    }
    destroy() {
    ...
    async setupPopup() {
      ...
      if ((_a4 = this._popupSetupTask) == null ? void 0 : _a4.abort(), this.popup && !i12(this.popup)) return this._popupSetupTask = d3(async (p27) => {
        if (!this.popupEnabled || !p5(this.popupElement)) if (this.dependencies.popup && "function" == typeof this.dependencies.popup) await this.dependencies.popup(), s2(p27), customElements.get("arcgis-popup") || i.getLogger(this).error(new s("view:undefined-popup-element", "`arcgis-popup` custom element is undefined and can't be opened")), this.popupElement = document.createElement("arcgis-popup");
          ...
          const { default: e30 } = await import("./Popup-MDKVVNBE.js");
...
function r27() {
  return Promise.all([import("./webglDeps-DLZVGKQ6.js"), import("./mapViewDeps-XFD5MR3I.js")]);
}
var a26 = () => r27().then(() => import("./TileLayerView2D-6YC2OQIP.js"));
var t22 = () => r27().then(() => import("./FeatureLayerView2D-XJXSZ4XM.js"));
var i29 = { "base-dynamic": () => r27().then(() => import("./BaseDynamicLayerView2D-O5CNUNW5.js")), "base-tile": a26, "bing-maps": a26, catalog: () => r27().then(() => import("./CatalogLayerView2D-LN7VB4AK.js")), "catalog-dynamic-group": () => r27().then(() => import("./CatalogDynamicGroupLayerView2D-6HO3R56F.js")), "catalog-footprint": () => r27().then(() => import("./CatalogFootprintLayerView2D-WZJF5OCY.js")), csv: t22, "geo-rss": () => r27().then(() => import("./GeoRSSLayerView2D-43DXDTXV.js")), feature: t22, geojson: t22, parquet: t22, graphics: () => r27().then(() => import("./GraphicsLayerView2D-6S6Y7LOO.js")), group: () => r27().then(() => import("./GroupLayerView2D-WPAWEGNE.js")), imagery: () => r27().then(() => import("./ImageryLayerView2D-CFJ2XBGI.js")), "imagery-tile": () => r27().then(() => import("./ImageryTileLayerView2D-ZO6BASZV.js")), kml: () => r27().then(() => import("./KMLLayerView2D-TDHNMSJ6.js")), "knowledge-graph": () => r27().then(() => import("./KnowledgeGraphLayerView2D-SMYWGNID.js")), "link-chart": () => r27().then(() => import("./KnowledgeGraphLayerView2D-SMYWGNID.js")), "knowledge-graph-sublayer": t22, "map-image": () => r27().then(() => import("./MapImageLayerView2D-HMHDOPEF.js")), "map-notes": () => r27().then(() => import("./MapNotesLayerView2D-EFFSXKSF.js")), media: () => r27().then(() => import("./MediaLayerView2D-XHGVGY7N.js")), "ogc-feature": () => r27().then(() => import("./OGCFeatureLayerView2D-PC5AL2KZ.js")), "open-street-map": a26, "oriented-imagery": t22, route: () => r27().then(() => import("./RouteLayerView2D-3ZZJF6GT.js")), stream: () => r27().then(() => import("./StreamLayerView2D-SDCCKRVF.js")), "subtype-group": () => r27().then(() => import("./SubtypeGroupLayerView2D-5QFHRWIC.js")), tile: a26, "vector-tile": () => r27().then(() => import("./VectorTileLayerView2D-RHH6VRUX.js")), video: () => r27().then(() => import("./VideoLayerView2D-K726VOKA.js")), wcs: () => r27().then(() => import("./ImageryTileLayerView2D-ZO6BASZV.js")), "web-tile": a26, wfs: t22, wms: () => r27().then(() => import("./WMSLayerView2D-MU4EJQQV.js")), wmts: () => r27().then(() => import("./WMTSLayerView2D-42K6XYYH.js")), "base-elevation": null, "building-scene": null, dimension: null, elevation: null, "gaussian-splat": null, "integrated-mesh-3dtiles": null, "integrated-mesh": null, "line-of-sight": null, "point-cloud": null, scene: null, unknown: null, unsupported: null, viewshed: null, voxel: null };
function s31(r29) {
...
var l21 = { "area-measurement": null, dimension: null, "direct-line-measurement": null, "elevation-profile": () => import("./ElevationProfileAnalysisView2D-4ZDSDX4X.js"), "line-of-sight": null, slice: null, viewshed: null, "volume-measurement": null };
function n29(n34) {
...
var ie;
async function re() {
  const [, { GraphicsView2D: e30, GraphicContainer: t27, LabelManager: i30, MapViewNavigation: r29, MagnifierView2D: s35, GridView2D: a31, Stage: n34 }] = await Promise.all([import("./webglDeps-DLZVGKQ6.js"), import("./mapViewDeps-XFD5MR3I.js")]);

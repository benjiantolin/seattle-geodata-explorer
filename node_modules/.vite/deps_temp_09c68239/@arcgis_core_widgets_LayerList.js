...
import {
  ...
  u,
  v
} from "./chunk-527OZE77.js";
import "./chunk-B634RVD4.js";
...
var j2 = class extends s2(B) {
  ...
  async _createCatalogLayerList(e7) {
    const { default: t3 } = await import("./CatalogLayerList-UIY566MA.js"), { headingLevel: i3, catalogOptions: o, view: s5, filterPlaceholder: l4, listItemCreatedFunction: r, minFilterItems: a3, selectionMode: n2, visibilityAppearance: d, _onCatalogOpen: p2, _onTablesOpen: c3, layerTablesEnabled: m4 } = this;
  ...
  async _createTableList(e7) {
    const { default: t3 } = await import("./TableList-CBOFOHLX.js"), { headingLevel: i3, selectionMode: o, dragEnabled: s5 } = this;

import {
  i as i9
} from "./chunk-YQ3OPQXI.js";
import {
  a as a6
} from "./chunk-KBYQEO2G.js";
import {
  r as r5
} from "./chunk-XRY732VE.js";
import {
  i as i8
} from "./chunk-LMCXLXMO.js";
import {
  i as i7,
  r as r3,
  s as s6
} from "./chunk-YA4PLG73.js";
import {
  A,
  F,
  b as b5,
  ...
  x2,
  z as z2
} from "./chunk-4BYHFD25.js";
import {
  b as b4
} from "./chunk-PN3U5PJ5.js";
import {
  b as b6
} from "./chunk-XD7DMRWW.js";
import {
  d as d3
} from "./chunk-HVUJKXA6.js";
import {
  y as y3
} from "./chunk-OXXGXV5H.js";
import {
  E
...
import {
  p2 as p4
} from "./chunk-HPJH3AU7.js";
import {
  e as e3,
  u as u7
} from "./chunk-Y3WYJHIR.js";
import {
  t as t2
} from "./chunk-YYGF76T3.js";
import {
  i as i5
} from "./chunk-45BLOVAO.js";
import {
  i as i6
} from "./chunk-XGK3YPUS.js";
import {
  T
} from "./chunk-ITBXONXW.js";
import {
  p as p3
} from "./chunk-L3WMZHKZ.js";
import {
  d as d2
} from "./chunk-WJV2LD7I.js";
import {
  e as e4
...
import {
  p as p2,
  y as y2
} from "./chunk-D46EFYZ4.js";
import {
  ot
} from "./chunk-HNDBSNXW.js";
import {
  n as n3
} from "./chunk-I5LASO46.js";
import {
  c
} from "./chunk-CXDQTGVN.js";
import {
  g as g2
...
__decorate([m2({ type: Boolean })], s7.prototype, "isAggregate", void 0), __decorate([m2({ clonable: "reference" })], s7.prototype, "origin", void 0), s7 = __decorate([a3("esri.AggregateGraphic")], s7);
var i10 = s7;
...
__decorate([m2({ type: Boolean })], s8.prototype, "isAggregate", void 0), __decorate([m2({ clonable: "reference" })], s8.prototype, "origin", void 0), s8 = __decorate([a3("esri.TrackGraphic")], s8);
var i11 = s8;

// node_modules/@arcgis/core/layers/effects/FeatureEffectView.js
var c3 = class extends b {
  constructor(e13) {
    super(e13), this._filter = null, this.duration = has("mapview-transitions-duration"), this._excludedEffectView = new a5(e13), this._includedEffectView = new a5(e13);
  }
  get excludedEffects() {
...
__decorate([m2({ type: [i10], json: { write: true } })], c4.prototype, "features", void 0), __decorate([o("features")], c4.prototype, "readFeatures", null), c4 = __decorate([a3("esri.rest.support.AggregateFeatureSet")], c4);
...
function x3(e13) {
  ...
  return { type: "sprite-rasterization-param", resource: a6(i16), overrides: [] };
}
...
function w3(e13, i16, a10) {
  ...
  return [o14.createMeshInfo({ type: "simple", color: p12, height: c9, width: u17, offsetX: 0, offsetY: 0, angle: 0, alignment: e5(l11) ? 1 : 0, outlineColor: p12, outlineSize: b8 ? i16.width : 0, referenceSize: c9 / n14, sprite: s14, overrideOutlineColor: b8 && null != l11.visualVariableColor, hasSizeVV: A(l11), placement: V2, transforms: null, effects: null, scaleInfo: null, minPixelBuffer: z2(l11) })];
}
function O2(e13, i16) {
  var _a, _b, _c, _d;
  const { uniforms: a10, schemaOptions: l11 } = i16, { store: r12 } = l11;
...
var f6 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const r12 = this.layer, t11 = r7(r12, e13) ?? l8(r12), s14 = e4(r12, e13), a10 = [...r12.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  getUpdateHashProperties(e13) {
    return this.layer.destroyed ? [] : [() => this.layer.apiKey, () => this.layer.customParameters, () => this.layer.definitionExpression, () => e4(this.layer, e13), () => o12(this.layer, e13) ? e13.floors : null, () => this.layer.gdbVersion, () => this.layer.historicMoment, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => this.layer.orderBy, () => this.layer.outFields, () => this.layer.renderer, () => this.layer.subtypeCode, () => this.layer.trackInfo];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
...
var p11 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const t11 = this.layer, n14 = r7(t11, e13) ?? l8(t11), s14 = e4(t11, e13), l11 = [...t11.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.definitionExpression, () => this.layer.displayFilterInfo, () => this.layer.orderBy, () => "outFields" in this.layer ? this.layer.outFields : null, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e4(this.layer, e13), () => "trackInfo" in this.layer ? this.layer.trackInfo : null];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
...
var d8 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.definitionExpression, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e4(this.layer, e13), () => y5(this.layer)];
  }
  hasFilters(e13) {
...
var u15 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.apiKey, () => this.layer.customParameters, () => e4(this.layer, e13), () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => this.layer.orderBy, () => this.layer.renderer];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
...
var m12 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.outFields, () => this.layer.orderBy, () => this.layer.definitionExpression, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e4(this.layer, e13), () => this.layer.customParameters, () => o12(this.layer, e13) ? e13.floors : null];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
...
var y6 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const r12 = this.layer, i16 = r7(r12, e13) ?? l8(r12), n14 = e4(r12, e13), o14 = [...r12.labelingInfo || [], ...(n14 == null ? void 0 : n14.labelingInfo) || []];
    return [{ vvEvaluators: { 0: o7(r12.renderer) }, deconflictionEnabled: i16, labelingInfo: o14 }];
  }
  getUpdateHashProperties(e13) {
    return [() => this.layer.urls.join(","), () => this.layer.outFields, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e4(this.layer, e13), () => this.layer.customParameters, () => this.layer.orderBy, () => this.layer.renderer, () => this.layer.popupTemplate];
  }
  async createSourceSchema(e13, r12) {
...
var s12 = class {
  ...
  getLabelingDeconflictionInfo(r12) {
    const a10 = this.layer, n14 = r7(a10, r12) ?? l8(a10), s14 = e4(a10, r12), o14 = [...a10.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  getUpdateHashProperties(r12) {
    return [() => this.layer.definitionExpression, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e4(this.layer, r12), () => this.layer.customParameters, () => this.layer.geometryDefinition, () => this.layer.definitionExpression, () => this.layer.trackInfo];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
...
var Q = (Q2) => {
  ...
  let A3 = class extends G2 {
    ...
    initialize() {
      ...
      }, () => this._handleChange(), w), a2(() => {
        var _a;
        return (_a = this.view) == null ? void 0 : _a.floors;
      }, "change", () => this._handleChange()), a2(() => {
        var _a;
        return (_a = this.layer.displayFilterInfo) == null ? void 0 : _a.filters;
      }, "change", () => this._handleChange()), a2(() => this.layer && "sublayers" in this.layer ? this.layer.sublayers : null, "change", () => this._handleChange())]);
    }
    get availableFields() {

...
import {
  ...
  n,
  r
} from "./chunk-R5MG3WDT.js";
import {
  f
} from "./chunk-5KAH7A2F.js";
...
var z = class extends b {
  ...
  initialize() {
    ...
    }), l(() => t2.elevationInfo, () => this._snappingElevationAligner.notifyElevationSourceChange(), h), a(() => t2, ["edits", "apply-edits", "graphic-update"], () => this._symbologySnappingFetcher.notifySymbologyChange())]);
  }
  ...
  async _fetchCandidatesForSource(e, t2, o2) {
    var _a;
    const r2 = h3({ parameters: t2, mode: ((_a = this.view) == null ? void 0 : _a.type) ?? "2d" }), s3 = await e.queryEngine.executeQueryForSnapping(r2, o2);
    s(o2);

...
import {
  b as b4,
  h as h3
} from "./chunk-NGDZAB6W.js";
import {
  n as n5
} from "./chunk-2HCUPVL6.js";
...
var R = class extends l2 {
  ...
  async setup({ viewSpatialReference: e12, renderSpatialReference: t5, viewingMode: r4, layerInfo: a10, layerViewInfo: n13 }) {
    ...
    return this._tileManager = new _2({ loadTile: (e13, t6) => this._fetcher.fetch(e13, t6), createAddCommand: (e13, t6) => this._createAddFeatureDataCommand(e13, t6), createRemoveCommand: (e13) => this._createRemoveFeatureDataCommand(e13), createUpdateCommand: (e13, t6) => this._createUpdateFeatureDataVisibilityCommand(e13, t6), tileLocks: this._tileLocks, extent: R2 }), this.addHandles(l(() => this.updating, (e13) => {
...
//# sourceMappingURL=Feature3DPipelineWorker-H37MPA7K.js.map
